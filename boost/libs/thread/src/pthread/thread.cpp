...
//                 }
    ...
    bool thread::start_thread_noexcept()
    {
        ...
        if (res != 0)
        {
            thread_info->self.reset();
            return false;
//            pdalboost::throw_exception(thread_resource_error(res, "boost thread: failed in pthread_create"));
        }
        return true;
    }
...
//            pdalboost::throw_exception(thread_resource_error(res, "boost thread: failed in pthread_create"));
        ...
        if (res != 0)
        {
            thread_info->self.reset();
            return false;
//            pdalboost::throw_exception(thread_resource_error(res, "boost thread: failed in pthread_attr_getdetachstate"));
        }
