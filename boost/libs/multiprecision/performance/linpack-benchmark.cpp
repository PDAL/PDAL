...
typedef pdalboost::multiprecision::cpp_dec_float_50 real_type;
#elif defined(TEST_MPFR_50)
#include <boost/multiprecision/mpfr.hpp>
typedef pdalboost::multiprecision::mpfr_float_50 real_type;
...
extern "C" int MAIN__()
{
   ...
   /* Computing 2nd power */
   d__2 = (real_type) n;
   ops = pdalboost::lexical_cast<double>(real_type(d__1 * (d__1 * d__1) * 2. / 3. + d__2 * d__2 * 2.));
...
pdalboost::multiprecision::ef::cpp_dec_float_50:
~~~~~~~~~~~~~~~~~~~~~~~~~
