...
void basic_tests()
{
   ...
   std::cout << "Allocation Counts for pdalboost::math::tools::evaluate_polynomial:\n";
#ifdef TEST_MPFR
   ...
   time_proc("Bessel Functions - real_concept", test_bessel<pdalboost::math::concepts::real_concept>);
   ...
   time_proc("Non-central T - real_concept", test_nct<pdalboost::math::concepts::real_concept>);
