...
void bessel_tests_1()
{
   ...
   time_proc("mpfr_float_50", test_bessel<pdalboost::multiprecision::mpfr_float_50>, 1);
...
#else
   time_proc("mpfr_float_50", test_bessel<pdalboost::multiprecision::mpfr_float_50>, mpfr_buildopt_tls_p() ? 3 : 1);
