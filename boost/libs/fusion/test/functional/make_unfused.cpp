...
using pdalboost::noncopyable;
typedef mpl::true_ no_nullary_call;

using pdalboost::ref;
using pdalboost::cref;

template <class Base = pdalboost::blank, class RemoveNullary = mpl::false_>
struct test_func
    : Base
{
    ...
    struct result< Self(Seq &) >
        : mpl::if_< mpl::and_< pdalboost::fusion::result_of::empty<Seq>, RemoveNullary >, 
                    pdalboost::blank, mpl::identity<long> >::type
    { };
...
int main()
{
    ...
    pdalboost::fusion::result_of::make_unfused< test_func<> >::type unfused_func =
        fusion::make_unfused(f);

    pdalboost::fusion::result_of::make_unfused< pdalboost::reference_wrapper< 
