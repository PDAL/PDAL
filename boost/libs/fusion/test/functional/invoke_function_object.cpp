...
struct object {};
struct object_nc : pdalboost::noncopyable {};
...
{
    test_sequence_n(seq, mpl::int_<pdalboost::fusion::result_of::size<Sequence>::value>());
}
...
void result_type_tests()
{
    ...
    BOOST_TEST(( is_same< pdalboost::fusion::result_of::invoke_function_object< nullary_fobj, fusion::vector<> >::type, int >::value ));
    BOOST_TEST(( is_same< pdalboost::fusion::result_of::invoke_function_object< fobj, fusion::vector<element1_type> >::type, int >::value ));
    BOOST_TEST(( is_same< pdalboost::fusion::result_of::invoke_function_object< fobj, fusion::vector<element1_type,element2_type> >::type, int >::value ));
}
