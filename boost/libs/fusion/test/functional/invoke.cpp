...
void result_type_tests()
{
    ...
    BOOST_TEST(( is_same<
      pdalboost::fusion::result_of::invoke<int (*)(), fusion::vector0<> >::type, int
    >::value ));
// disabled until pdalboost::result_of supports it
//    BOOST_TEST(( is_same<
//      pdalboost::fusion::result_of::invoke<int (*)(...), fusion::vector1<int> >::type, int
//    >::value ));
    BOOST_TEST(( is_same<
      pdalboost::fusion::result_of::invoke<int (members::*)(), fusion::vector1<members*> >::type, int
    >::value ));
// disabled until pdalboost::result_of supports it
//    BOOST_TEST(( is_same<
//      pdalboost::fusion::result_of::invoke<int (members::*)(...), fusion::vector2<members*,int> >::type, int
//    >::value ));
}
