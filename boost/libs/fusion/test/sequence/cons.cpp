...
/// Testing cons
    
    {
        ...
        *fusion::next(begin(ns)) += ' ';
        ...
        for_each(ns, pdalboost::lambda::_1 += ' ');
...

    {
        ...
        BOOST_TEST((t == nf));
        BOOST_TEST((vector<int>(1) == filter_if<is_same<pdalboost::mpl::_, int> >(nf)));

        std::cout << nf << std::endl;
        std::cout << filter_if<is_same<pdalboost::mpl::_, int> >(nf) << std::endl;
    }
