...
/// Testing the reverse_view
    ...
    {
        typedef pdalboost::mpl::range_c<int, 5, 9> mpl_list1;
        mpl_list1 l;
...

    {
        ...
        typedef pdalboost::fusion::result_of::begin<view_type>::type first_type;
        first_type first_it(begin(rev));
        typedef pdalboost::fusion::result_of::next<first_type>::type second_type;
        ...
        BOOST_MPL_ASSERT((
            pdalboost::is_same<pdalboost::fusion::result_of::value_at_c<view_type,0>::type,char const*>
        ));
        BOOST_MPL_ASSERT((
            pdalboost::is_same<pdalboost::fusion::result_of::value_at_c<view_type,1>::type,long>
        ));
        BOOST_MPL_ASSERT((
            pdalboost::is_same<pdalboost::fusion::result_of::value_at_c<view_type,2>::type,char>
        ));
        BOOST_MPL_ASSERT((
            pdalboost::is_same<pdalboost::fusion::result_of::value_at_c<view_type,3>::type,int>
        ));
    }
