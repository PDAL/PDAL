...
// this creates a fusion view: pdalboost::fusion::adapted::point
...
main()
{
    ...
    { // begin/end
        ...
        typedef pdalboost::fusion::result_of::begin<ns1::s1>::type b;
        typedef pdalboost::fusion::result_of::end<ns1::s1>::type e;
        // this fails
        BOOST_MPL_ASSERT((is_same<pdalboost::fusion::result_of::next<b>::type, e>));
    }
