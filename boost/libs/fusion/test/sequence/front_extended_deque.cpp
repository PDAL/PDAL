...
int main()
{
    ...
    }
    {
        ...
        BOOST_MPL_ASSERT((pdalboost::is_same<mpl::at_c<extended_type, 0>::type, int>));
        BOOST_MPL_ASSERT((pdalboost::is_same<mpl::at_c<extended_type, 1>::type, char>));
        BOOST_MPL_ASSERT((pdalboost::is_same<mpl::at_c<extended_type, 2>::type, long>));
        BOOST_MPL_ASSERT((pdalboost::is_same<mpl::deref<mpl::begin<extended_type>::type>::type, int>));
