...
int main()
{
    using namespace pdalboost::fusion;
    {
        ...
        BOOST_MPL_ASSERT((pdalboost::is_same<pdalboost::fusion::result_of::value_at_c<view,0>::type, vector2<int,char> >));
        BOOST_MPL_ASSERT((pdalboost::is_same<pdalboost::fusion::result_of::value_of<pdalboost::fusion::result_of::begin<view>::type>::type, vector2<int,char> >));
    }
    {
