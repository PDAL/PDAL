...
main()
{
...

    {
        ...
        BOOST_STATIC_ASSERT(pdalboost::fusion::result_of::size<pair_type>::value == 2);
        BOOST_STATIC_ASSERT(!pdalboost::fusion::result_of::empty<pair_type>::value);
...

    {
        ...
        BOOST_MPL_ASSERT((pdalboost::is_same<int, mpl::front<pair_type>::type>));
    }
