...
process_tree(Tree const &tree)
{
    ...
    typedef typename pdalboost::fusion::result_of::find_if<Tree const, is_same<_,short> >::type short_iter;
    typedef typename pdalboost::fusion::result_of::find_if<Tree const, is_same<_,float> >::type float_iter;
