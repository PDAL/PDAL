...
using pdalboost::fusion::vector;
using pdalboost::fusion::make_vector;
using pdalboost::fusion::tuple_close;
using pdalboost::fusion::tuple_open;
using pdalboost::fusion::tuple_delimiter;
