...
main()
{
...

    {
        ...
        *begin(view1) += 4;
        ...
        BOOST_TEST(at<pdalboost::mpl::int_<0> >(view1) == 3);
        ...
        BOOST_TEST(end(view1) == advance<pdalboost::mpl::int_<1> >(begin(view1)));
        BOOST_TEST(begin(view1) == advance<pdalboost::mpl::int_<0> >(begin(view1)));
        BOOST_TEST(end(view1) == advance<pdalboost::mpl::int_<0> >(end(view1)));
        BOOST_TEST(begin(view1) == advance<pdalboost::mpl::int_<-1> >(end(view1)));
        ...
        BOOST_MPL_ASSERT((pdalboost::is_same<int, pdalboost::fusion::result_of::value_at<single_view<int>, pdalboost::mpl::int_<0> >::type>));
