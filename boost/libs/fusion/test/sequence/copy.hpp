...
pdalboost::fusion::FUSION_SEQUENCE<double, double, double, double>
foo(int i)
{
   return pdalboost::fusion::FUSION_MAKE(i, i+1, i+2, i+3);
}
...
void test_mpl()
{
    ...
    typedef
        pdalboost::mpl::insert_range<
            pdalboost::mpl::vector<>
          , pdalboost::mpl::end< pdalboost::mpl::vector<> >::type
          , seq
        >::type
    sequence;

    typedef pdalboost::mpl::equal<sequence, pdalboost::mpl::vector<int, char> > equal;
