...
{
    template<typename T>
    struct apply : pdalboost::mpl::false_
    {};
};
...
main()
{
    ...
    using pdalboost::mpl::int_;
    using pdalboost::mpl::_;
    using pdalboost::mpl::not_;
    using pdalboost::mpl::less;
    using pdalboost::mpl::vector_c;
...

    {
        ...
        BOOST_STATIC_ASSERT(pdalboost::fusion::result_of::size<filter_view_type>::value == 4);
    }
...

    {
        ...
        BOOST_MPL_ASSERT((pdalboost::fusion::result_of::equal_to<pdalboost::fusion::result_of::begin<filter_view_type>::type, pdalboost::fusion::result_of::end<filter_view_type>::type>));
    }

    {
        ...
        BOOST_MPL_ASSERT((pdalboost::fusion::result_of::has_key<filter_view_type, double>::type));
        BOOST_MPL_ASSERT_NOT((pdalboost::fusion::result_of::has_key<filter_view_type, void>::type));

        BOOST_MPL_ASSERT((is_same<pdalboost::fusion::result_of::key_of<pdalboost::fusion::result_of::begin<filter_view_type>::type>::type, double>));
        BOOST_MPL_ASSERT((is_same<pdalboost::fusion::result_of::value_of_data<pdalboost::fusion::result_of::begin<filter_view_type>::type>::type, std::string>));
