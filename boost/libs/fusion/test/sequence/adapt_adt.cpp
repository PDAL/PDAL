...
namespace ns
{
    ...
    {
        friend struct pdalboost::fusion::extension::access;
...
main()
{
...
#if !BOOST_WORKAROUND(__GNUC__,<4)
    {
        ...
        BOOST_STATIC_ASSERT(pdalboost::fusion::result_of::size<ns::point_with_private_members>::value == 2);
        BOOST_STATIC_ASSERT(!pdalboost::fusion::result_of::empty<ns::point_with_private_members>::value);
...

    {
        BOOST_MPL_ASSERT((
            pdalboost::is_same<
                pdalboost::fusion::result_of::front<ns::point>::type,
                pdalboost::fusion::extension::adt_attribute_proxy<ns::point,0,false>
            >));
        BOOST_MPL_ASSERT((
            pdalboost::is_same<
                pdalboost::fusion::result_of::front<ns::point>::type::type,
                int
            >));
        BOOST_MPL_ASSERT((
            pdalboost::is_same<
                pdalboost::fusion::result_of::front<ns::point const>::type,
                pdalboost::fusion::extension::adt_attribute_proxy<ns::point,0,true>
            >));
        BOOST_MPL_ASSERT((
            pdalboost::is_same<
                pdalboost::fusion::result_of::front<ns::point const>::type::type,
                int
            >));
    }
