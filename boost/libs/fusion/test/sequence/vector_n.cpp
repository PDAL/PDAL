...
main()
{
...

    {
        ...
        std::cout << (pdalboost::is_empty<vector0<> >::value ? "is empty" : "is not empty") << std::endl;
    }

    {
        typedef vector1<int> type;
        type vec;
        BOOST_STATIC_ASSERT(pdalboost::fusion::result_of::size<type>::value == 1);

        BOOST_TEST(at_c<0>(vec) == 0);
        BOOST_STATIC_ASSERT((pdalboost::is_same<int, pdalboost::fusion::result_of::value_at_c<type, 0>::type>::value));
...

    {
        ...
        type vec;
        BOOST_STATIC_ASSERT(pdalboost::fusion::result_of::size<type>::value == 2);

        BOOST_TEST(at_c<0>(vec) == 0);
        BOOST_TEST(at_c<1>(vec) == char());

        BOOST_STATIC_ASSERT((pdalboost::is_same<int, pdalboost::fusion::result_of::value_at_c<type, 0>::type>::value));
        BOOST_STATIC_ASSERT((pdalboost::is_same<char, pdalboost::fusion::result_of::value_at_c<type, 1>::type>::value));
    }
...

    {
        ...
        type vec;
        BOOST_STATIC_ASSERT(pdalboost::fusion::result_of::size<type>::value == 3);
        ...
        BOOST_STATIC_ASSERT((pdalboost::is_same<int, pdalboost::fusion::result_of::value_at_c<type, 0>::type>::value));
        BOOST_STATIC_ASSERT((pdalboost::is_same<char, pdalboost::fusion::result_of::value_at_c<type, 1>::type>::value));
        BOOST_STATIC_ASSERT((pdalboost::is_same<double, pdalboost::fusion::result_of::value_at_c<type, 2>::type>::value));
    }
...

    {
        ...
        BOOST_STATIC_ASSERT((pdalboost::is_same<bool, pdalboost::fusion::result_of::value_at_c<type, 0>::type>::value));
        BOOST_STATIC_ASSERT((pdalboost::is_same<char, pdalboost::fusion::result_of::value_at_c<type, 1>::type>::value));
        BOOST_STATIC_ASSERT((pdalboost::is_same<short, pdalboost::fusion::result_of::value_at_c<type, 2>::type>::value));
        BOOST_STATIC_ASSERT((pdalboost::is_same<int, pdalboost::fusion::result_of::value_at_c<type, 3>::type>::value));
        BOOST_STATIC_ASSERT((pdalboost::is_same<long, pdalboost::fusion::result_of::value_at_c<type, 4>::type>::value));
        BOOST_STATIC_ASSERT((pdalboost::is_same<float, pdalboost::fusion::result_of::value_at_c<type, 5>::type>::value));
        BOOST_STATIC_ASSERT((pdalboost::is_same<double, pdalboost::fusion::result_of::value_at_c<type, 6>::type>::value));
