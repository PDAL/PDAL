...
/// Testing joint_view
...

    {
        ...
        BOOST_MPL_ASSERT((pdalboost::fusion::result_of::has_key<joint_view_type, void>::type));
        BOOST_MPL_ASSERT((pdalboost::fusion::result_of::has_key<joint_view_type, std::string>::type));
        BOOST_MPL_ASSERT((pdalboost::fusion::result_of::has_key<joint_view_type, float>::type));

        BOOST_MPL_ASSERT((pdalboost::is_same<pdalboost::fusion::result_of::key_of<pdalboost::fusion::result_of::begin<joint_view_type>::type>::type, void>));
        BOOST_MPL_ASSERT((pdalboost::is_same<pdalboost::fusion::result_of::key_of<pdalboost::fusion::result_of::next<pdalboost::fusion::result_of::begin<joint_view_type>::type>::type>::type, std::string>));
        BOOST_MPL_ASSERT((pdalboost::is_same<
                pdalboost::fusion::result_of::key_of<pdalboost::fusion::result_of::next<pdalboost::fusion::result_of::next<pdalboost::fusion::result_of::begin<joint_view_type>::type>::type>::type>::type
              , float>));

        BOOST_MPL_ASSERT((pdalboost::is_same<pdalboost::fusion::result_of::value_of_data<pdalboost::fusion::result_of::begin<joint_view_type>::type>::type, int>));
        BOOST_MPL_ASSERT((pdalboost::is_same<pdalboost::fusion::result_of::value_of_data<pdalboost::fusion::result_of::next<pdalboost::fusion::result_of::begin<joint_view_type>::type>::type>::type, std::string>));
        BOOST_MPL_ASSERT((pdalboost::is_same<
                pdalboost::fusion::result_of::value_of_data<pdalboost::fusion::result_of::next<pdalboost::fusion::result_of::next<pdalboost::fusion::result_of::begin<joint_view_type>::type>::type>::type>::type
              , float>));
