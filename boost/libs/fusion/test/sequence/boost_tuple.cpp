...
main()
{
    ...
    {
        typedef pdalboost::tuple<int, std::string> tuple_type;
        ...
        BOOST_STATIC_ASSERT(pdalboost::fusion::result_of::size<tuple_type>::value == 2);
        BOOST_STATIC_ASSERT(!pdalboost::fusion::result_of::empty<tuple_type>::value);
    ...
    
    {
        ...
        pdalboost::tuple<short, float> v2(5, 3.3f);
    ...
    { 
        ...
        pdalboost::tuple<int, char> t(3, 'a'); 
...

    {
        ...
        BOOST_MPL_ASSERT((pdalboost::is_same<int, mpl::front<tuple_type>::type>));
    }
