...
using pdalboost::reference_wrapper;
using pdalboost::fusion::traits::deduce;
using pdalboost::fusion::traits::deduce_sequence;
...
#define TEST_SAME_ELEMENTS(a,b) BOOST_TEST(( pdalboost::mpl::equal< a, b >::type::value ))
