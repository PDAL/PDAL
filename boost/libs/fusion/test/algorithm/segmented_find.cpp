...
process_tree(Tree const &tree)
{
    ...
    typedef typename pdalboost::fusion::result_of::find<Tree const, short>::type short_iter;
    typedef typename pdalboost::fusion::result_of::find<Tree const, float>::type float_iter;
    typedef typename pdalboost::fusion::result_of::find<Tree const, not_there>::type not_there_iter;
