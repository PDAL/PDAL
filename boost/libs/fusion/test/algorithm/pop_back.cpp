...
/// Testing pop_back
    ...
    {
        typedef pdalboost::mpl::vector_c<int, 1, 2, 3, 4, 5> mpl_vec;
        std::cout << pdalboost::fusion::pop_back(mpl_vec()) << std::endl;
        BOOST_TEST((pdalboost::fusion::pop_back(mpl_vec()) == make_vector(1, 2, 3, 4)));
    }
    ...
    {
        pdalboost::array<std::size_t, 2> a = { 10, 50 };
