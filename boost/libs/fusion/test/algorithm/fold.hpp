...
struct sum
{
    ...
    struct result<Self(State,T)>
      : pdalboost::fusion::result_of::make_pair<
            mpl::int_<
                pdalboost::remove_reference<
                    State
        ...
        >
    {
        BOOST_MPL_ASSERT((typename pdalboost::is_reference<State>::type));
        BOOST_MPL_ASSERT((typename pdalboost::is_reference<T>::type));
    };
...
struct meta_sum
{
    ...
    struct result<Self(State,T)>
    {
        ...
        typedef typename pdalboost::remove_reference<State>::type state;
        static const int n=mpl::front<state>::type::value;

#ifdef BOOST_FUSION_TEST_ITER_FOLD
        typedef typename
            pdalboost::fusion::result_of::value_of<
...
struct fold_test_n
{
    ...
    operator()(I)const
    {
...

        {
            ...
            typename pdalboost::fusion::result_of::as_vector<
...

        {
            typedef typename
#ifdef BOOST_FUSION_TEST_REVERSE_FOLD
                pdalboost::fusion::result_of::as_vector<
                    typename mpl::copy<
                ...
                >::type
#else
                pdalboost::fusion::result_of::as_vector<mpl::range_c<int, 1, n+1> >::type
#endif
            vec;

            typedef
                pdalboost::is_same<
                    typename pdalboost::fusion::result_of::BOOST_FUSION_TEST_FOLD_NAME<
                        vec
