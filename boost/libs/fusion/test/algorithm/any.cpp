...
{
    {
        ...
        BOOST_TEST(pdalboost::fusion::any(t, pdalboost::lambda::_1 == 2));
    }

    {
        pdalboost::fusion::vector<int, short, double> t(1, 2, 3.3);
        BOOST_TEST(!pdalboost::fusion::any(t, pdalboost::lambda::_1 == 3));
    }

    {
        ...
        BOOST_TEST(pdalboost::fusion::any(mpl_vec(), search_for(2)));
        BOOST_TEST(!pdalboost::fusion::any(mpl_vec(), search_for(4)));
    }
