...
struct add_ints_only
{
    ...
    struct result<add_ints_only(State, T)>
    {
        typedef typename pdalboost::remove_const<
            typename pdalboost::remove_reference<State>::type>::type type;
    };
...
struct count_ints
{
    ...
    {
        typedef typename pdalboost::remove_const<
            typename pdalboost::remove_reference<CountT>::type>::type state;
        typedef typename pdalboost::remove_const<
            typename pdalboost::remove_reference<T>::type>::type elem;

        typedef typename
            if_<
                is_same<elem, int>
              , typename pdalboost::mpl::next<state>::type
              , state
            >::type
        type;
    };
...
main()
{
    ...
    {
        typedef pdalboost::mpl::vector<int, char, int, double, int> mpl_vec;
