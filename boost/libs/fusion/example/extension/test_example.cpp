...
int main()
{
    ...
    BOOST_MPL_ASSERT((pdalboost::is_same<result_of::value_of<first>::type, std::string>));
    BOOST_MPL_ASSERT((pdalboost::is_same<result_of::value_of<second>::type, int>));
    ...
    BOOST_MPL_ASSERT((pdalboost::is_same<result_of::value_at_c<example::example_struct, 0>::type, std::string>));
    BOOST_MPL_ASSERT((pdalboost::is_same<result_of::value_at_c<example::example_struct, 1>::type, int>));

    BOOST_MPL_ASSERT((pdalboost::is_same<result_of::value_at_key<example::example_struct, fields::name>::type, std::string>));
    BOOST_MPL_ASSERT((pdalboost::is_same<result_of::value_at_key<example::example_struct, fields::age>::type, int>));
