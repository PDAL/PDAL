...
namespace
{
    struct zip_add
    {
        ...
        struct result
        {
            typedef typename 
                pdalboost::remove_reference<
                    typename pdalboost::fusion::result_of::value_at_c<Lhs, 0>::type 
                >::type
            type;
        };
        ...
        {
            return pdalboost::fusion::at_c<0>(lhs) + pdalboost::fusion::at_c<1>(lhs) + rhs;
        }
    };
    ...
    struct zip_accumulator
    {
        ...
        {
            this->sum += pdalboost::fusion::accumulate(seq, 0, zip_add());
        }
