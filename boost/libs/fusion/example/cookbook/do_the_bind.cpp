...
namespace impl
{
    ...
    namespace traits = pdalboost::fusion::traits;
    namespace result_of = pdalboost::fusion::result_of;
    ...
    public:
        ...
        struct result< Self (T) >
            : mpl::eval_if< is_placeholder<T>, 
                result_of::at<FinalArgs,typename pdalboost::remove_reference<T>::type>,
                mpl::identity<T>
            >
        { };
    };
    ...
    public:
        ...
        struct result< Self (FinalArgs) >
            : result_impl< typename pdalboost::remove_reference<FinalArgs>::type > 
        { };
    ...
    struct fused_binder
    {
        ...
        struct result_impl
        {
            typedef pdalboost::forward_adapter<fusion::unfused< 
        ...
        struct result< Self (BindArgs) >
            : result_impl< typename pdalboost::remove_reference<BindArgs>::type >
        { };
    ...
    typedef pdalboost::lightweight_forward_adapter< fusion::unfused<fused_binder> > binder;
}
