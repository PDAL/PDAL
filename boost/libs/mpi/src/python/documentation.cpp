...
const char* module_docstring = 
  ...
  "    pdalboost::mpi::python::register_serialized\n"
  "\n"
  ...
  "    pdalboost::mpi::python::register_skeleton_and_content\n"
  ...
  "  means sending and receiving values of type pdalboost::python::object, from\n"
  ...
  "    pdalboost::python::object value;\n"
  "    comm.recv(0, 0, value);\n"
  "    int int_value = pdalboost::python::extract<int>(value);\n\n"
