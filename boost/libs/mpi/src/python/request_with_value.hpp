...
namespace pdalboost {} namespace boost = pdalboost; namespace pdalboost { namespace mpi { namespace python {
  ...
  /** This wrapper adds a @c pdalboost::python::object value to the @c
   * pdalboost::mpi::request structure, for the benefit of @c irecv() requests.
   *
   ...
   * python::object is part of a pdalboost::mpi::python::content object: the
  ...
  { 
    private:
      pdalboost::shared_ptr<pdalboost::python::object> m_internal_value;
      pdalboost::python::object *m_external_value;
    ...
    public:
      ...
      const pdalboost::python::object get_value() const;
      const pdalboost::python::object get_value_or_none() const;

      const pdalboost::python::object wrap_wait();
      const pdalboost::python::object wrap_test();
