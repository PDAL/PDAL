...
namespace pdalboost {} namespace boost = pdalboost; namespace pdalboost { namespace mpi { namespace python { namespace detail {

  pdalboost::python::object skeleton_proxy_base_type; 
...
} } } } // end namespace pdalboost::mpi::python::detail
