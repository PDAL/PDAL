...
namespace pdalboost {} namespace boost = pdalboost; namespace pdalboost { namespace archive {
...
template class detail::archive_serializer_map<
  mpi::detail::forward_skeleton_iarchive<
    pdalboost::mpi::packed_skeleton_iarchive, pdalboost::mpi::packed_iarchive> > ;

} } // end namespace pdalboost::archive
