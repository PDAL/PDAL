...
main() 
{
  ...
  typedef pdalboost::date_time::utc_adjustment<time_duration,-5> us_eastern_offset_adj;
  //Type that embeds rules for UTC-5 plus DST offset
  typedef pdalboost::date_time::static_local_time_adjustor<ptime, 
                                                  us_dst, 
  ...
  check("check local offset-dst flag on",   
        us_eastern::local_to_utc_offset(t11, pdalboost::date_time::is_dst) == hours(4));
  check("check local offset-dst flag override",   
        us_eastern::local_to_utc_offset(t11, pdalboost::date_time::not_dst) == hours(5));
  ...
  check("check local dst start boundary case",   
        us_eastern::local_to_utc_offset(l_in_dst, pdalboost::date_time::is_dst) == hours(4));
  ...
  check("check local dst end boundary case - still dst",   
        us_eastern::local_to_utc_offset(dst_end, pdalboost::date_time::is_dst) == hours(4));
  check("check local dst end boundary case - still dst",   
        us_eastern::local_to_utc_offset(dst_end, pdalboost::date_time::not_dst) == hours(5));
  ...
  typedef pdalboost::date_time::utc_adjustment<time_duration,-7> us_az_offset_adj;
  typedef pdalboost::date_time::null_dst_rules<date, time_duration> us_az_dst_adj;
  ...
  typedef pdalboost::date_time::local_adjustor<ptime, -7, no_dst> us_arizona;
  ...
  typedef pdalboost::date_time::local_adjustor<ptime, -5, us_dst> us_eastern2;
  ...
  typedef pdalboost::date_time::local_adjustor<ptime, -5, us_dst_calc2> us_eastern3;
  {
    ptime t7a(date(2002,May,31), hours(17)); 
  ...
  //still experimental
  typedef pdalboost::date_time::dynamic_local_time_adjustor<ptime, us_dst> lta;
