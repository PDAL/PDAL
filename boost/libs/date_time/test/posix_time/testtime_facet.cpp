...
int main() {
  ...
  try {
    ...
    {
      pdalboost::gregorian::date date(2009, 1, 1);
      pdalboost::posix_time::time_duration td(0, 0, 0, 0);
      pdalboost::posix_time::ptime boost_time(date, td);
      std::stringstream sstr;
    
      pdalboost::posix_time::time_facet* pFacet = new pdalboost::posix_time::time_facet("");
