...
main()
{
  ...
  time_duration td2= pdalboost::date_time::parse_delimited_time_duration<time_duration>(s2);
  check("parse time duration: " + s2, 
        td2 == time_duration(12,11,10,123456789));
  std::string s3("12:11:10");
  time_duration td3= pdalboost::date_time::parse_delimited_time_duration<time_duration>(s3);
  check("parse time duration: " + s3, 
        td3 == time_duration(12,11,10,0));
  std::string s4("23:59:59.000000001");
  time_duration td4= pdalboost::date_time::parse_delimited_time_duration<time_duration>(s4);
  check("parse time duration: " + s4, 
        td4 == time_duration(23,59,59)+nanosec(1));
  std::string s5("23:59:59.999999999");
  time_duration td5= pdalboost::date_time::parse_delimited_time_duration<time_duration>(s5);
  check("parse time duration: " + s5, 
        td5 == time_duration(23,59,59)+nanosec(999999999));
  std::string s5b("-23:59:59.999999999");
  time_duration td5b= pdalboost::date_time::parse_delimited_time_duration<time_duration>(s5b);
  check("parse time duration: " + s5b, 
        td5b == time_duration(-23,59,59)-nanosec(999999999));
  
  std::string s6b("1:00:00.1"); // we want 1/10th
  time_duration td6b= pdalboost::date_time::parse_delimited_time_duration<time_duration>(s6b);
  ...
  time_duration td7b= pdalboost::date_time::parse_delimited_time_duration<time_duration>(s7b);
  ...
  time_duration td8b= pdalboost::date_time::parse_delimited_time_duration<time_duration>(s8b);
  ...
  pdalboost::date_time::split(ts1, ' ', date_1, tod_1);
...
//   std::cout << tod_1  << "|" << std::endl;
  ...
  time_duration td6= pdalboost::date_time::parse_undelimited_time_duration<time_duration>(s6);
  check("parse time duration: " + s6, 
        td6 == time_duration(23,58,59));

  s6 = "-235859";
  td6= pdalboost::date_time::parse_undelimited_time_duration<time_duration>(s6);
