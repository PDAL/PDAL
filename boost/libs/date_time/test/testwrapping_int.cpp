...
//   wrapping_int<pdalboost::int64_t, 86400*100000LL> wi4(0);
//   check("construction/conversion", wi4 == 0);
//   pdalboost::int64_t off2 = 372300000;
//   pdalboost::int64_t wrap = 86400LL*100000LL;
//   pdalboost::int64_t wrap2 = 86400000000;
//   wrapping_int<pdalboost::int64_t,86400000000LL> wi5((3600*1 + 60*2 + 3)*100000);
//   std::cout << wi5 << std::endl;
//   pdalboost::int64_t over = wi4.add(off2);
