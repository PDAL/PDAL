...
main() 
{
  ...
  pdalboost::int64_t one_hour_milli = 3600*1000;
  check("milli tick calculations",  
  ...
  pdalboost::int64_t one_hour_micro = 3600*1000;
  ...
  pdalboost::int64_t one_minute_nano = 60*1000*1000;
...
#endif
  pdalboost::int64_t one_hour_nano = one_hour_micro*1000;
#if (defined(BOOST_MSVC) && (_MSC_VER < 1300))
#else
