...
int main(){
  ...
  using namespace pdalboost::local_time;
  ...
  typedef pdalboost::date_time::time_facet<local_date_time, char> ldt_facet;
  ...
  typedef pdalboost::date_time::time_facet<ptime, char> pt_facet;
  ...
  typedef pdalboost::date_time::time_facet<local_date_time, wchar_t> wldt_facet;
