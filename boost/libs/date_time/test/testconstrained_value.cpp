...
public:
  ...
  static void on_error(unsigned int&, unsigned int, pdalboost::CV::violation_enum)
  {
    throw bad_day();
  }
};
...
typedef pdalboost::CV::simple_exception_policy<int,1,10,range_error> one_to_ten_range_policy;

int main()
{
  using namespace pdalboost::CV;
