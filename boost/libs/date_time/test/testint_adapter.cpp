...
void test_int()
{
  ...
  check("as_special convert", pdalboost::date_time::neg_infin == i.as_special() );
  check("as_special convert", pdalboost::date_time::neg_infin == int_type::to_special(i.as_number()) );
  int_type h = int_type::neg_infinity();
  i = int_type::pos_infinity();
  check("is infinity", i.is_infinity());
  check("as_special convert", pdalboost::date_time::pos_infin == i.as_special() );
  ...
  int_type k = 1;
  check("as_special convert", pdalboost::date_time::not_special == k.as_special() );
  check("equal",             i == k);
  ...
  check("as_special convert", pdalboost::date_time::not_a_date_time == i.as_special() );
  ...
  check("from special ", 
        int_type::from_special(pdalboost::date_time::pos_infin) == int_type::pos_infinity());
  check("from special ", 
        int_type::from_special(pdalboost::date_time::neg_infin) == int_type::neg_infinity());
  check("from special ", 
        int_type::from_special(pdalboost::date_time::not_a_date_time) == int_type::not_a_number());
  check("from special ", 
        int_type::from_special(pdalboost::date_time::min_date_time) == (int_type::min)());
  check("from special ", 
        int_type::from_special(pdalboost::date_time::max_date_time) == (int_type::max)());
}

int
main() 
{
  using namespace pdalboost::date_time;

  print< int_adapter<unsigned long> >();
  test_int< int_adapter<unsigned long> >();
  print< int_adapter<long> >();
  test_int< int_adapter<long> >();
  print< int_adapter<pdalboost::int64_t> >();
  test_int< int_adapter<pdalboost::int64_t> >();
