...
wtest_format(const std::basic_string<wchar_t>& format,
             ...
             pdalboost::gregorian::date expected_res)
{
  typedef pdalboost::date_time::format_date_parser<date, wchar_t> parser_type;
...
test_format(const std::basic_string<char>& format,
            ...
            pdalboost::gregorian::date expected_res)
{
  typedef pdalboost::date_time::format_date_parser<date, char> parser_type;
...
void
test_format2(pdalboost::date_time::format_date_parser<date, charT>& parser,
...
main()
{
...

  {
    try {
      ...
      pdalboost::date_time::format_date_parser<date,wchar_t> pt(format, 
                                                            wshort_month_names,
                                                            wlong_month_names,
                                                            wshort_week_names,
                                                            wlong_week_names);
...

  {
    ...
    pdalboost::date_time::format_date_parser<date,char> parser(format, 
                                                           roman_month_names,
                                                           long_month_names,
                                                           short_week_names,
                                                           long_week_names);
