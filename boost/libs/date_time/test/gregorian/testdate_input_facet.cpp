...
bool failure_test(temporal_type component,
                  ...
                  pdalboost::gregorian::date_input_facet* facet)
{
...
int main(){
...

  {
    ...
    typedef pdalboost::date_time::format_date_parser<date, char> date_parser;
    ...
    typedef pdalboost::date_time::date_generator_parser<date,char> date_gen_parser;
