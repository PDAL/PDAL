...
//#ifndef BOOST_NO_STD_LOCALE
  ...
  typedef pdalboost::date_time::all_date_names_put<facet_config> date_facet;
  typedef pdalboost::date_time::date_names_put<facet_config> date_facet_base;
  typedef pdalboost::date_time::ostream_month_formatter<date_facet_base> month_formatter;
  ...
  date_facet gdnp(de_short_month_names, de_long_month_names, 
                  ...
                  '.', 
                  pdalboost::date_time::ymd_order_dmy);
...
//         ss.str() == std::string("Oktober"));
  ...
  typedef pdalboost::date_time::ostream_ymd_formatter<greg_year_month_day, date_facet_base> ymd_formatter;
  ss.str(""); //reset string stream 
  ...
  typedef pdalboost::date_time::ostream_date_formatter<date, date_facet_base> datef;
...
//   //Locale tests
  ...
  check("facet registered here",
        std::has_facet<pdalboost::date_time::date_names_put<facet_config> >(global2));
...
//   // date formatter that takes locale and gets facet from locale
  std::locale german_dates1(global, 
                            new date_facet(de_short_month_names, 
                                           ...
                                           '.',
                                           pdalboost::date_time::ymd_order_dmy,
                                           pdalboost::date_time::month_as_integer));
  ...
  std::locale german_dates2(global, 
                            new date_facet(de_short_month_names, 
                                           ...
                                           de_long_weekday_names,
                                           ' ',
                                           pdalboost::date_time::ymd_order_iso,
                                           pdalboost::date_time::month_as_short_string));
  ...
  std::locale german_dates3(global, 
                            new date_facet(de_short_month_names, 
                                           ...
                                           de_long_weekday_names,
                                           ' ',
                                           pdalboost::date_time::ymd_order_us,
                                           pdalboost::date_time::month_as_long_string));
  ...
  dur = date_duration(pdalboost::date_time::pos_infin);
  ss2.str("");
  ss2 << dur;
