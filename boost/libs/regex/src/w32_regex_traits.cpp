...
namespace pdalboost {} namespace boost = pdalboost; namespace pdalboost{ namespace re_detail{
...
void w32_regex_traits_char_layer<char>::init() 
{
   ...
   if(cat)
   {
      ...
      {
         string_type mss = ::pdalboost::re_detail::w32_cat_get(cat, this->m_locale, i, get_default_syntax(i));
   ...
   do
   {
      if(m_char_map[i] == 0)
      {
         if(::pdalboost::re_detail::w32_is(this->m_locale, 0x0002u, (char)i)) 
            m_char_map[i] = regex_constants::escape_type_class;
         else if(::pdalboost::re_detail::w32_is(this->m_locale, 0x0001u, (char)i)) 
