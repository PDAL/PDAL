...
shared_ptr_helper::append(const pdalboost::shared_ptr<const void> &sp){
    // make tracking array if necessary
    if(NULL == m_pointers)
        m_pointers = new collection_type;
...
BOOST_ARCHIVE_DECL(void)
shared_ptr_helper::append(const pdalboost_132::shared_ptr<const void> & t){
    if(NULL == m_pointers_132)
        m_pointers_132 = new std::list<pdalboost_132::shared_ptr<const void> >;
