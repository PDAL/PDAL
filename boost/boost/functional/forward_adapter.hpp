...
#   define BOOST_TMP_MACRO(f,fn,fc) \
        pdalboost::detail::forward_adapter_impl< \
    ...
    namespace detail
    {
        ...
        struct forward_adapter_result::apply< Self() >
            : pdalboost::result_of< BOOST_DEDUCED_TYPENAME c<Self>::t() >
        { };

        template< class MD, class F, class FC >
        struct forward_adapter_impl<MD,F,FC,0,0>
        {
            inline typename pdalboost::result_of< FC() >::type
            operator()() const
            {
                return static_cast<MD const*>(this)->target_function()();
            }

            inline typename pdalboost::result_of< F() >::type
            operator()()
            {
...
#       define BOOST_TMP_MACRO(tpl_params,arg_types,params,args)              \
            template< tpl_params >                                             \
            inline typename pdalboost::result_of< FC(arg_types) >::type            \
            operator()(params) const                                           \
            {                                                                  \
                return static_cast<MD const*>(this)->target_function()(args);  \
            }                                                                  \
            template< tpl_params >                                             \
            inline typename pdalboost::result_of< F(arg_types)>::type              \
            operator()(params)                                                 \
            {                                                                  \
...
#       undef BOOST_TMP_MACRO
    ...
    struct result_of<pdalboost::forward_adapter<F,A0,A1> const ()>
        : pdalboost::detail::forward_adapter_result::template apply<
            pdalboost::forward_adapter<F,A0,A1> const () >
    { };
    template<class F, int A0, int A1>
    struct result_of<pdalboost::forward_adapter<F,A0,A1>()>
        : pdalboost::detail::forward_adapter_result::template apply<
            pdalboost::forward_adapter<F,A0,A1>() >
    { };
    template<class F, int A0, int A1>
    struct result_of<pdalboost::forward_adapter<F,A0,A1> const& ()>
        : pdalboost::detail::forward_adapter_result::template apply<
...
#         endif
        ...
        struct forward_adapter_impl<MD,F,FC,BOOST_PP_DEC(N),N>
        {
            ...
            inline typename pdalboost::result_of< F(
...
#       if BOOST_WORKAROUND(BOOST_MSVC,BOOST_TESTED_AT(1400)) 
            template< BOOST_PP_ENUM_PARAMS(N,typename T) >
            inline typename pdalboost::result_of<  FC(BOOST_PP_ENUM_PARAMS(N,PT)) 
                >::type
            ...
            template< BOOST_PP_ENUM_PARAMS(N,typename T) >
            inline typename pdalboost::result_of<  F(BOOST_PP_ENUM_PARAMS(N,PT))
                >::type
