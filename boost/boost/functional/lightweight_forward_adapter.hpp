...
namespace pdalboost {} namespace boost = pdalboost; namespace pdalboost 
{
    ...
    namespace detail
    {
        ...
        struct lightweight_forward_adapter_result
        {
            ...
            template< typename T > struct x< pdalboost::reference_wrapper<T> >
            { typedef T& t; };
...
#   define BOOST_TMP_MACRO(f,fn,fc) \
        pdalboost::detail::lightweight_forward_adapter_impl< \
...
#       include BOOST_PP_ITERATE()
    ...
    struct result_of<pdalboost::lightweight_forward_adapter<F,A0,A1> const ()>
        : pdalboost::detail::lightweight_forward_adapter_result::template apply<
            pdalboost::lightweight_forward_adapter<F,A0,A1> const () >
    { };
    template<class F, int A0, int A1>
    struct result_of<pdalboost::lightweight_forward_adapter<F,A0,A1>()>
        : pdalboost::detail::lightweight_forward_adapter_result::template apply<
            pdalboost::lightweight_forward_adapter<F,A0,A1>() >
    { };
    template<class F, int A0, int A1>
    struct result_of<pdalboost::lightweight_forward_adapter<F,A0,A1> const& ()>
        : pdalboost::detail::lightweight_forward_adapter_result::template apply<
...
#     define N BOOST_PP_ITERATION() 
            ...
            : lightweight_forward_adapter_result
        {
            ...
            inline typename pdalboost::result_of< F(BOOST_PP_ENUM_BINARY_PARAMS(N,
