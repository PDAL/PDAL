...
namespace pdalboost {} namespace boost = pdalboost; namespace pdalboost{ namespace multiprecision{ namespace backends{
...
struct tommath_int
{
   typedef mpl::list<pdalboost::int32_t, long long>             signed_types;
   typedef mpl::list<pdalboost::uint32_t, unsigned long long>   unsigned_types;
   ...
   //
   tommath_int& operator = (pdalboost::uint32_t i)
   {
      if(m_data.dp == 0)
         detail::check_tommath_result(mp_init(&m_data));
   ...
   tommath_int& operator = (pdalboost::int32_t i)
   {
      if(m_data.dp == 0)
         detail::check_tommath_result(mp_init(&m_data));
      bool neg = i < 0;
      *this = static_cast<pdalboost::uint32_t>(std::abs(i));
      if(neg)
         detail::check_tommath_result(mp_neg(&m_data, &m_data));
      return *this;
   }
   ...
   tommath_int& operator = (const char* s)
   {
      ...
      *this = static_cast<pdalboost::uint32_t>(0u);
      unsigned radix = 10;
      bool isneg = false;
      if(n && (*s == '-'))
      {
      ...
      if(n)
      {
         ...
         else
         {
            ...
            pdalboost::uint32_t block_mult = 1000000000;
            while(*s)
            {
               pdalboost::uint32_t block = 0;
               for(unsigned i = 0; i < 9; ++i)
               {
                  pdalboost::uint32_t val;
                  if(*s >= '0' && *s <= '9')
                     val = *s - '0';
                  else
                  ...
                  if(!*++s)
                  {
                     static const pdalboost::uint32_t block_multiplier[9]  = { 10, 100, 1000, 10000, 100000, 1000000, 10000000, 100000000, 1000000000 };
   ...
   std::string str(std::streamsize /*digits*/, std::ios_base::fmtflags f)const
   {
      ...
      pdalboost::scoped_array<char> a(new char[s+1]);
...
{
   *result = pdalboost::lexical_cast<A>(val.str(0, std::ios_base::fmtflags(0)));
}
inline void eval_convert_to(char* result, const tommath_int& val)
{
   *result = static_cast<char>(pdalboost::lexical_cast<int>(val.str(0, std::ios_base::fmtflags(0))));
}
inline void eval_convert_to(unsigned char* result, const tommath_int& val)
{
   *result = static_cast<unsigned char>(pdalboost::lexical_cast<unsigned>(val.str(0, std::ios_base::fmtflags(0))));
}
inline void eval_convert_to(signed char* result, const tommath_int& val)
{
   *result = static_cast<signed char>(pdalboost::lexical_cast<int>(val.str(0, std::ios_base::fmtflags(0))));
}
...
using pdalboost::multiprecision::backends::tommath_int;
...
class numeric_limits<pdalboost::multiprecision::number<pdalboost::multiprecision::tommath_int, ExpressionTemplates> >
{
   typedef pdalboost::multiprecision::number<pdalboost::multiprecision::tommath_int, ExpressionTemplates> number_type;
public:
...
template <pdalboost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST int numeric_limits<pdalboost::multiprecision::number<pdalboost::multiprecision::tommath_int, ExpressionTemplates> >::digits;
template <pdalboost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST int numeric_limits<pdalboost::multiprecision::number<pdalboost::multiprecision::tommath_int, ExpressionTemplates> >::digits10;
template <pdalboost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST int numeric_limits<pdalboost::multiprecision::number<pdalboost::multiprecision::tommath_int, ExpressionTemplates> >::max_digits10;
template <pdalboost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST bool numeric_limits<pdalboost::multiprecision::number<pdalboost::multiprecision::tommath_int, ExpressionTemplates> >::is_signed;
template <pdalboost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST bool numeric_limits<pdalboost::multiprecision::number<pdalboost::multiprecision::tommath_int, ExpressionTemplates> >::is_integer;
template <pdalboost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST bool numeric_limits<pdalboost::multiprecision::number<pdalboost::multiprecision::tommath_int, ExpressionTemplates> >::is_exact;
template <pdalboost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST int numeric_limits<pdalboost::multiprecision::number<pdalboost::multiprecision::tommath_int, ExpressionTemplates> >::radix;
template <pdalboost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST int numeric_limits<pdalboost::multiprecision::number<pdalboost::multiprecision::tommath_int, ExpressionTemplates> >::min_exponent;
template <pdalboost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST int numeric_limits<pdalboost::multiprecision::number<pdalboost::multiprecision::tommath_int, ExpressionTemplates> >::min_exponent10;
template <pdalboost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST int numeric_limits<pdalboost::multiprecision::number<pdalboost::multiprecision::tommath_int, ExpressionTemplates> >::max_exponent;
template <pdalboost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST int numeric_limits<pdalboost::multiprecision::number<pdalboost::multiprecision::tommath_int, ExpressionTemplates> >::max_exponent10;
template <pdalboost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST bool numeric_limits<pdalboost::multiprecision::number<pdalboost::multiprecision::tommath_int, ExpressionTemplates> >::has_infinity;
template <pdalboost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST bool numeric_limits<pdalboost::multiprecision::number<pdalboost::multiprecision::tommath_int, ExpressionTemplates> >::has_quiet_NaN;
template <pdalboost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST bool numeric_limits<pdalboost::multiprecision::number<pdalboost::multiprecision::tommath_int, ExpressionTemplates> >::has_signaling_NaN;
template <pdalboost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST float_denorm_style numeric_limits<pdalboost::multiprecision::number<pdalboost::multiprecision::tommath_int, ExpressionTemplates> >::has_denorm;
template <pdalboost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST bool numeric_limits<pdalboost::multiprecision::number<pdalboost::multiprecision::tommath_int, ExpressionTemplates> >::has_denorm_loss;
template <pdalboost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST bool numeric_limits<pdalboost::multiprecision::number<pdalboost::multiprecision::tommath_int, ExpressionTemplates> >::is_iec559;
template <pdalboost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST bool numeric_limits<pdalboost::multiprecision::number<pdalboost::multiprecision::tommath_int, ExpressionTemplates> >::is_bounded;
template <pdalboost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST bool numeric_limits<pdalboost::multiprecision::number<pdalboost::multiprecision::tommath_int, ExpressionTemplates> >::is_modulo;
template <pdalboost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST bool numeric_limits<pdalboost::multiprecision::number<pdalboost::multiprecision::tommath_int, ExpressionTemplates> >::traps;
template <pdalboost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST bool numeric_limits<pdalboost::multiprecision::number<pdalboost::multiprecision::tommath_int, ExpressionTemplates> >::tinyness_before;
template <pdalboost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST float_round_style numeric_limits<pdalboost::multiprecision::number<pdalboost::multiprecision::tommath_int, ExpressionTemplates> >::round_style;
