...
struct number_backend_float_architype
{
   ...
   number_backend_float_architype& operator = (const char* s)
   {
      try
      {
         m_value = pdalboost::lexical_cast<long double>(s);
      }
   ...
   std::string str(std::streamsize digits, std::ios_base::fmtflags f)const
   {
      ...
      pdalboost::intmax_t i = m_value;
      pdalboost::uintmax_t u = m_value;
...
{
   return (pdalboost::math::fpclassify)(arg.m_value);
}

typedef pdalboost::multiprecision::number<number_backend_float_architype> mp_number_float_architype;
...
class numeric_limits<pdalboost::multiprecision::number<pdalboost::multiprecision::concepts::number_backend_float_architype, ExpressionTemplates> > : public std::numeric_limits<long double>
{
   typedef std::numeric_limits<long double> base_type;
   typedef pdalboost::multiprecision::number<pdalboost::multiprecision::concepts::number_backend_float_architype, ExpressionTemplates> number_type;
public:
