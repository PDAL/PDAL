...
namespace pdalboost {} namespace boost = pdalboost; namespace pdalboost{ namespace multiprecision{ namespace detail{
...
#pragma warning(disable:4127)
   ...
   static const int shift = std::numeric_limits<pdalboost::intmax_t>::digits - 1;
   ...
   while(!eval_is_zero(f))
   {
      ...
      typename pdalboost::multiprecision::detail::canonical<pdalboost::intmax_t, To>::type ll;
