...
//
  ...
  namespace pdalboost {} namespace boost = pdalboost; namespace pdalboost { namespace multiprecision { namespace backends { namespace detail
  {
    template <class value_type, const pdalboost::uint32_t elem_number, class my_allocator>
  ...
  } } } } // namespace pdalboost::multiprecision::backends::detail
