...
namespace pdalboost {} namespace boost = pdalboost; namespace pdalboost{ namespace multiprecision{ namespace default_ops{
...
inline void eval_convert_to(terminal<R>* result, const B& backend)
{
   ...
   //
   result->value = pdalboost::lexical_cast<R>(backend.str(0, std::ios_base::fmtflags(0)));
}
...
{
   typedef typename pdalboost::multiprecision::detail::canonical<A, T>::type canonical_type;
...
inline void eval_round(T& result, const T& a)
{
   ...
   typedef typename pdalboost::multiprecision::detail::canonical<float, T>::type fp_type;
   int c = eval_fpclassify(a);
   if(c == FP_NAN || c == FP_INFINITE)
   {
...
{
   typedef typename pdalboost::multiprecision::detail::canonical<Arithmetic, T>::type si_type;
...
void eval_integer_sqrt(B& s, B& r, const B& x)
{
   ...
   // at some point.
   //
   typedef typename pdalboost::multiprecision::detail::canonical<unsigned char, B>::type ui_type;
...
{
   return itrunc(v, pdalboost::math::policies::policy<>());
}
template <class Backend, expression_template_option ExpressionTemplates, class Policy>
...
{
   return ltrunc(v, pdalboost::math::policies::policy<>());
}
...
{
   return lltrunc(v, pdalboost::math::policies::policy<>());
}
template <class T, expression_template_option ExpressionTemplates, class Policy>
...
{
   return iround(v, pdalboost::math::policies::policy<>());
}
template <class T, expression_template_option ExpressionTemplates, class Policy>
...
{
   return lround(v, pdalboost::math::policies::policy<>());
}
template <class T, expression_template_option ExpressionTemplates, class Policy>
...
{
   return llround(v, pdalboost::math::policies::policy<>());
}
template <class T, expression_template_option ExpressionTemplates, class Policy>
...
template <class Backend> \
inline typename pdalboost::enable_if_c<\
   pdalboost::multiprecision::number_category<Backend>::value == category,\
...
{
   return BOOST_MP_MOVE(pdalboost::math::sinhc_pi(x));
}
