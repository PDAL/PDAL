...
const T& get_constant_ln2()
{
   ...
   if(!b)
   {
      calc_log2(result, pdalboost::multiprecision::detail::digits2<number<T, et_on> >::value);
      b = true;
   }
...
const T& get_constant_e()
{
   ...
   if(!b)
   {
      calc_e(result, pdalboost::multiprecision::detail::digits2<number<T, et_on> >::value);
      b = true;
   }
...
const T& get_constant_pi()
{
   ...
   if(!b)
   {
      calc_pi(result, pdalboost::multiprecision::detail::digits2<number<T, et_on> >::value);
      b = true;
   }
