...
struct rational_adaptor
{
   ...
   explicit rational_adaptor(const U& u, 
      ...
      : m_value(IntBackend(u)){}
   template <class U>
   typename enable_if_c<(pdalboost::multiprecision::detail::is_explicitly_convertible<U, IntBackend>::value && !is_arithmetic<U>::value), rational_adaptor&>::type operator = (const U& u) 
   {
      m_value = IntBackend(u);
   }
...
using pdalboost::multiprecision::backends::rational_adaptor;
...
class numeric_limits<pdalboost::multiprecision::number<pdalboost::multiprecision::rational_adaptor<IntBackend>, ExpressionTemplates> > : public std::numeric_limits<pdalboost::multiprecision::number<IntBackend, ExpressionTemplates> >
{
   typedef std::numeric_limits<pdalboost::multiprecision::number<IntBackend> > base_type;
   typedef pdalboost::multiprecision::number<pdalboost::multiprecision::rational_adaptor<IntBackend> > number_type;
public:
...
template <class IntBackend, pdalboost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST bool numeric_limits<pdalboost::multiprecision::number<pdalboost::multiprecision::rational_adaptor<IntBackend>, ExpressionTemplates> >::is_integer;
template <class IntBackend, pdalboost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST bool numeric_limits<pdalboost::multiprecision::number<pdalboost::multiprecision::rational_adaptor<IntBackend>, ExpressionTemplates> >::is_exact;
