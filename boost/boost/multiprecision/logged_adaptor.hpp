...
class numeric_limits<pdalboost::multiprecision::number<pdalboost::multiprecision::backends::logged_adaptor<Backend>, ExpressionTemplates> >
   : public std::numeric_limits<pdalboost::multiprecision::number<Backend, ExpressionTemplates> >
{
   typedef std::numeric_limits<pdalboost::multiprecision::number<Backend, ExpressionTemplates> > base_type;
   typedef pdalboost::multiprecision::number<pdalboost::multiprecision::backends::logged_adaptor<Backend>, ExpressionTemplates> number_type;
public:
...
template <class Backend, pdalboost::multiprecision::expression_template_option ExpressionTemplates, class Policy>
struct precision< pdalboost::multiprecision::number<pdalboost::multiprecision::logged_adaptor<Backend>, ExpressionTemplates>, Policy>
   : public precision<pdalboost::multiprecision::number<Backend, ExpressionTemplates>, Policy>
{};
