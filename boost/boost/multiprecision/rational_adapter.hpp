...
struct rational_adapter
{
   ...
   typedef pdalboost::rational<integer_type>        rational_type;
   ...
   explicit rational_adapter(const U& u, 
      typename enable_if_c<
         pdalboost::multiprecision::detail::is_explicitly_convertible<U, IntBackend>::value && !is_convertible<U, IntBackend>::value
      >::type* = 0) 
      : m_value(IntBackend(u)){}
   template <class U>
   typename enable_if_c<(pdalboost::multiprecision::detail::is_explicitly_convertible<U, IntBackend>::value && !is_arithmetic<U>::value), rational_adapter&>::type operator = (const U& u) 
   {
      m_value = IntBackend(u);
   }
...
using pdalboost::multiprecision::backends::rational_adapter;
...
template <class IntBackend, pdalboost::multiprecision::expression_template_option ExpressionTemplates>
class numeric_limits<pdalboost::multiprecision::number<pdalboost::multiprecision::rational_adapter<IntBackend>, ExpressionTemplates> > : public std::numeric_limits<pdalboost::multiprecision::number<IntBackend, ExpressionTemplates> >
{
   typedef std::numeric_limits<pdalboost::multiprecision::number<IntBackend> > base_type;
   typedef pdalboost::multiprecision::number<pdalboost::multiprecision::rational_adapter<IntBackend> > number_type;
public:
...
template <class IntBackend, pdalboost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST bool numeric_limits<pdalboost::multiprecision::number<pdalboost::multiprecision::rational_adapter<IntBackend>, ExpressionTemplates> >::is_integer;
template <class IntBackend, pdalboost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST bool numeric_limits<pdalboost::multiprecision::number<pdalboost::multiprecision::rational_adapter<IntBackend>, ExpressionTemplates> >::is_exact;
