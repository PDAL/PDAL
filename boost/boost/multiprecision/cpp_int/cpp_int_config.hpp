...
// of bits.  Note that intN_t and pdalboost::int_t<N> find the first
   ...
   typedef typename mpl::if_c<
      ...
      typename mpl::if_c<
         ...
         typename mpl::if_c<
            ...
            int,
            typename pdalboost::int_t<N>::exact
         >::type
      >::type
   >::type type;
};
   ...
   typedef typename mpl::if_c<
      ...
      typename mpl::if_c<
         ...
         typename mpl::if_c<
            ...
            unsigned int,
            typename pdalboost::uint_t<N>::exact
         >::type
      >::type
   >::type type;
};
...
typedef pdalboost::uint128_type double_limb_type;
typedef pdalboost::int128_type signed_double_limb_type;
...
typedef pdalboost::uint64_t double_limb_type;
typedef pdalboost::int64_t signed_double_limb_type;
