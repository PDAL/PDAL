...
namespace mp = pdalboost::multiprecision;

namespace cpp_int_detail{

using namespace pdalboost::multiprecision;
using namespace pdalboost::multiprecision::backends;

template <class T>
struct is_binary_archive : public mpl::false_ {};
template <>
struct is_binary_archive<pdalboost::archive::binary_oarchive> : public mpl::true_ {};
template <>
struct is_binary_archive<pdalboost::archive::binary_iarchive> : public mpl::true_ {};
