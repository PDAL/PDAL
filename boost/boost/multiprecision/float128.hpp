...
#ifndef BOOST_MP_USE_QUAD
      char buf[100];
      pdalboost::scoped_array<char> buf2;
      std::string format = "%";
...
inline void eval_trunc(float128_backend& result, const float128_backend& arg)
{
   ...
   {
      result = pdalboost::math::policies::raise_rounding_error(
            "pdalboost::multiprecision::trunc<%1%>(%1%)", 0, 
            number<float128_backend, et_off>(arg), 
            number<float128_backend, et_off>(arg), 
            pdalboost::math::policies::policy<>()).backend();
      return;
   }
...
void do_serialize(Archive& ar, pdalboost::multiprecision::backends::float128_backend& val, const mpl::false_&, const mpl::false_&)
{
   // saving
   // non-binary
...
template <class Archive>
void do_serialize(Archive& ar, pdalboost::multiprecision::backends::float128_backend& val, const mpl::true_&, const mpl::false_&)
{
   // loading
   // non-binary
   std::string s;
...
template <class Archive>
void do_serialize(Archive& ar, pdalboost::multiprecision::backends::float128_backend& val, const mpl::false_&, const mpl::true_&)
{
   // saving
   // binary
...
template <class Archive>
void do_serialize(Archive& ar, pdalboost::multiprecision::backends::float128_backend& val, const mpl::true_&, const mpl::true_&)
{
   // loading
   // binary
...
template <class Archive>
void serialize(Archive& ar, pdalboost::multiprecision::backends::float128_backend& val, unsigned int /*version*/)
{
   typedef typename Archive::is_loading load_tag;
   typedef typename mpl::bool_<pdalboost::is_same<Archive, pdalboost::archive::binary_oarchive>::value || pdalboost::is_same<Archive, pdalboost::archive::binary_iarchive>::value> binary_tag;
...
class numeric_limits<pdalboost::multiprecision::number<pdalboost::multiprecision::backends::float128_backend, ExpressionTemplates> >
{
   typedef pdalboost::multiprecision::number<pdalboost::multiprecision::backends::float128_backend, ExpressionTemplates> number_type;
public:
