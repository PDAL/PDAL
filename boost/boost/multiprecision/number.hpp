...
public:
   ...
   //
   template <class V>
   number(V v, unsigned digits10, typename enable_if<mpl::or_<pdalboost::is_arithmetic<V>, is_same<std::string, V>, is_convertible<V, const char*> > >::type* dummy1 = 0)
   {
   ...
   */
   ...
   BOOST_MP_FORCEINLINE number(const number<Other, ET>& val, 
         typename enable_if_c<(pdalboost::is_convertible<Other, Backend>::value && !detail::is_restricted_conversion<Other, Backend>::value)>::type* = 0) 
   ...
   template <class V>
   BOOST_MP_FORCEINLINE number(V v1, V v2, typename enable_if<mpl::or_<pdalboost::is_arithmetic<V>, is_same<std::string, V>, is_convertible<V, const char*> > >::type* = 0)
   {
      using default_ops::assign_components;
      assign_components(m_backend, canonical_value(v1), canonical_value(v2));
   }
   template <class Other, expression_template_option ET>
   BOOST_MP_FORCEINLINE number(const number<Other, ET>& v1, const number<Other, ET>& v2, typename enable_if<pdalboost::is_convertible<Other, Backend> >::type* = 0)
   {
      using default_ops::assign_components;
   ...
   template <class Other, expression_template_option ET>
   typename disable_if<pdalboost::multiprecision::detail::is_explicitly_convertible<Other, Backend>, number<Backend, ExpressionTemplates>& >::type 
   ...
   template <class V>
   typename enable_if<pdalboost::is_convertible<V, self_type>, number<Backend, ExpressionTemplates>& >::type 
      operator+=(const V& v)
   {
   ...
   template <class V>
   BOOST_MP_FORCEINLINE typename enable_if<pdalboost::is_convertible<V, self_type>, number<Backend, ExpressionTemplates>& >::type 
      operator/=(const V& v)
   {
...
typename enable_if<pdalboost::is_arithmetic<Arithmetic>, bool>::type operator == (const rational<multiprecision::number<T, ExpressionTemplates> >& a, const Arithmetic& b)
{
   return a == multiprecision::number<T, ExpressionTemplates>(b);
}

template <class T, multiprecision::expression_template_option ExpressionTemplates, class Arithmetic>
typename enable_if<pdalboost::is_arithmetic<Arithmetic>, bool>::type operator == (const Arithmetic& b, const rational<multiprecision::number<T, ExpressionTemplates> >& a)
{
   return a == multiprecision::number<T, ExpressionTemplates>(b);
}
...
inline bool operator == (const sparse_vector_element<V>& a, const ::pdalboost::multiprecision::number<Backend, ExpressionTemplates>& b)
{
