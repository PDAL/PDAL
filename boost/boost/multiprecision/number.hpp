...
public:
   ...
   template <class V>
   BOOST_MP_FORCEINLINE number(const V& v, typename pdalboost::enable_if_c<
            (pdalboost::is_arithmetic<V>::value || is_same<std::string, V>::value || is_convertible<V, const char*>::value)
   ...
   template <class V>
   BOOST_MP_FORCEINLINE BOOST_CONSTEXPR number(const V& v, typename pdalboost::enable_if_c<
            is_convertible<typename detail::canonical<V, Backend>::type, Backend>::value
            && !detail::is_restricted_conversion<typename detail::canonical<V, Backend>::type, Backend>::value
         >::type* = 0)
      : m_backend(canonical_value(v)) {}
   ...
   template <class V>
   explicit BOOST_MP_FORCEINLINE number(const V& v, typename pdalboost::enable_if_c<
            (pdalboost::is_arithmetic<V>::value || is_same<std::string, V>::value || is_convertible<V, const char*>::value)
   ...
   template <class V>
   explicit BOOST_MP_FORCEINLINE BOOST_CONSTEXPR number(const V& v, typename pdalboost::enable_if_c<
            detail::is_explicitly_convertible<typename detail::canonical<V, Backend>::type, Backend>::value
            && (detail::is_restricted_conversion<typename detail::canonical<V, Backend>::type, Backend>::value
                || !is_convertible<typename detail::canonical<V, Backend>::type, Backend>::value)
         >::type* = 0)
   ...
   //
   template <class V>
   number(V v, unsigned digits10, typename pdalboost::enable_if<mpl::or_<pdalboost::is_arithmetic<V>, is_same<std::string, V>, is_convertible<V, const char*> > >::type* dummy1 = 0)
   {
   ...
   */
   ...
   BOOST_MP_FORCEINLINE number(const number<Other, ET>& val,
         typename pdalboost::enable_if_c<(pdalboost::is_convertible<Other, Backend>::value && !detail::is_restricted_conversion<Other, Backend>::value)>::type* = 0)
      BOOST_NOEXCEPT_IF(noexcept(Backend(static_cast<const Other&>(std::declval<Other>()))))
      : m_backend(val.backend()) {}

   template <class Other, expression_template_option ET>
   explicit number(const number<Other, ET>& val, typename pdalboost::enable_if_c<
   ...
   template <class Other, expression_template_option ET>
   explicit BOOST_MP_FORCEINLINE number(const number<Other, ET>& val, typename pdalboost::enable_if_c<
         (detail::is_explicitly_convertible<Other, Backend>::value
            && (detail::is_restricted_conversion<Other, Backend>::value || !pdalboost::is_convertible<Other, Backend>::value))
         >::type* = 0) BOOST_NOEXCEPT_IF(noexcept(Backend(static_cast<const Other&>(std::declval<Other>()))))
      : m_backend(val.backend()) {}

   template <class V>
   BOOST_MP_FORCEINLINE number(V v1, V v2, typename pdalboost::enable_if<mpl::or_<pdalboost::is_arithmetic<V>, is_same<std::string, V>, is_convertible<V, const char*> > >::type* = 0)
   {
      using default_ops::assign_components;
      assign_components(m_backend, canonical_value(v1), canonical_value(v2));
   }
   template <class Other, expression_template_option ET>
   BOOST_MP_FORCEINLINE number(const number<Other, ET>& v1, const number<Other, ET>& v2, typename pdalboost::enable_if<pdalboost::is_convertible<Other, Backend> >::type* = 0)
   {
      using default_ops::assign_components;
   ...
   typename pdalboost::enable_if<is_convertible<typename detail::expression<tag, Arg1, Arg2, Arg3, Arg4>::result_type, self_type>, number&>::type operator=(const detail::expression<tag, Arg1, Arg2, Arg3, Arg4>& e)
   {
   ...
   template <class V>
   BOOST_MP_FORCEINLINE typename pdalboost::enable_if<is_convertible<V, self_type>, number<Backend, ExpressionTemplates>& >::type
      operator=(const V& v)
      BOOST_NOEXCEPT_IF(noexcept(std::declval<Backend>() = static_cast<typename pdalboost::multiprecision::detail::canonical<V, Backend>::type const&>(std::declval<typename pdalboost::multiprecision::detail::canonical<V, Backend>::type>())))
   {
      m_backend = canonical_value(v);
      return *this;
   }
   ...
   template <class Other, expression_template_option ET>
   typename pdalboost::disable_if<pdalboost::multiprecision::detail::is_explicitly_convertible<Other, Backend>, number<Backend, ExpressionTemplates>& >::type
   ...
   template <class tag, class Arg1, class Arg2, class Arg3, class Arg4>
   number(const detail::expression<tag, Arg1, Arg2, Arg3, Arg4>& e, typename pdalboost::enable_if_c<is_convertible<typename detail::expression<tag, Arg1, Arg2, Arg3, Arg4>::result_type, self_type>::value>::type* = 0)
   {
      *this = e;
   }
   template <class tag, class Arg1, class Arg2, class Arg3, class Arg4>
   explicit number(const detail::expression<tag, Arg1, Arg2, Arg3, Arg4>& e,
      typename pdalboost::enable_if_c<!is_convertible<typename detail::expression<tag, Arg1, Arg2, Arg3, Arg4>::result_type, self_type>::value
      && pdalboost::multiprecision::detail::is_explicitly_convertible<typename detail::expression<tag, Arg1, Arg2, Arg3, Arg4>::result_type, self_type>::value>::type* = 0)
   {
      assign(e);
   }
   ...
   template <class V>
   typename pdalboost::enable_if<pdalboost::is_convertible<V, self_type>, number<Backend, ExpressionTemplates>& >::type
      operator+=(const V& v)
   {
   ...
   template <class V>
   BOOST_MP_FORCEINLINE typename pdalboost::enable_if<is_integral<V>, number&>::type operator <<= (V val)
   {
   ...
   template <class V>
   BOOST_MP_FORCEINLINE typename pdalboost::enable_if<pdalboost::is_convertible<V, self_type>, number<Backend, ExpressionTemplates>& >::type
      operator/=(const V& v)
   {
...
#  if defined(__GNUC__) && (__GNUC__ == 4) && (__GNUC_MINOR__ < 7)
   ...
   // an arithmetic type:
   //
   template <class T, typename pdalboost::enable_if<is_same<T, bool>, int>::type = 0>
   explicit operator T ()const
   {
      using default_ops::eval_is_zero;
      return !eval_is_zero(backend());
   }
   template <class T, typename pdalboost::disable_if_c<is_same<T, bool>::value || is_void<T>::value, int>::type = 0>
   explicit operator T ()const
   {
...
#  endif
   ...
   template <class V>
   BOOST_MP_FORCEINLINE typename pdalboost::enable_if<is_arithmetic<V>, int>::type compare(const V& o)const
   {
      using default_ops::eval_get_sign;
      if(o == 0)
         return eval_get_sign(m_backend);
...
public:
   ...
   template <class V>
   static BOOST_MP_FORCEINLINE BOOST_CONSTEXPR typename pdalboost::disable_if<is_same<typename detail::canonical<V, Backend>::type, V>, typename detail::canonical<V, Backend>::type>::type
      canonical_value(const V& v) BOOST_NOEXCEPT {  return static_cast<typename detail::canonical<V, Backend>::type>(v);  }
   template <class V>
   static BOOST_MP_FORCEINLINE BOOST_CONSTEXPR typename pdalboost::enable_if<is_same<typename detail::canonical<V, Backend>::type, V>, const V&>::type
...
typename pdalboost::enable_if<pdalboost::is_arithmetic<Arithmetic>, bool>::type operator == (const rational<multiprecision::number<T, ExpressionTemplates> >& a, const Arithmetic& b)
{
   return a == multiprecision::number<T, ExpressionTemplates>(b);
}

template <class T, multiprecision::expression_template_option ExpressionTemplates, class Arithmetic>
typename pdalboost::enable_if<pdalboost::is_arithmetic<Arithmetic>, bool>::type operator == (const Arithmetic& b, const rational<multiprecision::number<T, ExpressionTemplates> >& a)
{
   return a == multiprecision::number<T, ExpressionTemplates>(b);
}
