...
class numeric_limits<pdalboost::multiprecision::number<pdalboost::multiprecision::backends::debug_adaptor<Backend>, ExpressionTemplates> >
   : public std::numeric_limits<pdalboost::multiprecision::number<Backend, ExpressionTemplates> >
{
   ...
   typedef pdalboost::multiprecision::number<pdalboost::multiprecision::backends::debug_adaptor<Backend>, ExpressionTemplates> number_type;
public:
...
struct precision< pdalboost::multiprecision::number<pdalboost::multiprecision::debug_adaptor<Backend>, ExpressionTemplates>, Policy>
