...
// be recognised by pdalboost::int_t because they're larger than long long),
...
struct double_integer
{
   ...
   typedef typename mpl::if_c<
      ...
      typename mpl::if_c<
         is_signed<I>::value,
         typename pdalboost::int_t<int_t_digits>::least,
         typename pdalboost::uint_t<int_t_digits>::least
      >::type,
      typename mpl::if_c<
