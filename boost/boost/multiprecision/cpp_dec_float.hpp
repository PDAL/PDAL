...
template <unsigned Digits10, class ExponentType = pdalboost::int32_t, class Allocator = void>
class cpp_dec_float;
...
{
private:
   static const pdalboost::int32_t cpp_dec_float_digits10_setting = Digits10;
   ...
   BOOST_STATIC_ASSERT_MSG(pdalboost::is_signed<ExponentType>::value, "ExponentType must be a signed built in integer type.");
...
public:
   ...
   static const pdalboost::int32_t cpp_dec_float_radix             = 10L;
   static const pdalboost::int32_t cpp_dec_float_digits10_limit_lo = 9L;
   static const pdalboost::int32_t cpp_dec_float_digits10_limit_hi = pdalboost::integer_traits<pdalboost::int32_t>::const_max - 100;
   static const pdalboost::int32_t cpp_dec_float_digits10          = ((cpp_dec_float_digits10_setting < cpp_dec_float_digits10_limit_lo) ? cpp_dec_float_digits10_limit_lo : ((cpp_dec_float_digits10_setting > cpp_dec_float_digits10_limit_hi) ? cpp_dec_float_digits10_limit_hi : cpp_dec_float_digits10_setting));
...
private:
   static const pdalboost::int32_t cpp_dec_float_elem_digits10 = 8L;
   static const pdalboost::int32_t cpp_dec_float_elem_mask     = 100000000L;
   ...
   static const pdalboost::int32_t cpp_dec_float_elem_number_request = static_cast<pdalboost::int32_t>((cpp_dec_float_digits10 / cpp_dec_float_elem_digits10) + (((cpp_dec_float_digits10 % cpp_dec_float_elem_digits10) != 0) ? 1 : 0));

   // The number of elements needed (with a minimum of two) plus three added guard limbs.
   static const pdalboost::int32_t cpp_dec_float_elem_number = static_cast<pdalboost::int32_t>(((cpp_dec_float_elem_number_request < 2L) ? 2L : cpp_dec_float_elem_number_request) + 3L);

public:
   static const pdalboost::int32_t cpp_dec_float_total_digits10 = static_cast<pdalboost::int32_t>(cpp_dec_float_elem_number * cpp_dec_float_elem_digits10);
...
private:
   ...
   typedef typename mpl::if_<is_void<Allocator>,
      pdalboost::array<pdalboost::uint32_t, cpp_dec_float_elem_number>,
      detail::dynamic_array<pdalboost::uint32_t, cpp_dec_float_elem_number, Allocator>
      >::type array_type;
...
public:
   ...
   static const cpp_dec_float& (max)()
   {
      ...
      static const std::string str_max =   std::string("9." + std::string(static_cast<std::size_t>(cpp_dec_float_total_digits10), static_cast<char>('9')))
         + std::string("e+" + pdalboost::lexical_cast<std::string>(cpp_dec_float_max_exp10));
   ...
   static const cpp_dec_float& (min)()
   {
      ...
      {
         init = true;
         val_min = std::string("1.0e" + pdalboost::lexical_cast<std::string>(cpp_dec_float_min_exp10)).c_str();
      }
      return val_min;
   }
   ...
   std::string str(pdalboost::intmax_t digits, std::ios_base::fmtflags f)const;
   ...
   void precision(const pdalboost::int32_t prec_digits) 
   {
      ...
      {
         const pdalboost::int32_t elems = static_cast<pdalboost::int32_t>(  static_cast<pdalboost::int32_t>( (prec_digits + (cpp_dec_float_elem_digits10 / 2)) / cpp_dec_float_elem_digits10)
            + static_cast<pdalboost::int32_t>(((prec_digits %  cpp_dec_float_elem_digits10) != 0) ? 1 : 0));

         prec_elem = (std::min)(cpp_dec_float_elem_number, (std::max)(elems, static_cast<pdalboost::int32_t>(2)));
      }
   }
   static cpp_dec_float pow2(long long i);
   ExponentType order()const 
   {
      const bool bo_order_is_zero = ((!isfinite()) || (data[0] == static_cast<pdalboost::uint32_t>(0u)));
      //
...
private:
   static bool data_elem_is_non_zero_predicate(const pdalboost::uint32_t& d)  { return (d != static_cast<pdalboost::uint32_t>(0u)); }
   static bool data_elem_is_non_nine_predicate(const pdalboost::uint32_t& d)  { return (d != static_cast<pdalboost::uint32_t>(cpp_dec_float::cpp_dec_float_elem_mask - 1)); }
   ...
   static pdalboost::uint32_t mul_loop_uv(pdalboost::uint32_t* const u, const pdalboost::uint32_t* const v, const pdalboost::int32_t p)  ;
   static pdalboost::uint32_t mul_loop_n (pdalboost::uint32_t* const u, pdalboost::uint32_t n, const pdalboost::int32_t p)  ;
   static pdalboost::uint32_t div_loop_n (pdalboost::uint32_t* const u, pdalboost::uint32_t n, const pdalboost::int32_t p)  ;
...
template <unsigned Digits10, class ExponentType, class Allocator>
const pdalboost::int32_t cpp_dec_float<Digits10, ExponentType, Allocator>::cpp_dec_float_radix;
template <unsigned Digits10, class ExponentType, class Allocator>
const pdalboost::int32_t cpp_dec_float<Digits10, ExponentType, Allocator>::cpp_dec_float_digits10_setting;
template <unsigned Digits10, class ExponentType, class Allocator>
const pdalboost::int32_t cpp_dec_float<Digits10, ExponentType, Allocator>::cpp_dec_float_digits10_limit_lo;
template <unsigned Digits10, class ExponentType, class Allocator>
const pdalboost::int32_t cpp_dec_float<Digits10, ExponentType, Allocator>::cpp_dec_float_digits10_limit_hi;
template <unsigned Digits10, class ExponentType, class Allocator>
const pdalboost::int32_t cpp_dec_float<Digits10, ExponentType, Allocator>::cpp_dec_float_digits10;
template <unsigned Digits10, class ExponentType, class Allocator>
...
template <unsigned Digits10, class ExponentType, class Allocator>
const pdalboost::int32_t cpp_dec_float<Digits10, ExponentType, Allocator>::cpp_dec_float_elem_digits10;
template <unsigned Digits10, class ExponentType, class Allocator>
const pdalboost::int32_t cpp_dec_float<Digits10, ExponentType, Allocator>::cpp_dec_float_elem_number_request;
template <unsigned Digits10, class ExponentType, class Allocator>
const pdalboost::int32_t cpp_dec_float<Digits10, ExponentType, Allocator>::cpp_dec_float_elem_number;
template <unsigned Digits10, class ExponentType, class Allocator>
const pdalboost::int32_t cpp_dec_float<Digits10, ExponentType, Allocator>::cpp_dec_float_elem_mask;
...
cpp_dec_float<Digits10, ExponentType, Allocator>& cpp_dec_float<Digits10, ExponentType, Allocator>::operator+=(const cpp_dec_float<Digits10, ExponentType, Allocator>& v)
{
   ...
   bool                       b_copy = false;
   const pdalboost::int32_t       ofs    = static_cast<pdalboost::int32_t>(static_cast<pdalboost::int32_t>(ofs_exp) / cpp_dec_float_elem_digits10);
   array_type                 n_data;
   ...
   if(neg == v.neg)
   {
      ...
      if(ofs >= static_cast<pdalboost::int32_t>(0))
      {
         std::copy(v.data.begin(), v.data.end() - static_cast<size_t>(ofs), n_data.begin() + static_cast<size_t>(ofs));
         std::fill(n_data.begin(), n_data.begin() + static_cast<size_t>(ofs), static_cast<pdalboost::uint32_t>(0u));
         p_v = n_data.begin();
      }
      else
      {
      ...
      // Addition algorithm
      pdalboost::uint32_t carry = static_cast<pdalboost::uint32_t>(0u);

      for(pdalboost::int32_t j = static_cast<pdalboost::int32_t>(cpp_dec_float_elem_number - static_cast<pdalboost::int32_t>(1)); j >= static_cast<pdalboost::int32_t>(0); j--)
      {
         pdalboost::uint32_t t = static_cast<pdalboost::uint32_t>(static_cast<pdalboost::uint32_t>(p_u[j] + p_v[j]) + carry);
         carry    = t / static_cast<pdalboost::uint32_t>(cpp_dec_float_elem_mask);
         p_u[j]   = static_cast<pdalboost::uint32_t>(t - static_cast<pdalboost::uint32_t>(carry * static_cast<pdalboost::uint32_t>(cpp_dec_float_elem_mask)));
      }
      ...
      if(carry != static_cast<pdalboost::uint32_t>(0u))
      {
   ...
   else
   {
      ...
      // might have to be treated with a positive, negative or zero offset.
      if((ofs > static_cast<pdalboost::int32_t>(0))
         || (   (ofs == static_cast<pdalboost::int32_t>(0))
         && (cmp_data(v.data) > static_cast<pdalboost::int32_t>(0)))
         )
      {
      ...
      else
      {
         if(ofs != static_cast<pdalboost::int32_t>(0))
         {
            ...
            std::fill(data.begin(), data.begin() + static_cast<size_t>(-ofs), static_cast<pdalboost::uint32_t>(0u));
         }
      ...
      pdalboost::int32_t borrow = static_cast<pdalboost::int32_t>(0);

      for(j = static_cast<pdalboost::int32_t>(cpp_dec_float_elem_number - static_cast<pdalboost::int32_t>(1)); j >= static_cast<pdalboost::int32_t>(0); j--)
      {
         pdalboost::int32_t t = static_cast<pdalboost::int32_t>(static_cast<pdalboost::int32_t>(  static_cast<pdalboost::int32_t>(p_u[j])
            - static_cast<pdalboost::int32_t>(p_v[j])) - borrow);

         // Underflow? Borrow?
         if(t < static_cast<pdalboost::int32_t>(0))
         {
            // Yes, underflow and borrow
            t     += static_cast<pdalboost::int32_t>(cpp_dec_float_elem_mask);
            borrow = static_cast<pdalboost::int32_t>(1);
         }
         else
         {
            borrow = static_cast<pdalboost::int32_t>(0);
         }

         p_u[j] = static_cast<pdalboost::uint32_t>(static_cast<pdalboost::uint32_t>(t) % static_cast<pdalboost::uint32_t>(cpp_dec_float_elem_mask));
      }
      ...
      if(first_nonzero_elem != data.begin())
      {
         ...
         else
         {
            ...
            std::fill(data.end() - sj, data.end(), static_cast<pdalboost::uint32_t>(0u));
...
cpp_dec_float<Digits10, ExponentType, Allocator>& cpp_dec_float<Digits10, ExponentType, Allocator>::operator*=(const cpp_dec_float<Digits10, ExponentType, Allocator>& v)  
{
   ...
   const pdalboost::int32_t prec_mul = (std::min)(prec_elem, v.prec_elem);

   const pdalboost::uint32_t carry = mul_loop_uv(data.data(), v.data.data(), prec_mul);
   ...
   if(carry != static_cast<pdalboost::uint32_t>(0u))
   {
      ...
      std::copy_backward(data.begin(),
                         data.begin() + static_cast<std::size_t>(prec_elem - static_cast<pdalboost::int32_t>(1)),
...
cpp_dec_float<Digits10, ExponentType, Allocator>& cpp_dec_float<Digits10, ExponentType, Allocator>::mul_unsigned_long_long(const unsigned long long n)  
{
   ...
   // Handle special cases like zero, inf and NaN.
   const bool b_u_is_inf  = isinf();
   const bool b_n_is_zero = (n == static_cast<pdalboost::int32_t>(0));
   ...
   const pdalboost::uint32_t nn = static_cast<pdalboost::uint32_t>(n);
   const pdalboost::uint32_t carry = mul_loop_n(data.data(), nn, prec_elem);
   ...
   if(carry != static_cast<pdalboost::uint32_t>(0u))
   {
      ...
      data.front() = static_cast<pdalboost::uint32_t>(carry);
   }
...
cpp_dec_float<Digits10, ExponentType, Allocator>& cpp_dec_float<Digits10, ExponentType, Allocator>::div_unsigned_long_long(const unsigned long long n)  
{
   ...
   if(nn > static_cast<pdalboost::uint32_t>(1u))
   {
      // Do the division loop.
      const pdalboost::uint32_t prev = div_loop_n(data.data(), nn, prec_elem);

      // Determine if one leading zero is in the result data.
      if(data[0] == static_cast<pdalboost::uint32_t>(0u))
      {
         // Adjust the exponent
         exp -= static_cast<ExponentType>(cpp_dec_float_elem_digits10);
         ...
         data[prec_elem - static_cast<pdalboost::int32_t>(1)] = static_cast<pdalboost::uint32_t>(static_cast<pdalboost::uint64_t>(prev * static_cast<pdalboost::uint64_t>(cpp_dec_float_elem_mask)) / nn);
      }
   }
...
cpp_dec_float<Digits10, ExponentType, Allocator>& cpp_dec_float<Digits10, ExponentType, Allocator>::calculate_inv()  
{
   ...
   static const pdalboost::int32_t double_digits10_minus_a_few = std::numeric_limits<double>::digits10 - 3;

   for(pdalboost::int32_t digits = double_digits10_minus_a_few; digits <= cpp_dec_float_total_digits10; digits *= static_cast<pdalboost::int32_t>(2))
   {
      // Adjust precision of the terms.
      precision(static_cast<pdalboost::int32_t>((digits + 10) * static_cast<pdalboost::int32_t>(2)));
      x.precision(static_cast<pdalboost::int32_t>((digits + 10) * static_cast<pdalboost::int32_t>(2)));
...
cpp_dec_float<Digits10, ExponentType, Allocator>& cpp_dec_float<Digits10, ExponentType, Allocator>::calculate_sqrt(void)  
{
   ...
   *this = cpp_dec_float<Digits10, ExponentType, Allocator>(sqd, static_cast<ExponentType>(ne / static_cast<ExponentType>(2)));
   ...
   static const pdalboost::uint32_t double_digits10_minus_a_few = std::numeric_limits<double>::digits10 - 3;

   for(pdalboost::int32_t digits = double_digits10_minus_a_few; digits <= cpp_dec_float_total_digits10; digits *= 2u)
   {
      // Adjust precision of the terms.
...
bool cpp_dec_float<Digits10, ExponentType, Allocator>::isone() const 
{
   ...
   {
      if((data[0u] == static_cast<pdalboost::uint32_t>(1u)) && (exp == static_cast<ExponentType>(0)))
      {
      ...
      else if((data[0u] == static_cast<pdalboost::uint32_t>(cpp_dec_float_elem_mask - 1)) && (exp == static_cast<ExponentType>(-cpp_dec_float_elem_digits10)))
      {
...
void cpp_dec_float<Digits10, ExponentType, Allocator>::extract_parts(double& mantissa, ExponentType& exponent) const 
{
   ...
   pdalboost::uint32_t p10  = static_cast<pdalboost::uint32_t>(1u);
   pdalboost::uint32_t test = data[0u];

   for(;;)
   {
      test /= static_cast<pdalboost::uint32_t>(10u);

      if(test == static_cast<pdalboost::uint32_t>(0u))
      {
         break;
      }

      p10 *= static_cast<pdalboost::uint32_t>(10u);
      ++exponent;
   }

   // Establish the upper bound of limbs for extracting the double.
   const int max_elem_in_double_count =     static_cast<int>(static_cast<pdalboost::int32_t>(std::numeric_limits<double>::digits10) / cpp_dec_float_elem_digits10)
                                         + (static_cast<int>(static_cast<pdalboost::int32_t>(std::numeric_limits<double>::digits10) % cpp_dec_float_elem_digits10) != 0 ? 1 : 0)
                                         + 1;

   // And make sure this upper bound stays within bounds of the elems.
   const std::size_t max_elem_extract_count = static_cast<std::size_t>((std::min)(static_cast<pdalboost::int32_t>(max_elem_in_double_count), cpp_dec_float_elem_number));
...
signed long long cpp_dec_float<Digits10, ExponentType, Allocator>::extract_signed_long_long(void) const  
{
   ...
   else
   {
      ...
      const pdalboost::int32_t imax = (std::min)(static_cast<pdalboost::int32_t>(static_cast<pdalboost::int32_t>(xn.exp) / cpp_dec_float_elem_digits10), static_cast<pdalboost::int32_t>(cpp_dec_float_elem_number - static_cast<pdalboost::int32_t>(1)));

      for(pdalboost::int32_t i = static_cast<pdalboost::int32_t>(1); i <= imax; i++)
      {
...
cpp_dec_float<Digits10, ExponentType, Allocator> cpp_dec_float<Digits10, ExponentType, Allocator>::extract_integer_part(void) const  
{
   ...
   std::fill(x.data.begin() + first_clear, x.data.begin() + last_clear, static_cast<pdalboost::uint32_t>(0u));

   return x;
}

template <unsigned Digits10, class ExponentType, class Allocator>
std::string cpp_dec_float<Digits10, ExponentType, Allocator>::str(pdalboost::intmax_t number_of_digits, std::ios_base::fmtflags f) const
{
   if(this->isinf())
   {
      if(this->isneg())
   ...
   std::string str;
   pdalboost::intmax_t org_digits(number_of_digits);
   ...
   str = pdalboost::lexical_cast<std::string>(data[0]);
   ...
   if(number_of_digits < 0)
   {
      ...
      if(isneg())
         str.insert(0, 1, '-');
      pdalboost::multiprecision::detail::format_float_string(str, 0, number_of_digits - my_exp - 1, f, this->iszero());
      return str;
   }
   else
   {
      ...
      if(str.length() > static_cast<std::string::size_type>(number_of_digits))
      {
         ...
         const pdalboost::uint32_t round = static_cast<pdalboost::uint32_t>(static_cast<pdalboost::uint32_t>(str[static_cast<std::string::size_type>(number_of_digits)]) - static_cast<pdalboost::uint32_t>('0'));

         bool need_round_up = round >= 5u;

         if(round == 5u)
         {
            const pdalboost::uint32_t ix = static_cast<pdalboost::uint32_t>(static_cast<pdalboost::uint32_t>(str[static_cast<std::string::size_type>(number_of_digits - 1)]) - static_cast<pdalboost::uint32_t>('0'));
            if((ix & 1u) == 0)
            {
         ...
         if(need_round_up)
         {
            ...
            while(ix && (static_cast<pdalboost::int32_t>(str.at(ix)) - static_cast<pdalboost::int32_t>('0') == static_cast<pdalboost::int32_t>(9)))
            {
            ...
            if(!ix)
            {
               ...
               if(static_cast<pdalboost::int32_t>(static_cast<pdalboost::int32_t>(str.at(ix)) - static_cast<pdalboost::int32_t>(0x30)) == static_cast<pdalboost::int32_t>(9))
               {
   ...
   if(isneg())
      str.insert(0, 1, '-');
   pdalboost::multiprecision::detail::format_float_string(str, my_exp, org_digits, f, this->iszero());
   return str;
}
...
bool cpp_dec_float<Digits10, ExponentType, Allocator>::rd_string(const char* const s)
{
      ...
      )
   {
      ...
      exp = pdalboost::lexical_cast<ExponentType>(static_cast<const char*>(str.c_str() + (pos + 1u)));
   ...
   {
      const pdalboost::int32_t n_pos         = static_cast<pdalboost::int32_t>(pos);
      const pdalboost::int32_t n_rem_is_zero = ((static_cast<pdalboost::int32_t>(n_pos % cpp_dec_float_elem_digits10) == static_cast<pdalboost::int32_t>(0)) ? static_cast<pdalboost::int32_t>(1) : static_cast<pdalboost::int32_t>(0));
      const pdalboost::int32_t n             = static_cast<pdalboost::int32_t>(static_cast<pdalboost::int32_t>(n_pos / cpp_dec_float_elem_digits10) - n_rem_is_zero);

      str.insert(static_cast<std::size_t>(static_cast<pdalboost::int32_t>(n_pos - static_cast<pdalboost::int32_t>(n * cpp_dec_float_elem_digits10))), ".");
   ...
   const pdalboost::int32_t n_dec = static_cast<pdalboost::int32_t>(static_cast<pdalboost::int32_t>(str.length() - 1u) - static_cast<pdalboost::int32_t>(pos));
   const pdalboost::int32_t n_rem = static_cast<pdalboost::int32_t>(n_dec % cpp_dec_float_elem_digits10);
   pdalboost::int32_t n_cnt = ((n_rem != static_cast<pdalboost::int32_t>(0)) ? static_cast<pdalboost::int32_t>(cpp_dec_float_elem_digits10 - n_rem)
      : static_cast<pdalboost::int32_t>(0));

   if(n_cnt != static_cast<pdalboost::int32_t>(0))
   {
   ...
   std::fill(data.begin(), data.end(), static_cast<pdalboost::uint32_t>(0u));

   // Extract the data.

   // First get the digits to the left of the decimal point...
   data[0u] = pdalboost::lexical_cast<pdalboost::uint32_t>(str.substr(static_cast<std::size_t>(0u), pos));
   ...
   for(std::string::size_type i = static_cast<std::string::size_type>(0u); i < i_end; i++)
   {
      ...
      data[i + 1u] = pdalboost::lexical_cast<pdalboost::uint32_t>(std::string(it, it + static_cast<std::string::size_type>(cpp_dec_float_elem_digits10)));
   }
   ...
   prec_elem(cpp_dec_float_elem_number)
{
   ...
   pdalboost::int32_t shift = static_cast<pdalboost::int32_t>(e % static_cast<pdalboost::int32_t>(cpp_dec_float_elem_digits10));

   while(static_cast<pdalboost::int32_t>(shift-- % cpp_dec_float_elem_digits10) != static_cast<pdalboost::int32_t>(0))
   {
      d *= 10.0;
      --e;
   }
   ...
   static const pdalboost::int32_t digit_ratio = static_cast<pdalboost::int32_t>(static_cast<pdalboost::int32_t>(std::numeric_limits<double>::digits10) / static_cast<pdalboost::int32_t>(cpp_dec_float_elem_digits10));
   static const pdalboost::int32_t digit_loops = static_cast<pdalboost::int32_t>(digit_ratio + static_cast<pdalboost::int32_t>(2));

   for(pdalboost::int32_t i = static_cast<pdalboost::int32_t>(0); i < digit_loops; i++)
   {
      pdalboost::uint32_t n = static_cast<pdalboost::uint32_t>(static_cast<pdalboost::uint64_t>(d));
      data[i]  = static_cast<pdalboost::uint32_t>(n);
...
cpp_dec_float<Digits10, ExponentType, Allocator>& cpp_dec_float<Digits10, ExponentType, Allocator>::operator = (long double a)  
{
   ...
   if((pdalboost::math::isinf)(a))
   {
      return *this = inf();
   }
   if((pdalboost::math::isnan)(a))
      return *this = nan();
...
void cpp_dec_float<Digits10, ExponentType, Allocator>::from_unsigned_long_long(const unsigned long long u) 
{
   ...
   pdalboost::uint32_t temp[(std::numeric_limits<unsigned long long>::digits10 / static_cast<int>(cpp_dec_float_elem_digits10)) + 3] = { static_cast<pdalboost::uint32_t>(0u) };

   while(uu != static_cast<unsigned long long>(0u))
   {
      temp[i] = static_cast<pdalboost::uint32_t>(uu % static_cast<unsigned long long>(cpp_dec_float_elem_mask));
...
template <unsigned Digits10, class ExponentType, class Allocator>
pdalboost::uint32_t cpp_dec_float<Digits10, ExponentType, Allocator>::mul_loop_uv(pdalboost::uint32_t* const u, const pdalboost::uint32_t* const v, const pdalboost::int32_t p)  
{
   //
   ...
   pdalboost::uint64_t carry = static_cast<pdalboost::uint64_t>(0u);

   for(pdalboost::int32_t j = static_cast<pdalboost::int32_t>(p - 1u); j >= static_cast<pdalboost::int32_t>(0); j--)
   {
     pdalboost::uint64_t sum = carry;

     for(pdalboost::int32_t i = j; i >= static_cast<pdalboost::int32_t>(0); i--)
     {
       sum += static_cast<pdalboost::uint64_t>(u[j - i] * static_cast<pdalboost::uint64_t>(v[i]));
     }

     u[j]  = static_cast<pdalboost::uint32_t>(sum % static_cast<pdalboost::uint32_t>(cpp_dec_float_elem_mask));
     carry = static_cast<pdalboost::uint64_t>(sum / static_cast<pdalboost::uint32_t>(cpp_dec_float_elem_mask));
   }

   return static_cast<pdalboost::uint32_t>(carry);
}

template <unsigned Digits10, class ExponentType, class Allocator>
pdalboost::uint32_t cpp_dec_float<Digits10, ExponentType, Allocator>::mul_loop_n(pdalboost::uint32_t* const u, pdalboost::uint32_t n, const pdalboost::int32_t p)  
{
   pdalboost::uint64_t carry = static_cast<pdalboost::uint64_t>(0u);

   // Multiplication loop.
   for(pdalboost::int32_t j = p - 1; j >= static_cast<pdalboost::int32_t>(0); j--)
   {
      const pdalboost::uint64_t t = static_cast<pdalboost::uint64_t>(carry + static_cast<pdalboost::uint64_t>(u[j] * static_cast<pdalboost::uint64_t>(n)));
      carry          = static_cast<pdalboost::uint64_t>(t / static_cast<pdalboost::uint32_t>(cpp_dec_float_elem_mask));
      u[j]           = static_cast<pdalboost::uint32_t>(t - static_cast<pdalboost::uint64_t>(static_cast<pdalboost::uint32_t>(cpp_dec_float_elem_mask) * static_cast<pdalboost::uint64_t>(carry)));
   }
...
template <unsigned Digits10, class ExponentType, class Allocator>
pdalboost::uint32_t cpp_dec_float<Digits10, ExponentType, Allocator>::div_loop_n(pdalboost::uint32_t* const u, pdalboost::uint32_t n, const pdalboost::int32_t p)  
{
   pdalboost::uint64_t prev = static_cast<pdalboost::uint64_t>(0u);

   for(pdalboost::int32_t j = static_cast<pdalboost::int32_t>(0); j < p; j++)
   {
      const pdalboost::uint64_t t = static_cast<pdalboost::uint64_t>(u[j] + static_cast<pdalboost::uint64_t>(prev * static_cast<pdalboost::uint32_t>(cpp_dec_float_elem_mask)));
      u[j]           = static_cast<pdalboost::uint32_t>(t / n);
      prev           = static_cast<pdalboost::uint64_t>(t - static_cast<pdalboost::uint64_t>(n * static_cast<pdalboost::uint64_t>(u[j])));
   }

   return static_cast<pdalboost::uint32_t>(prev);
}
...
cpp_dec_float<Digits10, ExponentType, Allocator> cpp_dec_float<Digits10, ExponentType, Allocator>::pow2(const long long p)
{
   ...
   // symmetric about 0.
   init.do_nothing();
   static const pdalboost::array<cpp_dec_float<Digits10, ExponentType, Allocator>, 255u> p2_data =
   {{
       ...
       cpp_dec_float(static_cast<pdalboost::uint64_t>(1uL << 20u)),
       cpp_dec_float(static_cast<pdalboost::uint64_t>(1uL << 21u)),
       cpp_dec_float(static_cast<pdalboost::uint64_t>(1uL << 22u)),
       cpp_dec_float(static_cast<pdalboost::uint64_t>(1uL << 23u)),
       cpp_dec_float(static_cast<pdalboost::uint64_t>(1uL << 24u)),
       cpp_dec_float(static_cast<pdalboost::uint64_t>(1uL << 25u)),
       cpp_dec_float(static_cast<pdalboost::uint64_t>(1uL << 26u)),
       cpp_dec_float(static_cast<pdalboost::uint64_t>(1uL << 27u)),
       cpp_dec_float(static_cast<pdalboost::uint64_t>(1uL << 28u)),
       cpp_dec_float(static_cast<pdalboost::uint64_t>(1uL << 29u)),
       cpp_dec_float(static_cast<pdalboost::uint64_t>(1uL << 30u)),
       cpp_dec_float(static_cast<pdalboost::uint64_t>(1uL << 31u)),
       cpp_dec_float(static_cast<pdalboost::uint64_t>(1uLL << 32u)),
       cpp_dec_float(static_cast<pdalboost::uint64_t>(1uLL << 33u)),
       cpp_dec_float(static_cast<pdalboost::uint64_t>(1uLL << 34u)),
       cpp_dec_float(static_cast<pdalboost::uint64_t>(1uLL << 35u)),
       cpp_dec_float(static_cast<pdalboost::uint64_t>(1uLL << 36u)),
       cpp_dec_float(static_cast<pdalboost::uint64_t>(1uLL << 37u)),
       cpp_dec_float(static_cast<pdalboost::uint64_t>(1uLL << 38u)),
       cpp_dec_float(static_cast<pdalboost::uint64_t>(1uLL << 39u)),
       cpp_dec_float(static_cast<pdalboost::uint64_t>(1uLL << 40u)),
       cpp_dec_float(static_cast<pdalboost::uint64_t>(1uLL << 41u)),
       cpp_dec_float(static_cast<pdalboost::uint64_t>(1uLL << 42u)),
       cpp_dec_float(static_cast<pdalboost::uint64_t>(1uLL << 43u)),
       cpp_dec_float(static_cast<pdalboost::uint64_t>(1uLL << 44u)),
       cpp_dec_float(static_cast<pdalboost::uint64_t>(1uLL << 45u)),
       cpp_dec_float(static_cast<pdalboost::uint64_t>(1uLL << 46u)),
       cpp_dec_float(static_cast<pdalboost::uint64_t>(1uLL << 47u)),
       cpp_dec_float(static_cast<pdalboost::uint64_t>(1uLL << 48u)),
       cpp_dec_float(static_cast<pdalboost::uint64_t>(1uLL << 49u)),
       cpp_dec_float(static_cast<pdalboost::uint64_t>(1uLL << 50u)),
       cpp_dec_float(static_cast<pdalboost::uint64_t>(1uLL << 51u)),
       cpp_dec_float(static_cast<pdalboost::uint64_t>(1uLL << 52u)),
       cpp_dec_float(static_cast<pdalboost::uint64_t>(1uLL << 53u)),
       cpp_dec_float(static_cast<pdalboost::uint64_t>(1uLL << 54u)),
       cpp_dec_float(static_cast<pdalboost::uint64_t>(1uLL << 55u)),
       cpp_dec_float(static_cast<pdalboost::uint64_t>(1uLL << 56u)),
       cpp_dec_float(static_cast<pdalboost::uint64_t>(1uLL << 57u)),
       cpp_dec_float(static_cast<pdalboost::uint64_t>(1uLL << 58u)),
       cpp_dec_float(static_cast<pdalboost::uint64_t>(1uLL << 59u)),
       cpp_dec_float(static_cast<pdalboost::uint64_t>(1uLL << 60u)),
       cpp_dec_float(static_cast<pdalboost::uint64_t>(1uLL << 61u)),
       cpp_dec_float(static_cast<pdalboost::uint64_t>(1uLL << 62u)),
       cpp_dec_float(static_cast<pdalboost::uint64_t>(1uLL << 63u)),
   ...
   else if(p < static_cast<ExponentType>(std::numeric_limits<pdalboost::uint64_t>::digits))
   {
      const pdalboost::uint64_t p2 = static_cast<pdalboost::uint64_t>(static_cast<pdalboost::uint64_t>(1uLL) << p);
...
inline void eval_trunc(cpp_dec_float<Digits10, ExponentType, Allocator>& result, const cpp_dec_float<Digits10, ExponentType, Allocator>& x)
{
   if(!x.isfinite()) 
   { 
      result = pdalboost::math::policies::raise_rounding_error("pdalboost::multiprecision::trunc<%1%>(%1%)", 0, number<cpp_dec_float<Digits10, ExponentType, Allocator> >(x), 0, pdalboost::math::policies::policy<>()).backend();
      return;
   }
   else if(x.isint())
   {
...
using pdalboost::multiprecision::backends::cpp_dec_float;
...
namespace std
{
   template <unsigned Digits10, class ExponentType, class Allocator, pdalboost::multiprecision::expression_template_option ExpressionTemplates> 
   class numeric_limits<pdalboost::multiprecision::number<pdalboost::multiprecision::cpp_dec_float<Digits10, ExponentType, Allocator>, ExpressionTemplates> >
   {
   public:
      ...
      BOOST_STATIC_CONSTEXPR int                     digits            = pdalboost::multiprecision::cpp_dec_float<Digits10, ExponentType, Allocator>::cpp_dec_float_digits10;
      BOOST_STATIC_CONSTEXPR int                     digits10          = pdalboost::multiprecision::cpp_dec_float<Digits10, ExponentType, Allocator>::cpp_dec_float_digits10;
      BOOST_STATIC_CONSTEXPR int                     max_digits10      = pdalboost::multiprecision::cpp_dec_float<Digits10, ExponentType, Allocator>::cpp_dec_float_total_digits10;
      BOOST_STATIC_CONSTEXPR ExponentType          min_exponent      = pdalboost::multiprecision::cpp_dec_float<Digits10, ExponentType, Allocator>::cpp_dec_float_min_exp;      // Type differs from int.
      BOOST_STATIC_CONSTEXPR ExponentType          min_exponent10    = pdalboost::multiprecision::cpp_dec_float<Digits10, ExponentType, Allocator>::cpp_dec_float_min_exp10;    // Type differs from int.
      BOOST_STATIC_CONSTEXPR ExponentType          max_exponent      = pdalboost::multiprecision::cpp_dec_float<Digits10, ExponentType, Allocator>::cpp_dec_float_max_exp;      // Type differs from int.
      BOOST_STATIC_CONSTEXPR ExponentType          max_exponent10    = pdalboost::multiprecision::cpp_dec_float<Digits10, ExponentType, Allocator>::cpp_dec_float_max_exp10;    // Type differs from int.
      BOOST_STATIC_CONSTEXPR int                     radix             = pdalboost::multiprecision::cpp_dec_float<Digits10, ExponentType, Allocator>::cpp_dec_float_radix;
      ...
      BOOST_STATIC_CONSTEXPR pdalboost::multiprecision::number<pdalboost::multiprecision::cpp_dec_float<Digits10, ExponentType, Allocator>, ExpressionTemplates> (min)        (void)  { return (pdalboost::multiprecision::cpp_dec_float<Digits10, ExponentType, Allocator>::min)(); }
      BOOST_STATIC_CONSTEXPR pdalboost::multiprecision::number<pdalboost::multiprecision::cpp_dec_float<Digits10, ExponentType, Allocator>, ExpressionTemplates> (max)        (void)  { return (pdalboost::multiprecision::cpp_dec_float<Digits10, ExponentType, Allocator>::max)(); }
      BOOST_STATIC_CONSTEXPR pdalboost::multiprecision::number<pdalboost::multiprecision::cpp_dec_float<Digits10, ExponentType, Allocator>, ExpressionTemplates> lowest       (void)  { return pdalboost::multiprecision::cpp_dec_float<Digits10, ExponentType, Allocator>::zero(); }
      BOOST_STATIC_CONSTEXPR pdalboost::multiprecision::number<pdalboost::multiprecision::cpp_dec_float<Digits10, ExponentType, Allocator>, ExpressionTemplates> epsilon      (void)  { return pdalboost::multiprecision::cpp_dec_float<Digits10, ExponentType, Allocator>::eps(); }
      BOOST_STATIC_CONSTEXPR pdalboost::multiprecision::number<pdalboost::multiprecision::cpp_dec_float<Digits10, ExponentType, Allocator>, ExpressionTemplates> round_error  (void)  { return 0.5L; }
      BOOST_STATIC_CONSTEXPR pdalboost::multiprecision::number<pdalboost::multiprecision::cpp_dec_float<Digits10, ExponentType, Allocator>, ExpressionTemplates> infinity     (void)  { return pdalboost::multiprecision::cpp_dec_float<Digits10, ExponentType, Allocator>::inf(); }
      BOOST_STATIC_CONSTEXPR pdalboost::multiprecision::number<pdalboost::multiprecision::cpp_dec_float<Digits10, ExponentType, Allocator>, ExpressionTemplates> quiet_NaN    (void)  { return pdalboost::multiprecision::cpp_dec_float<Digits10, ExponentType, Allocator>::nan(); }
      BOOST_STATIC_CONSTEXPR pdalboost::multiprecision::number<pdalboost::multiprecision::cpp_dec_float<Digits10, ExponentType, Allocator>, ExpressionTemplates> signaling_NaN(void)  { return pdalboost::multiprecision::cpp_dec_float<Digits10, ExponentType, Allocator>::zero(); }
      BOOST_STATIC_CONSTEXPR pdalboost::multiprecision::number<pdalboost::multiprecision::cpp_dec_float<Digits10, ExponentType, Allocator>, ExpressionTemplates> denorm_min   (void)  { return pdalboost::multiprecision::cpp_dec_float<Digits10, ExponentType, Allocator>::zero(); }
   };

#ifndef BOOST_NO_INCLASS_MEMBER_INITIALIZATION

template <unsigned Digits10, class ExponentType, class Allocator, pdalboost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST int numeric_limits<pdalboost::multiprecision::number<pdalboost::multiprecision::cpp_dec_float<Digits10, ExponentType, Allocator>, ExpressionTemplates> >::digits;
template <unsigned Digits10, class ExponentType, class Allocator, pdalboost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST int numeric_limits<pdalboost::multiprecision::number<pdalboost::multiprecision::cpp_dec_float<Digits10, ExponentType, Allocator>, ExpressionTemplates> >::digits10;
template <unsigned Digits10, class ExponentType, class Allocator, pdalboost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST int numeric_limits<pdalboost::multiprecision::number<pdalboost::multiprecision::cpp_dec_float<Digits10, ExponentType, Allocator>, ExpressionTemplates> >::max_digits10;
template <unsigned Digits10, class ExponentType, class Allocator, pdalboost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST bool numeric_limits<pdalboost::multiprecision::number<pdalboost::multiprecision::cpp_dec_float<Digits10, ExponentType, Allocator>, ExpressionTemplates> >::is_signed;
template <unsigned Digits10, class ExponentType, class Allocator, pdalboost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST bool numeric_limits<pdalboost::multiprecision::number<pdalboost::multiprecision::cpp_dec_float<Digits10, ExponentType, Allocator>, ExpressionTemplates> >::is_integer;
template <unsigned Digits10, class ExponentType, class Allocator, pdalboost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST bool numeric_limits<pdalboost::multiprecision::number<pdalboost::multiprecision::cpp_dec_float<Digits10, ExponentType, Allocator>, ExpressionTemplates> >::is_exact;
template <unsigned Digits10, class ExponentType, class Allocator, pdalboost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST int numeric_limits<pdalboost::multiprecision::number<pdalboost::multiprecision::cpp_dec_float<Digits10, ExponentType, Allocator>, ExpressionTemplates> >::radix;
template <unsigned Digits10, class ExponentType, class Allocator, pdalboost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST ExponentType numeric_limits<pdalboost::multiprecision::number<pdalboost::multiprecision::cpp_dec_float<Digits10, ExponentType, Allocator>, ExpressionTemplates> >::min_exponent;
template <unsigned Digits10, class ExponentType, class Allocator, pdalboost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST ExponentType numeric_limits<pdalboost::multiprecision::number<pdalboost::multiprecision::cpp_dec_float<Digits10, ExponentType, Allocator>, ExpressionTemplates> >::min_exponent10;
template <unsigned Digits10, class ExponentType, class Allocator, pdalboost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST ExponentType numeric_limits<pdalboost::multiprecision::number<pdalboost::multiprecision::cpp_dec_float<Digits10, ExponentType, Allocator>, ExpressionTemplates> >::max_exponent;
template <unsigned Digits10, class ExponentType, class Allocator, pdalboost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST ExponentType numeric_limits<pdalboost::multiprecision::number<pdalboost::multiprecision::cpp_dec_float<Digits10, ExponentType, Allocator>, ExpressionTemplates> >::max_exponent10;
template <unsigned Digits10, class ExponentType, class Allocator, pdalboost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST bool numeric_limits<pdalboost::multiprecision::number<pdalboost::multiprecision::cpp_dec_float<Digits10, ExponentType, Allocator>, ExpressionTemplates> >::has_infinity;
template <unsigned Digits10, class ExponentType, class Allocator, pdalboost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST bool numeric_limits<pdalboost::multiprecision::number<pdalboost::multiprecision::cpp_dec_float<Digits10, ExponentType, Allocator>, ExpressionTemplates> >::has_quiet_NaN;
template <unsigned Digits10, class ExponentType, class Allocator, pdalboost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST bool numeric_limits<pdalboost::multiprecision::number<pdalboost::multiprecision::cpp_dec_float<Digits10, ExponentType, Allocator>, ExpressionTemplates> >::has_signaling_NaN;
template <unsigned Digits10, class ExponentType, class Allocator, pdalboost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST float_denorm_style numeric_limits<pdalboost::multiprecision::number<pdalboost::multiprecision::cpp_dec_float<Digits10, ExponentType, Allocator>, ExpressionTemplates> >::has_denorm;
template <unsigned Digits10, class ExponentType, class Allocator, pdalboost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST bool numeric_limits<pdalboost::multiprecision::number<pdalboost::multiprecision::cpp_dec_float<Digits10, ExponentType, Allocator>, ExpressionTemplates> >::has_denorm_loss;
template <unsigned Digits10, class ExponentType, class Allocator, pdalboost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST bool numeric_limits<pdalboost::multiprecision::number<pdalboost::multiprecision::cpp_dec_float<Digits10, ExponentType, Allocator>, ExpressionTemplates> >::is_iec559;
template <unsigned Digits10, class ExponentType, class Allocator, pdalboost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST bool numeric_limits<pdalboost::multiprecision::number<pdalboost::multiprecision::cpp_dec_float<Digits10, ExponentType, Allocator>, ExpressionTemplates> >::is_bounded;
template <unsigned Digits10, class ExponentType, class Allocator, pdalboost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST bool numeric_limits<pdalboost::multiprecision::number<pdalboost::multiprecision::cpp_dec_float<Digits10, ExponentType, Allocator>, ExpressionTemplates> >::is_modulo;
template <unsigned Digits10, class ExponentType, class Allocator, pdalboost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST bool numeric_limits<pdalboost::multiprecision::number<pdalboost::multiprecision::cpp_dec_float<Digits10, ExponentType, Allocator>, ExpressionTemplates> >::traps;
template <unsigned Digits10, class ExponentType, class Allocator, pdalboost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST bool numeric_limits<pdalboost::multiprecision::number<pdalboost::multiprecision::cpp_dec_float<Digits10, ExponentType, Allocator>, ExpressionTemplates> >::tinyness_before;
template <unsigned Digits10, class ExponentType, class Allocator, pdalboost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST float_round_style numeric_limits<pdalboost::multiprecision::number<pdalboost::multiprecision::cpp_dec_float<Digits10, ExponentType, Allocator>, ExpressionTemplates> >::round_style;
...
template <unsigned Digits10, class ExponentType, class Allocator, class Policy, pdalboost::multiprecision::expression_template_option ExpressionTemplates>
struct precision< pdalboost::multiprecision::number<pdalboost::multiprecision::cpp_dec_float<Digits10, ExponentType, Allocator>, ExpressionTemplates>, Policy>
{
   ...
   static const pdalboost::int32_t cpp_dec_float_digits10 = pdalboost::multiprecision::cpp_dec_float<Digits10, ExponentType, Allocator>::cpp_dec_float_digits10;
