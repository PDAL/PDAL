...
//
template<class Engine, class Backend, pdalboost::multiprecision::expression_template_option ExpressionTemplates>
pdalboost::multiprecision::number<Backend, ExpressionTemplates> 
   generate_uniform_int(Engine& eng, const pdalboost::multiprecision::number<Backend, ExpressionTemplates>& min_value, const pdalboost::multiprecision::number<Backend, ExpressionTemplates>& max_value);
...
template<class Backend, pdalboost::multiprecision::expression_template_option ExpressionTemplates>
struct subtract<pdalboost::multiprecision::number<Backend, ExpressionTemplates>, true> 
{ 
  typedef pdalboost::multiprecision::number<Backend, ExpressionTemplates> result_type;
  result_type operator()(result_type const& x, result_type const& y) { return x - y; }
};

}

template<class Engine, std::size_t w, class Backend, pdalboost::multiprecision::expression_template_option ExpressionTemplates>
class independent_bits_engine<Engine, w, pdalboost::multiprecision::number<Backend, ExpressionTemplates> >
{
public:
    ...
    {
        for(pdalboost::uintmax_t i = 0; i < z; ++i) {
            (*this)();
        }
    }
...
template<class Backend, pdalboost::multiprecision::expression_template_option ExpressionTemplates>
class uniform_smallint<pdalboost::multiprecision::number<Backend, ExpressionTemplates> >
{
public:
    typedef pdalboost::multiprecision::number<Backend, ExpressionTemplates> input_type;
    typedef pdalboost::multiprecision::number<Backend, ExpressionTemplates> result_type;
    ...
    result_type operator()(Engine& eng) const
    {
        ...
        return generate(eng, pdalboost::is_integral<base_result>());
    }
...
private:
    ...
    result_type generate(Engine& eng, pdalboost::mpl::true_) const
    {
        ...
        typedef typename Engine::result_type base_result;
        typedef typename pdalboost::make_unsigned<base_result>::type base_unsigned;
...
template<class Backend, pdalboost::multiprecision::expression_template_option ExpressionTemplates>
struct select_uniform_01<pdalboost::multiprecision::number<Backend, ExpressionTemplates> >
{
  template<class RealType>
  struct apply
  {
    typedef new_uniform_01<pdalboost::multiprecision::number<Backend, ExpressionTemplates> > type;
  };
};
...
pdalboost::multiprecision::number<Backend, ExpressionTemplates> 
   generate_uniform_int(
    Engine& eng, const pdalboost::multiprecision::number<Backend, ExpressionTemplates>& min_value, const pdalboost::multiprecision::number<Backend, ExpressionTemplates>& max_value,
...
template<class Engine, class Backend, pdalboost::multiprecision::expression_template_option ExpressionTemplates>
inline pdalboost::multiprecision::number<Backend, ExpressionTemplates> 
   generate_uniform_int(Engine& eng, const pdalboost::multiprecision::number<Backend, ExpressionTemplates>& min_value, const pdalboost::multiprecision::number<Backend, ExpressionTemplates>& max_value)
{
    typedef typename Engine::result_type base_result;
    typedef typename mpl::or_<pdalboost::is_integral<base_result>, mpl::bool_<pdalboost::multiprecision::number_category<Backend>::value == pdalboost::multiprecision::number_kind_integer> >::type tag_type;
