...
namespace pdalboost {} namespace boost = pdalboost; namespace pdalboost { namespace logic {
...
inline bool                                                             \
Name(pdalboost::logic::tribool x,                                           \
     pdalboost::logic::detail::indeterminate_t =                            \
       pdalboost::logic::detail::indeterminate_t())                         \
{ return x.value == pdalboost::logic::tribool::indeterminate_value; }
