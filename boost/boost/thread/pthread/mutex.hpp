  ...
  namespace posix {
    ...
    public:
        ...
        mutex()
        {
            ...
            if(res)
            {
                pdalboost::throw_exception(thread_resource_error(res, "pdalboost:: mutex constructor failed in pthread_mutex_init"));
            }
        }
        ~mutex()
        {
        ...
        void lock()
        {
            ...
            if (res)
            {
                pdalboost::throw_exception(lock_error(res,"boost: mutex lock failed in pthread_mutex_lock"));
            }
        }
        ...
        void unlock()
        {
            ...
            if (res)
            {
                pdalboost::throw_exception(lock_error(res,"boost: mutex unlock failed in pthread_mutex_unlock"));
            }
        }
...
#define BOOST_THREAD_DEFINES_MUTEX_NATIVE_HANDLE
    ...
    public:
        ...
        timed_mutex()
        {
            ...
            if(res)
            {
                pdalboost::throw_exception(thread_resource_error(res, "pdalboost:: timed_mutex constructor failed in pthread_mutex_init"));
            }
#ifndef BOOST_PTHREAD_HAS_TIMEDLOCK
            ...
            if(res2)
            {
                ...
                pdalboost::throw_exception(thread_resource_error(res2, "pdalboost:: timed_mutex constructor failed in pthread_cond_init"));
            }
            is_locked=false;
#endif
        }
    ...
    public:
        ...
        {
            struct timespec const ts=pdalboost::detail::to_timespec(abs_time);
