...
#define BOOST_THREAD_PROVIDES_INVOKE
    ...
    invoke(BOOST_THREAD_RV_REF(Fp) f, BOOST_THREAD_RV_REF(A0) a0)
        -> decltype(pdalboost::forward<A0>(a0).*f)
    {
        return pdalboost::forward<A0>(a0).*f;
    }
    ...
    -> decltype(pdalboost::forward<Fp>(f)(pdalboost::forward<Args>(args)...))
    {
      return pdalboost::forward<Fp>(f)(pdalboost::forward<Args>(args)...);
    }
    ...
    invoke(BOOST_THREAD_RV_REF(Fp) f, BOOST_THREAD_RV_REF(A0) a0, BOOST_THREAD_RV_REF(A1) a1)
        -> decltype((pdalboost::forward<A0>(a0).*f)(pdalboost::forward<Args>(a1)))
    {
        return (pdalboost::forward<A0>(a0).*f)(pdalboost::forward<Args>(a1));
    }
    ...
    invoke(BOOST_THREAD_RV_REF(Fp) f, BOOST_THREAD_RV_REF(A0) a0, BOOST_THREAD_RV_REF(A1) a1, BOOST_THREAD_RV_REF(A2) a2)
        -> decltype((pdalboost::forward<A0>(a0).*f)(pdalboost::forward<Args>(a1), pdalboost::forward<Args>(a2)))
    {
        return (pdalboost::forward<A0>(a0).*f)(pdalboost::forward<Args>(a1), pdalboost::forward<Args>(a2));
    }
    ...
    -> decltype(pdalboost::forward<Fp>(f)())
    {
      return pdalboost::forward<Fp>(f)();
    }
    template <class Fp, class A1>
    inline
    auto invoke(BOOST_THREAD_RV_REF(Fp) f, BOOST_THREAD_RV_REF(Args) a1)
    -> decltype(pdalboost::forward<Fp>(f)(pdalboost::forward<A1>(a1)))
    {
      return pdalboost::forward<Fp>(f)(pdalboost::forward<A1>(a1));
    ...
    -> decltype(pdalboost::forward<Fp>(f)(pdalboost::forward<A1>(a1), pdalboost::forward<A2>(a2)))
    {
      return pdalboost::forward<Fp>(f)(pdalboost::forward<A1>(a1), pdalboost::forward<A2>(a2));
    }
    ...
    -> decltype(pdalboost::forward<Fp>(f)(pdalboost::forward<A1>(a1), pdalboost::forward<A2>(a2), pdalboost::forward<A3>(a3)))
    {
      return pdalboost::forward<Fp>(f)(pdalboost::forward<A1>(a1), pdalboost::forward<A2>(a2), pdalboost::forward<A3>(a3));
    }
    ...
    {
      return std::bind(pdalboost::forward<Fp>(f), pdalboost::forward<A1>(a1))();
    }
    ...
    {
      return std::bind(pdalboost::forward<Fp>(f), pdalboost::forward<A1>(a1), pdalboost::forward<A2>(a2))();
    }
    ...
    {
      return std::bind(pdalboost::forward<Fp>(f), pdalboost::forward<A1>(a1), pdalboost::forward<A2>(a2), pdalboost::forward<A3>(a3))();
    }
...
//    }
    ...
    {
      return f(pdalboost::forward<Args>(args)...);
    }
#else // BOOST_NO_CXX11_VARIADIC_TEMPLATES
    // bullet 1
    // (t1.*f)(t2, ..., tN) when f is a pointer to a member function of a class T and t1 is an object of
    ...
    {
        return (pdalboost::forward<A0>(a0).*f)(pdalboost::forward<A1>(a1));
    }
    template <class Ret, class A, class A0, class A1>
    inline
    typename enable_if_c
    ...
    {
        return (pdalboost::forward<A0>(a0).*f)(pdalboost::forward<A1>(a1), pdalboost::forward<A2>(a2));
    }
    template <class Ret, class A, class A0, class A1, class A2>
    inline
    typename enable_if_c
    ...
    {
        return (pdalboost::forward<A0>(a0).*f)(pdalboost::forward<A1>(a1), pdalboost::forward<A2>(a2), pdalboost::forward<A3>(a3));
    }
    template <class Ret, class A, class A0, class A1, class A2, class A3>
    inline
    typename enable_if_c
...
///
    ...
    {
      return ((*pdalboost::forward<A0>(a0)).*f)(a1);
    }
    template <class Ret, class A, class A0, class A1>
    inline
    typename enable_if_c
...
//    }
    ...
    {
      return pdalboost::forward<Fp>(f)(a1);
    }
    template <class Ret, class Fp, class A1, class A2>
    inline
    typename enable_if_c
    ...
    {
      return pdalboost::forward<Fp>(f)(a1, a2);
    }
    template <class Ret, class Fp, class A1, class A2, class A3>
    inline
    typename enable_if_c
    ...
    {
      return pdalboost::forward<Fp>(f)(a1, a2, a3);
    }
    ...
    {
      return f(pdalboost::forward<A1>(a1));
    }
    template <class Ret, class Fp, class A1>
    inline
    typename enable_if_c
    ...
    {
      return f(pdalboost::forward<A1>(a1), pdalboost::forward<A2>(a2));
    }
    template <class Ret, class Fp, class A1, class A2>
    inline
    typename enable_if_c
    ...
    {
      return f(pdalboost::forward<A1>(a1), pdalboost::forward<A2>(a2), pdalboost::forward<A3>(a3));
    }
    template <class Ret, class Fp, class A1, class A2, class A3>
    inline
    typename enable_if_c
