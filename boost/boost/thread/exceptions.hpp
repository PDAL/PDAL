...
namespace pdalboost {} namespace boost = pdalboost; namespace pdalboost
{
    ...
    public:
        lock_error()
        : base_type(0, "pdalboost::lock_error")
        {}

        lock_error( int ev )
        : base_type(ev, "pdalboost::lock_error")
        {
        }
    ...
    public:
          ...
          : base_type(system::errc::resource_unavailable_try_again, "pdalboost::thread_resource_error")
          {}

          thread_resource_error( int ev )
          : base_type(ev, "pdalboost::thread_resource_error")
          {
          }
    ...
    public:
          ...
          : base_type(system::errc::invalid_argument, "pdalboost::unsupported_thread_option")
          {}

          unsupported_thread_option( int ev )
          : base_type(ev, "pdalboost::unsupported_thread_option")
          {
          }
    ...
    public:
        ...
        : base_type(system::errc::invalid_argument, "pdalboost::invalid_thread_argument")
        {}

        invalid_thread_argument( int ev )
        : base_type(ev, "pdalboost::invalid_thread_argument")
        {
        }
    ...
    public:
          ...
          : base_type(system::errc::permission_denied, "pdalboost::thread_permission_error")
          {}

          thread_permission_error( int ev )
          : base_type(ev, "pdalboost::thread_permission_error")
          {
          }
