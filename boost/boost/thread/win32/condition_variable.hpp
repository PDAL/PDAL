...
namespace pdalboost {} namespace boost = pdalboost; namespace pdalboost
{
    namespace detail
    {
        ...
        class basic_condition_variable
        {
            ...
            struct entry_manager
            {
                ...
                entry_manager(entry_ptr const& entry_, pdalboost::mutex& mutex_):
    ...
    public:
        ...
        bool timed_wait(unique_lock<mutex>& m,pdalboost::xtime const& abs_time)
        {
        ...
        template<typename predicate_type>
        bool timed_wait(unique_lock<mutex>& m,pdalboost::system_time const& abs_time,predicate_type pred)
        {
            return do_wait(m,abs_time,pred);
        }
        template<typename predicate_type>
        bool timed_wait(unique_lock<mutex>& m,pdalboost::xtime const& abs_time,predicate_type pred)
        {
    ...
    public:
        ...
        template<typename lock_type>
        bool timed_wait(lock_type& m,pdalboost::xtime const& abs_time)
        {
            return do_wait(m,system_time(abs_time));
        }
        ...
        template<typename lock_type,typename predicate_type>
        bool timed_wait(lock_type& m,pdalboost::xtime const& abs_time,predicate_type pred)
        {
            return do_wait(m,system_time(abs_time),pred);
        }
