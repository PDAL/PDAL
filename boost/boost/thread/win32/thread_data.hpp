...
//#endif
            ...
            void make_ready_pdalboostat_thread_exit(shared_ptr<shared_state_base> as)
            {
        ...
        struct BOOST_SYMBOL_VISIBLE timeout
        {
            ...
            bool relative;
            pdalboost::system_time abs_time;
            ...
            timeout(uintmax_t milliseconds_):
                ...
                relative(true),
                abs_time(pdalboost::get_system_time())
            {}

            timeout(pdalboost::system_time const& abs_time_):
                start(win32::GetTickCount64()),
                milliseconds(0),
                relative(false),
                abs_time(abs_time_)
