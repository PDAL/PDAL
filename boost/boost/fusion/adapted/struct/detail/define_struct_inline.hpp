...
#define BOOST_FUSION_MAKE_ITERATOR_VALUE_OF_SPECS(Z, N, NAME)                   \
    ...
    struct value_of<                                                            \
           ...
           >                                                                    \
        : pdalboost::mpl::identity<                                                 \
              typename pdalboost_fusion_detail_Sq::t##N##_type                      \
          >                                                                     \
    {                                                                           \
    };
...
#define BOOST_FUSION_MAKE_ITERATOR_DEREF_SPEC(                                  \
    ...
    {                                                                           \
        typedef typename pdalboost_fusion_detail_Sq::t##N##_type TYPE_QUAL& type;   \
...
#define BOOST_FUSION_MAKE_VALUE_AT_SPECS(Z, N, DATA)                            \
    template <typename boost_fusion_detail_Sq>                                  \
    struct value_at<boost_fusion_detail_Sq, pdalboost::mpl::int_<N> >               \
    {                                                                           \
        typedef typename pdalboost_fusion_detail_Sq::t##N##_type type;              \
    };

#define BOOST_FUSION_MAKE_AT_SPECS(R, DATA, N, ATTRIBUTE)                       \
    template <typename boost_fusion_detail_Sq>                                  \
    struct at<boost_fusion_detail_Sq, pdalboost::mpl::int_<N> >                     \
    {                                                                           \
        typedef typename pdalboost::mpl::if_<                                       \
            pdalboost::is_const<boost_fusion_detail_Sq>,                            \
            typename pdalboost_fusion_detail_Sq::t##N##_type const&,                \
            typename pdalboost_fusion_detail_Sq::t##N##_type&                       \
        >::type type;                                                           \
                                                                                \
...
#define BOOST_FUSION_DEFINE_ITERATOR_VALUE_OF(NAME, ATTRIBUTE_SEQ_SIZE)         \
        ...
        struct value_of : pdalboost::fusion::result_of::at_c<                       \
                              ref_vec_t,                                        \
                              pdalboost_fusion_detail_Iterator::index::value        \
                          >                                                     \
        {                                                                       \
        };
...
#define BOOST_FUSION_DEFINE_ITERATOR_DEREF(NAME, ATTRIBUTES_SEQ)                \
        ...
        {                                                                       \
            ...
            static const int index = iterator_raw_type::index::value;           \
                                                                                \
            typedef typename pdalboost::fusion::result_of::at_c<                    \
                ref_vec_t,                                                      \
                index                                                           \
            >::type result_raw_type;                                            \
                                                                                \
            typedef typename pdalboost::mpl::if_<                                   \
                pdalboost::is_const<typename iterator_raw_type::sequence_type>,     \
                typename pdalboost::add_const<result_raw_type>::type,               \
                result_raw_type                                                 \
            >::type type;                                                       \
                                                                                \
            static type call(iterator_raw_type const& iter)                     \
            {                                                                   \
                return pdalboost::fusion::at_c<index>(iter.ref_vec);                \
            }                                                                   \
        };
...
#define BOOST_FUSION_MAKE_ITERATOR_WKND_REF(Z, N, DATA)                         \
        ...
        typename pdalboost::mpl::if_<                                               \
                pdalboost::is_const<boost_fusion_detail_Seq>,                       \
                typename pdalboost::add_const<                                      \
                        typename pdalboost_fusion_detail_Seq::t##N##_type           \
                >::type,                                                        \
                typename pdalboost_fusion_detail_Seq::t##N##_type                   \
        >::type&

#define BOOST_FUSION_DEFINE_ITERATOR_WKND_MEMBERS(ATTRIBUTES_SEQ_SIZE)          \
        typedef pdalboost::fusion::vector<                                          \
            BOOST_PP_REPEAT(                                                    \
                    ATTRIBUTES_SEQ_SIZE,                                        \
...
#define BOOST_FUSION_DEFINE_STRUCT_INLINE_IMPL(NAME, ATTRIBUTES)                \
    ...
    struct NAME : pdalboost::fusion::sequence_facade<                               \
                      NAME,                                                     \
                      pdalboost::fusion::random_access_traversal_tag                \
                  >                                                             \
    {                                                                           \
...
#define BOOST_FUSION_DEFINE_STRUCT_INLINE_ITERATOR_IMPL_IMPL(                   \
    ...
    struct BOOST_FUSION_ITERATOR_NAME(NAME)                                     \
        : pdalboost::fusion::iterator_facade<                                       \
              BOOST_FUSION_ITERATOR_NAME(NAME)<boost_fusion_detail_Seq, N>,     \
              pdalboost::fusion::random_access_traversal_tag                        \
          >                                                                     \
    {                                                                           \
        typedef pdalboost::mpl::int_<N> index;                                      \
        ...
        {                                                                       \
            typedef BOOST_FUSION_ITERATOR_NAME(NAME)<                           \
                typename pdalboost_fusion_detail_It::sequence_type,                 \
                pdalboost_fusion_detail_It::index::value + 1                        \
            > type;                                                             \
                                                                                \
        ...
        struct distance                                                         \
        {                                                                       \
            typedef typename pdalboost::mpl::minus<                                 \
                typename pdalboost_fusion_detail_It2::index,                        \
                typename pdalboost_fusion_detail_It1::index                         \
            >::type type;                                                       \
                                                                                \
        ...
        {                                                                       \
            typedef BOOST_FUSION_ITERATOR_NAME(NAME)<                           \
                typename pdalboost_fusion_detail_It::sequence_type,                 \
                pdalboost_fusion_detail_It::index::value                            \
                    + pdalboost_fusion_detail_M::value                              \
            > type;                                                             \
                                                                                \
            static type call(boost_fusion_detail_It const& it)                  \
            {                                                                   \
...
#define BOOST_FUSION_DEFINE_STRUCT_INLINE_MEMBERS_IMPL_IMPL(                    \
    ...
    {                                                                           \
        pdalboost::fusion::copy(rhs, *this);                                        \
    }                                                                           \
                                                                                \
    template <typename boost_fusion_detail_Seq>                                 \
    ...
    {                                                                           \
        ...
        {                                                                       \
            return type(sq);                                                    \
                                                                                ...
                                                                                \
    template <typename boost_fusion_detail_Sq>                                  \
    struct size : pdalboost::mpl::int_<ATTRIBUTES_SEQ_SIZE>                         \
    {                                                                           \
    };                                                                          \
                                                                                \
    template <typename boost_fusion_detail_Sq>                                  \
    struct empty : pdalboost::mpl::bool_<ATTRIBUTES_SEQ_SIZE == 0>                  \
    {                                                                           \
    };                                                                          \
                                                                                \
    template <                                                                  \
    ...
    struct value_at : value_at<                                                 \
                          boost_fusion_detail_Sq,                               \
                          pdalboost::mpl::int_<pdalboost_fusion_detail_N::value>        \
                      >                                                         \
    {                                                                           \
    };                                                                          \
                                                                                \
