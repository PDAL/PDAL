...
#define BOOST_FUSION_MAKE_ITERATOR_VALUE_OF_SPECS(Z, N, NAME)                   \
    ...
    struct value_of<NAME##_iterator<boost_fusion_uglified_Sq, N> >              \
        : pdalboost::mpl::identity<                                                 \
              typename pdalboost_fusion_uglified_Sq::t##N##_type                    \
          >                                                                     \
    {                                                                           \
    };
...
#define BOOST_FUSION_MAKE_ITERATOR_DEREF_SPEC(                                  \
    ...
    {                                                                           \
        typedef typename pdalboost_fusion_uglified_Sq::t##N##_type TYPE_QUAL& type; \
...
#define BOOST_FUSION_MAKE_VALUE_AT_SPECS(Z, N, DATA)                            \
    template <typename boost_fusion_uglified_Sq>                                \
    struct value_at<boost_fusion_uglified_Sq, pdalboost::mpl::int_<N> >             \
    {                                                                           \
        typedef typename pdalboost_fusion_uglified_Sq::t##N##_type type;            \
    };

#define BOOST_FUSION_MAKE_AT_SPECS(R, DATA, N, ATTRIBUTE)                       \
    template <typename boost_fusion_uglified_Sq>                                \
    struct at<boost_fusion_uglified_Sq, pdalboost::mpl::int_<N> >                   \
    {                                                                           \
        typedef typename pdalboost::mpl::if_<                                       \
            pdalboost::is_const<boost_fusion_uglified_Sq>,                          \
            typename pdalboost_fusion_uglified_Sq::t##N##_type const&,              \
            typename pdalboost_fusion_uglified_Sq::t##N##_type&                     \
        >::type type;                                                           \
                                                                                \
...
#define BOOST_FUSION_DEFINE_STRUCT_INLINE_MEMBERS_IMPL_IMPL(                    \
    ...
    {                                                                           \
        ...
        {                                                                       \
            typedef NAME##_iterator<                                            \
                typename pdalboost_fusion_uglified_It::sequence_type,               \
                pdalboost_fusion_uglified_It::index::value + 1                      \
            > type;                                                             \
                                                                                \
        ...
        {                                                                       \
            typedef typename pdalboost::mpl::minus<                                 \
                typename pdalboost_fusion_uglified_It2::index,                      \
                typename pdalboost_fusion_uglified_It1::index                       \
            >::type type;                                                       \
                                                                                \
        ...
        {                                                                       \
            typedef NAME##_iterator<                                            \
                typename pdalboost_fusion_uglified_It::sequence_type,               \
                pdalboost_fusion_uglified_It::index::value                          \
                    + pdalboost_fusion_uglified_M::value                            \
            > type;                                                             \
                                                                                \
            static type call(boost_fusion_uglified_It const& it)                \
            {                                                                   \
    ...
    struct value_at : value_at<                                                 \
                          boost_fusion_uglified_Sq,                             \
                          pdalboost::mpl::int_<pdalboost_fusion_uglified_N::value>      \
                      >                                                         \
    {                                                                           \
    };                                                                          \
                                                                                \
