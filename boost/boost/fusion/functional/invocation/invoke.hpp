...
namespace pdalboost {} namespace boost = pdalboost; namespace pdalboost { namespace fusion
{
    ...
    namespace detail
    {
        ...
        private:
            ...
            typedef mpl::or_< pdalboost::is_convertible<that,C*>,
                              pdalboost::is_convertible<that,C&>,
        ...
        public:
            ...
            typedef typename pdalboost::add_reference<qualified_type>::type
                result_type;
    ...
    namespace result_of
    {
        template <typename Function, class Sequence> struct invoke
        {
            typedef typename detail::invoke_impl<
                typename pdalboost::remove_reference<Function>::type, Sequence
              >::result_type type;
        };
    }
    ...
    {
        return detail::invoke_impl<
                typename pdalboost::remove_reference<Function>::type,Sequence const
            >::call(f,s);
    }
