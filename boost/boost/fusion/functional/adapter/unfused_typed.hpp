...
namespace pdalboost {} namespace boost = pdalboost; namespace pdalboost 
{
    ...
    struct result_of< pdalboost::fusion::unfused_typed<F,Seq> const () >
        : pdalboost::fusion::unfused_typed<F,Seq>::template result< 
            pdalboost::fusion::unfused_typed<F,Seq> const () >
    { };
    template<class F, class Seq>
    struct result_of< pdalboost::fusion::unfused_typed<F,Seq>() >
        : pdalboost::fusion::unfused_typed<F,Seq>::template result< 
            pdalboost::fusion::unfused_typed<F,Seq> () >
    { };
#endif
    template<class F, class Seq>
    struct tr1_result_of< pdalboost::fusion::unfused_typed<F,Seq> const () >
        : pdalboost::fusion::unfused_typed<F,Seq>::template result< 
            pdalboost::fusion::unfused_typed<F,Seq> const () >
    { };
    template<class F, class Seq>
    struct tr1_result_of< pdalboost::fusion::unfused_typed<F,Seq>() >
        : pdalboost::fusion::unfused_typed<F,Seq>::template result< 
            pdalboost::fusion::unfused_typed<F,Seq> () >
    { };
}
...
#define M(z,i,s)                                                                \
    typename call_param<typename result_of::value_at_c<s,i>::type>::type a##i
            ...
            inline typename pdalboost::result_of< 
...
#undef M
            ...
            struct result< Self const (BOOST_PP_ENUM_PARAMS(N,T)) >
                : pdalboost::result_of< function_c(arg_vector_t &) > 
            { };

            template <class Self BOOST_PP_ENUM_TRAILING_PARAMS(N,typename T)>
            struct result< Self (BOOST_PP_ENUM_PARAMS(N,T)) >
                : pdalboost::result_of< function(arg_vector_t &) >
            { };
        };
