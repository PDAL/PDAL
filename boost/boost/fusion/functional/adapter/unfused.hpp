...
namespace pdalboost {} namespace boost = pdalboost; namespace pdalboost 
{
    ...
    template<class F>
    struct result_of< pdalboost::fusion::unfused<F> const () >
    {
        typedef typename pdalboost::fusion::unfused<F>::call_const_0_result type;
    };
    template<class F>
    struct result_of< pdalboost::fusion::unfused<F>() >
    {
        typedef typename pdalboost::fusion::unfused<F>::call_0_result type;
    };
#endif
    template<class F>
    struct tr1_result_of< pdalboost::fusion::unfused<F> const () >
    {
        typedef typename pdalboost::fusion::unfused<F>::call_const_0_result type;
    };
    template<class F>
    struct tr1_result_of< pdalboost::fusion::unfused<F>() >
    {
        typedef typename pdalboost::fusion::unfused<F>::call_0_result type;
    };
}
...
#define N BOOST_PP_ITERATION()
        ...
        struct result< Self const (BOOST_PP_ENUM_PARAMS(N,T)) >
            : pdalboost::result_of< function_c(
        ...
        struct result< Self(BOOST_PP_ENUM_PARAMS(N,T)) >
            : pdalboost::result_of< function(
                BOOST_PP_CAT(fusion::vector,N)< BOOST_PP_ENUM_BINARY_PARAMS(N,
                    typename detail::mref<T,>::type BOOST_PP_INTERCEPT) > & )>
        { };

        template <BOOST_PP_ENUM_PARAMS(N,typename T)>
        inline typename pdalboost::result_of<function_c(BOOST_PP_CAT(fusion::vector,N)
        ...
        template <BOOST_PP_ENUM_PARAMS(N,typename T)>
        inline typename pdalboost::result_of<function(BOOST_PP_CAT(fusion::vector,N)
            <BOOST_PP_ENUM_BINARY_PARAMS(N,T,& BOOST_PP_INTERCEPT)> & )>::type
