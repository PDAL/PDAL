...
using ::pdalboost::tuples::tuple;
using ::pdalboost::tuples::null_type;
...
namespace {
  ...
  pdalboost::lambda::placeholder1_type free1 = pdalboost::lambda::placeholder1_type();
  pdalboost::lambda::placeholder2_type free2 = pdalboost::lambda::placeholder2_type();
  pdalboost::lambda::placeholder3_type free3 = pdalboost::lambda::placeholder3_type();

  pdalboost::lambda::placeholder1_type& _1 = free1;
  pdalboost::lambda::placeholder2_type& _2 = free2;
  pdalboost::lambda::placeholder3_type& _3 = free3;
