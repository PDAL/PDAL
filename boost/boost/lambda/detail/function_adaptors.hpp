...
struct remove_references_from_elements {
  typedef typename pdalboost::tuples::cons<
    typename pdalboost::remove_reference<typename Tuple::head_type>::type,
    typename remove_references_from_elements<typename Tuple::tail_type>::type
  > type;
};

template<>
struct remove_references_from_elements<pdalboost::tuples::null_type> {
  typedef pdalboost::tuples::null_type type;
};
...
template <class Func> struct function_adaptor {
  ...
  // Support functors that use the pdalboost::result_of return type convention.
...
struct function_adaptor<T Object::*> {
  ...
  template<class Args> class sig { 
    typedef typename pdalboost::tuples::element<1, Args>::type argument_type;
    typedef typename pdalboost::remove_reference<
      argument_type
    >::type unref_type;

    typedef typename detail::IF<pdalboost::is_const<unref_type>::value,
      typename pdalboost::add_const<T>::type,
      T
    >::RET properly_consted_return_type;

    typedef typename detail::IF<pdalboost::is_volatile<unref_type>::value,
      typename pdalboost::add_volatile<properly_consted_return_type>::type,
      properly_consted_return_type
    >::RET properly_cvd_return_type;


  public:
    typedef typename detail::IF<pdalboost::is_reference<argument_type>::value,
      typename pdalboost::add_reference<properly_cvd_return_type>::type,
      typename pdalboost::remove_cv<T>::type
    >::RET type;
  };
