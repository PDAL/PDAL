...
struct member_pointer<const T U::*> {
  typedef typename pdalboost::add_reference<const T>::type type;
  typedef U class_type;
...
struct member_pointer<volatile T U::*> {
  typedef typename pdalboost::add_reference<volatile T>::type type;
  typedef U class_type;
...
struct member_pointer<const volatile T U::*> {
  typedef typename pdalboost::add_reference<const volatile T>::type type;
  typedef U class_type;
...
public:
  ...
  private:
    ...
    typedef typename pdalboost::remove_reference<type0>::type type1;
    ...
    typedef typename ::pdalboost::remove_pointer<non_ref_A>::type non_pointer_A; 
  ...
  public:
    ...
    typedef typename detail::IF<
      ::pdalboost::is_const<non_pointer_A>::value, 
      typename ::pdalboost::add_const<type1>::type,
      type1
    >::RET type2;
    typedef typename detail::IF<
      ::pdalboost::is_volatile<non_pointer_A>::value, 
      typename ::pdalboost::add_volatile<type2>::type,
      type2
    >::RET type3;
    // add reference back
    typedef typename ::pdalboost::add_reference<type3>::type type;
  };
};
...
struct member_pointer_action_helper<false, true> {
  ...
  template<class RET, class A, class B>
  static RET apply(A& a, B& b) { 
    typedef typename ::pdalboost::remove_cv<B>::type plainB;
    typedef typename detail::member_pointer<plainB>::type ret_t; 
    typedef typename ::pdalboost::remove_cv<A>::type plainA;
...
public:
  ...
  static RET apply(A& a, B& b) {
    typedef typename 
      ::pdalboost::remove_cv<B>::type plainB;

    return detail::member_pointer_action_helper<
        pdalboost::is_pointer<A>::value && 
...
struct return_type_N<other_action<member_pointer_action>, Args> {
  typedef typename pdalboost::tuples::element<0, Args>::type A;
  typedef typename pdalboost::tuples::element<1, Args>::type B;
  typedef typename 
    return_type_2<other_action<member_pointer_action>, 
                  typename pdalboost::remove_reference<A>::type, 
                  typename pdalboost::remove_reference<B>::type
                 >::type type;
};
