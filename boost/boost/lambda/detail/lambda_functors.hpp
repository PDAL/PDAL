...
template<> struct placeholder<FIRST> {
  ...
  RET call(CALL_FORMAL_ARGS) const { 
    BOOST_STATIC_ASSERT(pdalboost::is_reference<RET>::value); 
...
public:
  ...
  // Support for pdalboost::result_of.
  ...
  const lambda_functor<lambda_functor_base<
                  ...
                  pdalboost::tuple<lambda_functor,
...
template<class T>
struct result_of<pdalboost::lambda::lambda_functor<T>()>
{
    typedef typename pdalboost::lambda::lambda_functor<T>::nullary_return_type type;
};

template<class T>
struct result_of<const pdalboost::lambda::lambda_functor<T>()>
{
    typedef typename pdalboost::lambda::lambda_functor<T>::nullary_return_type type;
};
...
template<class T>
struct tr1_result_of<pdalboost::lambda::lambda_functor<T>()>
{
    typedef typename pdalboost::lambda::lambda_functor<T>::nullary_return_type type;
};

template<class T>
struct tr1_result_of<const pdalboost::lambda::lambda_functor<T>()>
{
    typedef typename pdalboost::lambda::lambda_functor<T>::nullary_return_type type;
};
