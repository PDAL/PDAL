...
struct return_type_1<other_action<addressof_action>, A> { 
  ...
  typedef typename detail::IF<
    pdalboost::is_same<type1, detail::unspecified>::value, 
...
template <class A> struct contentsof_type {
  typedef typename pdalboost::indirect_reference<A>::type type; 
};
...
struct pointer_arithmetic_traits<plus_action, A, B> { 
  ...
  typedef typename 
    array_to_pointer<typename pdalboost::remove_reference<A>::type>::type AP;
  typedef typename 
    array_to_pointer<typename pdalboost::remove_reference<B>::type>::type BP;

  static const bool is_pointer_A = pdalboost::is_pointer<AP>::value;
  static const bool is_pointer_B = pdalboost::is_pointer<BP>::value;  
    ...
    pdalboost::is_same<
      typename pdalboost::remove_const<
        typename pdalboost::remove_pointer<
          typename pdalboost::remove_const<AP>::type
        >::type
      >::type,
      typename pdalboost::remove_const<
        typename pdalboost::remove_pointer<
          typename pdalboost::remove_const<BP>::type
        >::type
      >::type
    >::value;
...
struct return_type_2<bitwise_action<Act>, A, B>
{
  ...
  // the apply function
  BOOST_STATIC_ASSERT(!(pdalboost::is_float<plain_A>::value && pdalboost::is_float<plain_B>::value));
...
struct leftshift_type {
private:
  typedef typename pdalboost::remove_reference<A>::type plainA;
public:
...
struct return_type_2<arithmetic_assignment_action<Act>, A, B> { 
  ...
  typedef typename 
    detail::IF<
      pdalboost::is_same<type1, detail::unspecified>::value, 
      typename pdalboost::add_reference<A>::type,
      type1
    >::RET type;
};
...
struct return_type_2<other_action<subscript_action>, A, B> {
  ...
  typedef typename pdalboost::remove_reference<A>::type nonref_A;
  typedef typename pdalboost::remove_reference<B>::type nonref_B;
