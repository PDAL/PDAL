...
#include <boost/move/detail/meta_utils.hpp>
   ...
   template <class T>
   inline typename ::pdalboost::move_detail::enable_if_c
      < enable_move_utility_emulation<T>::value && ::pdalboost::move_detail::is_rv<T>::value, T &>::type
         forward(const typename ::pdalboost::move_detail::identity<T>::type &x)
   {
   ...
   template <class T>
   inline typename ::pdalboost::move_detail::enable_if_c
      < enable_move_utility_emulation<T>::value && !::pdalboost::move_detail::is_rv<T>::value, const T &>::type
      forward(const typename ::pdalboost::move_detail::identity<T>::type &x)
   {
      return x;
   }
      ...
      //////////////////////////////////////////////////////////////////////////////
         ...
         template <class T>
         inline T&& forward (typename ::pdalboost::move_detail::identity<T>::type&& t)
         {  return t;   }
