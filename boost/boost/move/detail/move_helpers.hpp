...
#define BOOST_MOVE_CATCH_CONST(U)  \
   typename ::pdalboost::mpl::if_< ::pdalboost::is_class<U>, BOOST_CATCH_CONST_RLVALUE(U), const U &>::type
#define BOOST_MOVE_CATCH_RVALUE(U)\
   typename ::pdalboost::mpl::if_< ::pdalboost::is_class<U>, BOOST_RV_REF(U), not_a_type>::type
...
\
   ...
   typename ::pdalboost::enable_if_c\
                     <  ::pdalboost::is_class<TYPE>::value &&\
                        ::pdalboost::is_same<TYPE, BOOST_MOVE_TEMPL_PARAM>::value &&\
                       !::pdalboost::has_move_emulation_enabled<BOOST_MOVE_TEMPL_PARAM>::value\
                     , RETURN_VALUE >::type\
...
\
   template<class BOOST_MOVE_TEMPL_PARAM>\
   typename ::pdalboost::enable_if_c\
                     < (!::pdalboost::is_class<BOOST_MOVE_TEMPL_PARAM>::value || \
                        !::pdalboost::move_detail::is_rv<BOOST_MOVE_TEMPL_PARAM>::value) && \
                       !::pdalboost::is_same<TYPE, BOOST_MOVE_TEMPL_PARAM>::value \
                     , RETURN_VALUE >::type\
   PUB_FUNCTION(const BOOST_MOVE_TEMPL_PARAM &u)\
   {\
...
//
//                         ::pdalboost::is_convertible<BOOST_MOVE_TEMPL_PARAM, TYPE>::value &&
...
\
   ...
   typename ::pdalboost::enable_if_c<\
                       !::pdalboost::move_detail::is_rv<BOOST_MOVE_TEMPL_PARAM>::value && \
                       !::pdalboost::is_same<TYPE, BOOST_MOVE_TEMPL_PARAM>::value && \
                       !::pdalboost::is_convertible<BOOST_MOVE_TEMPL_PARAM, UNLESS_CONVERTIBLE_TO>::value \
                     , RETURN_VALUE >::type\
   PUB_FUNCTION(ARG1 arg1, const BOOST_MOVE_TEMPL_PARAM &u)\
   {\
      TYPE t(u);\
