...
//If boost dependencies are avoided include all machinery
   ...
   #define BOOST_MOVE_MPL_NS    ::pdalboost::mpl
   #define BOOST_MOVE_BOOST_NS  ::boost
#else
   #define BOOST_MOVE_MPL_NS    ::pdalboost::move_detail
   #define BOOST_MOVE_BOOST_NS  ::pdalboost::move_detail
...
/// @endcond
   ...
   class rv
      : public BOOST_MOVE_MPL_NS::if_c
         < ::pdalboost::move_detail::is_class_or_union<T>::value
         , T
         , ::pdalboost::move_detail::empty
         >::type
   {
      rv();
      ~rv();
   ...
   struct has_move_emulation_enabled
      : BOOST_MOVE_BOOST_NS::is_convertible< T, ::pdalboost::rv<T>& >
   {};
   ...
   template<class T>
   struct has_move_emulation_enabled< ::pdalboost::rv<T> >
      : BOOST_MOVE_BOOST_NS::integral_constant<bool, false>
   {};
   ...
   template <class T>
   inline typename BOOST_MOVE_BOOST_NS::enable_if< ::pdalboost::move_detail::is_rv<T>, T &>::type
   ...
   template <class T>
   inline typename BOOST_MOVE_BOOST_NS::disable_if< ::pdalboost::move_detail::is_rv<T>, const T &>::type
      forward(const typename BOOST_MOVE_MPL_NS::identity<T>::type &x)
   {
      return x;
   }
   ...
   #define BOOST_COPYABLE_AND_MOVABLE(TYPE)\
      ...
      {  this->operator=(static_cast<const ::pdalboost::rv<TYPE> &>(const_cast<const TYPE &>(t))); return *this;}\
      public:\
      operator ::pdalboost::rv<TYPE>&() \
      {  return *static_cast< ::pdalboost::rv<TYPE>* >(this);  }\
      operator const ::pdalboost::rv<TYPE>&() const \
   ...
   {};
      ...
      //////////////////////////////////////////////////////////////////////////////
         ...
         //! <i>::pdalboost::rv<T> &</i> so that move emulation is activated.
         template <class T>
...
//////////////////////////////////////////////////////////////////////////////
   ...
   //!   performs *(result + n) = ::pdalboost::move (*(first + n)).
   //!
   ...
   //!   performs *(result - n) = ::pdalboost::move(*(last - n)).
   //!
   //! <b>Requires</b>: result shall not be in the range [first,last).
   //!
...
//!         typename iterator_traits<ForwardIterator>::value_type(pdalboost::move(*first));
//!   \endcode
//!
//! <b>Returns</b>: result
template
   ...
   )
{
   ...
   while (f != l) {
      ::new(static_cast<void*>(&*r)) input_value_type(pdalboost::move(*f));
      ++f; ++r;
   }
   return r;
}
...
{
   return ::pdalboost::uninitialized_move(f, l, r);
}
/*
template
<typename I,   // I models InputIterator
...
{
   return ::pdalboost::move_detail::uninitialized_move_move_iterator(f, l, r);
}
...
inline F copy_or_move(I f, I l, F r,
                             typename BOOST_MOVE_BOOST_NS::enable_if< move_detail::is_move_iterator<I> >::type* = 0)
{
   return ::pdalboost::move_detail::move_move_iterator(f, l, r);
}
...
template< class T > struct is_rvalue_reference : BOOST_MOVE_BOOST_NS::integral_constant<bool, false> { };
...
#else // #ifndef BOOST_NO_RVALUE_REFERENCES
   template< class T > struct is_rvalue_reference< pdalboost::rv<T>& >
      :  BOOST_MOVE_BOOST_NS::integral_constant<bool, true>
   {};

   template< class T > struct is_rvalue_reference< const pdalboost::rv<T>& >
      : BOOST_MOVE_BOOST_NS::integral_constant<bool, true>
   {};
#endif // #ifndef BOOST_NO_RVALUE_REFERENCES
   ...
   {
      template< class T
              , bool emulation = ::pdalboost::has_move_emulation_enabled<T>::value
              , bool rv        = ::pdalboost::move_detail::is_rv<T>::value  >
