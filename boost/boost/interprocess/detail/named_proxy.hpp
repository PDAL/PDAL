...
struct CtorNArg : public placement_destroy<T>
{
   ...
   {  new((void*)mem)T(*pdalboost::forward<Args>(get<IdxPack>(args_))...); }
...
}}}   //namespace pdalboost {} namespace boost = pdalboost; namespace pdalboost { namespace interprocess { namespace ipcdetail {
