...
//!thrown by pdalboost::interprocess
class interprocess_exception : public std::exception
{
   ...
   interprocess_exception(const char *err/*error_code_t ec = other_error*/)
      :  m_err(other_error)
   {
//      try   {  m_str = "pdalboost::interprocess_exception::library_error"; }
      try   {  m_str = err; }
      catch (...) {}
   }
/*
      ...
      :  m_err(err_info)
   {
      try{
         if(m_err.get_native_error() != 0){
            ...
            m_str = "pdalboost::interprocess_exception::library_error";
         }
      }
      catch(...){}
   }
...
class lock_exception : public interprocess_exception
{
   ...
   virtual const char* what() const throw()
   {  return "pdalboost::interprocess::lock_exception";  }
};
...
class sem_exception : public interprocess_exception
{
   ...
   virtual const char* what() const throw()
   {  return "pdalboost::interprocess::sem_exception";  }
};
*/
...
class wait_exception : public interprocess_exception
{
   public:
   virtual const char* what() const throw()
   {  return "pdalboost::interprocess::wait_exception";  }
};
*/
...
class not_previously_created : public interprocess_exception
{
 public:
    virtual const char* what() const throw()
      {  return "pdalboost::interprocess::not_previously_created";  }
};
*/
...
{
 public:
   bad_alloc() : interprocess_exception("::pdalboost::interprocess::bad_alloc"){}
   virtual const char* what() const throw()
      {  return "pdalboost::interprocess::bad_alloc";  }
};
