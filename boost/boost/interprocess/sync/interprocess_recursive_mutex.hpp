...
inline void interprocess_recursive_mutex::lock()
{
      ...
      pdalboost::posix_time::ptime wait_time
         = pdalboost::posix_time::microsec_clock::universal_time()
         + pdalboost::posix_time::milliseconds(BOOST_INTERPROCESS_TIMEOUT_WHEN_LOCKING_DURATION_MS);
...
inline bool interprocess_recursive_mutex::timed_lock(const pdalboost::posix_time::ptime &abs_time)
