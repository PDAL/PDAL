...
class sync_id
{
   ...
   {  return pdalboost::hash_value(m.rand_);  }
...
class sync_handles
{
   ...
   typedef pdalboost::unordered_map<sync_id, void*> umap_type;
   typedef pdalboost::container::map<const sync_id*, umap_type::iterator, address_less> map_type;
