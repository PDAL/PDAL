...
//!\file
//!Describes index adaptor of pdalboost::intrusive::set container, to use it
...
//!Index type based in pdalboost::intrusive::set.
//!Just derives from pdalboost::intrusive::set
...
struct is_intrusive_index
   <pdalboost::interprocess::iset_index<MapConfig> >
{
