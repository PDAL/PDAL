    ...
    namespace range_detail
    {
        ...
        public:
            ...
            strided_range(Difference stride, Rng& rng)
                : super_t(make_strided_iterator(pdalboost::begin(rng), pdalboost::begin(rng), pdalboost::end(rng), stride),
                          make_strided_iterator(pdalboost::begin(rng), pdalboost::end(rng), pdalboost::end(rng), stride))
            {
                BOOST_ASSERT( stride >= 0 );
            }
        };
