...
namespace assign_detail
{
    ...
    struct assign_decay
    {
        ...
        typedef BOOST_DEDUCED_TYPENAME mpl::eval_if<
            ...
            ::pdalboost::decay<const T>,
            ::pdalboost::decay<T> >::type type;
    };
...
// old Dinkumware doesn't support iterator type as template
    ...
    {
        return ::pdalboost::iterator_range_detail::equal( l, r );
    }
    ...
    inline bool operator<( const converter<T,I>& l, const Range& r )
    {
        return ::pdalboost::iterator_range_detail::less_than( l, r );
    }
    ...
    {
        return Os << ::pdalboost::make_iterator_range( r.begin(), r.end() );
    }
...
#include BOOST_PP_LOCAL_ITERATE()
        ...
        {
            return range( pdalboost::begin(r), pdalboost::end(r) );
        }
