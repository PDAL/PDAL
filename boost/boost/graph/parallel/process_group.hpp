...
namespace pdalboost {} namespace boost = pdalboost; namespace pdalboost { namespace graph { namespace parallel {
...
} } } // end namespace pdalboost::graph::parallel
...
} } } // end namespace pdalboost::graph::distributed
