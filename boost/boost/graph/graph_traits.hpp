...
#define BOOST_GRAPH_SEQUENTIAL_TRAITS_DEFINES_DISTRIBUTED_TAGS // Disable these from external versions of PBGL
    ...
    typedef pdalboost::forward_traversal_tag multi_pass_input_iterator_tag;
    ...
    struct graph_property_type
      : pdalboost::mpl::eval_if<detail::has_graph_property_type<G>,
                            detail::get_graph_property_type<G>,
                            no_property> {};
    template <typename G>
    struct edge_property_type
      : pdalboost::mpl::eval_if<detail::has_edge_property_type<G>,
                            detail::get_edge_property_type<G>,
                            no_property> {};
    template <typename G>
    struct vertex_property_type
      : pdalboost::mpl::eval_if<detail::has_vertex_property_type<G>,
