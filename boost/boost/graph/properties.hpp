...
#undef BOOST_DEF_PROPERTY
  ...
  namespace detail {
    ...
    struct property_kind_from_graph<G, R T::*> {
      typedef typename pdalboost::mpl::if_<
                pdalboost::is_base_of<T, typename vertex_bundle_type<G>::type>,
                vertex_property_tag,
                typename pdalboost::mpl::if_<
                  pdalboost::is_base_of<T, typename edge_bundle_type<G>::type>,
                  edge_property_tag,
                  typename pdalboost::mpl::if_<
                    pdalboost::is_base_of<T, typename graph_bundle_type<G>::type>,
                    graph_property_tag,
  ...
  public:
    typedef typename property_value<
      typename pdalboost::graph_property_type<Graph>::type, Property
    >::type type;
  };
