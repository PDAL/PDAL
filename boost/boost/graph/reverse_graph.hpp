...
struct vertex_property_type<reverse_graph<BidirectionalGraph, GraphRef> > {
  typedef typename pdalboost::vertex_property_type<BidirectionalGraph>::type type;
};

template <class BidirectionalGraph, class GraphRef>
struct edge_property_type<reverse_graph<BidirectionalGraph, GraphRef> > {
  typedef typename pdalboost::edge_property_type<BidirectionalGraph>::type type;
};

template <class BidirectionalGraph, class GraphRef>
struct graph_property_type<reverse_graph<BidirectionalGraph, GraphRef> > {
  typedef typename pdalboost::graph_property_type<BidirectionalGraph>::type type;
};
...
struct property_map<reverse_graph<BidirGraph, GRef>, Property> {
  typedef pdalboost::is_same<typename detail::property_kind_from_graph<BidirGraph, Property>::type, edge_property_tag> is_edge_prop;
  typedef pdalboost::is_const<typename pdalboost::remove_reference<GRef>::type> is_ref_const;
  ...
  typedef typename pdalboost::mpl::if_<is_edge_prop, detail::reverse_graph_edge_property_map<orig_type>, orig_type>::type type;
  typedef typename pdalboost::mpl::if_<is_edge_prop, detail::reverse_graph_edge_property_map<orig_const_type>, orig_const_type>::type const_type;
};
...
template <typename T> struct is_reverse_graph: pdalboost::mpl::false_ {};
template <typename G, typename R> struct is_reverse_graph<reverse_graph<G, R> >: pdalboost::mpl::true_ {};
...
typename pdalboost::mpl::if_<
           pdalboost::is_const<typename pdalboost::remove_reference<GRef>::type>,
