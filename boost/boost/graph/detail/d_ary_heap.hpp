...
namespace pdalboost {} namespace boost = pdalboost; namespace pdalboost {
  ...
  inline void property_map_swap(
         PropMap prop_map,
         const typename pdalboost::property_traits<PropMap>::key_type& ka, 
         const typename pdalboost::property_traits<PropMap>::key_type& kb) {
    typename pdalboost::property_traits<PropMap>::value_type va = get(prop_map, ka);
  ...
  namespace detail {
    ...
    class fixed_max_size_vector {
      pdalboost::shared_array<Value> m_data;
      std::size_t m_size;
  ...
  class d_ary_heap_indirect {
    ...
    typedef typename pdalboost::property_traits<DistanceMap>::value_type key_type;
    ...
    // distance map
    typedef typename pdalboost::property_traits<DistanceMap>::value_type distance_type;
