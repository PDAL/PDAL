...
//
// It is needed in order to allow us to write using pdalboost::vertices as
...
typename T::ThereReallyIsNoMemberByThisNameInT vertices(T const&);
        ...
        : Graph<G>
    {
        ...
        BOOST_STATIC_ASSERT((pdalboost::mpl::not_<pdalboost::is_same<out_edge_iterator, void> >::value));
        BOOST_STATIC_ASSERT((pdalboost::mpl::not_<pdalboost::is_same<degree_size_type, void> >::value));
        ...
        : IncidenceGraph<G>
    {
        ...
        BOOST_STATIC_ASSERT((pdalboost::mpl::not_<pdalboost::is_same<in_edge_iterator, void> >::value));
        ...
        : Graph<G>
    {
        ...
        BOOST_STATIC_ASSERT((pdalboost::mpl::not_<pdalboost::is_same<adjacency_iterator, void> >::value));
        ...
        : Graph<G>
    {
        ...
        BOOST_STATIC_ASSERT((pdalboost::mpl::not_<pdalboost::is_same<vertex_iterator, void> >::value));
        BOOST_STATIC_ASSERT((pdalboost::mpl::not_<pdalboost::is_same<vertices_size_type, void> >::value));
        ...
        : Graph<G>
    {
        ...
        BOOST_STATIC_ASSERT((pdalboost::mpl::not_<pdalboost::is_same<edge_iterator, void> >::value));
        BOOST_STATIC_ASSERT((pdalboost::mpl::not_<pdalboost::is_same<edges_size_type, void> >::value));
        ...
        : MutableGraph<G>
    {
        ...
        typename pdalboost::graph_traits<G>::vertex_descriptor u;
        typename pdalboost::graph_traits<G>::out_edge_iterator iter;
    };
...
using pdalboost::concepts::MultiPassInputIteratorConcept;

// Graph concepts
using pdalboost::concepts::GraphConcept;
using pdalboost::concepts::IncidenceGraphConcept;
using pdalboost::concepts::BidirectionalGraphConcept;
using pdalboost::concepts::AdjacencyGraphConcept;
using pdalboost::concepts::VertexListGraphConcept;
using pdalboost::concepts::EdgeListGraphConcept;
using pdalboost::concepts::VertexAndEdgeListGraphConcept;
using pdalboost::concepts::EdgeMutableGraphConcept;
using pdalboost::concepts::VertexMutableGraphConcept;
using pdalboost::concepts::MutableGraphConcept;
using pdalboost::concepts::MutableIncidenceGraphConcept;
using pdalboost::concepts::MutableBidirectionalGraphConcept;
using pdalboost::concepts::MutableEdgeListGraphConcept;
using pdalboost::concepts::VertexMutablePropertyGraphConcept;
using pdalboost::concepts::EdgeMutablePropertyGraphConcept;
using pdalboost::concepts::AdjacencyMatrixConcept;
using pdalboost::concepts::ReadablePropertyGraphConcept;
using pdalboost::concepts::PropertyGraphConcept;
using pdalboost::concepts::LvaluePropertyGraphConcept;
using pdalboost::concepts::VertexIndexGraphConcept;
using pdalboost::concepts::EdgeIndexGraphConcept;

// Utility concepts
using pdalboost::concepts::ColorValueConcept;
using pdalboost::concepts::BasicMatrixConcept;
using pdalboost::concepts::NumericValueConcept;
using pdalboost::concepts::DistanceMeasureConcept;
using pdalboost::concepts::DegreeMeasureConcept;
