...
namespace pdalboost {} namespace boost = pdalboost; namespace pdalboost {
     ...
     Buffer& Q, BFSVisitor vis, ColorMap color)
  {
    ...
    while (! Q.empty()) {
      ...
      for (pdalboost::tie(ei, ei_end) = out_edges(u, g); ei != ei_end; ++ei) {
     ...
     Buffer& Q, BFSVisitor vis, ColorMap color)
  {
    ...
    typedef typename property_traits<ColorMap>::value_type ColorValue;
    typedef color_traits<ColorValue> Color;
    typename pdalboost::graph_traits<VertexListGraph>::vertex_iterator i, i_end;
    for (pdalboost::tie(i, i_end) = vertices(g); i != i_end; ++i) {
  ...
  public:
    ...
    {
      invoke_visitors(m_vis, u, g, ::pdalboost::on_initialize_vertex());
    ...
    {
      invoke_visitors(m_vis, u, g, ::pdalboost::on_discover_vertex());
      return graph::bfs_visitor_event_not_overridden();
    }
    ...
    {
      invoke_visitors(m_vis, u, g, ::pdalboost::on_examine_vertex());
      return graph::bfs_visitor_event_not_overridden();
    }
    ...
    {
      invoke_visitors(m_vis, e, g, ::pdalboost::on_examine_edge());
      return graph::bfs_visitor_event_not_overridden();
    }
    ...
    {
      invoke_visitors(m_vis, e, g, ::pdalboost::on_tree_edge());
      return graph::bfs_visitor_event_not_overridden();
    }
    ...
    {
      invoke_visitors(m_vis, e, g, ::pdalboost::on_non_tree_edge());
      return graph::bfs_visitor_event_not_overridden();
    }
    ...
    {
      invoke_visitors(m_vis, e, g, ::pdalboost::on_gray_target());
      return graph::bfs_visitor_event_not_overridden();
    }
    ...
    {
      invoke_visitors(m_vis, e, g, ::pdalboost::on_black_target());
      return graph::bfs_visitor_event_not_overridden();
    }
    ...
    {
      invoke_visitors(m_vis, u, g, ::pdalboost::on_finish_vertex());
      return graph::bfs_visitor_event_not_overridden();
    }
  ...
  namespace detail {
                                    ...
                                    void)* = 0)
    {
      ...
      typedef pdalboost::queue<Vertex> queue_t;
      queue_t Q;
      breadth_first_search
        (g, s,
         choose_param(get_param(params, buffer_param_t()), pdalboost::ref(Q)).get(),
         vis, color);
    }
     ...
     const bgl_named_params<P, T, R>& params)
  {
    ...
    typedef pdalboost::queue<vertex_descriptor> queue_t;
    queue_t Q;
    ...
    namespace detail {
      ...
      struct breadth_first_search_impl {
        ...
        void operator()(const Graph& g, const Source& source, const ArgPack& arg_pack) {
          using namespace pdalboost::graph::keywords;
          typename pdalboost::graph_traits<Graph>::vertex_descriptor sources[1] = {source};
          pdalboost::queue<typename pdalboost::graph_traits<Graph>::vertex_descriptor> Q;
          pdalboost::breadth_first_search(g,
                                      &sources[0],
                                      &sources[1], 
                                      pdalboost::unwrap_ref(arg_pack[_buffer | pdalboost::ref(Q)]),
                                      arg_pack[_visitor | make_bfs_visitor(null_visitor())],
                                      pdalboost::detail::make_color_map_from_arg_pack(g, arg_pack));
        }
      };
    }
