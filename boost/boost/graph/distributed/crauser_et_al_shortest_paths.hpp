...
namespace pdalboost {} namespace boost = pdalboost; namespace pdalboost { namespace graph { namespace distributed {
...
namespace detail {
  ...
  class crauser_et_al_dijkstra_queue
    : public graph::detail::remote_update_set<
               ...
               typename pdalboost::graph::parallel::process_group_type<Graph>::type,
               ...
               typename property_map<Graph, vertex_owner_t>::const_type>
  {
    ...
    typedef typename property_map<Graph, vertex_owner_t>::const_type
      OwnerPropertyMap;
    typedef typename pdalboost::graph::parallel::process_group_type<Graph>::type
      process_group_type;
  ...
  public:
    ...
    crauser_et_al_dijkstra_queue(const Graph& g,
      ...
      : inherited(pdalboost::graph::parallel::process_group(g), get(vertex_owner, g)),
    ...
    bool do_synchronize()
    {
      using pdalboost::parallel::all_reduce;
      using pdalboost::parallel::minimum;
   ...
   DijkstraVisitor vis)
{
  ...
  ::pdalboost::detail::dijkstra_bfs_visitor<
      DijkstraVisitor, Queue, WeightMap,
      pdalboost::parallel::caching_property_map<PredecessorMap>,
      pdalboost::parallel::caching_property_map<DistanceMap>, Combine, Compare
    > bfs_vis(vis, Q, weight,
              pdalboost::parallel::make_caching_property_map(predecessor),
              pdalboost::parallel::make_caching_property_map(distance),
