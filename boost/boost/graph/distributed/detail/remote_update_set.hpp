...
namespace pdalboost {} namespace boost = pdalboost; namespace pdalboost { namespace graph { namespace detail {

template<typename ProcessGroup>
void do_synchronize(ProcessGroup& pg)
{ 
  using pdalboost::parallel::synchronize;
  synchronize(pg);
}
...
} } } // end namespace pdalboost::graph::detail
