...
namespace pdalboost {} namespace boost = pdalboost; namespace pdalboost { namespace graph { namespace distributed { namespace detail {
...
} } } } // end namespace pdalboost::graph::distributed::detail
