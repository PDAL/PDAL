...
structured_pair<FirstType,SecondType,Info,Layout> 
    copy_with_first_replaced(structured_pair<FirstType,SecondType,Info,Layout> const& p,
        BOOST_DEDUCED_TYPENAME ::pdalboost::call_traits< BOOST_DEDUCED_TYPENAME 
...
template< class FirstType, class SecondType, class Layout>
structured_pair<FirstType,SecondType,::pdalboost::mpl::na,Layout> 
    copy_with_first_replaced(structured_pair<FirstType,SecondType,::pdalboost::mpl::na,Layout> const& p,
        BOOST_DEDUCED_TYPENAME ::pdalboost::call_traits< BOOST_DEDUCED_TYPENAME 
            structured_pair<FirstType,SecondType,::pdalboost::mpl::na,Layout>::first_type>
                ::param_type f)
{
    return structured_pair<FirstType,SecondType,::pdalboost::mpl::na,Layout>(f,p.second);
}
...
template< class FirstType, class SecondType, class Layout>
structured_pair<FirstType,SecondType,::pdalboost::mpl::na,Layout> 
    copy_with_second_replaced(structured_pair<FirstType,SecondType,::pdalboost::mpl::na,Layout> const& p,
        BOOST_DEDUCED_TYPENAME ::pdalboost::call_traits< BOOST_DEDUCED_TYPENAME 
            structured_pair<FirstType,SecondType,::pdalboost::mpl::na,Layout>::second_type>
                ::param_type s)
{
    return structured_pair<FirstType,SecondType,::pdalboost::mpl::na,Layout>(p.first,s);
}
