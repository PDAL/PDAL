...
public:
  ...
  std::size_t fill(pdalboost::system::error_code& ec)
  {
    detail::buffer_resize_guard<detail::buffered_stream_storage>
      resize_guard(storage_);
    std::size_t previous_size = storage_.size();
  ...
  {
  public:
    fill_handler(pdalboost::asio::io_service& io_service,
  ...
  {
  public:
    read_some_handler(pdalboost::asio::io_service& io_service,
        detail::buffered_stream_storage& storage,
      ...
      ReadHandler handler)
  {
    ...
    else
    {
      ...
      get_io_service().post(detail::bind_handler(
            handler, pdalboost::system::error_code(), length));
    }
  }
...
private:
  ...
  {
    return pdalboost::asio::buffer_copy(buffers, storage_.data(), storage_.size());
  }
