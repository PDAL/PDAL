...
public:
  ...
  {
  public:
    flush_handler(pdalboost::asio::io_service& io_service,
  ...
  {
  public:
    write_some_handler(pdalboost::asio::io_service& io_service,
    ...
    void operator()(const pdalboost::system::error_code& ec, std::size_t)
    {
      ...
      else
      {
        ...
        std::size_t bytes_copied = pdalboost::asio::buffer_copy(
      ...
      WriteHandler handler)
  {
    ...
    else
    {
      ...
      get_io_service().post(detail::bind_handler(
            handler, pdalboost::system::error_code(), bytes_copied));
    }
  }
