 ...
 * pdalboost::asio::streambuf::mutable_buffers_type bufs = b.prepare(512);
 *
...
public:
...
#else
  typedef pdalboost::asio::const_buffers_1 const_buffers_type;
  typedef pdalboost::asio::mutable_buffers_1 mutable_buffers_type;
#endif
  ...
  {
    return pdalboost::asio::buffer(pdalboost::asio::const_buffer(gptr(),
  ...
  {
    reserve(n);
    return pdalboost::asio::buffer(pdalboost::asio::mutable_buffer(
...
protected:
  ...
  void reserve(std::size_t n)
  {
    ...
    if (n > pend - pnext)
    {
      ...
      {
        std::length_error ex("pdalboost::asio::streambuf too long");
