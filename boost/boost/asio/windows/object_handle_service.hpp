...
#else
  : public pdalboost::asio::detail::service_base<object_handle_service>
#endif
{
public:
#if defined(GENERATING_DOCUMENTATION)
...
public:
  ...
  explicit object_handle_service(pdalboost::asio::io_service& io_service)
    : pdalboost::asio::detail::service_base<object_handle_service>(io_service),
