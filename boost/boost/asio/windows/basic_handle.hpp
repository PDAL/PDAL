...
public:
   ...
   */
  explicit basic_handle(pdalboost::asio::io_service& io_service)
   ...
   */
  basic_handle(pdalboost::asio::io_service& io_service,
   ...
   */
  pdalboost::system::error_code assign(const native_handle_type& handle,
      pdalboost::system::error_code& ec)
  {
