 ...
 * pdalboost::asio::use_future. For example:
 *
 * @code std::future<std::size_t> my_future
 *   = my_socket.async_read_some(my_buffer, pdalboost::asio::use_future); @endcode
 *
...
/**
 * See the documentation for pdalboost::asio::use_future_t for a usage example.
 */
