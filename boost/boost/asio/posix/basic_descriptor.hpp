...
public:
   ...
   * descriptor.
   */
  explicit basic_descriptor(pdalboost::asio::io_service& io_service)
   ...
   */
  basic_descriptor(pdalboost::asio::io_service& io_service,
   ...
   */
  pdalboost::system::error_code assign(const native_handle_type& native_descriptor,
      pdalboost::system::error_code& ec)
  {
   ...
   * pdalboost::asio::posix::descriptor_base::bytes_readable @n
   * pdalboost::asio::posix::descriptor_base::non_blocking_io
   *
   * @par Example
   * Getting the number of bytes ready to read:
   * @code
   * pdalboost::asio::posix::stream_descriptor descriptor(io_service);
   * ...
   * pdalboost::asio::posix::stream_descriptor::bytes_readable command;
