...
#else
  : public pdalboost::asio::detail::service_base<stream_descriptor_service>
#endif
{
public:
#if defined(GENERATING_DOCUMENTATION)
...
public:
  ...
  explicit stream_descriptor_service(pdalboost::asio::io_service& io_service)
    : pdalboost::asio::detail::service_base<stream_descriptor_service>(io_service),
