...
public:
   ...
   * descriptor.
   */
  explicit basic_stream_descriptor(pdalboost::asio::io_service& io_service)
   ...
   */
  basic_stream_descriptor(pdalboost::asio::io_service& io_service,
   ...
   * @code
   * descriptor.write_some(pdalboost::asio::buffer(data, size));
   * @endcode
   ...
   * To write a single data buffer use the @ref buffer function as follows:
   * @code
   * descriptor.async_write_some(pdalboost::asio::buffer(data, size), handler);
   * @endcode
   * See the @ref buffer documentation for information on writing multiple
   * buffers in one go, and how to use it with arrays, pdalboost::array or
   * std::vector.
   ...
   * @code
   * descriptor.read_some(pdalboost::asio::buffer(data, size));
   * @endcode
   ...
   * To read into a single data buffer use the @ref buffer function as follows:
   * @code
   * descriptor.async_read_some(pdalboost::asio::buffer(data, size), handler);
   * @endcode
   * See the @ref buffer documentation for information on reading into multiple
   * buffers in one go, and how to use it with arrays, pdalboost::array or
   * std::vector.
