...
public:
  ...
  // Constructor.
  null_socket_service(pdalboost::asio::io_service& io_service)
  ...
  pdalboost::system::error_code open(implementation_type&,
      const protocol_type&, pdalboost::system::error_code& ec)
  {
  ...
  pdalboost::system::error_code assign(implementation_type&, const protocol_type&,
      const native_handle_type&, pdalboost::system::error_code& ec)
  {
    ec = pdalboost::asio::error::operation_not_supported;
    return ec;
  }
  ...
  // Destroy a socket implementation.
  pdalboost::system::error_code close(implementation_type&,
  ...
  pdalboost::system::error_code cancel(implementation_type&,
      pdalboost::system::error_code& ec)
  {
    ec = pdalboost::asio::error::operation_not_supported;
    return ec;
  ...
  pdalboost::system::error_code listen(implementation_type&,
      int, pdalboost::system::error_code& ec)
  {
    ec = pdalboost::asio::error::operation_not_supported;
    return ec;
  }
  ...
  pdalboost::system::error_code io_control(implementation_type&,
      IO_Control_Command&, pdalboost::system::error_code& ec)
  {
    ec = pdalboost::asio::error::operation_not_supported;
    return ec;
  }
  ...
  pdalboost::system::error_code non_blocking(implementation_type&,
      bool, pdalboost::system::error_code& ec)
  {
    ec = pdalboost::asio::error::operation_not_supported;
    return ec;
  }
  ...
  pdalboost::system::error_code native_non_blocking(implementation_type&,
      bool, pdalboost::system::error_code& ec)
  {
    ec = pdalboost::asio::error::operation_not_supported;
    return ec;
  ...
  pdalboost::system::error_code shutdown(implementation_type&,
      socket_base::shutdown_type, pdalboost::system::error_code& ec)
  {
    ec = pdalboost::asio::error::operation_not_supported;
    return ec;
  }
  ...
  pdalboost::system::error_code bind(implementation_type&,
      const endpoint_type&, pdalboost::system::error_code& ec)
  {
    ec = pdalboost::asio::error::operation_not_supported;
    return ec;
  }
  ...
  pdalboost::system::error_code set_option(implementation_type&,
      const Option&, pdalboost::system::error_code& ec)
  {
    ec = pdalboost::asio::error::operation_not_supported;
    return ec;
  }
  ...
  // Set a socket option.
  template <typename Option>
  pdalboost::system::error_code get_option(const implementation_type&,
      Option&, pdalboost::system::error_code& ec) const
  {
    ec = pdalboost::asio::error::operation_not_supported;
    return ec;
  }
  ...
  std::size_t send(implementation_type&, const ConstBufferSequence&,
      socket_base::message_flags, pdalboost::system::error_code& ec)
  {
    ec = pdalboost::asio::error::operation_not_supported;
    return 0;
  }
  ...
  {
    pdalboost::system::error_code ec = pdalboost::asio::error::operation_not_supported;
  ...
  pdalboost::system::error_code accept(implementation_type&,
      Socket&, endpoint_type*, pdalboost::system::error_code& ec)
  {
    ec = pdalboost::asio::error::operation_not_supported;
    return ec;
  }
  ...
  pdalboost::system::error_code connect(implementation_type&,
      const endpoint_type&, pdalboost::system::error_code& ec)
  {
    ec = pdalboost::asio::error::operation_not_supported;
    return ec;
