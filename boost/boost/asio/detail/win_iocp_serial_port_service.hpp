...
public:
  ...
  BOOST_ASIO_DECL pdalboost::system::error_code open(implementation_type& impl,
      const std::string& device, pdalboost::system::error_code& ec);
  ...
  pdalboost::system::error_code set_option(implementation_type& impl,
      const SettableSerialPortOption& option, pdalboost::system::error_code& ec)
  {
  ...
  pdalboost::system::error_code get_option(const implementation_type& impl,
      GettableSerialPortOption& option, pdalboost::system::error_code& ec) const
  {
  ...
  pdalboost::system::error_code send_break(implementation_type&,
      pdalboost::system::error_code& ec)
  {
...
private:
  ...
  typedef pdalboost::system::error_code (*store_function_type)(
      const void*, ::DCB&, pdalboost::system::error_code&);

  // Helper function template to store a serial port option.
  template <typename SettableSerialPortOption>
  static pdalboost::system::error_code store_option(const void* option,
      ::DCB& storage, pdalboost::system::error_code& ec)
  {
  ...
  BOOST_ASIO_DECL pdalboost::system::error_code do_set_option(
      ...
      const void* option, pdalboost::system::error_code& ec);

  // Function pointer type for loading a serial port option.
  typedef pdalboost::system::error_code (*load_function_type)(
      void*, const ::DCB&, pdalboost::system::error_code&);

  // Helper function template to load a serial port option.
  template <typename GettableSerialPortOption>
  static pdalboost::system::error_code load_option(void* option,
      const ::DCB& storage, pdalboost::system::error_code& ec)
  {
    return static_cast<GettableSerialPortOption*>(option)->load(storage, ec);
  }

  // Helper function to get a serial port option.
  BOOST_ASIO_DECL pdalboost::system::error_code do_get_option(
      const implementation_type& impl, load_function_type load,
      void* option, pdalboost::system::error_code& ec) const;
