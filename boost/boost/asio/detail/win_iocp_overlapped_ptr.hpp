...
public:
  ...
  explicit win_iocp_overlapped_ptr(
      pdalboost::asio::io_service& io_service, BOOST_ASIO_MOVE_ARG(Handler) handler)
    : ptr_(0),
      iocp_service_(0)
  {
  ...
  // object.
  template <typename Handler>
  void reset(pdalboost::asio::io_service& io_service, Handler handler)
  {
  ...
  void complete(const pdalboost::system::error_code& ec,
