...
public:
  ...
  BOOST_ASIO_DECL win_iocp_handle_service(pdalboost::asio::io_service& io_service);
  ...
  BOOST_ASIO_DECL pdalboost::system::error_code assign(implementation_type& impl,
  ...
  // Destroy a handle implementation.
  BOOST_ASIO_DECL pdalboost::system::error_code close(implementation_type& impl,
  ...
  BOOST_ASIO_DECL pdalboost::system::error_code cancel(implementation_type& impl,
      pdalboost::system::error_code& ec);
...
private:
  ...
  size_t write_some(implementation_type& impl,
      const null_buffers& buffers, pdalboost::system::error_code& ec);
  size_t write_some_at(implementation_type& impl, uint64_t offset,
      const null_buffers& buffers, pdalboost::system::error_code& ec);
  ...
  BOOST_ASIO_DECL size_t do_write(implementation_type& impl,
      uint64_t offset, const pdalboost::asio::const_buffer& buffer,
      pdalboost::system::error_code& ec);
  ...
  BOOST_ASIO_DECL size_t do_read(implementation_type& impl,
      uint64_t offset, const pdalboost::asio::mutable_buffer& buffer,
      pdalboost::system::error_code& ec);
