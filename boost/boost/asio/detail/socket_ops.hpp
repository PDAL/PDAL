...
BOOST_ASIO_DECL int shutdown(socket_type s,
    int what, pdalboost::system::error_code& ec);
...
BOOST_ASIO_DECL bool sockatmark(socket_type s, pdalboost::system::error_code& ec);

BOOST_ASIO_DECL size_t available(socket_type s, pdalboost::system::error_code& ec);

BOOST_ASIO_DECL int listen(socket_type s,
    int backlog, pdalboost::system::error_code& ec);
...
BOOST_ASIO_DECL signed_size_type recv(socket_type s, buf* bufs,
    size_t count, int flags, pdalboost::system::error_code& ec);
...
BOOST_ASIO_DECL size_t sync_send(socket_type s, state_type state,
    ...
    bool all_empty, pdalboost::system::error_code& ec);
...
BOOST_ASIO_DECL int setsockopt(socket_type s, state_type& state,
    ...
    std::size_t optlen, pdalboost::system::error_code& ec);

BOOST_ASIO_DECL int getsockopt(socket_type s, state_type state,
    int level, int optname, void* optval,
    size_t* optlen, pdalboost::system::error_code& ec);
...
BOOST_ASIO_DECL int ioctl(socket_type s, state_type& state,
    int cmd, ioctl_arg_type* arg, pdalboost::system::error_code& ec);
...
BOOST_ASIO_DECL int poll_read(socket_type s,
    state_type state, pdalboost::system::error_code& ec);

BOOST_ASIO_DECL int poll_write(socket_type s,
    state_type state, pdalboost::system::error_code& ec);

BOOST_ASIO_DECL int poll_connect(socket_type s, pdalboost::system::error_code& ec);

BOOST_ASIO_DECL const char* inet_ntop(int af, const void* src, char* dest,
    size_t length, unsigned long scope_id, pdalboost::system::error_code& ec);
...
BOOST_ASIO_DECL int gethostname(char* name,
    int namelen, pdalboost::system::error_code& ec);

BOOST_ASIO_DECL pdalboost::system::error_code getaddrinfo(const char* host,
    const char* service, const addrinfo_type& hints,
    addrinfo_type** result, pdalboost::system::error_code& ec);

BOOST_ASIO_DECL pdalboost::system::error_code background_getaddrinfo(
...
BOOST_ASIO_DECL pdalboost::system::error_code getnameinfo(
    const socket_addr_type* addr, std::size_t addrlen,
    char* host, std::size_t hostlen, char* serv,
    std::size_t servlen, int flags, pdalboost::system::error_code& ec);

BOOST_ASIO_DECL pdalboost::system::error_code sync_getnameinfo(
    const socket_addr_type* addr, std::size_t addrlen,
    char* host, std::size_t hostlen, char* serv,
    std::size_t servlen, int sock_type, pdalboost::system::error_code& ec);

BOOST_ASIO_DECL pdalboost::system::error_code background_getnameinfo(
    const weak_cancel_token_type& cancel_token,
    const socket_addr_type* addr, std::size_t addrlen,
    char* host, std::size_t hostlen, char* serv,
    std::size_t servlen, int sock_type, pdalboost::system::error_code& ec);
