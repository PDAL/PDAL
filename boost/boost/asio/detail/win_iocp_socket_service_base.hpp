...
public:
  ...
  BOOST_ASIO_DECL pdalboost::system::error_code cancel(
      base_implementation_type& impl, pdalboost::system::error_code& ec);
  ...
  pdalboost::system::error_code listen(base_implementation_type& impl,
  ...
  pdalboost::system::error_code io_control(base_implementation_type& impl,
      IO_Control_Command& command, pdalboost::system::error_code& ec)
  {
  ...
  pdalboost::system::error_code non_blocking(base_implementation_type& impl,
  ...
  pdalboost::system::error_code native_non_blocking(base_implementation_type& impl,
      bool mode, pdalboost::system::error_code& ec)
  {
  ...
  pdalboost::system::error_code shutdown(base_implementation_type& impl,
...
protected:
  ...
  BOOST_ASIO_DECL pdalboost::system::error_code do_open(
      base_implementation_type& impl, int family, int type,
      int protocol, pdalboost::system::error_code& ec);

  // Assign a native socket to a socket implementation.
  BOOST_ASIO_DECL pdalboost::system::error_code do_assign(
      base_implementation_type& impl, int type,
      socket_type native_socket, pdalboost::system::error_code& ec);
