...
class winrt_timer_scheduler
  : public pdalboost::asio::detail::service_base<winrt_timer_scheduler>
{
public:
  // Constructor.
  BOOST_ASIO_DECL winrt_timer_scheduler(pdalboost::asio::io_service& io_service);
...
private:
  ...
  pdalboost::asio::detail::event event_;

  // The timer queues.
  timer_queue_set timer_queues_;

  // The background thread that is waiting for timers to expire.
  pdalboost::asio::detail::thread* thread_;
