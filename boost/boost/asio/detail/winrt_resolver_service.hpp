...
public:
  ...
  // The query type.
  typedef pdalboost::asio::ip::basic_resolver_query<Protocol> query_type;

  // The iterator type.
  typedef pdalboost::asio::ip::basic_resolver_iterator<Protocol> iterator_type;

  // Constructor.
  winrt_resolver_service(pdalboost::asio::io_service& io_service)
  ...
  void fork_service(pdalboost::asio::io_service::fork_event)
  {
  }
