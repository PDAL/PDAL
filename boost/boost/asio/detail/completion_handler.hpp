...
public:
      ...
      std::size_t /*bytes_transferred*/)
  {
    ...
    ptr p = { pdalboost::asio::detail::addressof(h->handler_), h, h };
    ...
    p.h = pdalboost::asio::detail::addressof(handler);
    p.reset();
    ...
    if (owner)
    {
      ...
      pdalboost_asio_handler_invoke_helpers::invoke(handler, handler);
