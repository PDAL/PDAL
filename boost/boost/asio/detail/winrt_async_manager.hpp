...
class winrt_async_manager
  : public pdalboost::asio::detail::service_base<winrt_async_manager>
{
public:
  // Constructor.
  winrt_async_manager(pdalboost::asio::io_service& io_service)
    : pdalboost::asio::detail::service_base<winrt_async_manager>(io_service),
      ...
      pdalboost::system::error_code& ec)
  {
    ...
    auto promise = std::make_shared<std::promise<pdalboost::system::error_code>>();
    ...
    action->Completed = ref new AsyncActionCompletedHandler(
      [promise](IAsyncAction^ action, AsyncStatus status)
      {
        ...
        case AsyncStatus::Canceled:
          promise->set_value(pdalboost::asio::error::operation_aborted);
          break;
      ...
      winrt_async_op<void>* handler)
  {
    ...
    auto on_completed = ref new AsyncActionCompletedHandler(
      [this, handler](IAsyncAction^ action, AsyncStatus status)
      {
        ...
        {
        case AsyncStatus::Canceled:
          handler->ec_ = pdalboost::asio::error::operation_aborted;
          break;
        case AsyncStatus::Started:
          return;
        case AsyncStatus::Completed:
        case AsyncStatus::Error:
        default:
          handler->ec_ = pdalboost::system::error_code(
              action->ErrorCode.Value,
              pdalboost::system::system_category());
          break;
        }
