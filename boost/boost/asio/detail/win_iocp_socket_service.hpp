...
public:
  ...
  // Constructor.
  win_iocp_socket_service(pdalboost::asio::io_service& io_service)
  ...
  pdalboost::system::error_code set_option(implementation_type& impl,
      const Option& option, pdalboost::system::error_code& ec)
  {
  ...
  pdalboost::system::error_code get_option(const implementation_type& impl,
      Option& option, pdalboost::system::error_code& ec) const
  {
  ...
  pdalboost::system::error_code accept(implementation_type& impl, Socket& peer,
