...
public:
  ...
  // Constructor.
  BOOST_ASIO_DECL resolver_service_base(pdalboost::asio::io_service& io_service);
...
protected:
  ...
  class auto_addrinfo
    : private pdalboost::asio::detail::noncopyable
  {
  public:
    explicit auto_addrinfo(pdalboost::asio::detail::addrinfo_type* ai)
      : ai_(ai)
    {
    }
    ...
    operator pdalboost::asio::detail::addrinfo_type*()
    {
      return ai_;
    }

  private:
    pdalboost::asio::detail::addrinfo_type* ai_;
  };
...
private:
  ...
  pdalboost::asio::detail::scoped_ptr<pdalboost::asio::io_service> work_io_service_;

  // The work io_service implementation used to post completions.
  io_service_impl& work_io_service_impl_;

  // Work for the private io_service to perform.
  pdalboost::asio::detail::scoped_ptr<pdalboost::asio::io_service::work> work_;

  // Thread used for running the work io_service's run loop.
  pdalboost::asio::detail::scoped_ptr<pdalboost::asio::detail::thread> work_thread_;
};
