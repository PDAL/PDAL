...
public:
  ...
  // Destroy a socket implementation.
  BOOST_ASIO_DECL pdalboost::system::error_code close(
      base_implementation_type& impl, pdalboost::system::error_code& ec);
  ...
  pdalboost::system::error_code cancel(base_implementation_type&,
  ...
  pdalboost::system::error_code io_control(base_implementation_type&,
  ...
  pdalboost::system::error_code non_blocking(base_implementation_type&,
  ...
  pdalboost::system::error_code native_non_blocking(base_implementation_type&,
      bool, pdalboost::system::error_code& ec)
  {
    ec = pdalboost::asio::error::operation_not_supported;
    return ec;
  ...
  pdalboost::system::error_code shutdown(base_implementation_type&,
...
protected:
  ...
  BOOST_ASIO_DECL std::size_t do_get_endpoint(
      ...
      void* addr, std::size_t addr_len, pdalboost::system::error_code& ec) const;

  // Helper function to set a socket option.
  BOOST_ASIO_DECL pdalboost::system::error_code do_set_option(
  ...
  BOOST_ASIO_DECL void do_get_option(
      ...
      std::size_t* optlen, pdalboost::system::error_code& ec) const;

  // Helper function to perform a synchronous connect.
  BOOST_ASIO_DECL pdalboost::system::error_code do_connect(
      base_implementation_type& impl,
      const void* addr, pdalboost::system::error_code& ec);
  ...
  BOOST_ASIO_DECL std::size_t do_send(
      base_implementation_type& impl, const pdalboost::asio::const_buffer& data,
      socket_base::message_flags flags, pdalboost::system::error_code& ec);

  // Helper function to start an asynchronous send.
  BOOST_ASIO_DECL void start_send_op(base_implementation_type& impl,
      const pdalboost::asio::const_buffer& data, socket_base::message_flags flags,
  ...
  BOOST_ASIO_DECL std::size_t do_receive(
      base_implementation_type& impl, const pdalboost::asio::mutable_buffer& data,
      socket_base::message_flags flags, pdalboost::system::error_code& ec);

  // Helper function to start an asynchronous receive.
  BOOST_ASIO_DECL void start_receive_op(base_implementation_type& impl,
      const pdalboost::asio::mutable_buffer& data, socket_base::message_flags flags,
  ...
  pdalboost::asio::detail::mutex mutex_;
