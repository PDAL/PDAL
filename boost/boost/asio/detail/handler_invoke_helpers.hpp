...
namespace pdalboost_asio_handler_invoke_helpers {
...
inline void invoke(Function& function, Context& context)
{
  ...
  tmp();
#else
  using pdalboost::asio::asio_handler_invoke;
  asio_handler_invoke(function, pdalboost::asio::detail::addressof(context));
#endif
}
