...
struct task_io_service::task_cleanup
{
  ~task_cleanup()
  {
    ...
    {
      pdalboost::asio::detail::increment(
...
task_io_service::task_io_service(
    pdalboost::asio::io_service& io_service, std::size_t concurrency_hint)
  : pdalboost::asio::detail::service_base<task_io_service>(io_service),
...
std::size_t task_io_service::run(pdalboost::system::error_code& ec)
{
...
std::size_t task_io_service::run_one(pdalboost::system::error_code& ec)
{
  ec = pdalboost::system::error_code();
  if (outstanding_work_ == 0)
  {
...
std::size_t task_io_service::poll(pdalboost::system::error_code& ec)
{
  ec = pdalboost::system::error_code();
  if (outstanding_work_ == 0)
  {
...
std::size_t task_io_service::poll_one(pdalboost::system::error_code& ec)
{
  ec = pdalboost::system::error_code();
  if (outstanding_work_ == 0)
  {
