...
{
#if defined(BOOST_ASIO_WINDOWS) || defined(__CYGWIN__)
  ec = pdalboost::system::error_code(WSAGetLastError(),
      pdalboost::asio::error::get_system_category());
#else
  ec = pdalboost::system::error_code(errno,
      pdalboost::asio::error::get_system_category());
#endif
  return return_value;
}
...
socket_type accept(socket_type s, socket_addr_type* addr,
    std::size_t* addrlen, pdalboost::system::error_code& ec)
{
  if (s == invalid_socket)
  {
    ec = pdalboost::asio::error::bad_descriptor;
...
socket_type sync_accept(socket_type s, state_type state,
    socket_addr_type* addr, std::size_t* addrlen, pdalboost::system::error_code& ec)
{
  // Accept a socket.
  for (;;)
  {
    ...
    else if (ec == pdalboost::asio::error::connection_aborted)
    {
...
void complete_iocp_accept(socket_type s,
    ...
    socket_type new_socket, pdalboost::system::error_code& ec)
{
  // Map non-portable errors to their portable counterparts.
  if (ec.value() == ERROR_NETNAME_DELETED)
    ec = pdalboost::asio::error::connection_aborted;
...
bool non_blocking_accept(socket_type s,
    ...
    pdalboost::system::error_code& ec, socket_type& new_socket)
{
  for (;;)
  {
...
int close(socket_type s, state_type& state,
    bool destruction, pdalboost::system::error_code& ec)
{
  int result = 0;
  if (s != invalid_socket)
  {
    ...
    if (destruction && (state & user_set_linger))
    {
      ...
      opt.l_onoff = 0;
      opt.l_linger = 0;
      pdalboost::system::error_code ignored_ec;
    ...
    if (result != 0
        && (ec == pdalboost::asio::error::would_block
          || ec == pdalboost::asio::error::try_again))
    {
...
bool set_user_non_blocking(socket_type s,
    state_type& state, bool value, pdalboost::system::error_code& ec)
{
  if (s == invalid_socket)
  {
    ec = pdalboost::asio::error::bad_descriptor;
...
int shutdown(socket_type s, int what, pdalboost::system::error_code& ec)
{
  if (s == invalid_socket)
  {
    ec = pdalboost::asio::error::bad_descriptor;
    ...
    std::size_t addrlen, pdalboost::system::error_code& ec)
{
  ...
  else if (ec == pdalboost::asio::error::try_again)
    ec = pdalboost::asio::error::no_buffer_space;
    ...
    std::size_t addrlen, pdalboost::system::error_code& ec)
{
  ...
  if (ec != pdalboost::asio::error::in_progress
      && ec != pdalboost::asio::error::would_block)
  {
  ...
  ec = pdalboost::system::error_code(connect_error,
      pdalboost::asio::error::get_system_category());
}

bool non_blocking_connect(socket_type s, pdalboost::system::error_code& ec)
{
...
int socketpair(int af, int type, int protocol,
    socket_type sv[2], pdalboost::system::error_code& ec)
{
#if defined(BOOST_ASIO_WINDOWS) || defined(__CYGWIN__)
  (void)(af);
  (void)(type);
  (void)(protocol);
  (void)(sv);
  ec = pdalboost::asio::error::operation_not_supported;
  return socket_error_retval;
#else
  clear_last_error();
...
bool sockatmark(socket_type s, pdalboost::system::error_code& ec)
{
  if (s == invalid_socket)
  {
    ec = pdalboost::asio::error::bad_descriptor;
...
# if defined(ENOTTY)
  if (ec.value() == ENOTTY)
    ec = pdalboost::asio::error::not_socket;
...
size_t available(socket_type s, pdalboost::system::error_code& ec)
{
  if (s == invalid_socket)
  {
    ec = pdalboost::asio::error::bad_descriptor;
...
int listen(socket_type s, int backlog, pdalboost::system::error_code& ec)
{
  if (s == invalid_socket)
  {
    ec = pdalboost::asio::error::bad_descriptor;
...
signed_size_type recv(socket_type s, buf* bufs, size_t count,
    int flags, pdalboost::system::error_code& ec)
{
  clear_last_error();
#if defined(BOOST_ASIO_WINDOWS) || defined(__CYGWIN__)
  // Receive some data.
...
size_t sync_recv(socket_type s, state_type state, buf* bufs,
    size_t count, int flags, bool all_empty, pdalboost::system::error_code& ec)
{
  if (s == invalid_socket)
  {
    ec = pdalboost::asio::error::bad_descriptor;
...
void complete_iocp_recv(state_type state,
    ...
    pdalboost::system::error_code& ec, size_t bytes_transferred)
{
  // Map non-portable errors to their portable counterparts.
  if (ec.value() == ERROR_NETNAME_DELETED)
  {
...
signed_size_type recvmsg(socket_type s, buf* bufs, size_t count,
    int in_flags, int& out_flags, pdalboost::system::error_code& ec)
{
  clear_last_error();
#if defined(BOOST_ASIO_WINDOWS) || defined(__CYGWIN__)
  out_flags = 0;
...
int setsockopt(socket_type s, state_type& state, int level, int optname,
    const void* optval, std::size_t optlen, pdalboost::system::error_code& ec)
{
  if (s == invalid_socket)
  {
    ec = pdalboost::asio::error::bad_descriptor;
...
int getsockopt(socket_type s, state_type state, int level, int optname,
    void* optval, size_t* optlen, pdalboost::system::error_code& ec)
{
  if (s == invalid_socket)
  {
    ec = pdalboost::asio::error::bad_descriptor;
...
int getpeername(socket_type s, socket_addr_type* addr,
    std::size_t* addrlen, bool cached, pdalboost::system::error_code& ec)
{
  if (s == invalid_socket)
  {
    ec = pdalboost::asio::error::bad_descriptor;
  ...
  if (cached)
  {
    ...
    {
      ec = pdalboost::asio::error::not_connected;
      return socket_error_retval;
    }
...
int ioctl(socket_type s, state_type& state, int cmd,
    ioctl_arg_type* arg, pdalboost::system::error_code& ec)
{
  if (s == invalid_socket)
  {
    ec = pdalboost::asio::error::bad_descriptor;
...
int select(int nfds, fd_set* readfds, fd_set* writefds,
    fd_set* exceptfds, timeval* timeout, pdalboost::system::error_code& ec)
{
  clear_last_error();
#if defined(BOOST_ASIO_WINDOWS) || defined(__CYGWIN__)
  ...
  // system clock (as wrapped by pdalboost::posix_time::microsec_clock) typically
...
int poll_read(socket_type s, state_type state, pdalboost::system::error_code& ec)
{
  if (s == invalid_socket)
  {
    ec = pdalboost::asio::error::bad_descriptor;
  ...
  if (result == 0)
    ec = (state & user_set_non_blocking)
      ? pdalboost::asio::error::would_block : pdalboost::system::error_code();
  else if (result > 0)
    ec = pdalboost::system::error_code();
  return result;
}

int poll_write(socket_type s, state_type state, pdalboost::system::error_code& ec)
{
  if (s == invalid_socket)
  {
    ec = pdalboost::asio::error::bad_descriptor;
...
int poll_connect(socket_type s, pdalboost::system::error_code& ec)
{
  if (s == invalid_socket)
  {
    ec = pdalboost::asio::error::bad_descriptor;
...
const char* inet_ntop(int af, const void* src, char* dest, size_t length,
    unsigned long scope_id, pdalboost::system::error_code& ec)
{
  clear_last_error();
#if defined(BOOST_ASIO_WINDOWS_RUNTIME)
  ...
  {
    ec = pdalboost::asio::error::address_family_not_supported;
    return 0;
  }
#elif defined(BOOST_ASIO_WINDOWS) || defined(__CYGWIN__)
  using namespace std; // For memcpy.
...
int gethostname(char* name, int namelen, pdalboost::system::error_code& ec)
{
  clear_last_error();
#if defined(BOOST_ASIO_WINDOWS_RUNTIME)
  try
...
inline pdalboost::system::error_code translate_netdb_error(int error)
{
  switch (error)
  {
  case 0:
  ...
  case HOST_NOT_FOUND:
    return pdalboost::asio::error::host_not_found;
  case TRY_AGAIN:
    return pdalboost::asio::error::host_not_found_try_again;
  case NO_RECOVERY:
    return pdalboost::asio::error::no_recovery;
  case NO_DATA:
    return pdalboost::asio::error::no_data;
  default:
    BOOST_ASIO_ASSERT(false);
    return pdalboost::asio::error::invalid_argument;
  }
}

inline hostent* gethostbyaddr(const char* addr, int length, int af,
    hostent* result, char* buffer, int buflength, pdalboost::system::error_code& ec)
{
  clear_last_error();
#if defined(BOOST_ASIO_WINDOWS) || defined(__CYGWIN__)
  (void)(buffer);
...
inline hostent* gethostbyname(const char* name, int af, struct hostent* result,
    char* buffer, int buflength, int ai_flags, pdalboost::system::error_code& ec)
{
  clear_last_error();
#if defined(BOOST_ASIO_WINDOWS) || defined(__CYGWIN__)
  (void)(buffer);
    ...
    const addrinfo_type* hintsp, addrinfo_type** result)
{
  ...
  for (gai_search* sptr = search; sptr < search + search_count; ++sptr)
  {
    ...
    if (hptr == 0)
    {
      ...
      freeaddrinfo_emulation(aihead);
      gai_free(canon);
      if (ec == pdalboost::asio::error::host_not_found)
        return EAI_NONAME;
      if (ec == pdalboost::asio::error::host_not_found_try_again)
        return EAI_AGAIN;
      if (ec == pdalboost::asio::error::no_recovery)
        return EAI_FAIL;
      if (ec == pdalboost::asio::error::no_data)
        return EAI_NONAME;
      return EAI_NONAME;
    }
...
inline pdalboost::system::error_code getnameinfo_emulation(
    ...
    pdalboost::system::error_code& ec)
{
  ...
  case BOOST_ASIO_OS_DEF(AF_INET):
    ...
    {
      return ec = pdalboost::asio::error::invalid_argument;
    }
  ...
  case BOOST_ASIO_OS_DEF(AF_INET6):
    ...
    break;
  default:
    return ec = pdalboost::asio::error::address_family_not_supported;
  }
  ...
  if (host && hostlen > 0)
  {
    ...
    else
    {
      ...
      else
      {
        ...
        {
          return ec = pdalboost::asio::error::host_not_found;
        }
  ...
  if (serv && servlen > 0)
  {
    if (flags & NI_NUMERICSERV)
    {
      if (servlen < 6)
      {
        return ec = pdalboost::asio::error::no_buffer_space;
      }
#if defined(BOOST_ASIO_HAS_SECURE_RTL)
...
inline pdalboost::system::error_code translate_addrinfo_error(int error)
{
  switch (error)
  {
  case 0:
  ...
  case EAI_FAIL:
    return pdalboost::asio::error::no_recovery;
  case EAI_FAMILY:
    return pdalboost::asio::error::address_family_not_supported;
  case EAI_MEMORY:
    return pdalboost::asio::error::no_memory;
  case EAI_NONAME:
  ...
  case EAI_NODATA:
    ...
    return pdalboost::asio::error::host_not_found;
  case EAI_SERVICE:
    return pdalboost::asio::error::service_not_found;
  case EAI_SOCKTYPE:
    return pdalboost::asio::error::socket_type_not_supported;
  default: // Possibly the non-portable EAI_SYSTEM.
#if defined(BOOST_ASIO_WINDOWS) || defined(__CYGWIN__)
    return pdalboost::system::error_code(
        WSAGetLastError(), pdalboost::asio::error::get_system_category());
#else
    return pdalboost::system::error_code(
        errno, pdalboost::asio::error::get_system_category());
#endif
  }
}

pdalboost::system::error_code getaddrinfo(const char* host,
    const char* service, const addrinfo_type& hints,
    addrinfo_type** result, pdalboost::system::error_code& ec)
{
...
pdalboost::system::error_code background_getaddrinfo(
...
pdalboost::system::error_code getnameinfo(const socket_addr_type* addr,
    std::size_t addrlen, char* host, std::size_t hostlen,
    char* serv, std::size_t servlen, int flags, pdalboost::system::error_code& ec)
{
#if defined(BOOST_ASIO_WINDOWS) || defined(__CYGWIN__)
# if defined(_WIN32_WINNT) && (_WIN32_WINNT >= 0x0501) || defined(UNDER_CE)
  // Building for Windows XP, Windows Server 2003, or later.
...
pdalboost::system::error_code sync_getnameinfo(
    const socket_addr_type* addr, std::size_t addrlen,
    char* host, std::size_t hostlen, char* serv,
    std::size_t servlen, int sock_type, pdalboost::system::error_code& ec)
{
...
pdalboost::system::error_code background_getnameinfo(
    const weak_cancel_token_type& cancel_token,
    const socket_addr_type* addr, std::size_t addrlen,
    char* host, std::size_t hostlen, char* serv,
    std::size_t servlen, int sock_type, pdalboost::system::error_code& ec)
