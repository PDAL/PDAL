...
void win_thread::start_thread(func_base* arg, unsigned int stack_size)
{
  ...
  if (!entry_event)
  {
    ...
    pdalboost::asio::detail::throw_error(ec, "thread.entry_event");
  }
  ...
  if (!exit_event_)
  {
    ...
    pdalboost::system::error_code ec(last_error,
        pdalboost::asio::error::get_system_category());
    pdalboost::asio::detail::throw_error(ec, "thread.exit_event");
  }
  ...
  if (!thread_)
  {
    ...
    pdalboost::system::error_code ec(last_error,
        pdalboost::asio::error::get_system_category());
    pdalboost::asio::detail::throw_error(ec, "thread");
  }
