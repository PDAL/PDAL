...
dev_poll_reactor::dev_poll_reactor(pdalboost::asio::io_service& io_service)
  : pdalboost::asio::detail::service_base<dev_poll_reactor>(io_service),
...
void dev_poll_reactor::fork_service(pdalboost::asio::io_service::fork_event fork_ev)
{
...
{
  pdalboost::asio::detail::mutex::scoped_lock lock(mutex_);
  cancel_ops_unlocked(descriptor, pdalboost::asio::error::operation_aborted);
}
...
void dev_poll_reactor::run(bool block, op_queue<operation>& ops)
{
  ...
  if (events_size > 0)
  {
    ...
    {
      pdalboost::system::error_code ec = pdalboost::system::error_code(
...
int dev_poll_reactor::do_dev_poll_create()
{
  ...
  if (fd == -1)
  {
    pdalboost::system::error_code ec(errno,
        pdalboost::asio::error::get_system_category());
    pdalboost::asio::detail::throw_error(ec, "/dev/poll");
  }
  return fd;
}
