...
{
public:
  explicit winrt_buffer_impl(const pdalboost::asio::const_buffer& b)
  {
    bytes_ = const_cast<byte*>(pdalboost::asio::buffer_cast<const byte*>(b));
    length_ = pdalboost::asio::buffer_size(b);
    capacity_ = pdalboost::asio::buffer_size(b);
  }

  explicit winrt_buffer_impl(const pdalboost::asio::mutable_buffer& b)
  {
    bytes_ = const_cast<byte*>(pdalboost::asio::buffer_cast<const byte*>(b));
    length_ = 0;
    capacity_ = pdalboost::asio::buffer_size(b);
