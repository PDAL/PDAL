...
kqueue_reactor::kqueue_reactor(pdalboost::asio::io_service& io_service)
  : pdalboost::asio::detail::service_base<kqueue_reactor>(io_service),
...
void kqueue_reactor::fork_service(pdalboost::asio::io_service::fork_event fork_ev)
{
  if (fork_ev == pdalboost::asio::io_service::fork_child)
  {
        ...
        state != 0; state = state->next_)
    {
      ...
      {
        pdalboost::system::error_code error(errno,
            pdalboost::asio::error::get_system_category());
        pdalboost::asio::detail::throw_error(error);
      }
    }
  }
}
...
int kqueue_reactor::do_kqueue_create()
{
  ...
  if (fd == -1)
  {
    pdalboost::system::error_code ec(errno,
        pdalboost::asio::error::get_system_category());
    pdalboost::asio::detail::throw_error(ec, "kqueue");
  }
  return fd;
}
