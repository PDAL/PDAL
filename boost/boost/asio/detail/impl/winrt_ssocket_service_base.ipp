    ...
    winrt_ssocket_service_base::base_implementation_type& other_impl)
{
  ...
  {
    // Insert implementation into linked list of all implementations.
    pdalboost::asio::detail::mutex::scoped_lock lock(other_service.mutex_);
...
pdalboost::system::error_code winrt_ssocket_service_base::close(
    winrt_ssocket_service_base::base_implementation_type& impl,
...
pdalboost::system::error_code winrt_ssocket_service_base::do_set_option(
    winrt_ssocket_service_base::base_implementation_type& impl,
...
pdalboost::system::error_code winrt_ssocket_service_base::do_connect(
    winrt_ssocket_service_base::base_implementation_type& impl,
    ...
    const void* addr, winrt_async_op<void>* op, bool is_continuation)
{
  if (!is_open(impl))
  {
    op->ec_ = pdalboost::asio::error::bad_descriptor;
  ...
  case BOOST_ASIO_OS_DEF(AF_INET6):
    ...
    break;
  default:
    op->ec_ = pdalboost::asio::error::address_family_not_supported;
    break;
  }
  ...
  {
    op->ec_ = pdalboost::system::error_code(
    ...
    socket_base::message_flags flags, pdalboost::system::error_code& ec)
{
  ...
  try
  {
    buffer_sequence_adapter<pdalboost::asio::const_buffer,
      pdalboost::asio::const_buffers_1> bufs(pdalboost::asio::buffer(data));
      ...
      winrt_async_op<unsigned int>* op, bool is_continuation)
{
  if (flags)
  {
    op->ec_ = pdalboost::asio::error::operation_not_supported;
    io_service_.post_immediate_completion(op, is_continuation);
    return;
  }
  ...
  {
    op->ec_ = pdalboost::system::error_code(e->HResult,
        pdalboost::system::system_category());
    io_service_.post_immediate_completion(op, is_continuation);
  }
}
    ...
    socket_base::message_flags flags, pdalboost::system::error_code& ec)
{
  ...
  try
  {
    buffer_sequence_adapter<pdalboost::asio::mutable_buffer,
        pdalboost::asio::mutable_buffers_1> bufs(pdalboost::asio::buffer(data));
