...
pdalboost::system::error_code win_iocp_socket_service_base::close(
    win_iocp_socket_service_base::base_implementation_type& impl,
...
pdalboost::system::error_code win_iocp_socket_service_base::cancel(
    win_iocp_socket_service_base::base_implementation_type& impl,
    pdalboost::system::error_code& ec)
{
  if (!is_open(impl))
...
pdalboost::system::error_code win_iocp_socket_service_base::do_open(
    win_iocp_socket_service_base::base_implementation_type& impl,
    int family, int type, int protocol, pdalboost::system::error_code& ec)
{
  if (is_open(impl))
  {
...
pdalboost::system::error_code win_iocp_socket_service_base::do_assign(
    win_iocp_socket_service_base::base_implementation_type& impl,
    int type, socket_type native_socket, pdalboost::system::error_code& ec)
{
  if (is_open(impl))
  {
    ec = pdalboost::asio::error::already_open;
    ...
    int protocol, void* output_buffer, DWORD address_length, operation* op)
{
  ...
  if (!is_open(impl))
    ...
    iocp_service_.on_completion(op, pdalboost::asio::error::already_open);
  else
  {
    pdalboost::system::error_code ec;
    ...
    reactor_op* op, const socket_addr_type* addr, std::size_t addrlen)
{
        ...
        impl.socket_, impl.state_, true, op->ec_))
  {
    ...
    {
      if (op->ec_ == pdalboost::asio::error::in_progress
          || op->ec_ == pdalboost::asio::error::would_block)
      {
