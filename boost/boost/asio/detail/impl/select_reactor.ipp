...
select_reactor::select_reactor(pdalboost::asio::io_service& io_service)
  : pdalboost::asio::detail::service_base<select_reactor>(io_service),
...
{
#if defined(BOOST_ASIO_HAS_IOCP)
  pdalboost::asio::detail::signal_blocker sb;
  thread_ = new pdalboost::asio::detail::thread(
...
void select_reactor::fork_service(pdalboost::asio::io_service::fork_event fork_ev)
{
