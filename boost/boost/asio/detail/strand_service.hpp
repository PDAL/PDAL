...
class strand_service
  : public pdalboost::asio::detail::service_base<strand_service>
{
private:
...
public:
  ...
  BOOST_ASIO_DECL explicit strand_service(pdalboost::asio::io_service& io_service);
...
private:
  ...
  BOOST_ASIO_DECL static void do_complete(io_service_impl* owner,
      operation* base, const pdalboost::system::error_code& ec,
