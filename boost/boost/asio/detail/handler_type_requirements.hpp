...
#define BOOST_ASIO_COMPLETION_HANDLER_CHECK( \
  ...
  BOOST_ASIO_HANDLER_TYPE_REQUIREMENTS_ASSERT( \
      sizeof(pdalboost::asio::detail::zero_arg_handler_test( \
          pdalboost::asio::detail::clvref< \
            asio_true_handler_type>(), 0)) == 1, \
      "CompletionHandler type requirements not met") \
  \
  typedef pdalboost::asio::detail::handler_type_requirements< \
      sizeof( \
        pdalboost::asio::detail::argbyv( \
          pdalboost::asio::detail::clvref< \
            asio_true_handler_type>())) + \
      sizeof( \
        pdalboost::asio::detail::lvref< \
          asio_true_handler_type>()(), \
        char(0))>
...
#define BOOST_ASIO_READ_HANDLER_CHECK( \
  ...
  \
  BOOST_ASIO_HANDLER_TYPE_REQUIREMENTS_ASSERT( \
      sizeof(pdalboost::asio::detail::two_arg_handler_test( \
          pdalboost::asio::detail::clvref< \
            asio_true_handler_type>(), \
          static_cast<const pdalboost::system::error_code*>(0), \
  ...
  typedef pdalboost::asio::detail::handler_type_requirements< \
      ...
      sizeof( \
        pdalboost::asio::detail::lvref< \
          asio_true_handler_type>()( \
            pdalboost::asio::detail::lvref<const pdalboost::system::error_code>(), \
            pdalboost::asio::detail::lvref<const std::size_t>()), \
        char(0))>
...
#define BOOST_ASIO_ACCEPT_HANDLER_CHECK( \
  ...
  \
  BOOST_ASIO_HANDLER_TYPE_REQUIREMENTS_ASSERT( \
      sizeof(pdalboost::asio::detail::one_arg_handler_test( \
          pdalboost::asio::detail::clvref< \
            asio_true_handler_type>(), \
          static_cast<const pdalboost::system::error_code*>(0))) == 1, \
...
#define BOOST_ASIO_COMPOSED_CONNECT_HANDLER_CHECK( \
  ...
  \
  typedef BOOST_ASIO_HANDLER_TYPE(handler_type, \
      void(pdalboost::system::error_code, iter_type)) \
    asio_true_handler_type; \
  \
  BOOST_ASIO_HANDLER_TYPE_REQUIREMENTS_ASSERT( \
      sizeof(pdalboost::asio::detail::two_arg_handler_test( \
  ...
  typedef pdalboost::asio::detail::handler_type_requirements< \
      ...
      sizeof( \
        pdalboost::asio::detail::lvref< \
          asio_true_handler_type>()( \
            pdalboost::asio::detail::lvref<const pdalboost::system::error_code>(), \
            pdalboost::asio::detail::lvref<const iter_type>()), \
        char(0))>
  ...
  typedef pdalboost::asio::detail::handler_type_requirements< \
      ...
      sizeof( \
        pdalboost::asio::detail::lvref< \
          asio_true_handler_type>()( \
            pdalboost::asio::detail::lvref<const pdalboost::system::error_code>(), \
            pdalboost::asio::detail::lvref<const int>()), \
        char(0))>
