...
public:
  ...
  // Constructor.
  BOOST_ASIO_DECL signal_set_service(pdalboost::asio::io_service& io_service);
  ...
  BOOST_ASIO_DECL pdalboost::system::error_code add(implementation_type& impl,
      int signal_number, pdalboost::system::error_code& ec);

  // Remove a signal to a signal_set.
  BOOST_ASIO_DECL pdalboost::system::error_code remove(implementation_type& impl,
      int signal_number, pdalboost::system::error_code& ec);

  // Remove all signals from a signal_set.
  BOOST_ASIO_DECL pdalboost::system::error_code clear(implementation_type& impl,
