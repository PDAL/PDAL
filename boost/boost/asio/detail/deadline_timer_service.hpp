...
public:
  ...
  // Constructor.
  deadline_timer_service(pdalboost::asio::io_service& io_service)
    : scheduler_(pdalboost::asio::use_service<timer_scheduler>(io_service))
  {
  ...
  std::size_t cancel(implementation_type& impl, pdalboost::system::error_code& ec)
  {
  ...
  std::size_t expires_at(implementation_type& impl,
      const time_type& expiry_time, pdalboost::system::error_code& ec)
  {
  ...
  void wait(implementation_type& impl, pdalboost::system::error_code& ec)
  {
...
private:
  ...
  // either be of type pdalboost::posix_time::time_duration, or implement the
