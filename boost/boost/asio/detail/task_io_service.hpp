...
class task_io_service
  : public pdalboost::asio::detail::service_base<task_io_service>
{
public:
  ...
  BOOST_ASIO_DECL task_io_service(pdalboost::asio::io_service& io_service,
...
private:
  ...
  BOOST_ASIO_DECL std::size_t do_run_one(mutex::scoped_lock& lock,
      thread_info& this_thread, const pdalboost::system::error_code& ec);
