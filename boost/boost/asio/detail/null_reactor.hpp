...
class null_reactor
  : public pdalboost::asio::detail::service_base<null_reactor>
{
public:
  // Constructor.
  null_reactor(pdalboost::asio::io_service& io_service)
    : pdalboost::asio::detail::service_base<null_reactor>(io_service)
  {
  }
