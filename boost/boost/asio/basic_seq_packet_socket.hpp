...
public:
   ...
   * the socket.
   */
  explicit basic_seq_packet_socket(pdalboost::asio::io_service& io_service)
   ...
   */
  basic_seq_packet_socket(pdalboost::asio::io_service& io_service,
   ...
   * follows:
   * @code
   * socket.receive(pdalboost::asio::buffer(data, size), out_flags);
   * @endcode
   ...
   * follows:
   * @code
   * socket.receive(pdalboost::asio::buffer(data, size), 0, out_flags);
   * @endcode
   * See the @ref buffer documentation for information on receiving into
   * multiple buffers in one go, and how to use it with arrays, pdalboost::array or
   * std::vector.
   ...
   * follows:
   * @code
   * socket.async_receive(pdalboost::asio::buffer(data, size), out_flags, handler);
   * @endcode
   * See the @ref buffer documentation for information on receiving into
   * multiple buffers in one go, and how to use it with arrays, pdalboost::array or
   * std::vector.
   ...
   *     pdalboost::asio::buffer(data, size),
   *     0, out_flags, handler);
   * @endcode
   * See the @ref buffer documentation for information on receiving into
   * multiple buffers in one go, and how to use it with arrays, pdalboost::array or
