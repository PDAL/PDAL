...
#else
  : public pdalboost::asio::detail::service_base<signal_set_service>
#endif
{
public:
#if defined(GENERATING_DOCUMENTATION)
...
public:
  ...
  explicit signal_set_service(pdalboost::asio::io_service& io_service)
    : pdalboost::asio::detail::service_base<signal_set_service>(io_service),
  ...
  pdalboost::system::error_code add(implementation_type& impl,
  ...
  pdalboost::system::error_code remove(implementation_type& impl,
      int signal_number, pdalboost::system::error_code& ec)
  {
  ...
  pdalboost::system::error_code clear(implementation_type& impl,
      ...
      BOOST_ASIO_MOVE_ARG(SignalHandler) handler)
  {
    detail::async_result_init<
      SignalHandler, void (pdalboost::system::error_code, int)> init(
...
private:
  ...
  void fork_service(pdalboost::asio::io_service::fork_event event)
  {
