...
#else
  : public pdalboost::asio::detail::service_base<socket_acceptor_service<Protocol> >
#endif
{
public:
#if defined(GENERATING_DOCUMENTATION)
...
public:
  ...
  explicit socket_acceptor_service(pdalboost::asio::io_service& io_service)
  ...
  /// connections.
  pdalboost::system::error_code listen(implementation_type& impl, int backlog,
      pdalboost::system::error_code& ec)
  {
  ...
  pdalboost::system::error_code accept(implementation_type& impl,
      ...
      typename enable_if<is_convertible<Protocol, Protocol1>::value>::type* = 0)
  {
    detail::async_result_init<
      AcceptHandler, void (pdalboost::system::error_code)> init(
