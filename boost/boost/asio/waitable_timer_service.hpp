...
public:
  ...
  explicit waitable_timer_service(pdalboost::asio::io_service& io_service)
  ...
  std::size_t expires_at(implementation_type& impl,
      const time_point& expiry_time, pdalboost::system::error_code& ec)
  {
  ...
  std::size_t expires_from_now(implementation_type& impl,
      const duration& expiry_time, pdalboost::system::error_code& ec)
  {
      ...
      BOOST_ASIO_MOVE_ARG(WaitHandler) handler)
  {
    detail::async_result_init<
      WaitHandler, void (pdalboost::system::error_code)> init(
