...
public:
...
#endif // defined(__GNUC__) && (__GNUC__ == 4) && (__GNUC_MINOR__ == 3)
  {
    ...
    while (new_iter.current_ != new_iter.end_)
    {
      ...
      if (pdalboost::asio::buffer_size(new_iter.current_buffer_) > 0)
        break;
      ++new_iter.current_;
    }
    return new_iter;
...
#endif // defined(__GNUC__) && (__GNUC__ == 4) && (__GNUC_MINOR__ == 3)
  {
    ...
    while (new_iter.current_ != new_iter.end_)
    {
      ...
      new_iter.position_ += pdalboost::asio::buffer_size(buffer);
      ++new_iter.current_;
    }
    return new_iter;
  }
...
private:
  ...
  void increment()
  {
    ...
    if (current_buffer_position_ != pdalboost::asio::buffer_size(current_buffer_))
      return;
    ...
    while (current_ != end_)
    {
      ...
      if (pdalboost::asio::buffer_size(current_buffer_) > 0)
        return;
      ++current_;
    }
  }
    ...
    if (n > 0)
    {
      ...
      for (;;)
      {
        std::ptrdiff_t current_buffer_balance
          = pdalboost::asio::buffer_size(current_buffer_)
          - current_buffer_position_;
