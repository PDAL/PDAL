 ...
 *
 * @code pdalboost::asio::mutable_buffer b1 = ...;
 * std::size_t s1 = pdalboost::asio::buffer_size(b1);
 * unsigned char* p1 = pdalboost::asio::buffer_cast<unsigned char*>(b1);
 * @endcode
 *
 * The pdalboost::asio::buffer_cast function permits violations of type safety, so
...
public:
...
#if defined(BOOST_ASIO_ENABLE_BUFFER_DEBUGGING)
  mutable_buffer(void* data, std::size_t size,
      pdalboost::asio::detail::function<void()> debug_check)
    : data_(data),
      size_(size),
  ...
  const pdalboost::asio::detail::function<void()>& get_debug_check() const
  {
    return debug_check_;
  }
#endif // BOOST_ASIO_ENABLE_BUFFER_DEBUGGING
...
private:
  friend void* pdalboost::asio::detail::buffer_cast_helper(
      const mutable_buffer& b);
  friend std::size_t pdalboost::asio::detail::buffer_size_helper(
      const mutable_buffer& b);
...
#if defined(BOOST_ASIO_ENABLE_BUFFER_DEBUGGING)
  pdalboost::asio::detail::function<void()> debug_check_;
#endif // BOOST_ASIO_ENABLE_BUFFER_DEBUGGING
};
 ...
 * and @ref buffer_cast functions:
 *
 * @code pdalboost::asio::const_buffer b1 = ...;
 * std::size_t s1 = pdalboost::asio::buffer_size(b1);
 * const unsigned char* p1 = pdalboost::asio::buffer_cast<const unsigned char*>(b1);
 * @endcode
 *
 * The pdalboost::asio::buffer_cast function permits violations of type safety, so
 * uses of it in application code should be carefully considered.
...
public:
  ...
  const_buffer(const mutable_buffer& b)
    : data_(pdalboost::asio::detail::buffer_cast_helper(b)),
      size_(pdalboost::asio::detail::buffer_size_helper(b))
#if defined(BOOST_ASIO_ENABLE_BUFFER_DEBUGGING)
...
private:
  friend const void* pdalboost::asio::detail::buffer_cast_helper(
...
/** @defgroup buffer_size pdalboost::asio::buffer_size
 *
 * @brief The pdalboost::asio::buffer_size function determines the total number of
...
/** @defgroup buffer_cast pdalboost::asio::buffer_cast
 *
 * @brief The pdalboost::asio::buffer_cast function is used to obtain a pointer to
 ...
 * @code pdalboost::asio::mutable_buffer b2 = ...;
 * unsigned char* p2 = pdalboost::asio::buffer_cast<unsigned char*>(b2);
 * @endcode
 *
 * The pdalboost::asio::buffer_cast function permits violations of type safety, so
 * uses of it in application code should be carefully considered.
...
/** @defgroup buffer pdalboost::asio::buffer
 *
 * @brief The pdalboost::asio::buffer function is used to create a buffer object to
 ...
 * specified size:
 *
 * @code sock.send(pdalboost::asio::buffer(data, size)); @endcode
 *
 * In the above example, the return value of pdalboost::asio::buffer meets the
 * requirements of the ConstBufferSequence concept so that it may be directly
 * passed to the socket's write function. A buffer created for modifiable
 * memory also meets the requirements of the MutableBufferSequence concept.
 *
 * An individual buffer may be created from a builtin array, std::vector,
 * std::array or pdalboost::array of POD elements. This helps prevent buffer
 * overruns by automatically determining the size of the buffer:
 *
 * @code char d1[128];
 * size_t bytes_transferred = sock.receive(pdalboost::asio::buffer(d1));
 *
 * std::vector<char> d2(128);
 * bytes_transferred = sock.receive(pdalboost::asio::buffer(d2));
 *
 * std::array<char, 128> d3;
 * bytes_transferred = sock.receive(pdalboost::asio::buffer(d3));
 *
 * pdalboost::array<char, 128> d4;
 * bytes_transferred = sock.receive(pdalboost::asio::buffer(d4)); @endcode
 *
 ...
 * unsigned char* p1 = pdalboost::asio::buffer_cast<unsigned char*>(b1);
 *
 * pdalboost::asio::const_buffer b2 = ...;
 * std::size_t s2 = pdalboost::asio::buffer_size(b2);
 * const void* p2 = pdalboost::asio::buffer_cast<const void*>(b2); @endcode
 *
 * The pdalboost::asio::buffer_cast function permits violations of type safety, so
 * uses of it in application code should be carefully considered.
 *
 ...
 *
 * vector<unsigned char> data(pdalboost::asio::buffer_size(buffers));
 * pdalboost::asio::buffer_copy(pdalboost::asio::buffer(data), buffers); @endcode
 *
 ...
 *
 * For the pdalboost::asio::buffer overloads that accept an argument of type
 ...
 * follows:
 *
 * @code pdalboost::array<char, 6> a = { 'a', 'b', 'c', 'd', 'e' }; @endcode
 *
 * A buffer object @c b1 created using:
 *
 * @code b1 = pdalboost::asio::buffer(a); @endcode
 *
 * represents the entire array, <tt>{ 'a', 'b', 'c', 'd', 'e' }</tt>. An
 * optional second argument to the pdalboost::asio::buffer function may be used to
 * limit the size, in bytes, of the buffer:
 *
 * @code b2 = pdalboost::asio::buffer(a, 3); @endcode
 *
 ...
 *
 * @code b4 = pdalboost::asio::buffer(b1 + 1, 3); @endcode
 *
 ...
 * char d1[128];
 * std::vector<char> d2(128);
 * pdalboost::array<char, 128> d3;
 *
 * pdalboost::array<mutable_buffer, 3> bufs1 = {
 *   pdalboost::asio::buffer(d1),
 *   pdalboost::asio::buffer(d2),
 *   pdalboost::asio::buffer(d3) };
 * bytes_transferred = sock.receive(bufs1);
 *
 * std::vector<const_buffer> bufs2;
 * bufs2.push_back(pdalboost::asio::buffer(d1));
 * bufs2.push_back(pdalboost::asio::buffer(d2));
 * bufs2.push_back(pdalboost::asio::buffer(d3));
...
//
//   unspecified buffer(pdalboost::array<PodType, N>& array ...);
//
// and
//
//   unspecified buffer(pdalboost::array<const PodType, N>& array ...);
//
...
buffer(pdalboost::array<PodType, N>& data)
{
  typedef typename pdalboost::asio::detail::buffer_types<PodType>::buffer_type
    buffer_type;
  typedef typename pdalboost::asio::detail::buffer_types<PodType>::container_type
    container_type;
...
template <typename PodType, std::size_t N>
inline typename detail::buffer_types<PodType>::container_type
buffer(pdalboost::array<PodType, N>& data, std::size_t max_size_in_bytes)
{
  typedef typename pdalboost::asio::detail::buffer_types<PodType>::buffer_type
    buffer_type;
  typedef typename pdalboost::asio::detail::buffer_types<PodType>::container_type
 ...
 */
template <typename PodType, std::size_t N>
inline mutable_buffers_1 buffer(pdalboost::array<PodType, N>& data)
{
  return mutable_buffers_1(
 ...
 */
template <typename PodType, std::size_t N>
inline const_buffers_1 buffer(pdalboost::array<const PodType, N>& data)
{
  return const_buffers_1(
 ...
 */
template <typename PodType, std::size_t N>
inline const_buffers_1 buffer(const pdalboost::array<PodType, N>& data)
{
  return const_buffers_1(
      const_buffer(data.data(), data.size() * sizeof(PodType)));
}
...
/** @defgroup buffer_copy pdalboost::asio::buffer_copy
 *
 * @brief The pdalboost::asio::buffer_copy function is used to copy bytes from a
