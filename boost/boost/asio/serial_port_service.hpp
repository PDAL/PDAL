...
#else
  : public pdalboost::asio::detail::service_base<serial_port_service>
#endif
{
public:
#if defined(GENERATING_DOCUMENTATION)
...
public:
  ...
  explicit serial_port_service(pdalboost::asio::io_service& io_service)
    : pdalboost::asio::detail::service_base<serial_port_service>(io_service),
