...
public:
   ...
   */
  explicit strand(pdalboost::asio::io_service& io_service)
    : service_(pdalboost::asio::use_service<
        pdalboost::asio::detail::strand_service>(io_service))
  {
   ...
   * @code strand.dispatch(pdalboost::bind(f, a1, ... an)); @endcode
   */
...
private:
  pdalboost::asio::detail::strand_service& service_;
  pdalboost::asio::detail::strand_service::implementation_type impl_;
};

/// Typedef for backwards compatibility.
typedef pdalboost::asio::io_service::strand strand;
