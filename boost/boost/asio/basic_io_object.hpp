...
protected:
   ...
   */
  explicit basic_io_object(pdalboost::asio::io_service& io_service)
    : service(pdalboost::asio::use_service<IoObjectService>(io_service))
  {
...
protected:
  explicit basic_io_object(pdalboost::asio::io_service& io_service)
    : service_(&pdalboost::asio::use_service<IoObjectService>(io_service))
  {
