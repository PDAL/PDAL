...
# define BOOST_ASIO_INITFN_RESULT_TYPE(h, sig) \
  typename ::pdalboost::asio::detail::async_result_type_helper<h, sig>::type
#else
# define BOOST_ASIO_INITFN_RESULT_TYPE(h, sig) \
  typename ::pdalboost::asio::async_result< \
    typename ::pdalboost::asio::handler_type<h, sig>::type>::type
#endif
