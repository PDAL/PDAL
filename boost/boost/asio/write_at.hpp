...
/**
 * @defgroup write_at pdalboost::asio::write_at
 *
 ...
 * @code pdalboost::asio::write_at(d, 42, pdalboost::asio::buffer(data, size)); @endcode
 * See the @ref buffer documentation for information on writing multiple
 * buffers in one go, and how to use it with arrays, pdalboost::array or
 * std::vector.
 *
 * @note This overload is equivalent to calling:
 * @code pdalboost::asio::write_at(
 *     d, offset, buffers,
 ...
 * @par Example
 * To write a single data buffer use the @ref buffer function as follows:
 * @code pdalboost::asio::write_at(d, 42,
 ...
 * @par Example
 * To write a single data buffer use the @ref buffer function as follows:
 * @code pdalboost::asio::write_at(d, 42, pdalboost::asio::buffer(data, size),
...
/*@}*/
/**
 * @defgroup async_write_at pdalboost::asio::async_write_at
 *
 ...
 * To write a single data buffer use the @ref buffer function as follows:
 * @code
 * pdalboost::asio::async_write_at(d, 42, pdalboost::asio::buffer(data, size), handler);
 * @endcode
 * See the @ref buffer documentation for information on writing multiple
 * buffers in one go, and how to use it with arrays, pdalboost::array or
 * std::vector.
 ...
 * @par Example
 * To write a single data buffer use the @ref buffer function as follows:
 * @code pdalboost::asio::async_write_at(d, 42,
