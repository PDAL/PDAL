...
/**
 * The pdalboost::asio::ip::address_v6 class provides the ability to use and
...
#else
  typedef pdalboost::asio::detail::array<unsigned char, 16> bytes_type;
#endif
...
private:
  ...
  pdalboost::asio::detail::in6_addr_type addr_;
 ...
 *
 * @relates pdalboost::asio::ip::address_v6
 */
