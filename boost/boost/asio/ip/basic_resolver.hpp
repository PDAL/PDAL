...
public:
   ...
   */
  explicit basic_resolver(pdalboost::asio::io_service& io_service)
   ...
   * will be invoked with the pdalboost::asio::error::operation_aborted error code.
   */
  void cancel()
  {
  ...
  iterator resolve(const query& q)
  {
    ...
    pdalboost::asio::detail::throw_error(ec, "resolve");
    return i;
  }
   ...
   * entry.
   */
  iterator resolve(const query& q, pdalboost::system::error_code& ec)
  {
   ...
   * entry.
   */
  iterator resolve(const endpoint_type& e, pdalboost::system::error_code& ec)
  {
