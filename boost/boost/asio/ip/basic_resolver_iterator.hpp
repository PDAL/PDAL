...
/**
 * The pdalboost::asio::ip::basic_resolver_iterator class template is used to define
...
public:
  ...
  static basic_resolver_iterator create(
      pdalboost::asio::detail::addrinfo_type* address_info,
  ...
  static basic_resolver_iterator create(
      ...
      const pdalboost::asio::detail::addrinfo_type& hints,
      const std::string& host_name, const std::string& service_name)
  {
    basic_resolver_iterator iter;
    if (endpoints->Size)
            ...
            basic_resolver_entry<InternetProtocol>(
              typename InternetProtocol::endpoint(
                ip::address::from_string(
                  pdalboost::asio::detail::winrt_utils::string(
                    pair->RemoteHostName->CanonicalName)),
                pdalboost::asio::detail::winrt_utils::integer(
...
private:
  ...
  pdalboost::asio::detail::shared_ptr<values_type> values_;
  std::size_t index_;
};
