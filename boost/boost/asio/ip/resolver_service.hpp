...
#if defined(BOOST_ASIO_WINDOWS_RUNTIME)
  typedef pdalboost::asio::detail::winrt_resolver_service<InternetProtocol>
    service_impl_type;
#else
  typedef pdalboost::asio::detail::resolver_service<InternetProtocol>
    service_impl_type;
#endif
...
public:
  ...
  explicit resolver_service(pdalboost::asio::io_service& io_service)
  ...
  BOOST_ASIO_INITFN_RESULT_TYPE(ResolveHandler,
      void (pdalboost::system::error_code, iterator_type))
      ...
      BOOST_ASIO_MOVE_ARG(ResolveHandler) handler)
  {
    pdalboost::asio::detail::async_result_init<
      ResolveHandler, void (pdalboost::system::error_code, iterator_type)> init(
