...
/**
 * The pdalboost::asio::ip::address_v4 class provides the ability to use and
...
#else
  typedef pdalboost::asio::detail::array<unsigned char, 4> bytes_type;
#endif
...
private:
  ...
  pdalboost::asio::detail::in4_addr_type addr_;
};
 ...
 *
 * @relates pdalboost::asio::ip::address_v4
 */
