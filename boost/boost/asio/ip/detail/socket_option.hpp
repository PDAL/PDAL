...
public:
  ...
  explicit multicast_request(const pdalboost::asio::ip::address& multicast_address)
    : ipv4_value_(), // Zero-initialisation gives the "any" address.
      ipv6_value_() // Zero-initialisation gives the "any" address.
  {
    if (multicast_address.is_v6())
    {
      ...
      pdalboost::asio::ip::address_v6 ipv6_address = multicast_address.to_v6();
      pdalboost::asio::ip::address_v6::bytes_type bytes = ipv6_address.to_bytes();
    ...
    else
    {
      ...
      ipv4_value_.imr_interface.s_addr =
        pdalboost::asio::detail::socket_ops::host_to_network_long(
            pdalboost::asio::ip::address_v4::any().to_ulong());
    }
  }

  // Construct with multicast address and IPv4 address specifying an interface.
  explicit multicast_request(
      const pdalboost::asio::ip::address_v4& multicast_address,
      const pdalboost::asio::ip::address_v4& network_interface
        = pdalboost::asio::ip::address_v4::any())
    : ipv6_value_() // Zero-initialisation gives the "any" address.
  {
    ipv4_value_.imr_multiaddr.s_addr =
      pdalboost::asio::detail::socket_ops::host_to_network_long(
  ...
  explicit multicast_request(
      const pdalboost::asio::ip::address_v6& multicast_address,
...
private:
  pdalboost::asio::detail::in4_mreq_type ipv4_value_;
  pdalboost::asio::detail::in6_mreq_type ipv6_value_;
};
...
public:
  ...
  explicit network_interface(const pdalboost::asio::ip::address_v4& ipv4_interface)
  {
    ipv4_value_.s_addr =
      pdalboost::asio::detail::socket_ops::host_to_network_long(
...
private:
  pdalboost::asio::detail::in4_addr_type ipv4_value_;
