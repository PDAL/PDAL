...
/**
 * The pdalboost::asio::ip::basic_resolver_query class template describes a query
...
public:
  ...
  const pdalboost::asio::detail::addrinfo_type& hints() const
  {
    return hints_;
  }
...
private:
  pdalboost::asio::detail::addrinfo_type hints_;
