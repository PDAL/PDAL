...
class openssl_context_service
  : public pdalboost::asio::detail::service_base<openssl_context_service>
{
public:
  ...
  typedef pdalboost::function<std::string(std::size_t,
      context_base::password_purpose)> password_callback_type;

  // Constructor.
  openssl_context_service(pdalboost::asio::io_service& io_service)
    : pdalboost::asio::detail::service_base<openssl_context_service>(io_service)
  {
  }
  ...
  void create(impl_type& impl, context_base::method m)
  {
    ...
    case context_base::sslv2_server:
      pdalboost::asio::detail::throw_error(pdalboost::asio::error::invalid_argument);
      break;
  ...
  pdalboost::system::error_code set_password_callback(impl_type& impl,
      Password_Callback callback, pdalboost::system::error_code& ec)
  {
