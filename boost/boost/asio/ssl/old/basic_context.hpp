...
public:
  ...
  /// Constructor.
  basic_context(pdalboost::asio::io_service& io_service, method m)
    : service_(pdalboost::asio::use_service<Service>(io_service)),
      impl_(service_.null())
  {
   ...
   */
  pdalboost::system::error_code set_options(options o,
      pdalboost::system::error_code& ec)
  {
   ...
   * @param ec Set to indicate what error occurred, if any.
   */
  pdalboost::system::error_code set_verify_mode(verify_mode v,
      pdalboost::system::error_code& ec)
  {
   ...
   * @param ec Set to indicate what error occurred, if any.
   */
  pdalboost::system::error_code load_verify_file(const std::string& filename,
      pdalboost::system::error_code& ec)
  {
   ...
   * @param ec Set to indicate what error occurred, if any.
   */
  pdalboost::system::error_code add_verify_path(const std::string& path,
      pdalboost::system::error_code& ec)
  {
   ...
   * @param ec Set to indicate what error occurred, if any.
   */
  pdalboost::system::error_code use_certificate_file(const std::string& filename,
      file_format format, pdalboost::system::error_code& ec)
  {
   ...
   * @param ec Set to indicate what error occurred, if any.
   */
  pdalboost::system::error_code use_certificate_chain_file(
   ...
   * @param ec Set to indicate what error occurred, if any.
   */
  pdalboost::system::error_code use_private_key_file(const std::string& filename,
      file_format format, pdalboost::system::error_code& ec)
  {
   ...
   * @param ec Set to indicate what error occurred, if any.
   */
  pdalboost::system::error_code use_rsa_private_key_file(
   ...
   * @param ec Set to indicate what error occurred, if any.
   */
  pdalboost::system::error_code use_tmp_dh_file(const std::string& filename,
      pdalboost::system::error_code& ec)
  {
