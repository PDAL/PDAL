...
#else
  : public pdalboost::asio::detail::service_base<stream_service>
#endif
{
private:
...
public:
  ...
  explicit stream_service(pdalboost::asio::io_service& io_service)
    : pdalboost::asio::detail::service_base<stream_service>(io_service),
