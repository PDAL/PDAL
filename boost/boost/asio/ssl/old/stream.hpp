 ...
 * pdalboost::asio::ssl::context context(io_service, pdalboost::asio::ssl::context::sslv23);
 * pdalboost::asio::ssl::stream<pdalboost::asio::ip::tcp::socket> sock(io_service, context);
 * @endcode
 *
 * @par Concepts:
...
public:
  ...
  explicit stream(Arg& arg, basic_context<Context_Service>& context)
    : next_layer_(arg),
      service_(pdalboost::asio::use_service<Service>(next_layer_.get_io_service())),
      impl_(service_.null())
  {
