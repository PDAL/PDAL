...
using pdalboost::asio::ssl::old::stream;
 ...
 * pdalboost::asio::ssl::context ctx(pdalboost::asio::ssl::context::sslv23);
 * pdalboost::asio::ssl::stream<asio:ip::tcp::socket> sock(io_service, ctx);
 * @endcode
 *
 * @par Concepts:
...
public:
   ...
   * @note Calls @c SSL_set_verify.
   */
  pdalboost::system::error_code set_verify_mode(
   ...
   * @note Calls @c SSL_set_verify_depth.
   */
  pdalboost::system::error_code set_verify_depth(
  ...
  void set_verify_callback(VerifyCallback callback)
  {
    ...
    pdalboost::asio::detail::throw_error(ec, "set_verify_callback");
  }
  ...
  void handshake(handshake_type type)
  {
    pdalboost::system::error_code ec;
    handshake(type, ec);
    pdalboost::asio::detail::throw_error(ec, "handshake");
  }
   ...
   * @param ec Set to indicate what error occurred, if any.
   */
  pdalboost::system::error_code handshake(handshake_type type,
      pdalboost::system::error_code& ec)
  {
  ...
  template <typename ConstBufferSequence>
  pdalboost::system::error_code handshake(handshake_type type,
      const ConstBufferSequence& buffers, pdalboost::system::error_code& ec)
  {
      ...
      BOOST_ASIO_MOVE_ARG(HandshakeHandler) handler)
  {
    ...
    pdalboost::asio::detail::async_result_init<
      HandshakeHandler, void (pdalboost::system::error_code)> init(
      ...
      BOOST_ASIO_MOVE_ARG(BufferedHandshakeHandler) handler)
  {
    ...
    pdalboost::asio::detail::async_result_init<BufferedHandshakeHandler,
      void (pdalboost::system::error_code, std::size_t)> init(
   ...
   * @param ec Set to indicate what error occurred, if any.
   */
  pdalboost::system::error_code shutdown(pdalboost::system::error_code& ec)
  {
  ...
  async_shutdown(BOOST_ASIO_MOVE_ARG(ShutdownHandler) handler)
  {
    ...
    pdalboost::asio::detail::async_result_init<
      ShutdownHandler, void (pdalboost::system::error_code)> init(
      ...
      BOOST_ASIO_MOVE_ARG(WriteHandler) handler)
  {
    ...
    pdalboost::asio::detail::async_result_init<
      WriteHandler, void (pdalboost::system::error_code, std::size_t)> init(
