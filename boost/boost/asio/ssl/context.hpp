...
public:
  ...
  BOOST_ASIO_DECL context(pdalboost::asio::io_service&, method m);
   ...
   * @note Calls @c SSL_CTX_clear_options.
   */
  BOOST_ASIO_DECL pdalboost::system::error_code clear_options(options o,
   ...
   * @note Calls @c SSL_CTX_set_options.
   */
  BOOST_ASIO_DECL pdalboost::system::error_code set_options(options o,
      pdalboost::system::error_code& ec);
   ...
   * @note Calls @c SSL_CTX_set_verify.
   */
  BOOST_ASIO_DECL pdalboost::system::error_code set_verify_mode(
   ...
   * @note Calls @c SSL_CTX_set_verify_depth.
   */
  BOOST_ASIO_DECL pdalboost::system::error_code set_verify_depth(
   ...
   */
  template <typename VerifyCallback>
  pdalboost::system::error_code set_verify_callback(VerifyCallback callback,
      pdalboost::system::error_code& ec);
   ...
   * @note Calls @c SSL_CTX_load_verify_locations.
   */
  BOOST_ASIO_DECL pdalboost::system::error_code load_verify_file(
   ...
   * @note Calls @c SSL_CTX_get_cert_store and @c X509_STORE_add_cert.
   */
  BOOST_ASIO_DECL pdalboost::system::error_code add_certificate_authority(
   ...
   * @note Calls @c SSL_CTX_set_default_verify_paths.
   */
  BOOST_ASIO_DECL pdalboost::system::error_code set_default_verify_paths(
      pdalboost::system::error_code& ec);
   ...
   * @note Calls @c SSL_CTX_load_verify_locations.
   */
  BOOST_ASIO_DECL pdalboost::system::error_code add_verify_path(
   ...
   * @note Calls @c SSL_CTX_use_certificate or SSL_CTX_use_certificate_ASN1.
   */
  BOOST_ASIO_DECL pdalboost::system::error_code use_certificate(
      const const_buffer& certificate, file_format format,
      pdalboost::system::error_code& ec);
   ...
   * @note Calls @c SSL_CTX_use_certificate_file.
   */
  BOOST_ASIO_DECL pdalboost::system::error_code use_certificate_file(
      const std::string& filename, file_format format,
      pdalboost::system::error_code& ec);
   ...
   * @note Calls @c SSL_CTX_use_certificate and SSL_CTX_add_extra_chain_cert.
   */
  BOOST_ASIO_DECL pdalboost::system::error_code use_certificate_chain(
   ...
   * @note Calls @c SSL_CTX_use_certificate_chain_file.
   */
  BOOST_ASIO_DECL pdalboost::system::error_code use_certificate_chain_file(
      const std::string& filename, pdalboost::system::error_code& ec);
   ...
   * @note Calls @c SSL_CTX_use_PrivateKey or SSL_CTX_use_PrivateKey_ASN1.
   */
  BOOST_ASIO_DECL pdalboost::system::error_code use_private_key(
      const const_buffer& private_key, file_format format,
      pdalboost::system::error_code& ec);
   ...
   * @note Calls @c SSL_CTX_use_PrivateKey_file.
   */
  BOOST_ASIO_DECL pdalboost::system::error_code use_private_key_file(
      const std::string& filename, file_format format,
      pdalboost::system::error_code& ec);
   ...
   * @note Calls @c SSL_CTX_use_RSAPrivateKey or SSL_CTX_use_RSAPrivateKey_ASN1.
   */
  BOOST_ASIO_DECL pdalboost::system::error_code use_rsa_private_key(
      const const_buffer& private_key, file_format format,
      pdalboost::system::error_code& ec);
   ...
   * @note Calls @c SSL_CTX_use_RSAPrivateKey_file.
   */
  BOOST_ASIO_DECL pdalboost::system::error_code use_rsa_private_key_file(
      const std::string& filename, file_format format,
      pdalboost::system::error_code& ec);
   ...
   * @note Calls @c SSL_CTX_set_tmp_dh.
   */
  BOOST_ASIO_DECL pdalboost::system::error_code use_tmp_dh(
   ...
   * @note Calls @c SSL_CTX_set_tmp_dh.
   */
  BOOST_ASIO_DECL pdalboost::system::error_code use_tmp_dh_file(
      const std::string& filename, pdalboost::system::error_code& ec);
   ...
   */
  template <typename PasswordCallback>
  pdalboost::system::error_code set_password_callback(PasswordCallback callback,
      pdalboost::system::error_code& ec);
...
private:
  ...
  BOOST_ASIO_DECL pdalboost::system::error_code do_set_verify_callback(
  ...
  BOOST_ASIO_DECL pdalboost::system::error_code do_set_password_callback(
  ...
  BOOST_ASIO_DECL pdalboost::system::error_code do_use_tmp_dh(
  ...
  pdalboost::asio::ssl::detail::openssl_init<> init_;
};
