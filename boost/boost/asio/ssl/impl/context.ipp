  ...
  : handle_(0)
{
  ...
  case context::sslv2_server:
    pdalboost::asio::detail::throw_error(
        pdalboost::asio::error::invalid_argument, "context");
    break;
  ...
  if (handle_ == 0)
  {
    ...
    pdalboost::asio::detail::throw_error(ec, "context");
  }

  set_options(no_compression);
}

context::context(pdalboost::asio::io_service&, context::method m)
  : handle_(0)
{
  context tmp(m);
  handle_ = tmp.handle_;
...
void context::clear_options(context::options o)
{
  pdalboost::system::error_code ec;
  clear_options(o, ec);
  pdalboost::asio::detail::throw_error(ec, "clear_options");
}

pdalboost::system::error_code context::clear_options(
    context::options o, pdalboost::system::error_code& ec)
{
...
void context::set_options(context::options o)
{
  pdalboost::system::error_code ec;
  set_options(o, ec);
  pdalboost::asio::detail::throw_error(ec, "set_options");
}

pdalboost::system::error_code context::set_options(
    context::options o, pdalboost::system::error_code& ec)
{
#if !defined(SSL_OP_NO_COMPRESSION)
  if ((o & context::no_compression) != 0)
  {
    ...
    handle_->comp_methods =
      pdalboost::asio::ssl::detail::openssl_init<>::get_null_compression_methods();
#endif // (OPENSSL_VERSION_NUMBER >= 0x00908000L)
    o ^= context::no_compression;
  }
#endif // !defined(SSL_OP_NO_COMPRESSION)
...
void context::set_verify_mode(verify_mode v)
{
  ...
  pdalboost::asio::detail::throw_error(ec, "set_verify_mode");
}

pdalboost::system::error_code context::set_verify_mode(
    verify_mode v, pdalboost::system::error_code& ec)
{
...
void context::set_verify_depth(int depth)
{
  ...
  pdalboost::asio::detail::throw_error(ec, "set_verify_depth");
}

pdalboost::system::error_code context::set_verify_depth(
    int depth, pdalboost::system::error_code& ec)
{
...
void context::load_verify_file(const std::string& filename)
{
  ...
  pdalboost::asio::detail::throw_error(ec, "load_verify_file");
}

pdalboost::system::error_code context::load_verify_file(
...
void context::add_certificate_authority(const const_buffer& ca)
{
  ...
  pdalboost::asio::detail::throw_error(ec, "add_certificate_authority");
}

pdalboost::system::error_code context::add_certificate_authority(
    const const_buffer& ca, pdalboost::system::error_code& ec)
{
  ::ERR_clear_error();
...
void context::set_default_verify_paths()
{
  ...
  pdalboost::asio::detail::throw_error(ec, "set_default_verify_paths");
}

pdalboost::system::error_code context::set_default_verify_paths(
    pdalboost::system::error_code& ec)
{
...
void context::add_verify_path(const std::string& path)
{
  ...
  pdalboost::asio::detail::throw_error(ec, "add_verify_path");
}

pdalboost::system::error_code context::add_verify_path(
    ...
    const const_buffer& certificate, file_format format)
{
  ...
  pdalboost::asio::detail::throw_error(ec, "use_certificate");
}

pdalboost::system::error_code context::use_certificate(
    const const_buffer& certificate, file_format format,
    pdalboost::system::error_code& ec)
{
  ::ERR_clear_error();
    ...
    const std::string& filename, file_format format)
{
  ...
  pdalboost::asio::detail::throw_error(ec, "use_certificate_file");
}

pdalboost::system::error_code context::use_certificate_file(
    const std::string& filename, file_format format,
    pdalboost::system::error_code& ec)
{
  int file_type;
...
void context::use_certificate_chain(const const_buffer& chain)
{
  ...
  pdalboost::asio::detail::throw_error(ec, "use_certificate_chain");
}

pdalboost::system::error_code context::use_certificate_chain(
    const const_buffer& chain, pdalboost::system::error_code& ec)
{
  ::ERR_clear_error();
  ...
  if (bio.p)
  {
    ...
    if (!cert.p)
    {
      ec = pdalboost::system::error_code(ERR_R_PEM_LIB,
          pdalboost::asio::error::get_ssl_category());
      return ec;
    }
...
void context::use_certificate_chain_file(const std::string& filename)
{
  ...
  pdalboost::asio::detail::throw_error(ec, "use_certificate_chain_file");
}

pdalboost::system::error_code context::use_certificate_chain_file(
    const std::string& filename, pdalboost::system::error_code& ec)
{
    ...
    const const_buffer& private_key, context::file_format format)
{
  ...
  pdalboost::asio::detail::throw_error(ec, "use_private_key");
}

pdalboost::system::error_code context::use_private_key(
    const const_buffer& private_key, context::file_format format,
    pdalboost::system::error_code& ec)
{
  ::ERR_clear_error();
    ...
    const std::string& filename, context::file_format format)
{
  ...
  pdalboost::asio::detail::throw_error(ec, "use_private_key_file");
}
    ...
    const const_buffer& private_key, context::file_format format)
{
  ...
  pdalboost::asio::detail::throw_error(ec, "use_rsa_private_key");
}

pdalboost::system::error_code context::use_rsa_private_key(
    const const_buffer& private_key, context::file_format format,
    pdalboost::system::error_code& ec)
{
  ::ERR_clear_error();
...
pdalboost::system::error_code context::use_private_key_file(
    const std::string& filename, context::file_format format,
    pdalboost::system::error_code& ec)
{
  int file_type;
    ...
    const std::string& filename, context::file_format format)
{
  ...
  pdalboost::asio::detail::throw_error(ec, "use_rsa_private_key_file");
}

pdalboost::system::error_code context::use_rsa_private_key_file(
    const std::string& filename, context::file_format format,
    pdalboost::system::error_code& ec)
{
  int file_type;
...
void context::use_tmp_dh(const const_buffer& dh)
{
  pdalboost::system::error_code ec;
  use_tmp_dh(dh, ec);
  pdalboost::asio::detail::throw_error(ec, "use_tmp_dh");
}

pdalboost::system::error_code context::use_tmp_dh(
    const const_buffer& dh, pdalboost::system::error_code& ec)
{
...
void context::use_tmp_dh_file(const std::string& filename)
{
  ...
  pdalboost::asio::detail::throw_error(ec, "use_tmp_dh_file");
}

pdalboost::system::error_code context::use_tmp_dh_file(
    const std::string& filename, pdalboost::system::error_code& ec)
{
...
pdalboost::system::error_code context::do_use_tmp_dh(
    BIO* bio, pdalboost::system::error_code& ec)
{
  ::ERR_clear_error();
...
pdalboost::system::error_code context::do_set_verify_callback(
    detail::verify_callback_base* callback, pdalboost::system::error_code& ec)
{
  if (SSL_CTX_get_app_data(handle_))
  {
...
pdalboost::system::error_code context::do_set_password_callback(
    detail::password_callback_base* callback, pdalboost::system::error_code& ec)
{
  if (handle_->default_passwd_callback_userdata)
