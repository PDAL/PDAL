...
template <typename VerifyCallback>
pdalboost::system::error_code context::set_verify_callback(
    VerifyCallback callback, pdalboost::system::error_code& ec)
{
...
void context::set_password_callback(PasswordCallback callback)
{
  ...
  pdalboost::asio::detail::throw_error(ec, "set_password_callback");
}

template <typename PasswordCallback>
pdalboost::system::error_code context::set_password_callback(
