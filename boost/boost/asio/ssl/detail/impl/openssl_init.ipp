...
public:
  do_init()
  {
    ...
    for (size_t i = 0; i < mutexes_.size(); ++i)
      mutexes_[i].reset(new pdalboost::asio::detail::mutex);
...
private:
  ...
  std::vector<pdalboost::asio::detail::shared_ptr<
        pdalboost::asio::detail::mutex> > mutexes_;

#if !defined(BOOST_ASIO_WINDOWS) && !defined(__CYGWIN__)
  // The thread identifiers to be used by openssl.
  pdalboost::asio::detail::tss_ptr<void> thread_id_;
#endif // !defined(BOOST_ASIO_WINDOWS) && !defined(__CYGWIN__)
...
pdalboost::asio::detail::shared_ptr<openssl_init_base::do_init>
openssl_init_base::instance()
{
  static pdalboost::asio::detail::shared_ptr<do_init> init(new do_init);
  return init;
}
