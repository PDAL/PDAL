...
public:
  ...
  BOOST_ASIO_DECL pdalboost::system::error_code set_verify_callback(
  ...
  BOOST_ASIO_DECL want shutdown(pdalboost::system::error_code& ec);

  // Write bytes to the SSL session.
  BOOST_ASIO_DECL want write(const pdalboost::asio::const_buffer& data,
      pdalboost::system::error_code& ec, std::size_t& bytes_transferred);

  // Read bytes from the SSL session.
  BOOST_ASIO_DECL want read(const pdalboost::asio::mutable_buffer& data,
      pdalboost::system::error_code& ec, std::size_t& bytes_transferred);

  // Get output data to be written to the transport.
  BOOST_ASIO_DECL pdalboost::asio::mutable_buffers_1 get_output(
      const pdalboost::asio::mutable_buffer& data);

  // Put input data that was read from the transport.
  BOOST_ASIO_DECL pdalboost::asio::const_buffer put_input(
      const pdalboost::asio::const_buffer& data);

  // Map an error::eof code returned by the underlying transport according to
  // the type and state of the SSL session. Returns a const reference to the
  // error code object, suitable for passing to a completion handler.
  BOOST_ASIO_DECL const pdalboost::system::error_code& map_error_code(
...
private:
  ...
  BOOST_ASIO_DECL static pdalboost::asio::detail::static_mutex& accept_mutex();
