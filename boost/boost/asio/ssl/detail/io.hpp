...
std::size_t io(Stream& next_layer, stream_core& core,
    const Operation& op, pdalboost::system::error_code& ec)
{
  ...
  case engine::want_input_and_retry:
    ...
    if (pdalboost::asio::buffer_size(core.input_) == 0)
      core.input_ = pdalboost::asio::buffer(core.input_buffer_,
  ...
  case engine::want_output_and_retry:
    ...
    // transport.
    pdalboost::asio::write(next_layer,
    ...
    case 1: // Called after at least one async operation.
      do
      {
        ...
        case engine::want_input_and_retry:
          ...
          if (pdalboost::asio::buffer_size(core_.input_) != 0)
          {
          ...
          if (core_.pending_read_.expires_at() == core_.neg_infin())
          {
            ...
            next_layer_.async_read_some(
                pdalboost::asio::buffer(core_.input_buffer_),
        ...
        case engine::want_output:
          ...
          if (core_.pending_write_.expires_at() == core_.neg_infin())
          {
            ...
            pdalboost::asio::async_write(next_layer_,
        ...
        default:
          ...
          {
            next_layer_.async_read_some(
                pdalboost::asio::buffer(core_.input_buffer_, 0),
                BOOST_ASIO_MOVE_CAST(io_op)(*this));
        ...
        case engine::want_input_and_retry:
          ...
          core_.input_ = pdalboost::asio::buffer(
    ...
    io_op<Stream, Operation, Handler>* this_handler)
{
  return this_handler->start_ == 0 ? true
    : pdalboost_asio_handler_cont_helpers::is_continuation(this_handler->handler_);
}
