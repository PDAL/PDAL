...
struct is_match_condition
{
  ...
  enum
  {
    value = pdalboost::asio::is_function<
        typename pdalboost::asio::remove_pointer<T>::type>::value
...
/**
 * @defgroup read_until pdalboost::asio::read_until
 *
 ...
 * @code pdalboost::asio::streambuf b;
 * pdalboost::asio::read_until(s, b, '\n');
 * std::istream is(&b);
 * std::string line;
...
std::size_t read_until(SyncReadStream& s,
    pdalboost::asio::basic_streambuf<Allocator>& b, char delim);
...
template <typename SyncReadStream, typename Allocator>
std::size_t read_until(SyncReadStream& s,
    pdalboost::asio::basic_streambuf<Allocator>& b, const std::string& delim);
 ...
 * @code pdalboost::asio::streambuf b;
 * pdalboost::asio::read_until(s, b, pdalboost::regex("\r\n"));
 * std::istream is(&b);
 * std::string line;
 * std::getline(is, line); @endcode
 * After the @c read_until operation completes successfully, the buffer @c b
...
template <typename SyncReadStream, typename Allocator>
std::size_t read_until(SyncReadStream& s,
    pdalboost::asio::basic_streambuf<Allocator>& b, const pdalboost::regex& expr);
 ...
 * @code typedef pdalboost::asio::buffers_iterator<
 *     pdalboost::asio::streambuf::const_buffers_type> iterator;
 *
 ...
 * }
 * ...
 * pdalboost::asio::streambuf b;
 * pdalboost::asio::read_until(s, b, match_whitespace);
 * @endcode
 *
 ...
 *     : public pdalboost::true_type {};
 * } // namespace asio
 * ...
 * pdalboost::asio::streambuf b;
 * pdalboost::asio::read_until(s, b, match_char('a'));
 * @endcode
 */
template <typename SyncReadStream, typename Allocator, typename MatchCondition>
std::size_t read_until(SyncReadStream& s,
    pdalboost::asio::basic_streambuf<Allocator>& b, MatchCondition match_condition,
...
template <typename SyncReadStream, typename Allocator, typename MatchCondition>
std::size_t read_until(SyncReadStream& s,
    pdalboost::asio::basic_streambuf<Allocator>& b,
    MatchCondition match_condition, pdalboost::system::error_code& ec,
    typename enable_if<is_match_condition<MatchCondition>::value>::type* = 0);

/*@}*/
/**
 * @defgroup async_read_until pdalboost::asio::async_read_until
 *
 ...
 * @code void handler(
 *   // Result of operation.
 *   const pdalboost::system::error_code& error,
 *
 ...
 * @code pdalboost::asio::streambuf b;
 * ...
 * void handler(const pdalboost::system::error_code& e, std::size_t size)
 * {
 *   if (!e)
 *   {
 *     std::istream is(&b);
 ...
 * }
 * ...
 * pdalboost::asio::async_read_until(s, b, '\n', handler); @endcode
 ...
 * }
 * ...
 * pdalboost::asio::async_read_until(s, b, pdalboost::regex("\r\n"), handler); @endcode
 * After the @c async_read_until operation completes successfully, the buffer
 ...
 * ...
 * pdalboost::asio::streambuf b;
 * pdalboost::asio::async_read_until(s, b, match_whitespace, handler);
 * @endcode
 *
 ...
 * ...
 * pdalboost::asio::streambuf b;
 * pdalboost::asio::async_read_until(s, b, match_char('a'), handler);
 * @endcode
 */
