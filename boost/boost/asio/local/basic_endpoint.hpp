...
/**
 * The pdalboost::asio::local::basic_endpoint class template describes an endpoint
...
private:
  ...
  pdalboost::asio::local::detail::endpoint impl_;
};
 ...
 *
 * @relates pdalboost::asio::local::basic_endpoint
 */
