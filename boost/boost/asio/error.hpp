...
inline const pdalboost::system::error_category& get_system_category()
{
  return pdalboost::system::system_category();
}

#if !defined(BOOST_ASIO_WINDOWS) && !defined(__CYGWIN__)

extern BOOST_ASIO_DECL
const pdalboost::system::error_category& get_netdb_category();

extern BOOST_ASIO_DECL
const pdalboost::system::error_category& get_addrinfo_category();

#else // !defined(BOOST_ASIO_WINDOWS) && !defined(__CYGWIN__)

inline const pdalboost::system::error_category& get_netdb_category()
{
  return get_system_category();
}

inline const pdalboost::system::error_category& get_addrinfo_category()
{
  return get_system_category();
}
...
extern BOOST_ASIO_DECL
const pdalboost::system::error_category& get_misc_category();

static const pdalboost::system::error_category& system_category
  = pdalboost::asio::error::get_system_category();
static const pdalboost::system::error_category& netdb_category
  = pdalboost::asio::error::get_netdb_category();
static const pdalboost::system::error_category& addrinfo_category
  = pdalboost::asio::error::get_addrinfo_category();
static const pdalboost::system::error_category& misc_category
  = pdalboost::asio::error::get_misc_category();
...
template<> struct is_error_code_enum<pdalboost::asio::error::basic_errors>
{
  static const bool value = true;
};

template<> struct is_error_code_enum<pdalboost::asio::error::netdb_errors>
{
  static const bool value = true;
};

template<> struct is_error_code_enum<pdalboost::asio::error::addrinfo_errors>
{
  static const bool value = true;
};

template<> struct is_error_code_enum<pdalboost::asio::error::misc_errors>
{
  static const bool value = true;
};
...
inline pdalboost::system::error_code make_error_code(basic_errors e)
{
  return pdalboost::system::error_code(
      static_cast<int>(e), get_system_category());
}

inline pdalboost::system::error_code make_error_code(netdb_errors e)
{
  return pdalboost::system::error_code(
      static_cast<int>(e), get_netdb_category());
}

inline pdalboost::system::error_code make_error_code(addrinfo_errors e)
{
  return pdalboost::system::error_code(
      static_cast<int>(e), get_addrinfo_category());
}

inline pdalboost::system::error_code make_error_code(misc_errors e)
{
  return pdalboost::system::error_code(
