...
inline io_service::work::work(pdalboost::asio::io_service& io_service)
...
inline pdalboost::asio::io_service& io_service::work::get_io_service()
{
  return io_service_impl_.get_io_service();
}

inline pdalboost::asio::io_service& io_service::service::get_io_service()
{
  return owner_;
}
