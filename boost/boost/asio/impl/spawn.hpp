...
namespace detail {
  ...
  public:
    ...
    {
      *ec_ = pdalboost::system::error_code();
      *value_ = value;
      (*coro_)();
    }

    void operator()(pdalboost::system::error_code ec, T value)
    {
      *ec_ = ec;
      *value_ = value;
      (*coro_)();
  ...
  public:
    ...
    void operator()(pdalboost::system::error_code ec)
    {
      *ec_ = ec;
      (*coro_)();
    }
...
struct handler_type<basic_yield_context<Handler>,
    ReturnType(pdalboost::system::error_code)>
{
  typedef detail::coro_handler<Handler, void> type;
};
...
struct handler_type<basic_yield_context<Handler>,
    ReturnType(pdalboost::system::error_code, Arg2)>
{
...
public:
  ...
  {
    ca_();
    if (!out_ec_ && ec_) throw pdalboost::system::system_error(ec_);
    return value_;
  }

private:
  typename basic_yield_context<Handler>::caller_type& ca_;
  pdalboost::system::error_code* out_ec_;
  pdalboost::system::error_code ec_;
  type value_;
};
...
namespace detail {
  ...
  struct spawn_helper
  {
    ...
    shared_ptr<spawn_data<Handler, Function> > data_;
    pdalboost::coroutines::attributes attributes_;
  };
    ...
    const pdalboost::coroutines::attributes& attributes)
{
  ...
  pdalboost_asio_handler_invoke_helpers::invoke(helper, helper.data_->handler_);
}
...
void spawn(pdalboost::asio::io_service::strand strand,
    ...
    const pdalboost::coroutines::attributes& attributes)
{
  pdalboost::asio::spawn(strand.wrap(&detail::default_spawn_handler),
...
void spawn(pdalboost::asio::io_service& io_service,
    ...
    const pdalboost::coroutines::attributes& attributes)
{
  pdalboost::asio::spawn(pdalboost::asio::io_service::strand(io_service),
      BOOST_ASIO_MOVE_CAST(Function)(function), attributes);
}
