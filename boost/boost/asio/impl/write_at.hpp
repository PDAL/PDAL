    ...
    uint64_t offset, const ConstBufferSequence& buffers)
{
  ...
  pdalboost::asio::detail::throw_error(ec, "write_at");
...
namespace detail
{
  ...
  class write_at_op<AsyncRandomAccessWriteDevice,
      pdalboost::asio::mutable_buffers_1, CompletionCondition, WriteHandler>
    : detail::base_from_completion_cond<CompletionCondition>
  {
  public:
    write_at_op(AsyncRandomAccessWriteDevice& device,
  ...
  template <typename AsyncRandomAccessWriteDevice,
      typename CompletionCondition, typename WriteHandler>
  class write_at_op<AsyncRandomAccessWriteDevice, pdalboost::asio::const_buffers_1,
      CompletionCondition, WriteHandler>
    : detail::base_from_completion_cond<CompletionCondition>
  {
  public:
    write_at_op(AsyncRandomAccessWriteDevice& device,
        uint64_t offset, const pdalboost::asio::const_buffers_1& buffers,
        CompletionCondition completion_condition,
        WriteHandler& handler)
      : detail::base_from_completion_cond<
          CompletionCondition>(completion_condition),
  ...
  template <typename AsyncRandomAccessWriteDevice, typename Elem,
      typename CompletionCondition, typename WriteHandler>
  class write_at_op<AsyncRandomAccessWriteDevice, pdalboost::array<Elem, 2>,
      CompletionCondition, WriteHandler>
    : detail::base_from_completion_cond<CompletionCondition>
  {
  public:
...
namespace detail
{
  ...
  public:
    write_at_streambuf_op(
        pdalboost::asio::basic_streambuf<Allocator>& streambuf,
        WriteHandler& handler)
  ...
  make_write_at_streambuf_op(
      pdalboost::asio::basic_streambuf<Allocator>& b, WriteHandler handler)
  {
