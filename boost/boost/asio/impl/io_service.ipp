...
io_service::io_service()
  : service_registry_(new pdalboost::asio::detail::service_registry(
...
std::size_t io_service::run(pdalboost::system::error_code& ec)
{
  return impl_.run(ec);
}
...
std::size_t io_service::run_one(pdalboost::system::error_code& ec)
{
...
std::size_t io_service::poll(pdalboost::system::error_code& ec)
{
...
std::size_t io_service::poll_one(pdalboost::system::error_code& ec)
{
...
void io_service::notify_fork(pdalboost::asio::io_service::fork_event event)
{
  service_registry_->notify_fork(event);
}

io_service::service::service(pdalboost::asio::io_service& owner)
  : owner_(owner),
    next_(0)
{
}
...
void io_service::service::fork_service(pdalboost::asio::io_service::fork_event)
{
}
