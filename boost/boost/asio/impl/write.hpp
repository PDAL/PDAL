...
inline std::size_t write(SyncWriteStream& s, const ConstBufferSequence& buffers)
{
  ...
  pdalboost::asio::detail::throw_error(ec, "write");
...
namespace detail
{
  ...
  template <typename AsyncWriteStream,
      typename CompletionCondition, typename WriteHandler>
  class write_op<AsyncWriteStream, pdalboost::asio::mutable_buffers_1,
      CompletionCondition, WriteHandler>
    : detail::base_from_completion_cond<CompletionCondition>
  {
  public:
    write_op(AsyncWriteStream& stream,
        const pdalboost::asio::mutable_buffers_1& buffers,
        CompletionCondition completion_condition,
  ...
  template <typename AsyncWriteStream,
      typename CompletionCondition, typename WriteHandler>
  class write_op<AsyncWriteStream, pdalboost::asio::const_buffers_1,
      CompletionCondition, WriteHandler>
    : detail::base_from_completion_cond<CompletionCondition>
  {
  public:
    write_op(AsyncWriteStream& stream,
        const pdalboost::asio::const_buffers_1& buffers,
        CompletionCondition completion_condition,
        WriteHandler& handler)
      : detail::base_from_completion_cond<
          CompletionCondition>(completion_condition),
  ...
  //private:
    AsyncWriteStream& stream_;
    pdalboost::asio::const_buffer buffer_;
    int start_;
    std::size_t total_transferred_;
    WriteHandler handler_;
  };
  ...
  template <typename AsyncWriteStream, typename Elem,
      typename CompletionCondition, typename WriteHandler>
  class write_op<AsyncWriteStream, pdalboost::array<Elem, 2>,
      CompletionCondition, WriteHandler>
    : detail::base_from_completion_cond<CompletionCondition>
  {
  public:
    write_op(AsyncWriteStream& stream, const pdalboost::array<Elem, 2>& buffers,
        CompletionCondition completion_condition, WriteHandler& handler)
      : detail::base_from_completion_cond<
          CompletionCondition>(completion_condition),
        stream_(stream),
        ...
        std::size_t bytes_transferred, int start = 0)
    {
      typename pdalboost::asio::detail::dependent_type<Elem,
          pdalboost::array<pdalboost::asio::const_buffer, 2> >::type bufs = {{
        pdalboost::asio::const_buffer(buffers_[0]),
        pdalboost::asio::const_buffer(buffers_[1]) }};
  ...
  public:
    ...
    {
      typename pdalboost::asio::detail::dependent_type<Elem,
          std::array<pdalboost::asio::const_buffer, 2> >::type bufs = {{
        pdalboost::asio::const_buffer(buffers_[0]),
        pdalboost::asio::const_buffer(buffers_[1]) }};
      std::size_t buffer_size0 = pdalboost::asio::buffer_size(bufs[0]);
      std::size_t buffer_size1 = pdalboost::asio::buffer_size(bufs[1]);
    ...
    BOOST_ASIO_MOVE_ARG(WriteHandler) handler)
{
  ...
  detail::write_op<AsyncWriteStream, ConstBufferSequence,
    CompletionCondition, BOOST_ASIO_HANDLER_TYPE(
      WriteHandler, void (pdalboost::system::error_code, std::size_t))>(
...
namespace detail
{
  ...
  {
  public:
    write_streambuf_handler(pdalboost::asio::basic_streambuf<Allocator>& streambuf,
        WriteHandler& handler)
  ...
  inline bool asio_handler_is_continuation(
      write_streambuf_handler<Allocator, WriteHandler>* this_handler)
  {
    return pdalboost_asio_handler_cont_helpers::is_continuation(
        this_handler->handler_);
  }
