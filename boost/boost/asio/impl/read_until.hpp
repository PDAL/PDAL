    ...
    pdalboost::asio::basic_streambuf<Allocator>& b, char delim)
{
  ...
  pdalboost::asio::detail::throw_error(ec, "read_until");
    ...
    pdalboost::system::error_code& ec)
{
  ...
  for (;;)
  {
    ...
    typedef typename pdalboost::asio::basic_streambuf<
      Allocator>::const_buffers_type const_buffers_type;
    typedef pdalboost::asio::buffers_iterator<const_buffers_type> iterator;
    ...
    pdalboost::system::error_code& ec)
{
  ...
  for (;;)
  {
    ...
    // Look for a match.
    pdalboost::match_results<iterator,
      typename std::vector<pdalboost::sub_match<iterator> >::allocator_type>
        match_results;
    if (regex_search(start_pos, end, match_results, expr,
          pdalboost::match_default | pdalboost::match_partial))
    {
...
namespace detail
{
  ...
  public:
    read_until_expr_op(AsyncReadStream& stream,
        pdalboost::asio::basic_streambuf<Allocator>& streambuf,
        const pdalboost::regex& expr, ReadHandler& handler)
      : stream_(stream),
        streambuf_(streambuf),
        expr_(expr),
        start_(0),
    ...
    BOOST_ASIO_MOVE_ARG(ReadHandler) handler)
{
  ...
  detail::read_until_expr_op<AsyncReadStream, Allocator,
    pdalboost::regex, BOOST_ASIO_HANDLER_TYPE(ReadHandler,
      void (pdalboost::system::error_code, std::size_t))>(
