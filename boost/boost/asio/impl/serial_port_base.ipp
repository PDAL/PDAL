...
pdalboost::system::error_code serial_port_base::baud_rate::store(
    BOOST_ASIO_OPTION_STORAGE& storage, pdalboost::system::error_code& ec) const
{
...
pdalboost::system::error_code serial_port_base::baud_rate::load(
    const BOOST_ASIO_OPTION_STORAGE& storage, pdalboost::system::error_code& ec)
{
#if defined(BOOST_ASIO_WINDOWS) || defined(__CYGWIN__)
...
pdalboost::system::error_code serial_port_base::flow_control::store(
    BOOST_ASIO_OPTION_STORAGE& storage, pdalboost::system::error_code& ec) const
{
#if defined(BOOST_ASIO_WINDOWS) || defined(__CYGWIN__)
...
pdalboost::system::error_code serial_port_base::flow_control::load(
    const BOOST_ASIO_OPTION_STORAGE& storage, pdalboost::system::error_code& ec)
{
#if defined(BOOST_ASIO_WINDOWS) || defined(__CYGWIN__)
...
pdalboost::system::error_code serial_port_base::parity::store(
    BOOST_ASIO_OPTION_STORAGE& storage, pdalboost::system::error_code& ec) const
{
#if defined(BOOST_ASIO_WINDOWS) || defined(__CYGWIN__)
  switch (value_)
...
pdalboost::system::error_code serial_port_base::parity::load(
    const BOOST_ASIO_OPTION_STORAGE& storage, pdalboost::system::error_code& ec)
{
#if defined(BOOST_ASIO_WINDOWS) || defined(__CYGWIN__)
...
pdalboost::system::error_code serial_port_base::stop_bits::store(
    BOOST_ASIO_OPTION_STORAGE& storage, pdalboost::system::error_code& ec) const
{
#if defined(BOOST_ASIO_WINDOWS) || defined(__CYGWIN__)
  switch (value_)
...
pdalboost::system::error_code serial_port_base::stop_bits::load(
    const BOOST_ASIO_OPTION_STORAGE& storage, pdalboost::system::error_code& ec)
{
#if defined(BOOST_ASIO_WINDOWS) || defined(__CYGWIN__)
...
pdalboost::system::error_code serial_port_base::character_size::store(
    BOOST_ASIO_OPTION_STORAGE& storage, pdalboost::system::error_code& ec) const
{
#if defined(BOOST_ASIO_WINDOWS) || defined(__CYGWIN__)
...
pdalboost::system::error_code serial_port_base::character_size::load(
    const BOOST_ASIO_OPTION_STORAGE& storage, pdalboost::system::error_code& ec)
{
#if defined(BOOST_ASIO_WINDOWS) || defined(__CYGWIN__)
