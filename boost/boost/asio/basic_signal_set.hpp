 ...
 *
 * Most applications will use the pdalboost::asio::signal_set typedef.
 *
 * @par Thread Safety
 ...
 * pdalboost::asio::signal_set signals(io_service, SIGINT, SIGTERM);
 *
...
public:
   ...
   */
  explicit basic_signal_set(pdalboost::asio::io_service& io_service)
   ...
   * @code pdalboost::asio::signal_set signals(io_service);
   * signals.add(signal_number_1); @endcode
   */
  basic_signal_set(pdalboost::asio::io_service& io_service, int signal_number_1)
    : basic_io_object<SignalSetService>(io_service)
  {
    pdalboost::system::error_code ec;
    this->service.add(this->implementation, signal_number_1, ec);
    pdalboost::asio::detail::throw_error(ec, "add");
  }
   ...
   */
  pdalboost::system::error_code add(int signal_number,
      pdalboost::system::error_code& ec)
  {
  ...
  void remove(int signal_number)
  {
    ...
    pdalboost::asio::detail::throw_error(ec, "remove");
  }
   ...
   * signal number.
   */
  pdalboost::system::error_code remove(int signal_number,
      pdalboost::system::error_code& ec)
  {
  ...
  void clear()
  {
    ...
    pdalboost::asio::detail::throw_error(ec, "clear");
  }
   ...
   * @note Removes all queued notifications.
   */
  pdalboost::system::error_code clear(pdalboost::system::error_code& ec)
  {
   ...
   * operation will be invoked with the pdalboost::asio::error::operation_aborted
   * error code.
   *
   ...
   * error code pdalboost::asio::error::operation_aborted.
   *
  ...
  BOOST_ASIO_INITFN_RESULT_TYPE(SignalHandler,
      void (pdalboost::system::error_code, int))
