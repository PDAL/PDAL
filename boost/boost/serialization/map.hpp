...
inline void save(
    ...
    pdalboost::serialization::stl::save_collection<
        Archive, 
...
inline void load(
    ...
    pdalboost::serialization::stl::load_collection<
        Archive,
        std::map<Key, Type, Compare, Allocator>,
        pdalboost::serialization::stl::archive_input_map<
            Archive, std::map<Key, Type, Compare, Allocator> >,
            pdalboost::serialization::stl::no_reserve_imp<std::map<
...
inline void load(
    ...
    pdalboost::serialization::stl::load_collection<
        ...
        >,
        pdalboost::serialization::stl::no_reserve_imp<
            std::multimap<Key, Type, Compare, Allocator> 
        >
    >(ar, t);
}
