...
public:
    ...
    virtual void * construct(unsigned int count, ...) const{
        ...
        switch(count){
        case 0:
            return factory<BOOST_DEDUCED_TYPENAME pdalboost::remove_const< T >::type, 0>(ap);
        case 1:
            return factory<BOOST_DEDUCED_TYPENAME pdalboost::remove_const< T >::type, 1>(ap);
        case 2:
            return factory<BOOST_DEDUCED_TYPENAME pdalboost::remove_const< T >::type, 2>(ap);
        case 3:
            return factory<BOOST_DEDUCED_TYPENAME pdalboost::remove_const< T >::type, 3>(ap);
        case 4:
            return factory<BOOST_DEDUCED_TYPENAME pdalboost::remove_const< T >::type, 4>(ap);
        default:
