...
using ::pdalboost::variate_generator;

template<class UIntType, UIntType a, UIntType c, UIntType m>
class linear_congruential
{
private:
   typedef ::pdalboost::random::linear_congruential<UIntType, a, c, m, 0> impl_type;
public:
   // types
   ...
   {
      init1(g, ::pdalboost::is_same<Gen,linear_congruential>());
   }
   void seed(unsigned long x0 = 1)
   { m_gen.seed(x0); }
   template<class Gen> void seed(Gen& g)
   { 
      init2(g, ::pdalboost::is_fundamental<Gen>());
   }
...
private:
   template <class Gen>
   void init1(Gen& g, const ::pdalboost::true_type&)
   {
      m_gen = g.m_gen;
   }
   template <class Gen>
   void init1(Gen& g, const ::pdalboost::false_type&)
   {
      init2(g, ::pdalboost::is_fundamental<Gen>());
   }
   template <class Gen>
   void init2(Gen& g, const ::pdalboost::true_type&)
   {
      m_gen.seed(static_cast<unsigned long>(g));
   }
   template <class Gen>
   void init2(Gen& g, const ::pdalboost::false_type&)
   {
      //typedef typename Gen::result_type gen_rt;
      pdalboost::tr1_details::functor2iterator<Gen, unsigned long> f1(g), f2;
      m_gen.seed(f1, f2);
   }
   impl_type m_gen;
};
...
{
   typedef ::pdalboost::random::mersenne_twister
...
public:
   ...
   {
      init1(g, ::pdalboost::is_same<mersenne_twister,Gen>());
   }
   void seed()
   { m_gen.seed(); }
...
public:
   ...
   { init1(g, ::pdalboost::is_same<Gen, subtract_with_carry<IntType, m, s, r> >()); }
...
private:
   ...
   ::pdalboost::random::subtract_with_carry<IntType, m, s, r, 0> m_gen;
};
...
public:
   ...
   { init1(g, ::pdalboost::is_same<Gen, subtract_with_carry_01<RealType, w, s, r> >()); }
   void seed(unsigned long value = 19780503UL)
   { m_gen.seed(value == 0 ? 19780503UL : value); }
   template<class Gen> void seed(Gen& g)
   { init2(g, ::pdalboost::is_fundamental<Gen>()); }
...
private:
   ...
   ::pdalboost::random::subtract_with_carry_01<RealType, w, s, r, 0> m_gen;
};

using ::pdalboost::random::discard_block;
...
public:
   ...
   { 
      init_minmax(); 
      init1(g, ::pdalboost::is_same<Gen, xor_combine<UniformRandomNumberGenerator1, s1, UniformRandomNumberGenerator2, s2> >());
   }
   void seed()
   {
      m_b1.seed();
...
typedef linear_congruential< ::pdalboost::int32_t, 16807, 0, 2147483647> minstd_rand0;
typedef linear_congruential< ::pdalboost::int32_t, 48271, 0, 2147483647> minstd_rand;
typedef mersenne_twister< ::pdalboost::uint32_t, 32,624,397,31,0x9908b0df,11,7,0x9d2c5680,15,0xefc60000,18> mt19937;
typedef subtract_with_carry_01<float, 24, 10, 24> ranlux_base_01;
typedef subtract_with_carry_01<double, 48, 10, 24> ranlux64_base_01;
typedef discard_block<subtract_with_carry< ::pdalboost::int32_t, (1<<24), 10, 24>, 223, 24> ranlux3;
typedef discard_block<subtract_with_carry< ::pdalboost::int32_t, (1<<24), 10, 24>, 389, 24> ranlux4;
...
#ifndef __SUNPRO_CC
using ::pdalboost::random_device;
#endif
using ::pdalboost::uniform_int;
...
private:
   ::pdalboost::bernoulli_distribution<double> m_dist;
};
//using ::pdalboost::bernoulli_distribution;
using ::pdalboost::geometric_distribution;
using ::pdalboost::poisson_distribution;
using ::pdalboost::binomial_distribution;
using ::pdalboost::uniform_real;
using ::pdalboost::exponential_distribution;
using ::pdalboost::normal_distribution;
using ::pdalboost::gamma_distribution;
