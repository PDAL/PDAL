...
namespace pdalboost {} namespace boost = pdalboost; namespace pdalboost{ namespace tr1_details{

template <class Func, class R>
struct functor2iterator : pdalboost::iterator_facade<functor2iterator<Func,R>, const R, std::input_iterator_tag>
{
