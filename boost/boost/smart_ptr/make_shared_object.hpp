...
template< class T, class Arg1, class... Args > typename pdalboost::detail::sp_if_not_array< T >::type make_shared( Arg1 && arg1, Args && ... args )
{
    pdalboost::shared_ptr< T > pt( static_cast< T* >( 0 ), BOOST_SP_MSD( T ) );
...
template< class T, class A, class Arg1, class... Args > typename pdalboost::detail::sp_if_not_array< T >::type allocate_shared( A const & a, Arg1 && arg1, Args && ... args )
{
    pdalboost::shared_ptr< T > pt( static_cast< T* >( 0 ), BOOST_SP_MSD( T ), a );
