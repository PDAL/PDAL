...
namespace pdalboost {} namespace boost = pdalboost; namespace pdalboost {
    ...
    allocate_shared(const A& allocator, std::size_t size) {
        ...
        pdalboost::detail::allocate_array_helper<A, T2[]> a1(allocator, n1, &p2);
    ...
    allocate_shared(const A& allocator, Args&&... args) {
        ...
        T1* p1 = 0;
        T2* p2 = 0;
        pdalboost::detail::allocate_array_helper<A, T2[N]> a1(allocator, &p2);
    ...
    inline typename pdalboost::detail::sp_if_array<T>::type
    allocate_shared(const A& allocator,
        std::initializer_list<typename pdalboost::detail::array_inner<T>::type> list) {
        typedef typename pdalboost::detail::array_inner<T>::type T1;
        typedef typename pdalboost::detail::array_base<T1>::type T2;
        typedef const T2 T3;
        T1* p1 = 0;
