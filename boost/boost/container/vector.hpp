...
class vector_const_iterator
{
   ...
   typedef typename pdalboost::intrusive::pointer_traits<Pointer>::template
...
struct vector_value_traits
{
   ...
   static const bool trivial_dctr = pdalboost::has_trivial_destructor<value_type>::value;
   static const bool trivial_dctr_after_move = ::pdalboost::has_trivial_destructor_after_move<value_type>::value;
...
template < class Allocator
         , class AllocatorVersion = container_detail::integral_constant
            < unsigned
            , pdalboost::container::container_detail::version<Allocator>::value
            >
         >
   ...
   : public Allocator
{
   ...
   vector_alloc_holder()
      BOOST_CONTAINER_NOEXCEPT_IF(::pdalboost::has_nothrow_default_constructor<Allocator>::value)
   ...
   vector_alloc_holder(BOOST_RV_REF(vector_alloc_holder) holder) BOOST_CONTAINER_NOEXCEPT
      : Allocator(pdalboost::move(static_cast<Allocator&>(holder)))
   ...
   {
      pdalboost::container::swap_dispatch(this->m_start, x.m_start);
      pdalboost::container::swap_dispatch(this->m_size, x.m_size);
      pdalboost::container::swap_dispatch(this->m_capacity, x.m_capacity);
   }
...
//! pdalboost::container::vector is similar to std::vector but it's compatible
...
class vector
{
   ...
   typedef container_detail::integral_constant
      <unsigned, pdalboost::container::container_detail::version
         <Allocator>::value >                               alloc_version;
   pdalboost::container::container_detail::vector_alloc_holder<Allocator, alloc_version> m_holder;
   ...
   explicit vector(size_type n)
      :  m_holder(n)
   {
      pdalboost::container::uninitialized_default_alloc_n(this->m_holder.alloc(), n, container_detail::to_raw_pointer(this->m_holder.start()));
   }
   ...
   vector(BOOST_RV_REF(vector) mx) BOOST_CONTAINER_NOEXCEPT
      :  m_holder(pdalboost::move(mx.m_holder))
   {}
   ...
   {
      if (&x != this){
         this->priv_copy_assign(pdalboost::move(x), alloc_version());
      }
      return *this;
   }
   ...
   {
      this->priv_move_assign(pdalboost::move(x), alloc_version());
      return *this;
   }
   ...
   void emplace_back(Args &&...args)
   {
      ...
      if (this->m_holder.m_size < this->m_holder.capacity()){
         ...
         allocator_traits_type::construct(this->m_holder.alloc(), back_pos, ::pdalboost::forward<Args>(args)...);
         ++this->m_holder.m_size;
      }
      else{
         typedef container_detail::insert_emplace_proxy<Allocator, T*, Args...> type;
         this->priv_forward_range_insert_no_capacity
            (vector_iterator_get_ptr(this->cend()), 1, type(this->m_holder.alloc(), ::pdalboost::forward<Args>(args)...), alloc_version());
      }
   }
   ...
   iterator emplace(const_iterator position, Args && ...args)
   {
      ...
      return this->priv_forward_range_insert( vector_iterator_get_ptr(position), 1, type(this->m_holder.alloc()
                                            , ::pdalboost::forward<Args>(args)...), alloc_version());
   }
   ...
   iterator erase(const_iterator position)
   {
      ...
      this->priv_destroy(::pdalboost::move(pos + 1, beg + this->m_holder.m_size, pos));
      --this->m_holder.m_size;
   ...
   iterator erase(const_iterator first, const_iterator last)
   {
      if (first != last){
         T* const end_pos = container_detail::to_raw_pointer(this->m_holder.start()) + this->m_holder.m_size;
         T* const ptr = container_detail::to_raw_pointer(pdalboost::move
         ...
         pdalboost::container::destroy_alloc_n(this->get_stored_allocator(), ptr, destroyed);
         ...
         >::type * = 0)
   {
      ...
      this->priv_move_assign_impl(pdalboost::move(x), AllocVersion());
   }
         ...
         >::type * = 0)
   {
      ...
      //If unequal allocators, then do a one by one move
         ...
         //TO-DO: optimize this
         this->assign( pdalboost::make_move_iterator(container_detail::to_raw_pointer(x.m_holder.start()))
                     , pdalboost::make_move_iterator(container_detail::to_raw_pointer(x.m_holder.start() + x.m_holder.m_size)));
      }
   }
   ...
   void priv_reserve(size_type new_cap, allocator_v1)
   {
      ...
      pdalboost::container::destroy_alloc_n(this->m_holder.alloc(), raw_beg, sz);
   ...
   void priv_reserve(size_type new_cap, allocator_v2)
   {
      ...
      //If there is no forward expansion, move objects
         ...
         if(ret.second){
            ...
            container_detail::insert_range_proxy<Allocator, pdalboost::move_iterator<T*>, T*>
               proxy(this->m_holder.alloc(), ::pdalboost::make_move_iterator((T *)0));
            #ifdef BOOST_CONTAINER_VECTOR_ALLOC_STATS
            ++this->num_expand_bwd;
            #endif
   ...
   {
      T* const end_pos = container_detail::to_raw_pointer(this->m_holder.start()) + this->m_holder.m_size;
      pdalboost::container::destroy_alloc_n(this->get_stored_allocator(), end_pos-n, n);
      this->m_holder.m_size -= n;
   }
   ...
   iterator priv_insert(const const_iterator &p, BOOST_FWD_REF(U) x)
   {
      return this->priv_forward_range_insert
         ...
         , ::pdalboost::forward<U>(x)), alloc_version());
   }
      ...
      (size_type first_pos, size_type last_pos, size_type limit_pos, size_type shift_count)
   {
      ...
      if((last_pos + shift_count) <= limit_pos){
         //All move assigned
         pdalboost::move_backward(first_ptr, last_ptr, last_ptr + shift_count);
      }
      //Case B:
      ...
      //Case C:
         ...
         pdalboost::move_backward(first_ptr, boundary_ptr, limit_ptr);
      }
      return hole_size;
   }
   ...
   void priv_forward_range_insert_expand_forward(T* const pos, const size_type n, InsertionProxy insert_range_proxy)
   {
      ...
      if (!elems_after){
         ...
         pdalboost::move_backward(pos, old_finish - n, old_finish);
          ...
          T* const pos, const size_type n, InsertionProxy insert_range_proxy)
   {
      ...
      if(s_before >= before_plus_new){
         ...
         T *const new_elem_pos = ::pdalboost::container::uninitialized_move_alloc(this->m_holder.alloc(), old_start, pos, new_start);
         ...
         //s_before is so big that divides old_end
            ...
            T * const to_destroy = ::pdalboost::move(pos + raw_gap, old_finish, old_start);
            ...
            if(!value_traits::trivial_dctr_after_move)
               pdalboost::container::destroy_alloc_n(this->get_stored_allocator(), to_destroy, n_destroy);
         ...
         if (s_before <= elemsbefore) {
            ...
            T *const next = ::pdalboost::move(old_start + s_before, pos, old_start);
            if(do_after){
               ...
               T* const move_end   = ::pdalboost::move(pos, old_finish, next + n);
            ...
            if(do_after){
               ...
               //Displace old_end
               T* move_end = ::pdalboost::move(pos, old_finish, move_start);
         ...
         if(do_after){
            ...
            if (elemsafter >= n_after){
               ...
               pdalboost::move_backward(pos, finish_n, old_finish);
               ...
               BOOST_CATCH(...){
                  pdalboost::container::destroy_alloc_n(this->get_stored_allocator(), pos, mid_last_dist);
                  BOOST_RETHROW
               }
               BOOST_CATCH_END
/*
...
struct has_trivial_destructor_after_move<pdalboost::container::vector<T, Allocator> >
   : public ::pdalboost::has_trivial_destructor_after_move<Allocator>
{};
...
template <class T, class Allocator>
inline void swap(pdalboost::container::vector<T, Allocator>& x, pdalboost::container::vector<T, Allocator>& y)
{  x.swap(y);  }
