...
namespace pdalboost {} namespace boost = pdalboost; namespace pdalboost { namespace container {
...
struct uses_allocator
   : pdalboost::integral_constant<bool, container_detail::uses_allocator_imp<T, Alloc>::value>
{};
...
struct is_scoped_allocator
   : pdalboost::integral_constant<bool, container_detail::is_scoped_allocator_imp<Alloc>::value>
{};
...
// Check if we can detect is_convertible using advanced SFINAE expressions
   ...
   struct is_constructible_impl
   {
      ...
      template<class X>
      static yes_type test(dummy<sizeof(X(pdalboost::move_detail::declval<Args>()...))>*);
   ...
   struct is_constructible
      : pdalboost::integral_constant<bool, is_constructible_impl<T, Args...>::value>
   {};
...
inline void dispatch_allocator_prefix_suffix
   ( pdalboost::true_type  use_alloc_prefix, OutermostAlloc& outermost_alloc
   , InnerAlloc& inner_alloc, T* p, BOOST_FWD_REF(Args) ...args)
{
   (void)use_alloc_prefix;
   allocator_traits<OutermostAlloc>::construct
      ( outermost_alloc, p, allocator_arg, inner_alloc, ::pdalboost::forward<Args>(args)...);
}
...
template < typename OutermostAlloc
         ...
         >
inline void dispatch_allocator_prefix_suffix
   ( pdalboost::false_type use_alloc_prefix, OutermostAlloc& outermost_alloc
   , InnerAlloc &inner_alloc, T* p, BOOST_FWD_REF(Args)...args)
{
   (void)use_alloc_prefix;
   allocator_traits<OutermostAlloc>::construct
      (outermost_alloc, p, ::pdalboost::forward<Args>(args)..., inner_alloc);
}
...
inline void dispatch_uses_allocator
   ( pdalboost::true_type uses_allocator, OutermostAlloc& outermost_alloc
   , InnerAlloc& inner_alloc, T* p, BOOST_FWD_REF(Args)...args)
{
   (void)uses_allocator;
   ...
   dispatch_allocator_prefix_suffix
      ...
      , outermost_alloc, inner_alloc, p, ::pdalboost::forward<Args>(args)...);
}
...
template < typename OutermostAlloc
         ...
         >
inline void dispatch_uses_allocator
   ( pdalboost::false_type uses_allocator, OutermostAlloc & outermost_alloc
   , InnerAlloc & inner_alloc
   ,T* p, BOOST_FWD_REF(Args)...args)
{
   (void)uses_allocator; (void)inner_alloc;
   allocator_traits<OutermostAlloc>::construct
      (outermost_alloc, p, ::pdalboost::forward<Args>(args)...);
}
...
template < typename OutermostAlloc                                                           \
         ...
         >                                                                                   \
inline void dispatch_allocator_prefix_suffix(                                                \
                                       pdalboost::true_type  use_alloc_prefix,                   \
...
template < typename OutermostAlloc                                                           \
         ...
         >                                                                                   \
inline void dispatch_allocator_prefix_suffix(                                                \
                           pdalboost::false_type use_alloc_prefix,                               \
                           OutermostAlloc& outermost_alloc,                                  \
                           InnerAlloc&    inner_alloc,                                       \
...
template < typename OutermostAlloc                                                           \
         ...
         BOOST_PP_ENUM_TRAILING_PARAMS(n, class P)                                           \
         >                                                                                   \
inline void dispatch_uses_allocator(pdalboost::true_type uses_allocator,                         \
                        OutermostAlloc& outermost_alloc,                                     \
                        InnerAlloc&    inner_alloc,                                          \
                        T* p BOOST_PP_ENUM_TRAILING(n, BOOST_CONTAINER_PP_PARAM_LIST, _))    \
{                                                                                            \
...
template < typename OutermostAlloc                                                           \
         ...
         BOOST_PP_ENUM_TRAILING_PARAMS(n, class P)                                           \
         >                                                                                   \
inline void dispatch_uses_allocator(pdalboost::false_type uses_allocator                         \
                        ,OutermostAlloc &    outermost_alloc                                 \
                        ,InnerAlloc &    inner_alloc                                         \
                        ,T* p BOOST_PP_ENUM_TRAILING(n, BOOST_CONTAINER_PP_PARAM_LIST, _))   \
{                                                                                            \
   ...
   : public OuterAlloc
{
   ...
   typedef pdalboost::integral_constant<
      bool,
   ...
   {
      pdalboost::container::swap_dispatch(this->outer_allocator(), r.outer_allocator());
      pdalboost::container::swap_dispatch(this->m_inner, r.inner_allocator());
   }
         ...
         >
{
   ...
   scoped_allocator_adaptor(BOOST_FWD_REF(OuterA2) outerAlloc                                   \
                     BOOST_PP_ENUM_TRAILING(n, BOOST_CONTAINER_PP_CONST_REF_PARAM_LIST_Q, _))   \
      : base_type(::pdalboost::forward<OuterA2>(outerAlloc)                                         \
                  BOOST_PP_ENUM_TRAILING_PARAMS(n, q)                                           \
                  )                                                                             \
      {}                                                                                        \
   //!
   ...
   {  return static_cast<scoped_allocator_adaptor&>(base_type::operator=(pdalboost::move(static_cast<base_type&>(other)))); }
   ...
   {  this->construct_pair(p, ::pdalboost::forward<U>(x), ::pdalboost::forward<V>(y));   }
   ...
   {
      this->construct(container_detail::addressof(p->first), ::pdalboost::forward<U>(x));
      BOOST_TRY{
         this->construct(container_detail::addressof(p->second), ::pdalboost::forward<V>(y));
      }
      BOOST_CATCH(...){
         this->destroy(container_detail::addressof(p->first));
         BOOST_RETHROW
   ...
   {
      this->construct(container_detail::addressof(p->first), ::pdalboost::move(pr.first));
      BOOST_TRY{
         this->construct(container_detail::addressof(p->second), ::pdalboost::move(pr.second));
      }
      BOOST_CATCH(...){
         this->destroy(container_detail::addressof(p->first));
         BOOST_RETHROW
   ...
   >& b)
{
   ...
   const bool has_zero_inner =
      pdalboost::container::container_detail::is_same
