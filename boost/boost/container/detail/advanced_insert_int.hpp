...
namespace pdalboost {} namespace boost = pdalboost; namespace pdalboost { namespace container { namespace container_detail {
...
struct insert_range_proxy
{
   ...
   void uninitialized_copy_n_and_update(Iterator p, size_type n)
   {
      this->first_ = ::pdalboost::container::uninitialized_copy_alloc_n_source(this->a_, this->first_, n, p);
   }
...
struct insert_n_copies_proxy
{
   ...
   {  pdalboost::container::uninitialized_fill_alloc_n(this->a_, v_, n, p);  }
...
{
   typedef ::pdalboost::container::allocator_traits<A> alloc_traits;
   typedef typename allocator_traits<A>::size_type size_type;
   typedef typename allocator_traits<A>::value_type value_type;
   ...
   void uninitialized_copy_n_and_update(Iterator p, size_type n) const
   {  pdalboost::container::uninitialized_value_init_alloc_n(this->a_, n, p);  }
...
struct insert_default_initialized_n_proxy
{
   ...
   void uninitialized_copy_n_and_update(Iterator p, size_type n) const
   {  pdalboost::container::uninitialized_default_init_alloc_n(this->a_, n, p);  }
   ...
   :  public insert_non_movable_emplace_proxy<A, Iterator, Args...>
{
   ...
   explicit insert_emplace_proxy(A &a, Args&&... args)
      : base_t(a, ::pdalboost::forward<Args>(args)...)
   {}
