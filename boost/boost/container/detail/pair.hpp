...
/*
   ...
   pair(U &&u, V &&v)
      : first(::pdalboost::forward<U>(u))
      , second(::pdalboost::forward<V>(v), ::pdalboost::forward<Args>(args)...)
   {}
...
*/
   ...
   typename ::pdalboost::container::container_detail::enable_if_c
      < !(::pdalboost::container::container_detail::is_same<T1, D>::value &&
          ::pdalboost::container::container_detail::is_same<T2, S>::value)
      , pair &>::type
