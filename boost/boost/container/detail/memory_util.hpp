...
#define BOOST_INTRUSIVE_HAS_MEMBER_FUNCTION_CALLABLE_WITH_NS_BEGIN namespace pdalboost {} namespace boost = pdalboost; namespace pdalboost { namespace container { namespace container_detail {
