...
enum {
   ...
   && !::pdalboost::is_fundamental<_TypeT>::value
};
...
struct move_const_ref_type
   : if_c
//   < ::pdalboost::is_fundamental<T>::value || ::pdalboost::is_pointer<T>::value || ::pdalboost::is_member_pointer<T>::value || ::pdalboost::is_enum<T>::value
