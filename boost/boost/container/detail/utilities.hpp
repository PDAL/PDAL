...
//!      allocator_traits::construct(a, &*result, pdalboost::move(*first));
//!   \endcode
//!
//! <b>Returns</b>: result
template
...
F uninitialized_copy_or_move_alloc
   (A &a, I f, I l, F r
   ,typename pdalboost::container::container_detail::enable_if
      < pdalboost::move_detail::is_move_iterator<I> >::type* = 0)
{
   return ::pdalboost::container::uninitialized_move_alloc(a, f, l, r);
}
...
F uninitialized_copy_or_move_alloc
   (A &a, I f, I l, F r
   ,typename pdalboost::container::container_detail::disable_if
      < pdalboost::move_detail::is_move_iterator<I> >::type* = 0)
{
   return ::pdalboost::container::uninitialized_copy_alloc(a, f, l, r);
}
...
F uninitialized_copy_or_move_alloc_n
   ...
   ,typename pdalboost::container::container_detail::enable_if
      < pdalboost::move_detail::is_move_iterator<I> >::type* = 0)
{
   return ::pdalboost::container::uninitialized_move_alloc_n(a, f, n, r);
}
...
F uninitialized_copy_or_move_alloc_n
   ...
   ,typename pdalboost::container::container_detail::disable_if
      < pdalboost::move_detail::is_move_iterator<I> >::type* = 0)
{
   return ::pdalboost::container::uninitialized_copy_alloc_n(a, f, n, r);
}
...
I uninitialized_copy_or_move_alloc_n_source
   ...
   ,typename pdalboost::container::container_detail::enable_if
      < pdalboost::move_detail::is_move_iterator<I> >::type* = 0)
{
   return ::pdalboost::container::uninitialized_move_alloc_n_source(a, f, n, r);
}
...
I uninitialized_copy_or_move_alloc_n_source
   ...
   ,typename pdalboost::container::container_detail::disable_if
      < pdalboost::move_detail::is_move_iterator<I> >::type* = 0)
{
   return ::pdalboost::container::uninitialized_copy_alloc_n_source(a, f, n, r);
}
