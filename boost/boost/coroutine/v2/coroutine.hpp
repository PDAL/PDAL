...
public:
    ...
    {
        push_coroutine tmp( pdalboost::move( other) );
        swap( tmp);
        return * this;
    }
...
public:
    ...
    {
        pull_coroutine tmp( pdalboost::move( other) );
        swap( tmp);
        return * this;
    }
...
template< typename R >
inline
typename pdalboost::coroutines::pull_coroutine< R >::iterator
begin( pdalboost::coroutines::pull_coroutine< R > & c)
{ return pdalboost::begin( c); }

template< typename R >
inline
typename pdalboost::coroutines::pull_coroutine< R >::iterator
end( pdalboost::coroutines::pull_coroutine< R > & c)
{ return pdalboost::end( c); }

template< typename R >
inline
typename pdalboost::coroutines::pull_coroutine< R >::const_iterator
begin( pdalboost::coroutines::pull_coroutine< R > const& c)
{ return pdalboost::const_begin( c); }

template< typename R >
inline
typename pdalboost::coroutines::pull_coroutine< R >::const_iterator
end( pdalboost::coroutines::pull_coroutine< R > const& c)
{ return pdalboost::const_end( c); }

template< typename R >
inline
typename pdalboost::coroutines::push_coroutine< R >::iterator
begin( pdalboost::coroutines::push_coroutine< R > & c)
{ return pdalboost::begin( c); }

template< typename R >
inline
typename pdalboost::coroutines::push_coroutine< R >::iterator
end( pdalboost::coroutines::push_coroutine< R > & c)
{ return pdalboost::end( c); }

template< typename R >
inline
typename pdalboost::coroutines::push_coroutine< R >::const_iterator
begin( pdalboost::coroutines::push_coroutine< R > const& c)
{ return pdalboost::const_begin( c); }

template< typename R >
inline
typename pdalboost::coroutines::push_coroutine< R >::const_iterator
end( pdalboost::coroutines::push_coroutine< R > const& c)
{ return pdalboost::const_end( c); }
