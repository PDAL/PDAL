...
namespace pdalboost {} namespace boost = pdalboost; namespace pdalboost
{
    ...
    #define BOOST_PROTO_DEFINE_ENV_VAR(TAG, NAME)                                                   \
        ...
        {                                                                                           \
            ...
            pdalboost::proto::env<TAG, Value &> const                                                   \
                operator =(pdalboost::reference_wrapper<Value> &value) const                            \
            {                                                                                       \
                return pdalboost::proto::env<TAG, Value &>(value.get());                                \
            }                                                                                       \
            template<typename Value>                                                                \
            pdalboost::proto::env<TAG, Value &> const                                                   \
                operator =(pdalboost::reference_wrapper<Value> const &value) const                      \
            {                                                                                       \
                return pdalboost::proto::env<TAG, Value &>(value.get());                                \
            }                                                                                       \
            template<typename Value>                                                                \
            typename pdalboost::disable_if_c<                                                           \
                pdalboost::is_const<Value>::value                                                       \
              , pdalboost::proto::env<TAG, typename pdalboost::proto::detail::value_type<Value>::type>      \
            >::type const operator =(Value &value) const                                            \
            {                                                                                       \
                return pdalboost::proto::env<TAG, typename pdalboost::proto::detail::value_type<Value>::type>(value); \
            }                                                                                       \
            template<typename Value>                                                                \
            pdalboost::proto::env<TAG, typename pdalboost::proto::detail::value_type<Value const>::type> const \
                operator =(Value const &value) const                                                \
            {                                                                                       \
                return pdalboost::proto::env<TAG, typename pdalboost::proto::detail::value_type<Value const>::type>(value); \
            }                                                                                       \
        };                                                                                          \
                                                                                                    \
        TAG const NAME = {}                                                                         \
