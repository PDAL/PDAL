...
namespace pdalboost {} namespace boost = pdalboost; namespace pdalboost { namespace numeric { namespace ublas {
    ...
    public:
        ...
        typedef typename pdalboost::mpl::if_<pdalboost::is_const<M>,
    ...
    public:
        ...
        public:
            ...
            BOOST_STATIC_ASSERT ((pdalboost::is_same<typename M::const_iterator1::iterator_category, typename M::const_iterator2::iterator_category>::value ));
     ...
     * - \c pdalboost::numeric::ublas::indirect_array<A> where \c A can be \c int, \c size_t, \c long, etc...
     * - \c pdalboost::numeric::ublas::matrix<int> can work too (\c int can be replaced by another integer type)
     * - etc...
     *
