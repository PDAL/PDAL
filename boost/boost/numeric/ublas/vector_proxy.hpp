...
namespace pdalboost {} namespace boost = pdalboost; namespace pdalboost { namespace numeric { namespace ublas {
    ...
    public:
        ...
        typedef typename pdalboost::mpl::if_<pdalboost::is_const<V>,
     ...
     * - \c pdalboost::numeric::ublas::vector<int> can work too (\c int can be replaced by another integer type)
     * - etc...
     *
