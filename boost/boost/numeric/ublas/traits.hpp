...
namespace pdalboost {} namespace boost = pdalboost; namespace pdalboost { namespace numeric { namespace ublas {
    ...
    struct promote_traits {
      ...
      typename pdalboost::enable_if<
        mpl::and_<
          pdalboost::is_float<R>,
          pdalboost::is_integral<I>
          >,
    ...
    template<>
    struct type_traits<pdalboost::numeric::interval<float> > : scalar_traits<pdalboost::numeric::interval<float> > {
        typedef type_traits<pdalboost::numeric::interval<float> > self_type;
        typedef pdalboost::numeric::interval<float> value_type;
        typedef const value_type &const_reference;
        typedef value_type &reference;
        typedef value_type real_type;
        typedef pdalboost::numeric::interval<double> precision_type;

    };
    template<>
    struct type_traits<pdalboost::numeric::interval<double> > : scalar_traits<pdalboost::numeric::interval<double> > {
        typedef type_traits<pdalboost::numeric::interval<double> > self_type;
        typedef pdalboost::numeric::interval<double> value_type;
        typedef const value_type &const_reference;
        typedef value_type &reference;
        typedef value_type real_type;
        typedef pdalboost::numeric::interval<long double> precision_type;
    };
    template<>
    struct type_traits<pdalboost::numeric::interval<long double> > : scalar_traits<pdalboost::numeric::interval<long double> > {
        typedef type_traits<pdalboost::numeric::interval<long double> > self_type;
        typedef pdalboost::numeric::interval<long double> value_type;
        typedef const value_type &const_reference;
        typedef value_type &reference;
        typedef value_type real_type;
        typedef value_type precision_type;
    ...
    namespace detail {
        ...
        template<typename T>
        struct has_trivial_constructor : public pdalboost::has_trivial_constructor<T> {};

        template<typename T>
        struct has_trivial_destructor : public pdalboost::has_trivial_destructor<T> {};
