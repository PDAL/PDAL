...
namespace pdalboost {} namespace boost = pdalboost; namespace pdalboost { namespace numeric { 
	 ...
	 * \code namespace ublas = pdalboost::numeric::ublas; \endcode
	 *
	 * A common practice is to bring this namespace into the current scope with
	 * \code using namespace pdalboost::numeric::ublas; \endcode.
	 *
	 ...
	 * The solution is simply to prefix each ublas vector like \c pdalboost::numeric::ublas::vector<T>. If you think it's too long to 
	 * write, you can define a new namespace like \c namespace ublas = pdalboost::numeric::ublas and then just declare your vectors
	 * with \c ublas::vector<T>. STL vectors will be declared as vector<T>. No need to prefix with \c std::
	 */
	namespace ublas {

    namespace detail {
        using namespace pdalboost::numeric::ublas;
