...
namespace local_time {
  ...
  //typedef pdalboost::date_time::time_zone_names time_zone_names;
  typedef pdalboost::date_time::dst_adjustment_offsets<pdalboost::posix_time::time_duration> dst_adjustment_offsets;
  //typedef pdalboost::date_time::time_zone_base<pdalboost::posix_time::ptime> time_zone;
  typedef pdalboost::shared_ptr<dst_calc_rule> dst_calc_rule_ptr;
  ...
  public:
    ...
    custom_time_zone_base(const time_zone_names& zone_names,   
                     ...
                     pdalboost::shared_ptr<dst_calc_rule> calc_rule) :
