...
namespace local_time {
  ...
  typedef pdalboost::date_time::period<local_date_time, 
                                   pdalboost::posix_time::time_duration> local_time_period;
  ...
  typedef pdalboost::shared_ptr<time_zone> time_zone_ptr;
  typedef pdalboost::shared_ptr<wtime_zone> wtime_zone_ptr;
