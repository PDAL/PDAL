...
namespace local_time{
  ...
  typedef pdalboost::date_time::dst_adjustment_offsets<pdalboost::posix_time::time_duration> dst_adjustment_offsets;
   ...
   * A pdalboost::local_time::bad_offset exception will be thrown for:<br>
   ...
   * A pdalboost::local_time::bad_adjustment exception will be thrown for:<br>
  ...
  public:
    typedef pdalboost::posix_time::time_duration time_duration_type;
    ...
    virtual string_type to_posix_string() const
    {
      ...
      ss.fill('0');
      pdalboost::shared_ptr<dst_calc_rule> no_rules;
      // std
      ss << std_zone_abbrev();
      // offset
  ...
  private:
    ...
    pdalboost::shared_ptr<dst_calc_rule> dst_calc_rules_;
    ...
    void calc_zone(const string_type& obj){
      ...
      if(sit != obj_end){
        ...
        {
          pdalboost::throw_exception(bad_offset(posix_time::to_simple_string(base_utc_offset_)));
        }
      }
      ...
      if(sit != obj_end){
        ...
        {
          pdalboost::throw_exception(bad_adjustment(posix_time::to_simple_string(dst_offsets_.dst_adjust_)));
        }
      }
    ...
    void calc_rules(const string_type& start, const string_type& end){
      ...
      {
        pdalboost::throw_exception(bad_offset(posix_time::to_simple_string(dst_offsets_.dst_start_offset_)));
      }
      ...
      {
        pdalboost::throw_exception(bad_offset(posix_time::to_simple_string(dst_offsets_.dst_end_offset_)));
      }
    }
...
} } // namespace pdalboost::local_time
