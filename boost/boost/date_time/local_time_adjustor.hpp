...
#include <boost/date_time/time_defs.hpp> // pdalboost::date_time::dst_flags
  ...
  namespace date_time {
    ...
    public:
      ...
      static time_duration_type utc_to_local_offset(const time_type& t)
      {
        ...
        pdalboost::throw_exception(std::out_of_range("Unreachable case"));
                                                    ...
                                                    date_time::dst_flags dst=date_time::calculate) 
      {
        ...
        pdalboost::throw_exception(std::out_of_range("Time label invalid"));
        BOOST_DATE_TIME_UNREACHABLE_EXPRESSION(return time_duration_type(not_a_date_time)); // should never reach
      }
