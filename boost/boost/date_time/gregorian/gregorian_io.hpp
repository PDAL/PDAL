...
namespace gregorian {
  ...
  typedef pdalboost::date_time::period_formatter<wchar_t> wperiod_formatter;
  typedef pdalboost::date_time::period_formatter<char>    period_formatter;
  
  typedef pdalboost::date_time::date_facet<date,wchar_t> wdate_facet;
  typedef pdalboost::date_time::date_facet<date,char>    date_facet;

  typedef pdalboost::date_time::period_parser<date,char>       period_parser;
  typedef pdalboost::date_time::period_parser<date,wchar_t>    wperiod_parser;
    
  typedef pdalboost::date_time::special_values_formatter<char> special_values_formatter; 
  typedef pdalboost::date_time::special_values_formatter<wchar_t> wspecial_values_formatter; 
  
  typedef pdalboost::date_time::special_values_parser<date,char> special_values_parser; 
  typedef pdalboost::date_time::special_values_parser<date,wchar_t> wspecial_values_parser; 
  
  typedef pdalboost::date_time::date_input_facet<date,char>    date_input_facet;
  typedef pdalboost::date_time::date_input_facet<date,wchar_t> wdate_input_facet;

  template <class CharT, class TraitsT>
  inline std::basic_ostream<CharT, TraitsT>&
  operator<<(std::basic_ostream<CharT, TraitsT>& os, const pdalboost::gregorian::date& d) {
    pdalboost::io::ios_flags_saver iflags(os);
    typedef pdalboost::date_time::date_facet<date, CharT> custom_date_facet;
  ...
  {
    pdalboost::io::ios_flags_saver iflags(is);
  ...
  template <class CharT, class TraitsT>
  inline std::basic_ostream<CharT, TraitsT>&
  operator<<(std::basic_ostream<CharT, TraitsT>& os, const pdalboost::gregorian::date_duration& dd) {
    pdalboost::io::ios_flags_saver iflags(os);
    typedef pdalboost::date_time::date_facet<date, CharT> custom_date_facet;
    std::ostreambuf_iterator<CharT> output_itr(os);
    if (std::has_facet<custom_date_facet>(os.getloc()))
  ...
  template <class CharT, class TraitsT>
  inline std::basic_ostream<CharT, TraitsT>&
  operator<<(std::basic_ostream<CharT, TraitsT>& os, const pdalboost::gregorian::date_period& dp) {
    pdalboost::io::ios_flags_saver iflags(os);
    typedef pdalboost::date_time::date_facet<date, CharT> custom_date_facet;
    std::ostreambuf_iterator<CharT> output_itr(os);
    if (std::has_facet<custom_date_facet>(os.getloc()))
  ...
  template <class CharT, class TraitsT>
  inline std::basic_ostream<CharT, TraitsT>&
  operator<<(std::basic_ostream<CharT, TraitsT>& os, const pdalboost::gregorian::greg_month& gm) {
    pdalboost::io::ios_flags_saver iflags(os);
    typedef pdalboost::date_time::date_facet<date, CharT> custom_date_facet;
    std::ostreambuf_iterator<CharT> output_itr(os);
    if (std::has_facet<custom_date_facet>(os.getloc()))
  ...
  template <class CharT, class TraitsT>
  inline std::basic_ostream<CharT, TraitsT>&
  operator<<(std::basic_ostream<CharT, TraitsT>& os, const pdalboost::gregorian::greg_weekday& gw) {
    pdalboost::io::ios_flags_saver iflags(os);
    typedef pdalboost::date_time::date_facet<date, CharT> custom_date_facet;
    std::ostreambuf_iterator<CharT> output_itr(os);
    if (std::has_facet<custom_date_facet>(os.getloc()))
  ...
  template <class CharT, class TraitsT>
  inline std::basic_ostream<CharT, TraitsT>&
  operator<<(std::basic_ostream<CharT, TraitsT>& os, const pdalboost::gregorian::partial_date& pd) {
    pdalboost::io::ios_flags_saver iflags(os);
    typedef pdalboost::date_time::date_facet<date, CharT> custom_date_facet;
    std::ostreambuf_iterator<CharT> output_itr(os);
    if (std::has_facet<custom_date_facet>(os.getloc()))
  ...
  template <class CharT, class TraitsT>
  inline std::basic_ostream<CharT, TraitsT>&
  operator<<(std::basic_ostream<CharT, TraitsT>& os, const pdalboost::gregorian::nth_day_of_the_week_in_month& nkd) {
    pdalboost::io::ios_flags_saver iflags(os);
    typedef pdalboost::date_time::date_facet<date, CharT> custom_date_facet;
    std::ostreambuf_iterator<CharT> output_itr(os);
    if (std::has_facet<custom_date_facet>(os.getloc()))
  ...
  template <class CharT, class TraitsT>
  inline std::basic_ostream<CharT, TraitsT>&
  operator<<(std::basic_ostream<CharT, TraitsT>& os, const pdalboost::gregorian::first_day_of_the_week_in_month& fkd) {
    pdalboost::io::ios_flags_saver iflags(os);
    typedef pdalboost::date_time::date_facet<date, CharT> custom_date_facet;
    std::ostreambuf_iterator<CharT> output_itr(os);
    if (std::has_facet<custom_date_facet>(os.getloc()))
  ...
  template <class CharT, class TraitsT>
  inline std::basic_ostream<CharT, TraitsT>&
  operator<<(std::basic_ostream<CharT, TraitsT>& os, const pdalboost::gregorian::last_day_of_the_week_in_month& lkd) {
    pdalboost::io::ios_flags_saver iflags(os);
    typedef pdalboost::date_time::date_facet<date, CharT> custom_date_facet;
    std::ostreambuf_iterator<CharT> output_itr(os);
    if (std::has_facet<custom_date_facet>(os.getloc()))
  ...
  template <class CharT, class TraitsT>
  inline std::basic_ostream<CharT, TraitsT>&
  operator<<(std::basic_ostream<CharT, TraitsT>& os, const pdalboost::gregorian::first_day_of_the_week_after& fda) {
    pdalboost::io::ios_flags_saver iflags(os);
    typedef pdalboost::date_time::date_facet<date, CharT> custom_date_facet;
    std::ostreambuf_iterator<CharT> output_itr(os);
    if (std::has_facet<custom_date_facet>(os.getloc())) {
  ...
  template <class CharT, class TraitsT>
  inline std::basic_ostream<CharT, TraitsT>&
  operator<<(std::basic_ostream<CharT, TraitsT>& os, const pdalboost::gregorian::first_day_of_the_week_before& fdb) {
    pdalboost::io::ios_flags_saver iflags(os);
    typedef pdalboost::date_time::date_facet<date, CharT> custom_date_facet;
    std::ostreambuf_iterator<CharT> output_itr(os);
    if (std::has_facet<custom_date_facet>(os.getloc())) {
