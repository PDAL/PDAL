...
// NOTE: these macros define template functions in the pdalboost::serialization namespace.
// They must be expanded *outside* of any namespace
BOOST_SERIALIZATION_SPLIT_FREE(::pdalboost::gregorian::date_duration)
BOOST_SERIALIZATION_SPLIT_FREE(::pdalboost::gregorian::date_duration::duration_rep)
BOOST_SERIALIZATION_SPLIT_FREE(::pdalboost::gregorian::date_period)
BOOST_SERIALIZATION_SPLIT_FREE(::pdalboost::gregorian::greg_year)
BOOST_SERIALIZATION_SPLIT_FREE(::pdalboost::gregorian::greg_month)
BOOST_SERIALIZATION_SPLIT_FREE(::pdalboost::gregorian::greg_day)
BOOST_SERIALIZATION_SPLIT_FREE(::pdalboost::gregorian::greg_weekday)
BOOST_SERIALIZATION_SPLIT_FREE(::pdalboost::gregorian::partial_date)
BOOST_SERIALIZATION_SPLIT_FREE(::pdalboost::gregorian::nth_kday_of_month)
BOOST_SERIALIZATION_SPLIT_FREE(::pdalboost::gregorian::first_kday_of_month)
BOOST_SERIALIZATION_SPLIT_FREE(::pdalboost::gregorian::last_kday_of_month)
BOOST_SERIALIZATION_SPLIT_FREE(::pdalboost::gregorian::first_kday_before)
BOOST_SERIALIZATION_SPLIT_FREE(::pdalboost::gregorian::first_kday_after)
...
void save(Archive & ar, 
          const ::pdalboost::gregorian::date & d, 
          ...
          unsigned int /*version*/)
{
  ...
  ar & make_nvp("date", ds);
  try{
    d = ::pdalboost::gregorian::from_undelimited_string(ds);
