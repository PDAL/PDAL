...
class escape : 
    public pdalboost::iterator_adaptor<
        Derived, 
        Base, 
        BOOST_DEDUCED_TYPENAME pdalboost::iterator_value<Base>::type,
        single_pass_traversal_tag,
        BOOST_DEDUCED_TYPENAME pdalboost::iterator_value<Base>::type
    >
{
    typedef BOOST_DEDUCED_TYPENAME pdalboost::iterator_value<Base>::type base_value_type;
    typedef BOOST_DEDUCED_TYPENAME pdalboost::iterator_reference<Base>::type reference_type;
    friend class pdalboost::iterator_core_access;

    typedef BOOST_DEDUCED_TYPENAME pdalboost::iterator_adaptor<
        Derived, 
        Base, 
        base_value_type,
        single_pass_traversal_tag,
