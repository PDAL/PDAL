    ...
    basic_xml_oarchive<Archive>(flags)
{
    ...
    if(0 == (flags & no_codecvt)){
        pdalboost::archive::detail::utf8_codecvt_facet *pfacet;
        #if defined(__SGI_STL_PORT)
            static pdalboost::archive::detail::utf8_codecvt_facet 
                facet(static_cast<size_t>(1));
            pfacet = & facet;
        #else
            pfacet = new pdalboost::archive::detail::utf8_codecvt_facet;
        #endif
