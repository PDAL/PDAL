...
private:
    ...
    typedef BOOST_DEDUCED_TYPENAME pdalboost::spirit::classic::chset<CharType> chset_t;
    typedef BOOST_DEDUCED_TYPENAME pdalboost::spirit::classic::chlit<CharType> chlit_t;
    typedef BOOST_DEDUCED_TYPENAME pdalboost::spirit::classic::scanner<
        BOOST_DEDUCED_TYPENAME  std::basic_string<CharType>::iterator
    > scanner_t;
    typedef BOOST_DEDUCED_TYPENAME pdalboost::spirit::classic::rule<scanner_t> rule_t;
