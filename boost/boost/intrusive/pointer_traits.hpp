...
struct pointer_traits
{
      ...
      //
      typedef typename pdalboost::intrusive::detail::unvoid<element_type>::type&  reference;
      //
      template <class U> struct rebind_pointer
      {
         typedef typename pdalboost::intrusive::detail::type_rebinder<Ptr, U>::type  type;
      };

      #if !defined(BOOST_NO_TEMPLATE_ALIASES)
         template <class U> using rebind = typename pdalboost::intrusive::detail::type_rebinder<Ptr, U>::type;
      #endif
   ...
   static pointer pointer_to(reference r)
   {
      ...
      const bool value = pdalboost::intrusive::detail::
         has_member_function_callable_with_pointer_to
            <Ptr, typename pdalboost::intrusive::detail::unvoid<element_type &>::type>::value;
   ...
   //priv_pointer_to
   static pointer priv_pointer_to(pdalboost::true_type, typename pdalboost::intrusive::detail::unvoid<element_type>::type& r)
      { return Ptr::pointer_to(r); }

   static pointer priv_pointer_to(pdalboost::false_type, typename pdalboost::intrusive::detail::unvoid<element_type>::type& r)
      { return pointer(pdalboost::intrusive::detail::addressof(r)); }

   //priv_static_cast_from
   template<class UPtr>
   static pointer priv_static_cast_from(pdalboost::true_type, const UPtr &uptr)
   { return Ptr::static_cast_from(uptr); }

   template<class UPtr>
   static pointer priv_static_cast_from(pdalboost::false_type, const UPtr &uptr)
   {  return pointer_to(static_cast<element_type&>(*uptr));  }

   //priv_const_cast_from
   template<class UPtr>
   static pointer priv_const_cast_from(pdalboost::true_type, const UPtr &uptr)
   { return Ptr::const_cast_from(uptr); }

   template<class UPtr>
   static pointer priv_const_cast_from(pdalboost::false_type, const UPtr &uptr)
   {  return pointer_to(const_cast<element_type&>(*uptr));  }

   //priv_dynamic_cast_from
   template<class UPtr>
   static pointer priv_dynamic_cast_from(pdalboost::true_type, const UPtr &uptr)
   { return Ptr::dynamic_cast_from(uptr); }

   template<class UPtr>
   static pointer priv_dynamic_cast_from(pdalboost::false_type, const UPtr &uptr)
