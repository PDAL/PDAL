   ...
   , public ValueTraits
{
   ...
   typedef pdalboost::intrusive::detail::reverse_iterator<iterator>         reverse_iterator;
   typedef pdalboost::intrusive::detail::reverse_iterator<const_iterator>   const_reverse_iterator;
         ...
         >
{
   ...
   typedef BOOST_INTRUSIVE_IMPDEF(pdalboost::intrusive::detail::reverse_iterator<iterator>)         reverse_iterator;
   typedef BOOST_INTRUSIVE_IMPDEF(pdalboost::intrusive::detail::reverse_iterator<const_iterator>)   const_reverse_iterator;
   ...
   bstree_impl(BOOST_RV_REF(bstree_impl) x)
      : data_type(::pdalboost::move(x.comp()), ::pdalboost::move(x.val_traits()))
   {
      node_algorithms::init_header(this->header_ptr());
      this->sz_traits().set_size(size_type(0));
      this->swap(x);
   ...
   static bstree_impl &container_from_end_iterator(iterator end_iterator)
   {
      return *static_cast<bstree_impl*>
               (pdalboost::intrusive::detail::to_raw_pointer(end_iterator.pointed_node()));
   }
      ...
      >::type
{
   ...
   {  return static_cast<bstree &>(this->Base::operator=(::pdalboost::move(static_cast<Base&>(x))));  }
