...
#define BOOST_INTRUSIVE_INSTANTIATE_DEFAULT_TYPE_TMPLT(TNAME)              \
   ...
   {                                                                       \
      ...
      static char test(int, typename X::TNAME*);                           \
                                                                           \
      template <typename X>                                                \
      static int test(pdalboost::intrusive::detail::                           \
...
}}}   //namespace pdalboost::intrusive::detail

#include <boost/intrusive/detail/has_member_function_callable_with.hpp>

#define BOOST_INTRUSIVE_HAS_MEMBER_FUNCTION_CALLABLE_WITH_FUNCNAME pointer_to
#define BOOST_INTRUSIVE_HAS_MEMBER_FUNCTION_CALLABLE_WITH_NS_BEGIN namespace pdalboost {} namespace boost = pdalboost; namespace pdalboost { namespace intrusive { namespace detail {
...
struct type_has_rebind
{
   ...
   template <typename X>
   static int test(pdalboost::intrusive::detail::LowPriorityConversion<int>, void*);
