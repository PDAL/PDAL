...
inline typename pdalboost::intrusive::pointer_traits<Pointer>::element_type*
...
{
   typedef typename pdalboost::intrusive::pointer_traits<VoidPointer>::
...
struct constptr
{
   ...
   {  return pdalboost::intrusive::detail::to_raw_pointer(const_void_ptr_);  }
...
inline float fast_log2 (float val)
{
   union caster_t
   {
      pdalboost::uint32_t x;
      float val;
   } caster;

   caster.val = val;
   pdalboost::uint32_t x = caster.x;
   const int log_2 = int((x >> 23) & 255) - 128;
   x &= ~(pdalboost::uint32_t(255u) << 23u);
   x += pdalboost::uint32_t(127) << 23u;
   caster.x = x;
   val = caster.val;
...
{
   static const pdalboost::uint32_t value = 0xb504f334;
...
{
   static const pdalboost::uint64_t value = 0xb504f333f9de6484ull;
   ...
   static pointer to_value_ptr(const node_ptr & n)
   {
      return pointer_traits<pointer>::pointer_to
         (*detail::parent_from_member<T, node>
            (pdalboost::intrusive::detail::to_raw_pointer(n), P));
   }
...
struct mhtraits
{
   ...
   static pointer to_value_ptr(const node_ptr & n)
   {
      return pointer_traits<pointer>::pointer_to
         (*detail::parent_from_member<T, Hook>
            (static_cast<Hook*>(pdalboost::intrusive::detail::to_raw_pointer(n)), P));
   }
   ...
   static const_pointer to_value_ptr(const const_node_ptr & n)
   {
      return pointer_traits<const_pointer>::pointer_to
         (*detail::parent_from_member<T, Hook>
            (static_cast<const Hook*>(pdalboost::intrusive::detail::to_raw_pointer(n)), P));
   }
};
...
struct fhtraits
{
   ...
   static node_ptr to_node_ptr(reference value)
   {  return static_cast<node*>(pdalboost::intrusive::detail::to_raw_pointer(Functor::to_hook_ptr(value)));  }

   static const_node_ptr to_node_ptr(const_reference value)
   {  return static_cast<const node*>(pdalboost::intrusive::detail::to_raw_pointer(Functor::to_hook_ptr(value)));  }
...
struct iiterator
{
   ...
   typedef typename node_traits::node                          node;
   typedef typename node_traits::node_ptr                      node_ptr;
   typedef ::pdalboost::intrusive::pointer_traits<node_ptr>        nodepointer_traits_t;
...
{
   typedef ::pdalboost::intrusive::pointer_traits<NodePtr>   pointer_traits_t;
