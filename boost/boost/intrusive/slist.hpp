         ...
         >
{
   ...
   slist_impl(BOOST_RV_REF(slist_impl) x)
      : data_(::pdalboost::move(x.priv_value_traits()))
   {
      this->priv_size_traits().set_size(size_type(0));
      node_algorithms::init_header(this->get_root_node());
      this->swap(x);
   ...
   static slist_impl &priv_container_from_end_iterator(const const_iterator &end_iterator)
   {
      ...
      root_plus_size *r = detail::parent_from_member<root_plus_size, node>
         ( pdalboost::intrusive::detail::to_raw_pointer(end_iterator.pointed_node()), (&root_plus_size::root_));
      ...
      >::type
{
   ...
   {  return static_cast<slist &>(this->Base::operator=(::pdalboost::move(static_cast<Base&>(x))));  }
