...
struct make_instantiate_concept {
    ...
    typedef typename ::pdalboost::type_erasure::detail::make_instantiate_concept_impl<
        (::pdalboost::mpl::size<normalized>::value)
    >::type type;
};

#define BOOST_TYPE_ERASURE_INSTANTIATE(Concept, Map)            \
    (::pdalboost::type_erasure::detail::make_instantiate_concept<   \
        Concept                                                 \
...
#define BOOST_TYPE_ERASURE_INSTANTIATE1(Concept, P0, T0)        \
    ...
    >::type::apply(                                             \
        (Concept*)0,                                            \
        (::pdalboost::mpl::map1< ::pdalboost::mpl::pair<P0, T0> >*)0))
...
#define BOOST_TYPE_ERASURE_INSTANTIATE_IMPL(z, n, data)\
    (void)&::pdalboost::mpl::at_c<data, n>::type::apply;
...
struct BOOST_PP_CAT(instantiate_concept, N) {
    ...
    static void apply(Concept *, Map *) {
        ...
        typedef typename ::pdalboost::mpl::transform<
            normalized,
...
{
    typedef ::pdalboost::type_erasure::detail::BOOST_PP_CAT(instantiate_concept, N) type;
};
