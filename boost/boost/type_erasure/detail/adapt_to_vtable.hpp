...
struct replace_param_for_vtable
{
    typedef typename ::pdalboost::mpl::if_<
        ::pdalboost::type_erasure::is_placeholder<typename ::pdalboost::remove_cv<T>::type>,
...
struct is_internal_concept :
    ::pdalboost::type_erasure::detail::has_type<T>
{};

template<class PrimitiveConcept>
struct adapt_to_vtable
{
    typedef ::pdalboost::type_erasure::detail::vtable_adapter<
        PrimitiveConcept,
        typename ::pdalboost::type_erasure::detail::get_vtable_signature<
            typename ::pdalboost::type_erasure::detail::get_signature<
                PrimitiveConcept
            >::type
        >::type
    > type;
...
struct maybe_adapt_to_vtable
{
    typedef typename ::pdalboost::mpl::eval_if<
        ::pdalboost::type_erasure::detail::is_internal_concept<Concept>,
        ::pdalboost::mpl::identity<Concept>,
        ::pdalboost::type_erasure::detail::adapt_to_vtable<Concept>
    >::type type;
};
...
struct vtable_adapter_impl<PrimitiveConcept, R(T...), R2(U...)>
{
    ...
    static R value(T... arg)
    {
        return PrimitiveConcept::apply(
            ::pdalboost::type_erasure::detail::extract<U>(std::forward<T>(arg))...);
    }
};

template<class PrimitiveConcept, class... T, class R2, class... U>
struct vtable_adapter_impl<PrimitiveConcept, ::pdalboost::type_erasure::detail::storage&(T...), R2(U...)>
{
    typedef ::pdalboost::type_erasure::detail::storage (*type)(T...);
    static ::pdalboost::type_erasure::detail::storage value(T... arg)
    {
        ::pdalboost::type_erasure::detail::storage result;
        typename ::pdalboost::remove_reference<R2>::type* p =
            ::pdalboost::addressof(
                PrimitiveConcept::apply(::pdalboost::type_erasure::detail::extract<U>(std::forward<T>(arg))...));
...
struct vtable_adapter_impl<PrimitiveConcept, ::pdalboost::type_erasure::detail::storage&&(T...), R2(U...)>
{
    ...
    {
        ::pdalboost::type_erasure::detail::storage result;
        R2 tmp = PrimitiveConcept::apply(::pdalboost::type_erasure::detail::extract<U>(std::forward<T>(arg))...);
        typename ::pdalboost::remove_reference<R2>::type* p = ::pdalboost::addressof(tmp);
        result.data = const_cast<void*>(static_cast<const void*>(p));
        return result;
    }
};
...
{
    typedef typename ::pdalboost::type_erasure::detail::replace_result_for_vtable<
        R
    >::type type(typename ::pdalboost::type_erasure::detail::replace_param_for_vtable<T>::type...);
};
...
#define BOOST_TYPE_ERASURE_EXTRACT(z, n, data)                  \
    ::pdalboost::type_erasure::detail::extract<                     \
        typename traits::                                       \
...
#define BOOST_TYPE_ERASURE_REPLACE_PARAM(z, n, data)                    \
    typename ::pdalboost::type_erasure::detail::replace_param_for_vtable<   \
...
struct vtable_adapter<PrimitiveConcept, R(BOOST_PP_ENUM_PARAMS(N, T))>
{
    ...
    {
        typedef typename ::pdalboost::function_traits<
            typename ::pdalboost::type_erasure::detail::get_signature<
                PrimitiveConcept
            >::type
        > traits;
...
template<class PrimitiveConcept
    BOOST_PP_ENUM_TRAILING_PARAMS(N, class T)>
struct vtable_adapter<PrimitiveConcept, ::pdalboost::type_erasure::detail::storage&(BOOST_PP_ENUM_PARAMS(N, T))>
{
    typedef ::pdalboost::type_erasure::detail::storage (*type)(BOOST_PP_ENUM_PARAMS(N, T));
    static ::pdalboost::type_erasure::detail::storage value(BOOST_PP_ENUM_BINARY_PARAMS(N, T, arg))
    {
        typedef typename ::pdalboost::function_traits<
            typename ::pdalboost::type_erasure::detail::get_signature<
                PrimitiveConcept
        ...
        > traits;
        ::pdalboost::type_erasure::detail::storage result;
        typename ::pdalboost::remove_reference<typename traits::result_type>::type* p =
            ::pdalboost::addressof(
