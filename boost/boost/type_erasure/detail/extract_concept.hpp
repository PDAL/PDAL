...
struct maybe_extract_concept
{
    typedef typename ::pdalboost::mpl::eval_if<
        ::pdalboost::type_erasure::is_placeholder<
            ...
            >::type
        >,
        ::pdalboost::type_erasure::concept_of<typename ::pdalboost::remove_reference<U>::type>,
...
{
    typedef typename ::pdalboost::type_erasure::detail::combine_concepts<
        typename ::pdalboost::type_erasure::detail::maybe_extract_concept<
            T0, U0
        >::type,
