...
struct check_call : ::pdalboost::mpl::false_ {};
...
{
    typedef typename ::pdalboost::type_erasure::placeholder_of<T>::type placeholder;
    typedef typename ::pdalboost::remove_reference<placeholder>::type unref;
    typedef typename ::pdalboost::mpl::if_< ::pdalboost::is_const<T>,
        const unref,
        unref
    >::type add_const;
...
struct check_placeholder_arg_impl : ::pdalboost::mpl::false_ {};

template<class P>
struct check_placeholder_arg_impl<P, P&> : ::pdalboost::mpl::true_ {};

template<class P>
struct check_placeholder_arg_impl<P, const P&> : ::pdalboost::mpl::true_ {};
...
template<class P>
struct check_placeholder_arg_impl<const P&, P&> : ::pdalboost::mpl::true_ {};

template<class P>
struct check_placeholder_arg_impl<const P&, const P&> : ::pdalboost::mpl::true_ {};
...
struct check_placeholder_arg :
    check_placeholder_arg_impl<
        P,
        typename ::pdalboost::type_erasure::detail::qualified_placeholder<Arg>::type
    >::type
{};
    ...
    typedef typename ::pdalboost::mpl::eval_if<
        is_placeholder<
            typename ::pdalboost::remove_cv<
                typename ::pdalboost::remove_reference<FormalArg>::type
            >::type
        >,
        ::pdalboost::type_erasure::detail::check_placeholder_arg<FormalArg, ActualArg>,
#ifdef BOOST_TYPE_ERASURE_BROKEN_RVALUE_IS_CONVERTIBLE
        ::pdalboost::mpl::true_
#else
        ::pdalboost::is_convertible<ActualArg, FormalArg>
#endif
    >::type type;
};
...
#define BOOST_TYPE_ERASURE_CHECK_ARG(z, n, data)                \
    typedef typename ::pdalboost::type_erasure::detail::check_arg<  \
        BOOST_PP_CAT(T, n),                                     \
        BOOST_PP_CAT(U, n)                                      \
...
struct check_call<R(BOOST_PP_ENUM_PARAMS(N, T)), void(BOOST_PP_ENUM_BINARY_PARAMS(N, U, u))> {
    typedef ::pdalboost::mpl::true_ type0;
