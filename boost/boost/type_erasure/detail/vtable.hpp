...
struct make_arg_pack_impl
{
    typedef typename make_arg_pack_impl<
        typename ::pdalboost::mpl::next<It>::type,
        End,
        T...,
        typename ::pdalboost::mpl::deref<It>::type
    >::type type;
};
...
{
    typedef typename make_arg_pack_impl<
        typename ::pdalboost::mpl::begin<Seq>::type,
        typename ::pdalboost::mpl::end<Seq>::type
    >::type type;
};
...
struct make_vtable
{
    typedef typename ::pdalboost::type_erasure::detail::make_vtable_impl<
        typename ::pdalboost::type_erasure::detail::make_arg_pack<Seq>::type
    >::type type;
};
...
struct vtable_storage : vtable_entry<T>...
{
    ...
    void convert_from(const Src& src)
    {
        *this = vtable_storage(
            src.lookup(
                (typename ::pdalboost::type_erasure::detail::rebind_placeholders<
                T, Bindings
            >::type*)0)...);
    }
...
struct make_vtable
{
    typedef typename make_vtable_impl<
        (::pdalboost::mpl::size<Seq>::value)>::template apply<Seq>::type type;
};
...
{
    typedef typename make_vtable_init_impl<
        (::pdalboost::mpl::size<Seq>::value)>::template apply<Seq, Table>::type type;
};
...
#define BOOST_TYPE_ERASURE_AT(z, n, data)       \
    typename ::pdalboost::mpl::at_c<data, n>::type
...
struct make_vtable_impl<N>
{
    ...
    struct apply
    {
        typedef ::pdalboost::type_erasure::detail::BOOST_PP_CAT(vtable_storage, N)<
...
struct make_vtable_init_impl<N>
{
    ...
    struct apply
    {
        typedef ::pdalboost::type_erasure::detail::BOOST_PP_CAT(vtable_init, N)<
            Table
