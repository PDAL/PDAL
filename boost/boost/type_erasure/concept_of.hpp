...
#else
    typedef typename ::pdalboost::type_erasure::concept_of<
...
/** INTERNAL ONLY */
template<class Concept, class T>
struct concept_of< ::pdalboost::type_erasure::any<Concept, T> >
{
...
/** INTERNAL ONLY */
template<class Concept, class T>
struct concept_of< ::pdalboost::type_erasure::param<Concept, T> >
{
    typedef Concept type;
};
