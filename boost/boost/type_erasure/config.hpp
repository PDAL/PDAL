...
/** The maximum number of functions that an @ref pdalboost::type_erasure::any "any" can have. */
...
/** The maximum number of elements in a @ref pdalboost::type_erasure::tuple "tuple". */
