...
{
    return ::pdalboost::type_erasure::detail::access::table(arg).template find<
        ::pdalboost::type_erasure::typeid_<
...
{
    return binding_arg.template find< ::pdalboost::type_erasure::typeid_<T> >()();
}
