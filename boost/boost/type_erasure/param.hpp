...
struct placeholder_conversion : pdalboost::mpl::false_ {};
template<class T>
struct placeholder_conversion<T, T> : pdalboost::mpl::true_ {};
template<class T>
struct placeholder_conversion<T, T&> : pdalboost::mpl::true_ {};
template<class T>
struct placeholder_conversion<T, const T&> : pdalboost::mpl::true_ {};
template<class T>
struct placeholder_conversion<const T, T> : pdalboost::mpl::true_ {};
template<class T>
struct placeholder_conversion<const T, const T&> : pdalboost::mpl::true_ {};
template<class T>
struct placeholder_conversion<T&, T> : pdalboost::mpl::true_ {};
template<class T>
struct placeholder_conversion<T&, T&> : pdalboost::mpl::true_ {};
...
public:
    ...
    param(any<Concept, U>& a
        ...
        , typename pdalboost::enable_if<
            ::pdalboost::type_erasure::detail::placeholder_conversion<U, T>
        >::type* = 0
#endif
        )
      : _impl(a)
...
#ifndef BOOST_TYPE_ERASURE_DOXYGEN
        , typename pdalboost::enable_if<
            ::pdalboost::type_erasure::detail::placeholder_conversion<
                typename ::pdalboost::add_const<U>::type,
                T
            >
        >::type* = 0
#endif
...
public:
    ...
    param(const ::pdalboost::type_erasure::detail::storage& data,
          const ::pdalboost::type_erasure::binding<Concept>& table)
      : _impl(data, table)
    {}
    template<class U>
    param(U& u, typename pdalboost::enable_if< ::pdalboost::is_same<U, const any<Concept, T> > >::type* = 0) : _impl(u) {}
...
public:
    ...
    any<Concept, T&> get() const
    {
        return any<Concept, T&>(
            ::pdalboost::type_erasure::detail::access::data(this->_impl),
            ::pdalboost::type_erasure::detail::access::table(this->_impl));
    }
};
    ...
    typedef typename ::pdalboost::mpl::if_<
        ::pdalboost::type_erasure::is_placeholder<
            typename ::pdalboost::remove_cv<
                typename ::pdalboost::remove_reference<T>::type>::type>,
        param<typename ::pdalboost::type_erasure::concept_of<Any>::type, T>,
        T
    >::type type;
#endif
};
