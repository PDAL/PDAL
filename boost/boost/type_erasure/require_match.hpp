...
void require_match_impl(
    ...
    U&&... arg)
{
    if(!::pdalboost::type_erasure::check_match(table, op, std::forward<U>(arg)...)) {
        BOOST_THROW_EXCEPTION(::pdalboost::type_erasure::bad_function_call());
    }
}
...
void require_match_impl(
    ...
    const ::pdalboost::type_erasure::binding<Concept>&,
    const Op&,
    U&&...)
{}
...
void require_match_impl(
    ...
    U&&... arg)
{
    if(!::pdalboost::type_erasure::check_match(op, ::std::forward<U>(arg)...)) {
        BOOST_THROW_EXCEPTION(::pdalboost::type_erasure::bad_function_call());
    }
}
...
void require_match(
    ...
    U&&... arg)
{
    ::pdalboost::type_erasure::is_relaxed<Concept> cond;
    ::pdalboost::type_erasure::detail::require_match_impl(cond, table, op, ::std::forward<U>(arg)...);
}
    ...
    U&&... arg)
{
    ::pdalboost::type_erasure::is_relaxed<
        typename ::pdalboost::type_erasure::detail::extract_concept<
            ...
            U...>::type
    > cond;
    ::pdalboost::type_erasure::detail::require_match_impl(cond, op, ::std::forward<U>(arg)...);
}
...
{
    if(!::pdalboost::type_erasure::check_match
...
{
    ::pdalboost::type_erasure::is_relaxed<Concept> cond;
    ::pdalboost::type_erasure::detail::require_match_impl
