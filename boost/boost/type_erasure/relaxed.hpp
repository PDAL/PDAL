...
struct is_relaxed_impl :
    ::pdalboost::mpl::not_<
        typename ::pdalboost::is_same<
            typename ::pdalboost::mpl::find_if<
                T,
                ::pdalboost::type_erasure::is_relaxed< ::pdalboost::mpl::_1>
            >::type,
            typename ::pdalboost::mpl::end<T>::type
        >::type
    >::type
{};
 ...
 *   behavior.
 */
struct relaxed : ::pdalboost::mpl::vector0<> {};
...
struct is_relaxed :
    ::pdalboost::mpl::eval_if< ::pdalboost::mpl::is_sequence<Concept>,
        ::pdalboost::type_erasure::detail::is_relaxed_impl<Concept>,
...
/** INTERNAL ONLY */
template<>
struct is_relaxed< ::pdalboost::type_erasure::relaxed> :
    ::pdalboost::mpl::true_
{};
