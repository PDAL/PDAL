...
#else
    typedef typename ::pdalboost::type_erasure::placeholder_of<
...
/** INTERNAL ONLY */
template<class Concept, class T>
struct placeholder_of< ::pdalboost::type_erasure::any<Concept, T> >
{
    typedef T type;
};
...
/** INTERNAL ONLY */
template<class Concept, class T>
struct placeholder_of< ::pdalboost::type_erasure::param<Concept, T> >
{
    typedef T type;
};
