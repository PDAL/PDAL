...
struct compute_bases
{
    typedef typename ::pdalboost::mpl::fold<
        typename ::pdalboost::type_erasure::detail::collect_concepts<
            Concept
        >::type,
        ::pdalboost::type_erasure::any_base<Derived>,
        ::pdalboost::type_erasure::concept_interface<
            ::pdalboost::mpl::_2,
            ::pdalboost::mpl::_1,
            T
        >
...
template<class T>
fallback make_fallback(const T&, pdalboost::mpl::false_)
{
    return fallback();
}

template<class T>
const T& make_fallback(const T& arg, pdalboost::mpl::true_)
{
    return arg;
}

template<class T>
struct is_any : ::pdalboost::mpl::false_ {};

template<class Concept, class T>
struct is_any<any<Concept, T> > : ::pdalboost::mpl::true_ {};
...
class any :
    public ::pdalboost::type_erasure::detail::compute_bases<
        ::pdalboost::type_erasure::any<Concept, T>,
        Concept,
        T
    >::type
{
    typedef ::pdalboost::type_erasure::binding<Concept> table_type;
public:
    /** INTERNAL ONLY */
    typedef Concept _boost_type_erasure_concept_type;
    /** INTERNAL ONLY */
    any(const ::pdalboost::type_erasure::detail::storage& data_arg, const table_type& table_arg)
      : table(table_arg),
        data(data_arg)
    {}
#ifndef BOOST_NO_CXX11_RVALUE_REFERENCES
    /** INTERNAL ONLY */
    any(::pdalboost::type_erasure::detail::storage&& data_arg, const table_type& table_arg)
      : table(table_arg),
        data(data_arg)
    {}
#endif
    ...
    any()
    {
        BOOST_MPL_ASSERT((::pdalboost::type_erasure::is_relaxed<Concept>));
        data.data = 0;
    }
    ...
    any(const U& data_arg)
      : table((
            ...
            ::pdalboost::type_erasure::make_binding<
                ::pdalboost::mpl::map< ::pdalboost::mpl::pair<T, U> >
            >()
        )),
        data(data_arg)
    {}
    ...
    any(const U& data_arg, const static_binding<Map>& binding_arg)
      : table((
        ...
        data(data_arg)
    {
        BOOST_MPL_ASSERT((::pdalboost::is_same<
            typename ::pdalboost::mpl::at<Map, T>::type, U>));
    }
    ...
    any(U&& data_arg)
      : table((
            BOOST_TYPE_ERASURE_INSTANTIATE1(Concept, T, typename ::pdalboost::remove_cv<typename ::pdalboost::remove_reference<U>::type>::type),
            ::pdalboost::type_erasure::make_binding<
                ::pdalboost::mpl::map< ::pdalboost::mpl::pair<T, typename ::pdalboost::remove_cv<typename ::pdalboost::remove_reference<U>::type>::type> >
            >()
        )),
    ...
    {
        BOOST_MPL_ASSERT((::pdalboost::is_same<
            typename ::pdalboost::mpl::at<Map, T>::type, typename ::pdalboost::remove_cv<typename ::pdalboost::remove_reference<U>::type>::type>));
    }
    ...
    any(const any& other)
      : table(other.table),
        data(::pdalboost::type_erasure::call(constructible<T(const T&)>(), other))
    {}
    /**
    ...
    any(const any<Concept2, Tag2>& other)
      : table(
            ::pdalboost::type_erasure::detail::access::table(other),
            ::pdalboost::mpl::map<
                ::pdalboost::mpl::pair<
                    T,
                    typename ::pdalboost::remove_const<
                        typename ::pdalboost::remove_reference<Tag2>::type
                    >::type
                >
            >()
        ),
        data(::pdalboost::type_erasure::call(
            constructible<
                typename ::pdalboost::remove_const<
                    typename pdalboost::remove_reference<Tag2>::type
                >::type(const typename pdalboost::remove_reference<Tag2>::type&)
            >(), other)
        )
    {}
    /**
    ...
    any(const any<Concept2, Tag2>& other, const static_binding<Map>& binding_arg)
      : table(::pdalboost::type_erasure::detail::access::table(other), binding_arg),
        data(::pdalboost::type_erasure::call(
            constructible<
                typename ::pdalboost::remove_const<
                    typename pdalboost::remove_reference<Tag2>::type
    ...
    explicit any(const binding<Concept>& binding_arg, U&&... arg)
      : table(binding_arg),
        data(
            ::pdalboost::type_erasure::detail::make(
...
#ifndef BOOST_NO_CXX11_RVALUE_REFERENCES
    any(any&& other)
      : table(::pdalboost::type_erasure::detail::access::table(other)),
        data(::pdalboost::type_erasure::call(
            ::pdalboost::type_erasure::detail::make(
    ...
    explicit any(const binding<Concept>& binding_arg)
      : table(binding_arg),
        data(
            ::pdalboost::type_erasure::call(
                binding_arg,
                ::pdalboost::type_erasure::constructible<T()>()
            )
        )
    {}
    ...
    const table_type& _boost_type_erasure_extract_table(
        ::pdalboost::type_erasure::constructible<R(A...)>*,
        U&&... u)
    {
        return *::pdalboost::type_erasure::detail::extract_table(static_cast<void(*)(A...)>(0), u...);
    }
...
private:
    ...
    void _boost_type_erasure_resolve_assign(const Other& other)
    {
        _boost_type_erasure_assign_impl(
            ...
            false? this->_boost_type_erasure_deduce_assign(
                ::pdalboost::type_erasure::detail::make_fallback(
                    other,
                    ::pdalboost::mpl::bool_<
                        sizeof(
                            ::pdalboost::type_erasure::detail::check_overload(
                                ::pdalboost::declval<any&>().
                                    _boost_type_erasure_deduce_assign(other)
                            )
                        ) == sizeof(::pdalboost::type_erasure::detail::yes)
                    >()
                )
            ) : 0,
    ...
    {
        ::pdalboost::type_erasure::call(assignable<T, U>(), *this, other);
    }
    /** INTERNAL ONLY */
    template<class Other, class U>
    void _boost_type_erasure_assign_impl(
    ...
    void _boost_type_erasure_assign_impl(
        ...
        ::pdalboost::mpl::true_)
    {
        if(::pdalboost::type_erasure::check_match(assignable<T, U>(), *this, other))
        {
            ::pdalboost::type_erasure::unchecked_call(assignable<T, U>(), *this, other);
        }
        else
        {
            any temp(other);
    ...
    friend struct ::pdalboost::type_erasure::detail::access;
    // The table has to be initialized first for exception
    // safety in some constructors.
    table_type table;
    ::pdalboost::type_erasure::detail::storage data;
};
...
public:
    ...
    typedef Concept _boost_type_erasure_concept_type;
    /** INTERNAL ONLY */
    any(const ::pdalboost::type_erasure::detail::storage& data_arg,
    ...
    any(U& arg
        ...
        ,  typename ::pdalboost::disable_if<
            ::pdalboost::mpl::or_<
                ::pdalboost::is_const<U>,
                ::pdalboost::type_erasure::detail::is_any<U>
            >
        >::type* = 0
#endif
        )
    ...
    {
        data.data = ::pdalboost::addressof(arg);
    }
    /**
     * Constructs an @ref any from a reference.
     *
     ...
     */
    any(any<Concept, T>& other)
      : data(::pdalboost::type_erasure::detail::access::data(other)),
        table(::pdalboost::type_erasure::detail::access::table(other))
    {}
    /**
     * Constructs an @ref any from another reference.
    ...
    any(const any<Concept2, Tag2&>& other
        ...
        , typename ::pdalboost::disable_if<
            ::pdalboost::mpl::or_<
                ::pdalboost::is_same<Concept, Concept2>,
                ::pdalboost::is_const<Tag2>
            >
        >::type* = 0
#endif
        )
    ...
    any(any<Concept2, Tag2>& other
        ...
        , typename ::pdalboost::disable_if<
            ::pdalboost::mpl::or_<
                ::pdalboost::is_same<Concept, Concept2>,
                ::pdalboost::is_const<typename ::pdalboost::remove_reference<Tag2>::type>
            >
        >::type* = 0
#endif
        )
    ...
    any(const any<Concept2, Tag2&>& other, const static_binding<Map>& binding_arg
#ifndef BOOST_TYPE_ERASURE_DOXYGEN
        , typename ::pdalboost::disable_if< ::pdalboost::is_const<Tag2> >::type* = 0
#endif
        )
      : data(::pdalboost::type_erasure::detail::access::data(other)),
        table(::pdalboost::type_erasure::detail::access::table(other), binding_arg)
...
class any<Concept, const T&> :
    public ::pdalboost::type_erasure::detail::compute_bases<
        ::pdalboost::type_erasure::any<Concept, const T&>,
        Concept,
        T
    >::type
{
...
public:
    ...
    {
        data.data = const_cast<void*>(static_cast<const void*>(::pdalboost::addressof(arg)));
    }
    /**
     * Constructs an @ref any from a reference.
     *
    ...
    any(const any<Concept2, Tag2>& other
#ifndef BOOST_TYPE_ERASURE_DOXYGEN
        , typename ::pdalboost::disable_if< ::pdalboost::is_same<Concept, Concept2> >::type* = 0
#endif
        )
      : data(::pdalboost::type_erasure::detail::access::data(other)),
        table(
...
public:
    ...
    any(any<Concept, T>&& other)
      : data(::pdalboost::type_erasure::detail::access::data(other)),
        table(std::move(::pdalboost::type_erasure::detail::access::table(other)))
    {}
    /**
     * Constructs an @ref any from another rvalue reference.
     *
    ...
    any(any<Concept2, Tag2&&>&& other
      ...
      : data(::pdalboost::type_erasure::detail::access::data(other)),
        table(
            std::move(::pdalboost::type_erasure::detail::access::table(other)),
            ::pdalboost::mpl::map<
                ::pdalboost::mpl::pair<
                    T,
                    Tag2
    ...
    any(const any<Concept2, Tag2&&>& other, const static_binding<Map>& binding_arg
      ...
      : data(::pdalboost::type_erasure::detail::access::data(other)),
        table(std::move(::pdalboost::type_erasure::detail::access::table(other)), binding_arg)
    {}
    /**
     * Constructs an @ref any from another @ref any.
     *
