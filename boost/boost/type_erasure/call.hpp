...
struct is_placeholder_arg :
    ::pdalboost::type_erasure::is_placeholder<
        typename ::pdalboost::remove_cv<
...
int maybe_get_table(const T& arg, const Table*& table, pdalboost::mpl::true_)
{
    if(table == 0) {
        table = &::pdalboost::type_erasure::detail::access::table(arg);
    }
    return 0;
}

template<class T, class Table>
int maybe_get_table(const T&, const Table*&, pdalboost::mpl::false_) { return 0; }

template<class T>
::pdalboost::type_erasure::detail::storage& convert_arg(any_base<T>& arg, pdalboost::mpl::true_)
{
    return ::pdalboost::type_erasure::detail::access::data(arg);
}

template<class Concept, class T>
const ::pdalboost::type_erasure::detail::storage&
convert_arg(any_base<any<Concept, const T&> >& arg, pdalboost::mpl::true_)
{
    return ::pdalboost::type_erasure::detail::access::data(arg);
}
...
template<class T>
const ::pdalboost::type_erasure::detail::storage&
convert_arg(const any_base<T>& arg, pdalboost::mpl::true_)
{
    return ::pdalboost::type_erasure::detail::access::data(arg);
}

template<class Concept, class T>
::pdalboost::type_erasure::detail::storage&
convert_arg(const any_base<any<Concept, T&> >& arg, pdalboost::mpl::true_)
{
    return ::pdalboost::type_erasure::detail::access::data(arg);
}
...
template<class Concept, class T>
const ::pdalboost::type_erasure::detail::storage&
convert_arg(const any_base<any<Concept, const T&> >& arg, pdalboost::mpl::true_)
{
    return ::pdalboost::type_erasure::detail::access::data(arg);
}
...
template<class Concept, class T>
::pdalboost::type_erasure::detail::storage&
convert_arg(param<Concept, T>& arg, pdalboost::mpl::true_)
{
    return ::pdalboost::type_erasure::detail::access::data(arg);
}
...
template<class Concept, class T>
const ::pdalboost::type_erasure::detail::storage&
convert_arg(param<Concept, const T&>& arg, pdalboost::mpl::true_)
{
    return ::pdalboost::type_erasure::detail::access::data(arg);
}
...
template<class Concept, class T>
const ::pdalboost::type_erasure::detail::storage&
convert_arg(const param<Concept, T>& arg, pdalboost::mpl::true_)
{
    return ::pdalboost::type_erasure::detail::access::data(arg);
}
...
template<class Concept, class T>
::pdalboost::type_erasure::detail::storage&
convert_arg(any_base<any<Concept, T&> >&& arg, pdalboost::mpl::true_)
{
    return ::pdalboost::type_erasure::detail::access::data(arg);
}
...
convert_arg(any_base<any<Concept, T> >&& arg, pdalboost::mpl::true_)
{
    return ::pdalboost::type_erasure::detail::access::data(std::move(arg));
}
...
template<class T>
T&& convert_arg(T&& arg, pdalboost::mpl::false_) { return std::forward<T>(arg); }

#else

template<class T>
T& convert_arg(T& arg, pdalboost::mpl::false_) { return arg; }
...
typename ::pdalboost::type_erasure::detail::call_impl<Sig, U..., Concept>::type
...
typename ::pdalboost::type_erasure::detail::call_impl<Sig, U...>::type
...
template<class Sig, class Args, class Concept = void,
    bool Check = ::pdalboost::type_erasure::detail::check_call<Sig, Args>::type::value>
struct call_impl {};

template<class Op, class Args, class Concept = void>
struct call_result :
    call_impl<
        typename ::pdalboost::type_erasure::detail::get_signature<Op>::type,
        Args,
        Concept>
{};
...
struct call_result<
    ::pdalboost::type_erasure::binding<C1>,
    Args,
    Concept
>
{};
...
const ::pdalboost::type_erasure::binding<
    typename ::pdalboost::type_erasure::detail::extract_concept<void(T...), U...>::type>*
extract_table(R(*)(T...), const U&... arg)
{
    const ::pdalboost::type_erasure::binding<
        typename ::pdalboost::type_erasure::detail::extract_concept<
            void(T...), U...>::type>* result = 0;

    // the order that we run maybe_get_table in doesn't matter
    ignore(::pdalboost::type_erasure::detail::maybe_get_table(
        arg,
        result,
        ::pdalboost::type_erasure::detail::is_placeholder_arg<T>())...);
...
struct call_impl_dispatch<R(T...), void(U...), Concept, false>
{
    typedef R type;
    template<class F>
    static R apply(const ::pdalboost::type_erasure::binding<Concept>* table, U... arg)
    {
        return table->template find<F>()(
            ::pdalboost::type_erasure::detail::convert_arg(
                ::std::forward<U>(arg),
                ::pdalboost::type_erasure::detail::is_placeholder_arg<T>())...);
    }
};
...
{
    typedef ::pdalboost::type_erasure::any<Concept, R> type;
    template<class F>
    static type apply(const ::pdalboost::type_erasure::binding<Concept>* table, U... arg)
    {
        return type(table->template find<F>()(
            ::pdalboost::type_erasure::detail::convert_arg(
                ::std::forward<U>(arg),
                ::pdalboost::type_erasure::detail::is_placeholder_arg<T>())...), *table);
    }
};

template<class R, class... T, class... U, class Concept>
struct call_impl<R(T...), void(U...), Concept, true> :
    ::pdalboost::type_erasure::detail::call_impl_dispatch<
        R(T...),
        void(U...),
        Concept,
        ::pdalboost::type_erasure::detail::is_placeholder_arg<R>::value
    >
{
};
...
struct call_impl<R(T...), void(U...), void, true> :
    ::pdalboost::type_erasure::detail::call_impl_dispatch<
        ...
        typename ::pdalboost::type_erasure::detail::extract_concept<
            void(T...),
            typename ::pdalboost::remove_reference<U>::type...
        >::type,
        ::pdalboost::type_erasure::detail::is_placeholder_arg<R>::value
    >
{
...
template<
    ...
    class... U
>
typename ::pdalboost::type_erasure::detail::call_result<
    Op,
    void(U&&...),
    Concept
>::type
unchecked_call(
    const ::pdalboost::type_erasure::binding<Concept>& table,
    const Op&,
    U&&... arg)
{
    return ::pdalboost::type_erasure::detail::call_impl<
        typename ::pdalboost::type_erasure::detail::get_signature<Op>::type,
        void(U&&...),
        Concept
    >::template apply<
        typename ::pdalboost::type_erasure::detail::adapt_to_vtable<Op>::type
...
call(
    ...
    U&&... arg)
{
    ::pdalboost::type_erasure::require_match(table, f, std::forward<U>(arg)...);
    return ::pdalboost::type_erasure::unchecked_call(table, f, std::forward<U>(arg)...);
}
    ...
    U&&... arg)
{
    ...
    >::template apply<
        typename ::pdalboost::type_erasure::detail::adapt_to_vtable<Op>::type
    >(::pdalboost::type_erasure::detail::extract_table(
        static_cast<typename ::pdalboost::type_erasure::detail::get_signature<Op>::type*>(0), arg...),
        std::forward<U>(arg)...);
}
...
call(
    ...
    U&&... arg)
{
    ::pdalboost::type_erasure::require_match(f, std::forward<U>(arg)...);
    return ::pdalboost::type_erasure::unchecked_call(f, std::forward<U>(arg)...);
}
...
#define BOOST_TYPE_ERASURE_CONVERT_ARG(z, n, data)                      \
    ::pdalboost::type_erasure::detail::convert_arg(                         \
        ...
        ::pdalboost::type_erasure::detail::is_placeholder_arg<BOOST_PP_CAT(T, n)>())
...
#define BOOST_TYPE_ERASURE_GET_TABLE(z, n, data)                        \
    ::pdalboost::type_erasure::detail::maybe_get_table(                     \
        BOOST_PP_CAT(arg, n),                                           \
        result,                                                         \
        ::pdalboost::type_erasure::detail::is_placeholder_arg<BOOST_PP_CAT(T, n)>());
...
const ::pdalboost::type_erasure::binding<
    typename ::pdalboost::type_erasure::detail::BOOST_PP_CAT(extract_concept, N)<
...
#endif
    ,
    bool ReturnsAny = ::pdalboost::type_erasure::detail::is_placeholder_arg<R>::value>
...
>
{
    typedef R type;
    template<class F>
    static R apply(const ::pdalboost::type_erasure::binding<Concept>* table
...
>
{
    typedef ::pdalboost::type_erasure::any<Concept, R> type;
    template<class F>
    static type apply(const ::pdalboost::type_erasure::binding<Concept>* table
        BOOST_PP_ENUM_TRAILING_BINARY_PARAMS(N, U, arg))
    {
        return type(table->template find<F>()(
...
call(
    ...
    BOOST_PP_ENUM_TRAILING_BINARY_PARAMS(N, U, RREF arg))
{
    ::pdalboost::type_erasure::require_match(table, f BOOST_TYPE_ERASURE_FORWARD_ARGS(N, U, arg));
    return ::pdalboost::type_erasure::unchecked_call(table, f BOOST_TYPE_ERASURE_FORWARD_ARGS(N, U, arg));
}
    ...
    BOOST_PP_ENUM_TRAILING_BINARY_PARAMS(N, U, RREF arg))
{
    ...
    >::template apply<
        typename ::pdalboost::type_erasure::detail::adapt_to_vtable<Op>::type
    >(
        ::pdalboost::type_erasure::detail::BOOST_PP_CAT(extract_table, N)(
            (typename ::pdalboost::type_erasure::detail::get_signature<Op>::type*)0,
...
call(
    ...
    BOOST_PP_ENUM_TRAILING_BINARY_PARAMS(N, U, RREF arg))
{
    ::pdalboost::type_erasure::require_match(f BOOST_TYPE_ERASURE_FORWARD_ARGS(N, U, arg));
    return ::pdalboost::type_erasure::unchecked_call(f BOOST_TYPE_ERASURE_FORWARD_ARGS(N, U, arg));
}
