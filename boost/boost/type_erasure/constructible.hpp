...
struct concept_interface<
    ::pdalboost::type_erasure::constructible<Tag(T...)>,
    Base,
    Tag
> : Base
{
    ...
    _boost_type_erasure_deduce_constructor(
        typename ::pdalboost::type_erasure::as_param<Base, T>::type...)
    {
        return 0;
    }
};
...
#define BOOST_TYPE_ERASURE_ARG_DECL(z, n, data)     \
    typename ::pdalboost::type_erasure::as_param<          \
        Base,                                       \
        BOOST_PP_CAT(T, n)                          \
    >::type
...
struct concept_interface<
    ::pdalboost::type_erasure::constructible<Tag(BOOST_PP_ENUM_PARAMS(N, T))>,
    Base,
    Tag
> : Base
{
