...
namespace pdalboost {} namespace boost = pdalboost; namespace pdalboost { namespace polygon { namespace detail { namespace simplify_detail {
  ...
  {
    using namespace pdalboost::polygon;
