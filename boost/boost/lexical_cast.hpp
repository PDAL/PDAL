...
namespace pdalboost {} namespace boost = pdalboost; namespace pdalboost {
    ...
    namespace detail // is_char_or_wchar<...> and stream_char<...> templates
    {
        ...
        {
            typedef ::pdalboost::type_traits::ice_or<
        ...
        struct stream_char
        {
            typedef BOOST_DEDUCED_TYPENAME pdalboost::mpl::if_c<
                ...
                Type,
                pdalboost::detail::not_a_character_type
            >::type type;
        };
        ...
        template <class CharT, class Traits, class Alloc>
        struct stream_char< ::pdalboost::container::basic_string<CharT, Traits, Alloc> >
        {
            typedef CharT type;
        };

        template<typename CharT, std::size_t N>
        struct stream_char<pdalboost::array<CharT, N> >
        {
            typedef BOOST_DEDUCED_TYPENAME stream_char<CharT>::type type;
        };

        template<typename CharT, std::size_t N>
        struct stream_char<pdalboost::array<const CharT, N> >
        {
            typedef BOOST_DEDUCED_TYPENAME stream_char<CharT>::type type;
        };
        ...
        {
            typedef pdalboost::detail::not_a_character_type type;
        };
    ...
    namespace detail // deduce_char_traits template
    {
        ...
        template<class CharT, class Traits, class Alloc, class Source>
        struct deduce_char_traits< CharT
                                 , ::pdalboost::container::basic_string<CharT,Traits,Alloc>
                                 , Source
                                 >
        {
            typedef Traits type;
        ...
        template<class CharT, class Traits, class Alloc1, class Alloc2>
        struct deduce_char_traits< CharT
                                 , ::pdalboost::container::basic_string<CharT,Traits,Alloc1>
                                 , ::pdalboost::container::basic_string<CharT,Traits,Alloc2>
                                 >
        {
            typedef Traits type;
        };
...
/************************************ HELPER FUNCTIONS FOR OPERATORS << ( ... ) ********************************/
            ...
            bool shl_char(T ch)
            {
                BOOST_STATIC_ASSERT_MSG(( sizeof(T) <= sizeof(CharT)) ,
                    "pdalboost::lexical_cast does not support conversions from wide character to char types."
            ...
            {
                BOOST_STATIC_ASSERT_MSG(( sizeof(T) <= sizeof(CharT)),
                    "pdalboost::lexical_cast does not support conversions from wide characters to char types."
                    "Use pdalboost::locale instead" );
...
/************************************ OPERATORS << ( ... ) ********************************/
        public:
            ...
            template<class Alloc>
            bool operator<<(::pdalboost::container::basic_string<CharT,Traits,Alloc> const& str)
            {
                start = const_cast<CharT*>(str.data());
                finish = start + str.length();
                return true;
            ...
            bool operator<<(pdalboost::array<CharT, N> const& input)
            { return shl_char_array_limited(input.begin(), N); }

            template <std::size_t N>
            bool operator<<(pdalboost::array<unsigned char, N> const& input)   
            { return ((*this) << reinterpret_cast<pdalboost::array<char, N> const& >(input)); }

            template <std::size_t N>
            bool operator<<(pdalboost::array<signed char, N> const& input)   
            { return ((*this) << reinterpret_cast<pdalboost::array<char, N> const& >(input)); }

            template <std::size_t N>
            bool operator<<(pdalboost::array<const CharT, N> const& input)
            { return shl_char_array_limited(input.begin(), N); }

            template <std::size_t N>
            bool operator<<(pdalboost::array<const unsigned char, N> const& input)   
            { return ((*this) << reinterpret_cast<pdalboost::array<const char, N> const& >(input)); }

            template <std::size_t N>
            bool operator<<(pdalboost::array<const signed char, N> const& input)   
            { return ((*this) << reinterpret_cast<pdalboost::array<const char, N> const& >(input)); }
...
/************************************ OPERATORS >> ( ... ) ********************************/
            ...
            template<class Alloc>
            bool operator>>(::pdalboost::container::basic_string<CharT,Traits,Alloc>& str) { str.assign(start, finish); return true; }

            
    private:
            template <std::size_t N, class ArrayT>
            bool shr_std_array(ArrayT& output, pdalboost::mpl::bool_<true> /*is_T_char_tag*/) 
            {
                using namespace std;
            ...
            template <std::size_t N, class ArrayT>
            bool shr_std_array(ArrayT& output, pdalboost::mpl::bool_<false> /*is_T_char_tag*/) 
            {
    ...
    public:
            ...
            template <std::size_t N>
            bool operator>>(pdalboost::array<CharT, N>& output) 
            { 
                typedef pdalboost::mpl::bool_<true> tag_type;
                return shr_std_array<N>(output, tag_type()); 
            }

            template <std::size_t N>
            bool operator>>(pdalboost::array<unsigned char, N>& output)   
            { 
                return ((*this) >> reinterpret_cast<pdalboost::array<char, N>& >(output)); 
            }

            template <std::size_t N>
            bool operator>>(pdalboost::array<signed char, N>& output)   
            { 
                return ((*this) >> reinterpret_cast<pdalboost::array<char, N>& >(output)); 
            }
    ...
    namespace detail
    {
        ...
        {
            typedef ::pdalboost::type_traits::ice_and<
                ::pdalboost::is_float<Float>::value,
#if !defined(BOOST_LCAST_NO_WCHAR_T) && !defined(BOOST_NO_SWPRINTF) && !defined(__MINGW32__)
                ::pdalboost::type_traits::ice_or<
                    ::pdalboost::type_traits::ice_eq<sizeof(Char), sizeof(char) >::value,
                    ::pdalboost::is_same<Char, wchar_t>::value
                >::value
#else
                ::pdalboost::type_traits::ice_eq<sizeof(Char), sizeof(char) >::value
#endif
...
# pragma warning( disable : 4267 ) // conversion from 'size_t' to 'unsigned int'
        ...
        struct lexical_cast_do_cast
        {
            static inline Target lexical_cast_impl(const Source& arg)
            {
...
#if !defined(BOOST_NO_CHAR16_T) && defined(BOOST_NO_UNICODE_LITERALS)
                BOOST_STATIC_ASSERT_MSG(( !::pdalboost::is_same<char16_t, src_char_type>::value
                                          && !::pdalboost::is_same<char16_t, target_char_t>::value),
                    "Your compiler does not have full support for char16_t" );
#endif
#if !defined(BOOST_NO_CHAR32_T) && defined(BOOST_NO_UNICODE_LITERALS)
                BOOST_STATIC_ASSERT_MSG(( !::pdalboost::is_same<char32_t, src_char_type>::value
                                          && !::pdalboost::is_same<char32_t, target_char_t>::value),
                    "Your compiler does not have full support for char32_t" );
#endif

                typedef BOOST_DEDUCED_TYPENAME ::pdalboost::detail::deduce_char_traits<
                    char_type, Target, no_cv_src
                >::type traits;

                typedef ::pdalboost::type_traits::ice_and<
                    ::pdalboost::detail::is_char_or_wchar<src_char_type>::value,                    // source is lexical type
                    ::pdalboost::detail::is_char_or_wchar<target_char_t>::value,                    // target is a lexical type
                    ::pdalboost::is_same<char, src_char_type>::value,                               // source is not a wide character based type
                    ::pdalboost::type_traits::ice_ne<sizeof(char), sizeof(target_char_t) >::value   // target type is based on wide character
                >   is_string_widening_required_t;

                typedef ::pdalboost::type_traits::ice_or<
                    ::pdalboost::is_integral<no_cv_src>::value,
                    ::pdalboost::detail::is_this_float_conversion_optimized<no_cv_src, char_type >::value,
                    ::pdalboost::detail::is_char_or_wchar<src_char_type >::value
                ...
                const bool requires_stringbuf = ::pdalboost::type_traits::ice_or<
                        is_string_widening_required_t::value,
                        ::pdalboost::type_traits::ice_not< is_source_input_optimized_t::value >::value
                >::value;
...
# pragma warning( pop )
        ...
        {
          void operator() ( pdalboost::numeric::range_check_result r )
          {
            if (r != pdalboost::numeric::cInRange)
                BOOST_LCAST_THROW_BAD_CAST(Source, Target);
          }
        } ;
        ...
        struct lexical_cast_dynamic_num_not_ignoring_minus
        {
            static inline Target lexical_cast_impl(const Source &arg)
            {
                return pdalboost::numeric::converter<
                        Target,
                        Source,
    ...
    inline Target lexical_cast(const Source &arg)
    {
        ...
        typedef BOOST_DEDUCED_TYPENAME
                ::pdalboost::detail::is_arithmetic_and_not_xchars<Target, src > shall_we_copy_with_dynamic_check_t;

        typedef BOOST_DEDUCED_TYPENAME ::pdalboost::mpl::if_c<
            shall_we_copy_t::value,
            ::pdalboost::detail::lexical_cast_copy<src >,
            BOOST_DEDUCED_TYPENAME ::pdalboost::mpl::if_c<
                 shall_we_copy_with_dynamic_check_t::value,
                 ::pdalboost::detail::lexical_cast_dynamic_num<Target, src >,
                 ::pdalboost::detail::lexical_cast_do_cast<Target, src >
            >::type
        >::type caster_type;
