...
namespace pdalboost {} namespace boost = pdalboost; namespace pdalboost {
    ...
    namespace detail // stream_char_common<T>
    {
        ...
        struct stream_char_common: public pdalboost::mpl::if_c<
            pdalboost::detail::is_char_or_wchar< Type >::value,
            Type,
        ...
        struct stream_char_common< Char* >: public pdalboost::mpl::if_c<
            pdalboost::detail::is_char_or_wchar< Char >::value,
            Char,
    ...
    namespace detail // deduce_char_traits template
    {
        ...
        template < class Char, class Traits, class Alloc, class Source >
        struct deduce_char_traits< Char
                                 , pdalboost::container::basic_string< Char, Traits, Alloc >
                                 , Source
                                 >
        {
            typedef Traits type;
        ...
        template<class Char, class Traits, class Alloc1, class Alloc2>
        struct deduce_char_traits< Char
                                 , pdalboost::container::basic_string< Char, Traits, Alloc1 >
                                 , pdalboost::container::basic_string< Char, Traits, Alloc2 >
                                 >
        {
            typedef Traits type;
        };
...
#endif
#ifdef BOOST_LCAST_HAS_INT128
        BOOST_LCAST_DEF(pdalboost::int128_type)
        BOOST_LCAST_DEF(pdalboost::uint128_type)
#endif
        ...
        struct lexical_cast_stream_traits {
            ...
            typedef pdalboost::type_traits::ice_and<
                ...
                pdalboost::type_traits::ice_not<
                    pdalboost::detail::is_char_or_wchar<no_cv_src>::value                     // single character widening is optimized
                >::value                                                                  // and does not requires stringbuffer
            >   is_string_widening_required_t;

            typedef pdalboost::type_traits::ice_not< pdalboost::type_traits::ice_or<
                pdalboost::is_integral<no_cv_src>::value,
                pdalboost::detail::is_this_float_conversion_optimized<no_cv_src, char_type >::value,
                pdalboost::detail::is_char_or_wchar<
...
/************************************ OPERATORS << ( ... ) ********************************/
...
#ifdef BOOST_LCAST_HAS_INT128
        bool operator<<(const pdalboost::uint128_type& n)   { start = lcast_put_unsigned<Traits>(n, finish); return true; }
        bool operator<<(const pdalboost::int128_type& n)    { return shl_signed(n); }
            ...
            bool operator<<(pdalboost::array<CharT, N> const& input) BOOST_NOEXCEPT
            { return shl_char_array_limited(input.begin(), N); }

            template <std::size_t N>
            bool operator<<(pdalboost::array<unsigned char, N> const& input) BOOST_NOEXCEPT
            { return ((*this) << reinterpret_cast<pdalboost::array<char, N> const& >(input)); }

            template <std::size_t N>
            bool operator<<(pdalboost::array<signed char, N> const& input) BOOST_NOEXCEPT
            { return ((*this) << reinterpret_cast<pdalboost::array<char, N> const& >(input)); }
        ...
        struct lexical_cast_dynamic_num_ignoring_minus
        {
            static inline Target lexical_cast_impl(const Source &arg)
            {
                ...
                typedef pdalboost::numeric::converter<
                        Target,
                        usource_t,
                        pdalboost::numeric::conversion_traits<Target,usource_t>,
