...
#undef BGL_DO_ONE_BUNDLE_TYPE
  ...
  template <typename Tag, typename T, typename Base>
  struct lookup_one_property_internal<pdalboost::property<Tag, T, Base>, Tag> {
    BOOST_STATIC_CONSTANT(bool, found = true);
  ...
  struct lookup_one_property_internal<pdalboost::property<Tag, T, Base>, PropName>: lookup_one_property_internal<Base, PropName> {
    private:
    typedef lookup_one_property_internal<Base, PropName> base_type;
    public:
    template <typename PL>
    static typename lazy_enable_if<is_same<PL, pdalboost::property<Tag, T, Base> >,
                                   add_reference<typename base_type::type> >::type
  ...
  template <class P>
  struct has_property : pdalboost::mpl::true_ {};
  template <>
  struct has_property<no_property> : pdalboost::mpl::false_ {};
...
namespace detail {
  ...
  struct remove_first_property {
    template <typename F>
    struct result {
      typedef typename pdalboost::function_traits<F>::arg1_type a1;
      typedef typename pdalboost::remove_reference<a1>::type non_ref;
      typedef typename non_ref::next_type nx;
      typedef typename pdalboost::mpl::if_<pdalboost::is_const<non_ref>, pdalboost::add_const<nx>, nx>::type with_const;
      typedef typename pdalboost::add_reference<with_const>::type type;
    };
