...
//   test_spots(pdalboost::math::concepts::real_concept(0.));
...
public:
   ...
   real_concept(pdalboost::ulong_long_type c) : m_value(static_cast<real_concept_base_type>(c)){}
   real_concept(pdalboost::long_long_type c) : m_value(static_cast<real_concept_base_type>(c)){}
   ...
   real_concept& operator=(pdalboost::long_long_type c) { m_value = static_cast<real_concept_base_type>(c); return *this; }
   real_concept& operator=(pdalboost::ulong_long_type c) { m_value = static_cast<real_concept_base_type>(c); return *this; }
#endif
...
{ return pdalboost::math::iround(v.value(), pol); }
inline int iround(const concepts::real_concept& v)
{ return pdalboost::math::iround(v.value(), policies::policy<>()); }
template <class Policy>
inline long lround(const concepts::real_concept& v, const Policy& pol)
{ return pdalboost::math::lround(v.value(), pol); }
inline long lround(const concepts::real_concept& v)
{ return pdalboost::math::lround(v.value(), policies::policy<>()); }

#ifdef BOOST_HAS_LONG_LONG
template <class Policy>
inline pdalboost::long_long_type llround(const concepts::real_concept& v, const Policy& pol)
{ return pdalboost::math::llround(v.value(), pol); }
inline pdalboost::long_long_type llround(const concepts::real_concept& v)
{ return pdalboost::math::llround(v.value(), policies::policy<>()); }
#endif

template <class Policy>
inline int itrunc(const concepts::real_concept& v, const Policy& pol)
{ return pdalboost::math::itrunc(v.value(), pol); }
inline int itrunc(const concepts::real_concept& v)
{ return pdalboost::math::itrunc(v.value(), policies::policy<>()); }
template <class Policy>
inline long ltrunc(const concepts::real_concept& v, const Policy& pol)
{ return pdalboost::math::ltrunc(v.value(), pol); }
inline long ltrunc(const concepts::real_concept& v)
{ return pdalboost::math::ltrunc(v.value(), policies::policy<>()); }

#ifdef BOOST_HAS_LONG_LONG
template <class Policy>
inline pdalboost::long_long_type lltrunc(const concepts::real_concept& v, const Policy& pol)
{ return pdalboost::math::lltrunc(v.value(), pol); }
inline pdalboost::long_long_type lltrunc(const concepts::real_concept& v)
{ return pdalboost::math::lltrunc(v.value(), policies::policy<>()); }
#endif
