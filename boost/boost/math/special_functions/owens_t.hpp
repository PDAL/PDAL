...
namespace pdalboost {} namespace boost = pdalboost; namespace pdalboost
{
   namespace math
   {
      ...
      const unsigned short m = 20;
        ...
        inline RealType owens_t_T3(const RealType h, const RealType a, const RealType ah, const Policy&)
        {
         ...
         inline RealType owens_t_T5_imp(const RealType h, const RealType a, const mpl::int_<53>&)
         {
            ...
            const RealType as = a*a;
            const RealType hs = -h*h*pdalboost::math::constants::half<RealType>();
        ...
        inline RealType owens_t_T5(const RealType h, const RealType a, const Policy&)
        {
         ...
         std::pair<T, T> owens_t_T1_accelerated(T h, T a, const Policy& pol)
         {
            ...
            //
            BOOST_MATH_STD_USING
            static const char* function = "pdalboost::math::owens_t<%1%>(%1%, %1%)";
            T half_h_h = h * h / 2;
            T a_pow = a;
            T aa = a * a;
            ...
            return std::pair<T, T>((sum / d) / pdalboost::math::constants::two_pi<T>(), abs_err / sum);
         }
         ...
         inline std::pair<RealType, RealType> owens_t_T2_accelerated(const RealType h, const RealType a, const RealType ah, const Policy&)
         {
            ...
            RealType val = 0;
            RealType vi = a * exp( -ah*ah*half<RealType>() ) / root_two_pi<RealType>();
            RealType z = pdalboost::math::detail::owens_t_znorm1(ah)/h;
            RealType last_z = fabs(z);
         ...
         inline RealType T4_mp(const RealType h, const RealType a, const Policy& pol)
         {
            ...
            RealType lim = pdalboost::math::policies::get_epsilon<RealType, Policy>();
            ...
            while( true )
            {
               ...
               if(ii > (std::min)(1500, (int)policies::get_max_series_iterations<Policy>()))
                  policies::raise_evaluation_error("pdalboost::math::owens_t<%1%>", 0, val, pol);
            } // while( true )
         ...
         inline RealType owens_t_dispatch(const RealType h, const RealType a, const RealType ah, const Policy& pol, const mpl::int_<65>&)
         {
            ...
            typedef typename pdalboost::math::policies::normalise<Policy, pdalboost::math::policies::evaluation_error<> >::type forwarding_policy;
            ...
            if(ah < 3)
            {
               ...
               catch(const pdalboost::math::evaluation_error&){}  // T1 may fail and throw, that's OK
            }
            if(ah > 1)
            {
               try
               ...
               catch(const pdalboost::math::evaluation_error&){}  // T2 may fail and throw, that's OK
            }
            //
            ...
            catch(const pdalboost::math::evaluation_error&){}  // T4 may fail and throw, that's OK
            //
         ...
         struct owens_t_initializer
         {
            struct init
            {
               ...
               {
                  pdalboost::math::owens_t(static_cast<T>(7), static_cast<T>(0.96875), Policy());
                  pdalboost::math::owens_t(static_cast<T>(2), static_cast<T>(0.5), Policy());
               }
      ...
      inline typename tools::promote_args<T1, T2>::type owens_t(T1 h, T2 a, const Policy& pol)
      {
         ...
         return policies::checked_narrowing_cast<result_type, Policy>(detail::owens_t(static_cast<value_type>(h), static_cast<value_type>(a), pol), "pdalboost::math::owens_t<%1%>(%1%,%1%)");
      }
