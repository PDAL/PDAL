...
laguerre(unsigned n, T x, const Policy&, const mpl::true_&)
{
   ...
   return policies::checked_narrowing_cast<result_type, Policy>(detail::laguerre_imp(n, static_cast<value_type>(x)), "pdalboost::math::laguerre<%1%>(unsigned, %1%)");
}
...
{
   return pdalboost::math::laguerre(n, m, x, policies::policy<>());
}
...
T laguerre_imp(unsigned n, unsigned m, T x, const Policy& pol)
{
   // Special cases:
   if(m == 0)
      return pdalboost::math::laguerre(n, x, pol);
   ...
   laguerre(unsigned n, unsigned m, T x, const Policy& pol)
{
   typedef typename tools::promote_args<T>::type result_type;
   typedef typename policies::evaluation<result_type, Policy>::type value_type;
   return policies::checked_narrowing_cast<result_type, Policy>(detail::laguerre_imp(n, m, static_cast<value_type>(x), pol), "pdalboost::math::laguerre<%1%>(unsigned, unsigned, %1%)");
}
