...
{
   return policies::checked_narrowing_cast<float, policies::policy<> >(binomial_coefficient<double>(n, k, pol), "pdalboost::math::binomial_coefficient<%1%>(unsigned,unsigned)");
}
