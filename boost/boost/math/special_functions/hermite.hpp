   ...
   hermite(unsigned n, T x, const Policy&)
{
   ...
   return policies::checked_narrowing_cast<result_type, Policy>(detail::hermite_imp(n, static_cast<value_type>(x)), "pdalboost::math::hermite<%1%>(unsigned, %1%)");
}
...
{
   return pdalboost::math::hermite(n, x, policies::policy<>());
}
