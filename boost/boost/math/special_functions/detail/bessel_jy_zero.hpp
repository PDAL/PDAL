...
//
  ...
  namespace detail
  {
    namespace bessel_zero
    {
      ...
      public:
        ...
        pdalboost::math::tuple<T, T> operator()(const T& z) const
        {
          ...
          return pdalboost::math::tuple<T, T>(the_function, its_derivative);
        }
      ...
      static T equation_as_9_5_26(const T& v, const T& ai_bi_root)
      {
        ...
        const T v_pow_third(pdalboost::math::cbrt(v));
        ...
        const T b = -((((zeta * zeta_sqrt) * 2U) / 3U) + pdalboost::math::constants::half_pi<T>());
        ...
        pdalboost::uintmax_t iteration_count = pdalboost::uintmax_t(std::numeric_limits<T>::digits10 * 2);

        // Calculate the root of z as a function of zeta.
        const T z = pdalboost::math::tools::newton_raphson_iterate(
          pdalboost::math::detail::bessel_zero::equation_as_9_3_39_and_its_derivative<T>(zeta),
          z_estimate,
          range_zmin,
          range_zmax,
          digits2_for_root,
      ...
      namespace cyl_bessel_j_zero_detail
      {
        ...
        public:
          ...
          {
            return pdalboost::math::cyl_bessel_j(my_v, x, my_pol);
          }
        ...
        public:
          ...
          pdalboost::math::tuple<T, T> operator()(const T& x) const
          {
            ...
            if(my_order_is_zero)
            {
              j_v       =  pdalboost::math::cyl_bessel_j(0, x, my_pol);
              j_v_prime = -pdalboost::math::cyl_bessel_j(1, x, my_pol);
            }
            else
            {
                      j_v       = pdalboost::math::cyl_bessel_j(  my_v,      x, my_pol);
              const T j_v_m1     (pdalboost::math::cyl_bessel_j(T(my_v - 1), x, my_pol));
                      j_v_prime = j_v_m1 - ((my_v * j_v) / x);
            }

            // Return a tuple containing both Jv(x) and Jv'(x).
            return pdalboost::math::make_tuple(j_v, j_v_prime);
          }
        ...
        T initial_guess(const T& v, const int m, const Policy& pol)
        {
          ...
          if(v < 0)
          {
            ...
            T root_hi = pdalboost::math::detail::bessel_zero::cyl_bessel_j_zero_detail::initial_guess(vv_floor, m, pol);
            T root_lo;
            ...
            if(m == 1)
            {
              ...
              const bool hi_end_of_bracket_is_negative = (pdalboost::math::cyl_bessel_j(v, root_hi, pol) < 0);

              while((root_lo > pdalboost::math::tools::epsilon<T>()))
              {
                const bool lo_end_of_bracket_is_negative = (pdalboost::math::cyl_bessel_j(v, root_lo, pol) < 0);
            ...
            {
              root_lo = pdalboost::math::detail::bessel_zero::cyl_bessel_j_zero_detail::initial_guess(vv_floor, m - 1, pol);
            }

            // Perform several steps of bisection iteration to refine the guess.
            pdalboost::uintmax_t number_of_iterations(12U);

            // Do the bisection iteration.
            const pdalboost::math::tuple<T, T> guess_pair =
               pdalboost::math::tools::bisect(
                  pdalboost::math::detail::bessel_zero::cyl_bessel_j_zero_detail::function_object_jv<T, Policy>(v, pol),
                  root_lo,
                  root_hi,
                  pdalboost::math::detail::bessel_zero::cyl_bessel_j_zero_detail::my_bisection_unreachable_tolerance<T>,
                  number_of_iterations);

            return (pdalboost::math::get<0>(guess_pair) + pdalboost::math::get<1>(guess_pair)) / 2U;
          }
          ...
          if(m == 1U)
          {
            ...
            else
            {
              ...
              guess = pdalboost::math::detail::bessel_zero::cyl_bessel_j_zero_detail::equation_nist_10_21_40_a(v);
            }
          }
          else
          {
            if(v < 2.2F)
            {
              ...
              const T a(((v + T(m * 2U)) - T(0.5)) * pdalboost::math::constants::half_pi<T>());

              guess = pdalboost::math::detail::bessel_zero::equation_nist_10_21_19(v, a);
            }
            else
            {
              // Get an estimate of the m'th root of airy_ai.
              const T airy_ai_root(pdalboost::math::detail::airy_zero::airy_ai_zero_detail::initial_guess<T>(m));

              // Use Eq. 9.5.26 in the A&S Handbook.
              guess = pdalboost::math::detail::bessel_zero::equation_as_9_5_26(v, airy_ai_root);
            }
          }
      ...
      namespace cyl_neumann_zero_detail
      {
        ...
        public:
          ...
          T operator()(const T& x) const
          {
            return pdalboost::math::cyl_neumann(my_v, x, my_pol);
          }
        ...
        public:
          ...
          pdalboost::math::tuple<T, T> operator()(const T& x) const
          {
            const T half_epsilon(pdalboost::math::tools::epsilon<T>() / 2U);
            ...
            if(order_is_zero)
            {
              y_v       =  pdalboost::math::cyl_neumann(0, x, my_pol);
              y_v_prime = -pdalboost::math::cyl_neumann(1, x, my_pol);
            }
            else
            {
                      y_v       = pdalboost::math::cyl_neumann(  my_v,      x, my_pol);
              const T y_v_m1     (pdalboost::math::cyl_neumann(T(my_v - 1), x, my_pol));
                      y_v_prime = y_v_m1 - ((my_v * y_v) / x);
            }

            // Return a tuple containing both Yv(x) and Yv'(x).
            return pdalboost::math::make_tuple(y_v, y_v_prime);
          }
        ...
        T initial_guess(const T& v, const int m, const Policy& pol)
        {
          ...
          if(v < 0)
          {
            ...
            if(m == 1)
            {
              ...
              {
                root_hi = pdalboost::math::detail::bessel_zero::cyl_neumann_zero_detail::initial_guess(vv_floor, m, pol);
              }
              else
              {
                root_hi = pdalboost::math::detail::bessel_zero::cyl_bessel_j_zero_detail::initial_guess(T(vv_floor + 0.5F), m, pol);
              }

              root_lo = T(root_hi - 0.1F);

              const bool hi_end_of_bracket_is_negative = (pdalboost::math::cyl_neumann(v, root_hi, pol) < 0);

              while((root_lo > pdalboost::math::tools::epsilon<T>()))
              {
                const bool lo_end_of_bracket_is_negative = (pdalboost::math::cyl_neumann(v, root_lo, pol) < 0);
            ...
            else
            {
              if(T(vv - vv_floor) < 0.5F)
              {
                root_lo  = pdalboost::math::detail::bessel_zero::cyl_neumann_zero_detail::initial_guess(vv_floor, m - 1, pol);
                root_hi = pdalboost::math::detail::bessel_zero::cyl_neumann_zero_detail::initial_guess(vv_floor, m, pol);
                root_lo += 0.01F;
                root_hi += 0.01F;
              }
              ...
              {
                root_lo = pdalboost::math::detail::bessel_zero::cyl_bessel_j_zero_detail::initial_guess(T(vv_floor + 0.5F), m - 1, pol);
                root_hi = pdalboost::math::detail::bessel_zero::cyl_bessel_j_zero_detail::initial_guess(T(vv_floor + 0.5F), m, pol);
                root_lo += 0.01F;
                root_hi += 0.01F;
              }
            ...
            const pdalboost::math::tuple<T, T> guess_pair =
               pdalboost::math::tools::bisect(
                  pdalboost::math::detail::bessel_zero::cyl_neumann_zero_detail::function_object_yv<T, Policy>(v, pol),
                  root_lo,
                  root_hi,
                  pdalboost::math::detail::bessel_zero::cyl_neumann_zero_detail::my_bisection_unreachable_tolerance<T>,
                  number_of_iterations);
          ...
          if(m == 1U)
          {
            ...
            else
            {
              ...
              guess = pdalboost::math::detail::bessel_zero::cyl_neumann_zero_detail::equation_nist_10_21_40_b(v);
            }
          }
          else
          {
            ...
            {
              // Use Eq. 10.21.19 in the NIST Handbook.
              const T a(((v + T(m * 2U)) - T(1.5)) * pdalboost::math::constants::half_pi<T>());
            ...
            else
            {
              ...
              const T airy_bi_root(pdalboost::math::detail::airy_zero::airy_bi_zero_detail::initial_guess<T>(m));

              // Use Eq. 9.5.26 in the A&S Handbook.
              guess = pdalboost::math::detail::bessel_zero::equation_as_9_5_26(v, airy_bi_root);
            }
          }
  ...
  } } } // namespace pdalboost::math::detail
