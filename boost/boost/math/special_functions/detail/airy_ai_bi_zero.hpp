  ...
  namespace detail
  {
    ...
    namespace airy_zero
    {
      ...
      T equation_as_10_4_105(const T& z)
      {
        ...
        const T z_pow_third     (pdalboost::math::cbrt(z));
      ...
      namespace airy_ai_zero_detail
      {
        ...
        T initial_guess(const unsigned m)
        {
          ...
          switch(m)
          {
            ...
            default:
            {
              const T t(((pdalboost::math::constants::pi<T>() * 3U) * ((T(m) * 4U) - 1)) / 8U);
              guess = -pdalboost::math::detail::airy_zero::equation_as_10_4_105(t);
              break;
            }
          }
        ...
        public:
          ...
          pdalboost::math::tuple<T, T> operator()(const T& x) const
          {
            ...
            return pdalboost::math::make_tuple(
              pdalboost::math::detail::airy_ai_imp      (x, my_pol),
              pdalboost::math::detail::airy_ai_prime_imp(x, my_pol));
          }
      ...
      namespace airy_bi_zero_detail
      {
        ...
        T initial_guess(const unsigned m)
        {
          ...
          switch(m)
          {
            ...
            default:
            {
              const T t(((pdalboost::math::constants::pi<T>() * 3U) * ((T(m) * 4U) - 3)) / 8U);
              guess = -pdalboost::math::detail::airy_zero::equation_as_10_4_105(t);
              break;
            }
          }
        ...
        public:
          ...
          pdalboost::math::tuple<T, T> operator()(const T& x) const
          {
            ...
            return pdalboost::math::make_tuple(
              pdalboost::math::detail::airy_bi_imp      (x, my_pol),
              pdalboost::math::detail::airy_bi_prime_imp(x, my_pol));
          }
