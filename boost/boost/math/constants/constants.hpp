  ...
  namespace constants
  {
   ...
   public:
      typedef typename mpl::if_<
         mpl::and_<pdalboost::is_convertible<float, Real>, mpl::bool_< t1::value <= t2::value>, mpl::bool_<0 != t1::value> >,
         mpl::int_<construct_from_float>,
         typename mpl::if_<
            mpl::and_<pdalboost::is_convertible<double, Real>, mpl::bool_< t1::value <= t3::value>, mpl::bool_<0 != t1::value> >,
            mpl::int_<construct_from_double>,
            typename mpl::if_<
               mpl::and_<pdalboost::is_convertible<long double, Real>, mpl::bool_< t1::value <= t4::value>, mpl::bool_<0 != t1::value> >,
               mpl::int_<construct_from_long_double>,
#ifdef BOOST_MATH_USE_FLOAT128
               typename mpl::if_<
                  mpl::and_<pdalboost::is_convertible<__float128, Real>, mpl::bool_< t1::value <= t5::value>, mpl::bool_<0 != t1::value> >,
...
#define BOOST_MATH_CONSTANT_THREAD_HELPER(name, prefix) \
      pdalboost::once_flag f = BOOST_ONCE_INIT;\
      pdalboost::call_once(f, &BOOST_JOIN(BOOST_JOIN(string_, get_), name)<T>);
#else
#define BOOST_MATH_CONSTANT_THREAD_HELPER(name, prefix)
#endif
   ...
   namespace detail{
      ...
      template <class Real, class Policy = pdalboost::math::policies::policy<> >
...
#else
         return pdalboost::lexical_cast<Real>(p);
#endif
      }
      template <class Real>
...
#  define BOOST_MATH_FLOAT128_CONSTANT_OVERLOAD(x)
   ...
   {\
      static const T result = convert_from_string<T>(y, pdalboost::is_convertible<const char*, T>());\
      return result;\
   }\
   ...
   { return name<T, pdalboost::math::policies::policy<> >(); }\
   \
   \
