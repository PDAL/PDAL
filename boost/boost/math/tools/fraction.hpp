...
namespace detail
{
   ...
   template <class T>
   struct is_pair : public pdalboost::false_type{};

   template <class T, class U>
   struct is_pair<std::pair<T,U> > : public pdalboost::true_type{};
...
inline typename detail::fraction_traits<Gen>::result_type continued_fraction_b(Gen& g, const U& factor, pdalboost::uintmax_t& max_terms)
{
   ...
   pdalboost::uintmax_t counter(max_terms);
...
{
   pdalboost::uintmax_t max_terms = (std::numeric_limits<pdalboost::uintmax_t>::max)();
...
template <class Gen>
inline typename detail::fraction_traits<Gen>::result_type continued_fraction_b(Gen& g, int bits, pdalboost::uintmax_t& max_terms)
{
   BOOST_MATH_STD_USING // ADL of std names
...
//
template <class Gen, class U>
inline typename detail::fraction_traits<Gen>::result_type continued_fraction_a(Gen& g, const U& factor, pdalboost::uintmax_t& max_terms)
{
   BOOST_MATH_STD_USING // ADL of std names
...
{
   pdalboost::uintmax_t max_iter = (std::numeric_limits<pdalboost::uintmax_t>::max)();
...
template <class Gen>
inline typename detail::fraction_traits<Gen>::result_type continued_fraction_a(Gen& g, int bits, pdalboost::uintmax_t& max_terms)
{
   BOOST_MATH_STD_USING // ADL of std names
