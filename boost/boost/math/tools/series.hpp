...
inline typename Functor::result_type sum_series(Functor& func, const U& factor, pdalboost::uintmax_t& max_terms, const V& init_value)
{
...
inline typename Functor::result_type sum_series(Functor& func, const U& factor, pdalboost::uintmax_t& max_terms)
{
...
template <class Functor, class U>
inline typename Functor::result_type sum_series(Functor& func, int bits, pdalboost::uintmax_t& max_terms, const U& init_value)
{
   BOOST_MATH_STD_USING
   typedef typename Functor::result_type result_type;
...
inline typename Functor::result_type sum_series(Functor& func, int bits)
{
   BOOST_MATH_STD_USING
   typedef typename Functor::result_type result_type;
   pdalboost::uintmax_t iters = (std::numeric_limits<pdalboost::uintmax_t>::max)();
   result_type init_val = 0;
   return sum_series(func, bits, iters, init_val);
}

template <class Functor>
inline typename Functor::result_type sum_series(Functor& func, int bits, pdalboost::uintmax_t& max_terms)
{
   BOOST_MATH_STD_USING
   typedef typename Functor::result_type result_type;
   result_type init_val = 0;
...
template <class Functor>
inline typename Functor::result_type kahan_sum_series(Functor& func, int bits, pdalboost::uintmax_t& max_terms)
{
   BOOST_MATH_STD_USING
