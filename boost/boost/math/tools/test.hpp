...
{
private:
   pdalboost::math::tools::stats<T> stat;   // Statistics for the test.
...
public:
   ...
   pdalboost::uintmax_t count()const{ return stat.count(); }
...
//
// Function test accepts an matrix of input values (probably a 2D pdalboost::array)
...
#endif
      if(!(pdalboost::math::isfinite)(point) && (pdalboost::math::isfinite)(expected))
      {
