...
template <std::size_t N, class T, class V>
inline V evaluate_polynomial(const pdalboost::array<T,N>& a, const V& val)
{
   typedef mpl::int_<N> tag_type;
...
template <std::size_t N, class T, class V>
inline V evaluate_even_polynomial(const pdalboost::array<T,N>& a, const V& z)
{
   return evaluate_polynomial(a, V(z*z));
}
//
...
template <std::size_t N, class T, class V>
inline V evaluate_odd_polynomial(const pdalboost::array<T,N>& a, const V& z)
{
   typedef mpl::int_<N-1> tag_type;
...
{
   return pdalboost::math::tools::evaluate_rational(num, denom, z, Tag::value);
}
...
template <std::size_t N, class T, class U, class V>
inline V evaluate_rational(const pdalboost::array<T,N>& a, const pdalboost::array<U,N>& b, const V& z)
{
