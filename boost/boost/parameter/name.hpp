...
#  define BOOST_PARAMETER_NAME_OBJECT(tag, name)                    \
    static ::pdalboost::parameter::keyword<tag> const& name             \
       = ::pdalboost::parameter::keyword<tag>::instance;
# else
#  define BOOST_PARAMETER_NAME_OBJECT(tag, name)                    \
    namespace                                                       \
    {                                                               \
       ::pdalboost::parameter::keyword<tag> const& name                 \
       = ::pdalboost::parameter::keyword<tag>::instance;                \
    }
# endif
      ...
      {                                                             \
          ...
          {                                                         \
              return BOOST_PP_STRINGIZE(tag);                       \
                                                                    ...
                                                                    \
          typedef pdalboost::parameter::value_type<                     \
              pdalboost::mpl::_2, tag, pdalboost::parameter::void_          \
          > _;                                                      \
                                                                    \
          typedef pdalboost::parameter::value_type<                     \
              pdalboost::mpl::_2, tag, pdalboost::parameter::void_          \
...
# define BOOST_PARAMETER_TEMPLATE_KEYWORD(name)                     \
    ...
    template <class T>                                              \
    struct name                                                     \
      : pdalboost::parameter::template_keyword<tag::name, T>            \
    {};                                                             \
/**/
