...
//
#ifndef BOOST_TEST_TR1_REGEX
namespace global_regex_namespace = ::pdalboost;
#else
...
struct BaseRegexConcept
{
   ...
   void global_constraints()
   {
      ...
      BOOST_STATIC_ASSERT((::pdalboost::is_enum<global_regex_namespace::regex_constants::error_type>::value));
      ...
      BOOST_STATIC_ASSERT((::pdalboost::is_base_and_derived<std::runtime_error, global_regex_namespace::regex_error>::value  ));
   ...
   void constraints() 
   {
      ...
      BOOST_STATIC_ASSERT((::pdalboost::is_same< flag_type, global_regex_namespace::regex_constants::syntax_option_type>::value));
      flag_type opts
         = Regex::icase
         | Regex::nosubs
         | Regex::optimize
      ...
      // sub_match:
      BOOST_STATIC_ASSERT((::pdalboost::is_base_and_derived<std::pair<BidiIterator, BidiIterator>, sub_match_type>::value));
      ...
      BOOST_STATIC_ASSERT((::pdalboost::is_same<sub_value_type, value_type>::value));
      BOOST_STATIC_ASSERT((::pdalboost::is_same<sub_iter_type, BidiIterator>::value));
      ...
      BOOST_STATIC_ASSERT((::pdalboost::is_same<rit_regex_type, Regex>::value));
      BOOST_STATIC_ASSERT((::pdalboost::is_same<rit_value_type, match_results_default_type>::value));
      BOOST_STATIC_ASSERT((::pdalboost::is_same<rit_difference_type, std::ptrdiff_t>::value));
      BOOST_STATIC_ASSERT((::pdalboost::is_same<rit_pointer, const match_results_default_type*>::value));
      BOOST_STATIC_ASSERT((::pdalboost::is_same<rit_reference, const match_results_default_type&>::value));
      BOOST_STATIC_ASSERT((::pdalboost::is_convertible<rit_iterator_category*, std::forward_iterator_tag*>::value));
      ...
      BOOST_STATIC_ASSERT((::pdalboost::is_same<rtit_regex_type, Regex>::value));
      BOOST_STATIC_ASSERT((::pdalboost::is_same<rtit_value_type, sub_match_type>::value));
      BOOST_STATIC_ASSERT((::pdalboost::is_same<rtit_difference_type, std::ptrdiff_t>::value));
      BOOST_STATIC_ASSERT((::pdalboost::is_same<rtit_pointer, const sub_match_type*>::value));
      BOOST_STATIC_ASSERT((::pdalboost::is_same<rtit_reference, const sub_match_type&>::value));
      BOOST_STATIC_ASSERT((::pdalboost::is_convertible<rtit_iterator_category*, std::forward_iterator_tag*>::value));
      // this takes care of most of the checks needed:
...
struct RegexConcept
{
   ...
   typedef pdalboost::bidirectional_iterator_archetype<value_type> BidiIterator;
   typedef global_regex_namespace::sub_match<BidiIterator> sub_match_type;
   typedef global_regex_namespace::match_results<BidiIterator, allocator_architype<sub_match_type> > match_results_type;
   typedef output_iterator_archetype<value_type> OutIterator;
...
struct BoostRegexConcept
{
   ...
   void constraints() 
   {
      ...
      out = regex_format(out, m_cresults, pdalboost::ref(func3b), f);
      out = regex_format(out, m_cresults, pdalboost::ref(func3b));
      out = regex_format(out, m_cresults, pdalboost::ref(func2b), f);
      out = regex_format(out, m_cresults, pdalboost::ref(func2b));
      out = regex_format(out, m_cresults, pdalboost::ref(func1b), f);
      out = regex_format(out, m_cresults, pdalboost::ref(func1b));
      out = regex_format(out, m_cresults, pdalboost::cref(func3b), f);
      out = regex_format(out, m_cresults, pdalboost::cref(func3b));
      out = regex_format(out, m_cresults, pdalboost::cref(func2b), f);
      out = regex_format(out, m_cresults, pdalboost::cref(func2b));
      out = regex_format(out, m_cresults, pdalboost::cref(func1b), f);
      out = regex_format(out, m_cresults, pdalboost::cref(func1b));
      ...
      m_string += regex_format(m_cresults, pdalboost::ref(func3b), f);
      m_string += regex_format(m_cresults, pdalboost::ref(func3b));
      m_string += regex_format(m_cresults, pdalboost::ref(func2b), f);
      m_string += regex_format(m_cresults, pdalboost::ref(func2b));
      m_string += regex_format(m_cresults, pdalboost::ref(func1b), f);
      m_string += regex_format(m_cresults, pdalboost::ref(func1b));
      m_string += regex_format(m_cresults, pdalboost::cref(func3b), f);
      m_string += regex_format(m_cresults, pdalboost::cref(func3b));
      m_string += regex_format(m_cresults, pdalboost::cref(func2b), f);
      m_string += regex_format(m_cresults, pdalboost::cref(func2b));
      m_string += regex_format(m_cresults, pdalboost::cref(func1b), f);
      m_string += regex_format(m_cresults, pdalboost::cref(func1b));
      ...
      out = m_cresults.format(out, pdalboost::ref(func3b), f);
      out = m_cresults.format(out, pdalboost::ref(func3b));
      out = m_cresults.format(out, pdalboost::ref(func2b), f);
      out = m_cresults.format(out, pdalboost::ref(func2b));
      out = m_cresults.format(out, pdalboost::ref(func1b), f);
      out = m_cresults.format(out, pdalboost::ref(func1b));
      out = m_cresults.format(out, pdalboost::cref(func3b), f);
      out = m_cresults.format(out, pdalboost::cref(func3b));
      out = m_cresults.format(out, pdalboost::cref(func2b), f);
      out = m_cresults.format(out, pdalboost::cref(func2b));
      out = m_cresults.format(out, pdalboost::cref(func1b), f);
      out = m_cresults.format(out, pdalboost::cref(func1b));
      ...
      m_string += m_cresults.format(pdalboost::ref(func3b), f);
      m_string += m_cresults.format(pdalboost::ref(func3b));
      m_string += m_cresults.format(pdalboost::ref(func2b), f);
      m_string += m_cresults.format(pdalboost::ref(func2b));
      m_string += m_cresults.format(pdalboost::ref(func1b), f);
      m_string += m_cresults.format(pdalboost::ref(func1b));
      m_string += m_cresults.format(pdalboost::cref(func3b), f);
      m_string += m_cresults.format(pdalboost::cref(func3b));
      m_string += m_cresults.format(pdalboost::cref(func2b), f);
      m_string += m_cresults.format(pdalboost::cref(func2b));
      m_string += m_cresults.format(pdalboost::cref(func1b), f);
      m_string += m_cresults.format(pdalboost::cref(func1b));
      ...
      out = regex_replace(out, m_in, m_in, ce, pdalboost::ref(func3), f);
      out = regex_replace(out, m_in, m_in, ce, pdalboost::ref(func3));
      out = regex_replace(out, m_in, m_in, ce, pdalboost::ref(func2), f);
      out = regex_replace(out, m_in, m_in, ce, pdalboost::ref(func2));
      out = regex_replace(out, m_in, m_in, ce, pdalboost::ref(func1), f);
      out = regex_replace(out, m_in, m_in, ce, pdalboost::ref(func1));
      out = regex_replace(out, m_in, m_in, ce, pdalboost::cref(func3), f);
      out = regex_replace(out, m_in, m_in, ce, pdalboost::cref(func3));
      out = regex_replace(out, m_in, m_in, ce, pdalboost::cref(func2), f);
      out = regex_replace(out, m_in, m_in, ce, pdalboost::cref(func2));
      out = regex_replace(out, m_in, m_in, ce, pdalboost::cref(func1), f);
      out = regex_replace(out, m_in, m_in, ce, pdalboost::cref(func1));
      ...
      m_string += regex_replace(m_string, ce, pdalboost::ref(func3s), f);
      m_string += regex_replace(m_string, ce, pdalboost::ref(func3s));
      m_string += regex_replace(m_string, ce, pdalboost::ref(func2s), f);
      m_string += regex_replace(m_string, ce, pdalboost::ref(func2s));
      m_string += regex_replace(m_string, ce, pdalboost::ref(func1s), f);
      m_string += regex_replace(m_string, ce, pdalboost::ref(func1s));
      m_string += regex_replace(m_string, ce, pdalboost::cref(func3s), f);
      m_string += regex_replace(m_string, ce, pdalboost::cref(func3s));
      m_string += regex_replace(m_string, ce, pdalboost::cref(func2s), f);
      m_string += regex_replace(m_string, ce, pdalboost::cref(func2s));
      m_string += regex_replace(m_string, ce, pdalboost::cref(func1s), f);
      m_string += regex_replace(m_string, ce, pdalboost::cref(func1s));
   }
