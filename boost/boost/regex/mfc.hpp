...
make_regex(const ATL::CSimpleStringT<SIMPLE_STRING_ARG_LIST>& s, ::pdalboost::regex_constants::syntax_option_type f = pdalboost::regex_constants::normal)
{
...
inline bool regex_match(const ATL::CSimpleStringT<SIMPLE_STRING_ARG_LIST>& s,
                 ...
                 pdalboost::regex_constants::match_flag_type f = pdalboost::regex_constants::match_default)
{
   return ::pdalboost::regex_match(s.GetString(),
...
inline bool regex_search(const ATL::CSimpleStringT<SIMPLE_STRING_ARG_LIST>& s,
                 ...
                 pdalboost::regex_constants::match_flag_type f = pdalboost::regex_constants::match_default)
{
   return ::pdalboost::regex_search(s.GetString(),
                               s.GetString() + s.GetLength(),
                               what,
                               e,
                               f);
...
make_regex_iterator(const ATL::CSimpleStringT<SIMPLE_STRING_ARG_LIST>& s, const basic_regex<B>& e, ::pdalboost::regex_constants::match_flag_type f = pdalboost::regex_constants::match_default)
{
...
inline regex_token_iterator<B const*> 
   make_regex_token_iterator(const ATL::CSimpleStringT<SIMPLE_STRING_ARG_LIST>& s, const basic_regex<B>& e, int sub = 0, ::pdalboost::regex_constants::match_flag_type f = pdalboost::regex_constants::match_default)
{
...
template <SIMPLE_STRING_PARAM>
inline regex_token_iterator<B const*> 
make_regex_token_iterator(const ATL::CSimpleStringT<SIMPLE_STRING_ARG_LIST>& s, const basic_regex<B>& e, const std::vector<int>& subs, ::pdalboost::regex_constants::match_flag_type f = pdalboost::regex_constants::match_default)
{
...
inline regex_token_iterator<B const*> 
make_regex_token_iterator(const ATL::CSimpleStringT<SIMPLE_STRING_ARG_LIST>& s, const basic_regex<B>& e, const int (& subs)[N], ::pdalboost::regex_constants::match_flag_type f = pdalboost::regex_constants::match_default)
{
   regex_token_iterator<B const*> result(s.GetString(), s.GetString() + s.GetLength(), e, subs, f);
   return result;
}
...
{
   return ::pdalboost::regex_replace(out, first, last, e, fmt.GetString(), flags);
}
