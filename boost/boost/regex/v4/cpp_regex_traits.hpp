...
void cpp_regex_traits_implementation<charT>::init()
{
   ...
   if((int)cat >= 0)
   {
      ...
      static const char_class_type masks[16] = 
      {
         ::pdalboost::re_detail::char_class_alnum,
         ::pdalboost::re_detail::char_class_alpha,
         ::pdalboost::re_detail::char_class_cntrl,
         ::pdalboost::re_detail::char_class_digit,
         ::pdalboost::re_detail::char_class_graph,
         ::pdalboost::re_detail::char_class_horizontal_space,
         ::pdalboost::re_detail::char_class_lower,
         ::pdalboost::re_detail::char_class_print,
         ::pdalboost::re_detail::char_class_punct,
         ::pdalboost::re_detail::char_class_space,
         ::pdalboost::re_detail::char_class_upper,
         ::pdalboost::re_detail::char_class_vertical_space,
         ::pdalboost::re_detail::char_class_xdigit,
         ::pdalboost::re_detail::char_class_blank,
         ::pdalboost::re_detail::char_class_word,
         ::pdalboost::re_detail::char_class_unicode,
      };
#endif
   ...
   cpp_regex_traits_implementation<charT>::lookup_classname_imp(const charT* p1, const charT* p2) const
{
   ...
   static const char_class_type masks[22] = 
   {
      ...
      ::pdalboost::re_detail::char_class_upper,
      ::pdalboost::re_detail::char_class_vertical_space,
      ::pdalboost::re_detail::char_class_alnum | ::pdalboost::re_detail::char_class_word, 
      ::pdalboost::re_detail::char_class_alnum | ::pdalboost::re_detail::char_class_word, 
      ::pdalboost::re_detail::char_class_xdigit,
   };
#endif
...
{
   return
      ((mask & ::pdalboost::re_detail::char_class_space) && (this->m_pctype->is(std::ctype<charT>::space, c)))
      || ((mask & ::pdalboost::re_detail::char_class_print) && (this->m_pctype->is(std::ctype<charT>::print, c)))
      || ((mask & ::pdalboost::re_detail::char_class_cntrl) && (this->m_pctype->is(std::ctype<charT>::cntrl, c)))
      || ((mask & ::pdalboost::re_detail::char_class_upper) && (this->m_pctype->is(std::ctype<charT>::upper, c)))
      || ((mask & ::pdalboost::re_detail::char_class_lower) && (this->m_pctype->is(std::ctype<charT>::lower, c)))
      || ((mask & ::pdalboost::re_detail::char_class_alpha) && (this->m_pctype->is(std::ctype<charT>::alpha, c)))
      || ((mask & ::pdalboost::re_detail::char_class_digit) && (this->m_pctype->is(std::ctype<charT>::digit, c)))
      || ((mask & ::pdalboost::re_detail::char_class_punct) && (this->m_pctype->is(std::ctype<charT>::punct, c)))
      || ((mask & ::pdalboost::re_detail::char_class_xdigit) && (this->m_pctype->is(std::ctype<charT>::xdigit, c)))
      || ((mask & ::pdalboost::re_detail::char_class_blank) && (this->m_pctype->is(std::ctype<charT>::space, c)) && !::pdalboost::re_detail::is_separator(c))
      || ((mask & ::pdalboost::re_detail::char_class_word) && (c == '_'))
      || ((mask & ::pdalboost::re_detail::char_class_unicode) && ::pdalboost::re_detail::is_extended(c))
      || ((mask & ::pdalboost::re_detail::char_class_vertical_space) && (is_separator(c) || (c == '\v')))
      || ((mask & ::pdalboost::re_detail::char_class_horizontal_space) && this->m_pctype->is(std::ctype<charT>::space, c) && !(is_separator(c) || (c == '\v')));
}
#endif


template <class charT>
inline pdalboost::shared_ptr<const cpp_regex_traits_implementation<charT> > create_cpp_regex_traits(const std::locale& l BOOST_APPEND_EXPLICIT_TEMPLATE_TYPE(charT))
{
   cpp_regex_traits_base<charT> key(l);
   return ::pdalboost::object_cache<cpp_regex_traits_base<charT>, cpp_regex_traits_implementation<charT> >::get(key, 5);
}
...
private:
   pdalboost::shared_ptr<const re_detail::cpp_regex_traits_implementation<charT> > m_pimpl;
   //
