...
struct default_wrapper : public BaseT
{
   ...
   std::string error_string(::pdalboost::regex_constants::error_type e)const
   {
      return ::pdalboost::re_detail::get_default_error_string(e);
   }
   ::pdalboost::regex_constants::syntax_type syntax_type(char_type c)const
   {
      return ((c & 0x7f) == c) ? get_default_syntax_type(static_cast<char>(c)) : ::pdalboost::regex_constants::syntax_char;
   }
   ::pdalboost::regex_constants::escape_syntax_type escape_syntax_type(char_type c)const
   {
      return ((c & 0x7f) == c) ? get_default_escape_syntax_type(static_cast<char>(c)) : ::pdalboost::regex_constants::escape_type_identity;
   }
...
struct regex_traits_wrapper 
   : public ::pdalboost::re_detail::compute_wrapper_base<
               BaseT, 
               ::pdalboost::re_detail::has_boost_extensions_tag<BaseT>::value
            >::type
{
