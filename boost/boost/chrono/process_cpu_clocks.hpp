...
namespace pdalboost {} namespace boost = pdalboost; namespace pdalboost { namespace chrono {
...
namespace chrono
{
  ...
  typedef process_times<nanoseconds::rep> process_cpu_clock_times;
    ...
    public:
        ...
        typedef pdalboost::chrono::duration<times,  nano>                duration;
        typedef duration::rep                       rep;
        typedef duration::period                    period;
...
namespace std {
    ...
    template <typename Rep>
    struct numeric_limits<pdalboost::chrono::process_times<Rep> >
    {
        typedef pdalboost::chrono::process_times<Rep> Res;
