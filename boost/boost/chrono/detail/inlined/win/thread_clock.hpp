...
thread_clock::time_point thread_clock::now( system::error_code & ec )
{
    ...
    pdalboost::detail::win32::FILETIME_ creation, exit, user_time, system_time;

    if ( pdalboost::detail::win32::GetThreadTimes(
            pdalboost::detail::win32::GetCurrentThread (), &creation, &exit,
    ...
    else
    {
        ...
        {
            ec.assign( pdalboost::detail::win32::GetLastError(), BOOST_CHRONO_SYSTEM_CATEGORY );
