...
thread_clock::time_point thread_clock::now( system::error_code & ec )
{
    ...
    if ( pdalboost::detail::winapi::GetThreadTimes(
            pdalboost::detail::winapi::GetCurrentThread (), &creation, &exit,
    ...
    else
    {
        ...
        {
            ec.assign( pdalboost::detail::winapi::GetLastError(), BOOST_CHRONO_SYSTEM_CATEGORY );
