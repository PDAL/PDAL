...
namespace pdalboost {} namespace boost = pdalboost; namespace pdalboost { namespace unordered { namespace detail {
    ...
    struct value_base
    {
        ...
        typename pdalboost::aligned_storage<
            sizeof(value_type),
            pdalboost::alignment_of<value_type>::value>::type data_;
    ...
    struct move_nodes
    {
        ...
        {
            constructor.construct_with_value2(pdalboost::move(v));
            return constructor.release();
        }
    };
    ...
    struct table :
        pdalboost::unordered::detail::functions<
    ...
    public:
        ...
        typedef pdalboost::unordered::detail::allocator_traits<node_allocator>
            node_allocator_traits;
        typedef pdalboost::unordered::detail::allocator_traits<bucket_allocator>
        ...
        typedef typename bucket_allocator_traits::pointer
            bucket_pointer;
        typedef pdalboost::unordered::detail::node_constructor<node_allocator>
            node_constructor;

        typedef pdalboost::unordered::iterator_detail::
        ...
        pdalboost::unordered::detail::compressed<bucket_allocator, node_allocator>
            allocators_;
        ...
        std::size_t max_size() const
        {
            ...
            // size < mlf_ * count
            return pdalboost::unordered::detail::double_to_size(ceil(
        ...
        void recalculate_max_load()
        {
            ...
            max_load_ = buckets_ ? pdalboost::unordered::detail::double_to_size(ceil(
                    static_cast<double>(mlf_) *
        ...
        std::size_t min_buckets_for_size(std::size_t size) const
        {
            ...
            return policy::new_bucket_count(
                pdalboost::unordered::detail::double_to_size(floor(
        ...
        {
            pdalboost::unordered::detail::array_constructor<bucket_allocator>
        ...
        void swap(table& x)
        {
            ...
            pdalboost::swap(buckets_, x.buckets_);
            pdalboost::swap(bucket_count_, x.bucket_count_);
            pdalboost::swap(size_, x.size_);
