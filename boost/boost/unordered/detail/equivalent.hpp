...
namespace pdalboost {} namespace boost = pdalboost; namespace pdalboost { namespace unordered { namespace detail {
    ...
    struct grouped_node :
        pdalboost::unordered::detail::value_base<T>
    {
        typedef typename ::pdalboost::unordered::detail::rebind_wrap<
    ...
    struct grouped_ptr_node :
        pdalboost::unordered::detail::value_base<T>,
        pdalboost::unordered::detail::ptr_bucket
    {
        typedef pdalboost::unordered::detail::ptr_bucket bucket_base;
    ...
    {
        typedef pdalboost::unordered::detail::grouped_node<A, T> node;

        typedef typename pdalboost::unordered::detail::allocator_traits<
            typename pdalboost::unordered::detail::rebind_wrap<A, node>::type
        >::pointer node_pointer;

        typedef pdalboost::unordered::detail::bucket<node_pointer> bucket;
        typedef node_pointer link_pointer;
    };

    template <typename A, typename T>
    struct pick_grouped_node2<A, T,
        pdalboost::unordered::detail::grouped_ptr_node<T>*,
        pdalboost::unordered::detail::ptr_bucket*>
    {
        typedef pdalboost::unordered::detail::grouped_ptr_node<T> node;
        typedef pdalboost::unordered::detail::ptr_bucket bucket;
    ...
    {
        typedef pdalboost::unordered::detail::allocator_traits<
            typename pdalboost::unordered::detail::rebind_wrap<A,
                pdalboost::unordered::detail::grouped_ptr_node<T> >::type
        > tentative_node_traits;

        typedef pdalboost::unordered::detail::allocator_traits<
            typename pdalboost::unordered::detail::rebind_wrap<A,
                pdalboost::unordered::detail::ptr_bucket >::type
    ...
    struct multiset
    {
        typedef pdalboost::unordered::detail::multiset<A, T, H, P> types;
        ...
        typedef pdalboost::unordered::detail::pick_grouped_node<allocator,
            value_type> pick;
        typedef typename pick::node node;
        typedef typename pick::bucket bucket;
        typedef typename pick::link_pointer link_pointer;

        typedef pdalboost::unordered::detail::grouped_table_impl<types> table;
        typedef pdalboost::unordered::detail::set_extractor<value_type> extractor;

        typedef pdalboost::unordered::detail::pick_policy::type policy;
    };

    template <typename A, typename K, typename M, typename H, typename P>
    struct multimap
    {
        typedef pdalboost::unordered::detail::multimap<A, K, M, H, P> types;
        ...
        typedef pdalboost::unordered::detail::grouped_table_impl<types> table;
        typedef pdalboost::unordered::detail::map_extractor<key_type, value_type>
            extractor;
    ...
    struct grouped_table_impl : pdalboost::unordered::detail::table<Types>
    {
        typedef pdalboost::unordered::detail::table<Types> table;
...
#   if defined(BOOST_NO_CXX11_VARIADIC_TEMPLATES)
        iterator emplace(pdalboost::unordered::detail::emplace_args1<
                pdalboost::unordered::detail::please_ignore_this_overload> const&)
        {
            BOOST_ASSERT(false);
            return iterator();
        }
...
#   endif
        ...
        template <class I>
        typename pdalboost::unordered::detail::enable_if_forward<I, void>::type
            insert_range(I i, I j)
        {
            if(i == j) return;

            std::size_t distance = pdalboost::unordered::detail::distance(i, j);
            if(distance == 1) {
                node_constructor a(this->node_alloc());
        ...
        template <class I>
        typename pdalboost::unordered::detail::disable_if_forward<I, void>::type
            insert_range(I i, I j)
        {
            node_constructor a(this->node_alloc());
            for (; i != j; ++i) {
        ...
        static link_pointer split_groups(node_pointer begin, node_pointer end)
        {
            ...
            if (end) {
                ...
                pdalboost::swap(first->group_prev_, end->group_prev_);
            ...
            if (prev) {
                ...
                pdalboost::swap(first->group_prev_, begin->group_prev_);
            }
