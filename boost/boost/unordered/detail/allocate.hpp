...
namespace pdalboost {} namespace boost = pdalboost; namespace pdalboost { namespace unordered { namespace detail {
    ...
    template <typename T> typename pdalboost::add_lvalue_reference<T>::type make();
...
#define BOOST_UNORDERED_EMPLACE_FORWARD pdalboost::forward<Args>(args)...
...
#define BOOST_UNORDERED_CALL_FORWARD(z, i, a) \
    pdalboost::forward<BOOST_PP_CAT(A,i)>(BOOST_PP_CAT(a,i))
...
#define BOOST_UNORDERED_EARGS_INIT(z, n, _)                                 \
    BOOST_PP_CAT(a, n)(                                                     \
        pdalboost::forward<BOOST_PP_CAT(A,n)>(BOOST_PP_CAT(b, n)))

#else

#define BOOST_UNORDERED_EARGS_MEMBER(z, n, _)                               \
    typedef typename pdalboost::add_lvalue_reference<BOOST_PP_CAT(A, n)>::type  \
        BOOST_PP_CAT(Arg, n);                                               \
    BOOST_PP_CAT(Arg, n) BOOST_PP_CAT(a, n);
...
// 2 = pdalboost::container::allocator_traits
...
namespace pdalboost {} namespace boost = pdalboost; namespace pdalboost { namespace unordered { namespace detail {
    ...
    typedef pdalboost::unordered::detail::integral_constant<bool, true> true_type;
    typedef pdalboost::unordered::detail::integral_constant<bool, false> false_type;
...
#   define BOOST_UNORDERED_CHECK_MEMBER(count, result, name, member)        \
                                                                            \
    typedef typename pdalboost::unordered::detail::identity<member>::type       \
...
#       define BOOST_UNORDERED_DEFAULT_TYPE_TMPLT(tname)                    \
    ...
    struct default_type_ ## tname {                                         \
        ...
        enum { value = (1 == sizeof(test<Tp>(choose()))) };                 \
                                                                            \
        typedef typename pdalboost::detail::if_true<value>::                    \
...
#       define BOOST_UNORDERED_DEFAULT_TYPE_TMPLT(tname)                    \
    ...
    struct default_type_ ## tname {                                         \
                                                                            \
        template <typename X>                                               \
        static typename pdalboost::unordered::detail::sfinae<                   \
...
#       if !defined(BOOST_NO_CXX11_VARIADIC_TEMPLATES)
    ...
    BOOST_UNORDERED_HAS_FUNCTION(
    construct, U, (
        pdalboost::unordered::detail::make<ValueType*>(),
        pdalboost::unordered::detail::make<Args const>()...), 2
    );
...
#       else
    ...
    construct, U, (
        pdalboost::unordered::detail::make<ValueType*>(),
        pdalboost::unordered::detail::make<ValueType const>()), 2
    );
...
#       endif
    ...
    template <typename T, typename ValueType>
    BOOST_UNORDERED_HAS_FUNCTION(
        destroy, U, (pdalboost::unordered::detail::make<ValueType*>()), 1
    );
...
#   endif
    ...
    template <typename Alloc>
    inline Alloc call_select_on_container_copy_construction(const Alloc& rhs,
        typename pdalboost::disable_if_c<
            pdalboost::unordered::detail::
            has_select_on_container_copy_construction<Alloc>::value, void*
        >::type = 0)
    {
    ...
    inline SizeType call_max_size(const Alloc& a,
        typename pdalboost::enable_if_c<
            pdalboost::unordered::detail::has_max_size<Alloc>::value, void*
        >::type = 0)
    {
        return a.max_size();
    }
    ...
    template <typename SizeType, typename Alloc>
    inline SizeType call_max_size(const Alloc&, typename pdalboost::disable_if_c<
            pdalboost::unordered::detail::has_max_size<Alloc>::value, void*
        >::type = 0)
    {
    ...
    struct allocator_traits
    {
        ...
        template <typename T>
        struct pointer_to_other : pdalboost::pointer_to_other<pointer, T> {};
...
#   if BOOST_UNORDERED_DETAIL_FULL_CONSTRUCT
        ...
        static typename pdalboost::enable_if_c<
                pdalboost::unordered::detail::has_construct<Alloc, T, Args...>
                ::value>::type
            construct(Alloc& a, T* p, BOOST_FWD_REF(Args)... x)
        {
            a.construct(p, pdalboost::forward<Args>(x)...);
        }

        template <typename T, typename... Args>
        static typename pdalboost::disable_if_c<
                pdalboost::unordered::detail::has_construct<Alloc, T, Args...>
                ::value>::type
            construct(Alloc&, T* p, BOOST_FWD_REF(Args)... x)
        {
            new ((void*) p) T(pdalboost::forward<Args>(x)...);
        }
...
#   elif !defined(BOOST_NO_SFINAE_EXPR)
        ...
        template <typename T>
        static typename pdalboost::enable_if_c<
                pdalboost::unordered::detail::has_construct<Alloc, T>::value>::type
...
#   else
        ...
        static void construct(Alloc& a, T* p, T const& x,
            typename pdalboost::enable_if_c<
                    pdalboost::unordered::detail::has_construct<Alloc, T>::value &&
        ...
        static void destroy(Alloc& a, T* p,
            typename pdalboost::enable_if_c<
                pdalboost::unordered::detail::has_destroy<Alloc, T>::value &&
                pdalboost::is_same<T, value_type>::value,
                void*>::type = 0)
        {
            a.destroy(p);
...
////////////////////////////////////////////////////////////////////////////////
//
// pdalboost::container::allocator_traits
...
namespace pdalboost {} namespace boost = pdalboost; namespace pdalboost { namespace unordered { namespace detail {
    ...
    template <typename Alloc>
    struct allocator_traits :
        pdalboost::container::allocator_traits<Alloc> {};
...
#   if BOOST_UNORDERED_DETAIL_FULL_CONSTRUCT
    ...
    {
        pdalboost::unordered::detail::allocator_traits<Alloc>::construct(alloc,
            address, pdalboost::forward<Args>(args)...);
    }

    template <typename Alloc, typename T>
    inline void destroy_value_impl(Alloc& alloc, T* x) {
        pdalboost::unordered::detail::allocator_traits<Alloc>::destroy(alloc, x);
    }
...
#   else
    ...
    inline void call_construct(Alloc&, T* address,
        BOOST_FWD_REF(Args)... args)
    {
        new((void*) address) T(pdalboost::forward<Args>(args)...);
    }
...
#   define BOOST_UNORDERED_CONSTRUCT_FROM_TUPLE(n, namespace_)              \
    ...
    void construct_from_tuple_impl(                                         \
            pdalboost::unordered::detail::length<0>, Alloc&, T* ptr,            \
            namespace_ tuple<>)                                             \
    {                                                                       \
        new ((void*) ptr) T();                                              \
    }                                                                       \
...
#   define BOOST_UNORDERED_CONSTRUCT_FROM_TUPLE_IMPL(z, n, namespace_)      \
    template<typename Alloc, typename T,                                    \
        BOOST_PP_ENUM_PARAMS_Z(z, n, typename A)>                           \
    void construct_from_tuple_impl(                                         \
            pdalboost::unordered::detail::length<n>, Alloc&, T* ptr,            \
            namespace_ tuple<BOOST_PP_ENUM_PARAMS_Z(z, n, A)> const& x)     \
    {                                                                       \
        new ((void*) ptr) T(                                                \
            BOOST_PP_ENUM_##z(n, BOOST_UNORDERED_GET_TUPLE_ARG, namespace_) \
...
BOOST_UNORDERED_CONSTRUCT_FROM_TUPLE(10, pdalboost::)
...
#undef BOOST_UNORDERED_GET_TUPLE_ARG
    ...
    void construct_from_tuple(Alloc& alloc, T* ptr, Tuple const& x)
    {
        construct_from_tuple_impl(
            pdalboost::unordered::detail::length<
                pdalboost::tuples::length<Tuple>::value>(),
            alloc, ptr, x);
    }
    ...
    struct use_piecewise {
        static choice1::type test(choice1,
            pdalboost::unordered::piecewise_construct_t);

        static choice2::type test(choice2, ...);

        enum { value = sizeof(choice1::type) ==
            sizeof(test(choose(), pdalboost::unordered::detail::make<A0>())) };
    };
...
// Construct from emplace_args
    ...
    {
        new((void*) address) T(pdalboost::forward<A0>(args.a0));
    }
    ...
    {
        new((void*) address) T(
            pdalboost::forward<A0>(args.a0),
            pdalboost::forward<A1>(args.a1)
        );
    }
...
#define BOOST_UNORDERED_CONSTRUCT_IMPL(z, num_params, _)                    \
    ...
    >                                                                       \
    inline void construct_value_impl(Alloc&, T* address,                    \
        pdalboost::unordered::detail::BOOST_PP_CAT(emplace_args,num_params) <   \
...
namespace pdalboost {} namespace boost = pdalboost; namespace pdalboost { namespace unordered { namespace detail {
    ...
    {
        typedef pdalboost::unordered::detail::allocator_traits<Allocator> traits;
        ...
        ~array_constructor() {
            if (ptr_) {
                for(pointer p = ptr_; p != constructed_; ++p)
                    traits::destroy(alloc_, pdalboost::addressof(*p));
        ...
        void construct(V const& v, std::size_t l)
        {
            ...
            for(constructed_ = ptr_; constructed_ != end; ++constructed_)
                traits::construct(alloc_, pdalboost::addressof(*constructed_), v);
        }
