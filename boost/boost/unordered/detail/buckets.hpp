...
namespace pdalboost {} namespace boost = pdalboost; namespace pdalboost { namespace unordered { namespace iterator_detail {
            ...
            typename Node::value_type&>
    {
        ...
        friend struct pdalboost::unordered::iterator_detail::cl_iterator;
    private:
#endif
        typedef typename Node::node_pointer node_pointer;
        typedef pdalboost::unordered::iterator_detail::iterator<Node> iterator;
        node_pointer ptr_;
        std::size_t bucket_;
    ...
    {
        friend struct pdalboost::unordered::iterator_detail::l_iterator
            <Node, Policy>;
    private:
    ...
    public:
        ...
        cl_iterator(pdalboost::unordered::iterator_detail::l_iterator<
            ...
            typename Node::value_type&>
    {
        ...
        friend struct pdalboost::unordered::iterator_detail::c_iterator;
        template <typename, typename>
        friend struct pdalboost::unordered::iterator_detail::l_iterator;
        template <typename, typename, typename>
        friend struct pdalboost::unordered::iterator_detail::cl_iterator;
        template <typename>
        friend struct pdalboost::unordered::detail::table;
        template <typename>
        friend struct pdalboost::unordered::detail::table_impl;
        template <typename>
        friend struct pdalboost::unordered::detail::grouped_table_impl;
    private:
#endif
        typedef typename Node::node_pointer node_pointer;
        node_pointer node_;
    ...
    struct c_iterator
        : public pdalboost::iterator<
            ...
            typename Node::value_type const&>
    {
        friend struct pdalboost::unordered::iterator_detail::iterator<Node>;
...
namespace pdalboost {} namespace boost = pdalboost; namespace pdalboost { namespace unordered { namespace detail {
    ...
    private:
        ...
        typedef pdalboost::unordered::detail::allocator_traits<NodeAlloc>
    ...
    public:
        ...
        {
            construct();
            pdalboost::unordered::detail::func::construct_value_impl(
        ...
        void construct_with_value2(BOOST_FWD_REF(A0) a0)
        {
            ...
            pdalboost::unordered::detail::func::construct_value_impl(
                ...
                BOOST_UNORDERED_EMPLACE_ARGS1(pdalboost::forward<A0>(a0)));
            value_constructed_ = true;
        }
    ...
    node_constructor<Alloc>::~node_constructor()
    {
        if (node_) {
            if (value_constructed_) {
                pdalboost::unordered::detail::func::destroy_value_impl(alloc_,
                    node_->value_ptr());
            }

            if (node_constructed_) {
                node_allocator_traits::destroy(alloc_,
                    pdalboost::addressof(*node_));
            }
    ...
    void node_constructor<Alloc>::construct()
    {
        if(!node_) {
            ...
            node_allocator_traits::construct(alloc_,
                pdalboost::addressof(*node_), node());
            node_->init(node_);
    ...
    public:
        ...
        inline void move_assign_impl(T& v) {
            if (this->node_ && this->value_constructed_) {
                this->node_->value() = pdalboost::move(v);
            }
            else {
                this->construct_with_value2(pdalboost::move(v));
            }
        }
    ...
    node_holder<Alloc>::~node_holder()
    {
        while (nodes_) {
            ...
            pdalboost::unordered::detail::func::destroy_value_impl(this->alloc_,
                p->value_ptr());
            node_allocator_traits::destroy(this->alloc_, pdalboost::addressof(*p));
    ...
    struct prime_policy
    {
        ...
        static inline SizeT new_bucket_count(SizeT min) {
            return pdalboost::unordered::detail::next_prime(min);
        }

        static inline SizeT prev_bucket_count(SizeT max) {
            return pdalboost::unordered::detail::prev_prime(max);
        }
    };
    ...
    public:
        static const bool nothrow_move_assignable =
                pdalboost::is_nothrow_move_assignable<H>::value &&
                pdalboost::is_nothrow_move_assignable<P>::value;
        static const bool nothrow_move_constructible =
                pdalboost::is_nothrow_move_constructible<H>::value &&
                pdalboost::is_nothrow_move_constructible<P>::value;

    private:
        friend class pdalboost::unordered::detail::set_hash_functions<H, P,
        ...
        typedef typename pdalboost::aligned_storage<
            ...
            pdalboost::alignment_of<function_pair>::value>::type aligned_function;
        ...
        void construct(bool which, function_pair const& f,
                pdalboost::unordered::detail::false_type =
                    pdalboost::unordered::detail::false_type())
        {
        ...
        void construct(bool which, function_pair& f,
                pdalboost::unordered::detail::true_type)
        {
            new((void*) &funcs_[which]) function_pair(f,
        ...
        {
            pdalboost::unordered::detail::func::destroy((function_pair*)(&funcs_[which]));
        }
        
    public:

        typedef pdalboost::unordered::detail::set_hash_functions<H, P,
        ...
        functions(functions& bf, pdalboost::unordered::detail::move_tag)
            : current_(false)
        {
            construct(current_, bf.current(),
                pdalboost::unordered::detail::integral_constant<bool,
    ...
    public:
        ...
        void commit()
        {
            functions_.current().first() = pdalboost::move(hash_);
            functions_.current().second() = pdalboost::move(pred_);
        }
    };
...
#   define BOOST_UNORDERED_RV_REF(T) BOOST_RV_REF(T)
    ...
    template <typename T>
    struct rv_ref :
        pdalboost::detail::if_true<
            pdalboost::is_class<T>::value
        >::BOOST_NESTED_TEMPLATE then <
            pdalboost::unordered::detail::rv_ref_impl<T>,
            please_ignore_this_overload
        >::type
    {};

#   define BOOST_UNORDERED_RV_REF(T) \
        typename pdalboost::unordered::detail::rv_ref<T>::type
#endif
}}}
