...
namespace pdalboost {} namespace boost = pdalboost; namespace pdalboost { namespace unordered { namespace detail {
    ...
    public:
        ...
        {
            construct();
            pdalboost::unordered::detail::construct_value_impl(
    ...
    node_constructor<Alloc>::~node_constructor()
    {
        if (node_) {
            if (value_constructed_) {
                pdalboost::unordered::detail::destroy_value_impl(alloc_,
                    node_->value_ptr());
            }
    ...
    node_holder<Alloc>::~node_holder()
    {
        while (nodes_) {
            ...
            pdalboost::unordered::detail::destroy_value_impl(this->alloc_,
                p->value_ptr());
    ...
    private:
        ...
        {
            pdalboost::unordered::detail::destroy((function_pair*)(&funcs_[which]));
        }
    ...
    public:
        ...
        functions(functions& bf, pdalboost::unordered::detail::move_tag m)
            : current_(false)
        {
