 ...
 * pdalboost::geometric_distribution.  A backwards compatible
 * wrapper is provided in namespace pdalboost.
 * @endxmlwarning
 */
...
public:
    ...
    result_type operator()(Engine& eng) const
    {
        using std::log;
        using std::floor;
        RealType x = RealType(1) - pdalboost::uniform_01<RealType>()(eng);
