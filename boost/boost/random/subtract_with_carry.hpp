...
struct subtract_with_carry_discard
{
    ...
    static void apply(Engine& eng, pdalboost::uintmax_t z)
    {
...
public:
                                        ...
                                        IntType, value)
    {
        ...
        gen_t intgen(static_cast<pdalboost::uint32_t>(value));
...
public:
    ...
    BOOST_STATIC_CONSTANT(std::size_t, long_lag = r);
    BOOST_STATIC_CONSTANT(std::size_t, short_lag = s);
    BOOST_STATIC_CONSTANT(pdalboost::uint32_t, default_seed = 19780503u);
...
class subtract_with_carry :
    public subtract_with_carry_engine<IntType,
        pdalboost::static_log2<m>::value, s, r>
{
    typedef subtract_with_carry_engine<IntType,
        pdalboost::static_log2<m>::value, s, r> base_type;
public:
    subtract_with_carry() {}
