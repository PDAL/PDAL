...
public:
    ...
    BOOST_RANDOM_DETAIL_ARITHMETIC_SEED(lagged_fibonacci_engine,
        UIntType, value)
    {
        minstd_rand0 intgen(static_cast<pdalboost::uint32_t>(value));
...
public:
    ...
    BOOST_STATIC_CONSTANT(pdalboost::uint32_t, default_seed = 331u);
     ...
     */
    BOOST_RANDOM_DETAIL_ARITHMETIC_SEED(lagged_fibonacci_01_engine, pdalboost::uint32_t, value)
    {
...
template<class RealType, int w, unsigned int p, unsigned int q>
const pdalboost::uint32_t lagged_fibonacci_01_engine<RealType,w,p,q>::default_seed;
#endif
...
public:
    lagged_fibonacci_01() {}
    BOOST_RANDOM_DETAIL_ARITHMETIC_CONSTRUCTOR(lagged_fibonacci_01, pdalboost::uint32_t, val)
    { this->seed(val); }
...
/** @copydoc pdalboost::random::detail::lagged_fibonacci_doc */
