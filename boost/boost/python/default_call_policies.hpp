...
struct default_result_converter
{
    ...
    struct apply
    {
        typedef typename mpl::if_<
          ...
          , pdalboost::python::to_python_value<
...
{
    typedef pdalboost::python::to_python_value<char const*const&> type;
};

template <>
struct default_result_converter::apply<PyObject*>
{
    typedef pdalboost::python::to_python_value<PyObject*const&> type;
};
