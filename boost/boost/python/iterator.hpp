...
namespace detail
{
  ...
  )
  {
      return objects::make_iterator_function<Target>(
          pdalboost::protect(pdalboost::bind(get_start, _1))
        , pdalboost::protect(pdalboost::bind(get_finish, _1))
        , next_policies
      );
  }
...
object range(Accessor1 start, Accessor2 finish, NextPolicies* = 0, pdalboost::type<Target>* = 0)
{
