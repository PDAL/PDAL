...
namespace detail
{
    ...
    template<class T>
    struct test_get_pytype : pdalboost::mpl::bool_<test_get_pytype_base<T>::value> 
    {
    };
...
#else
    typedef pdalboost::mpl::bool_<has_get_pytype> HasGetPytype;
#endif

    static PyTypeObject const* get_pytype_1(pdalboost::mpl::true_ *)
    {
        return Conversion::get_pytype();
    }

    static PyTypeObject const* get_pytype_1(pdalboost::mpl::false_ *)
    {
        return 0;
    }
