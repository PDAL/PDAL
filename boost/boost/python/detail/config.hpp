...
# else
#  define BOOST_PYTHON_BEGIN_CONVERSION_NAMESPACE namespace pdalboost {} namespace boost = pdalboost; namespace pdalboost { namespace python {
#  define BOOST_PYTHON_END_CONVERSION_NAMESPACE }} // namespace pdalboost::python
#  define BOOST_PYTHON_CONVERSION pdalboost::python
...
//
#define BOOST_LIB_NAME pdalboost_python
//
