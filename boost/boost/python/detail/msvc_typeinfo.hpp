...
template <class T>
inline typeinfo msvc_typeid(pdalboost::type<T>*)
{
    return detail::typeid_ref(
        (pdalboost::type<T>*)0, detail::is_ref_tester1(type<T>())
        );
}

template <>
inline typeinfo msvc_typeid<void>(pdalboost::type<void>*)
{
    return typeid(void);
}
...
{
    return msvc_typeid((pdalboost::type<char const[3]>*)0)
        , msvc_typeid((pdalboost::type<char[3]>*)0);
}
#  endif
