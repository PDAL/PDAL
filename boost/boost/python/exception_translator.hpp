...
void register_exception_translator(Translate translate, pdalboost::type<ExceptionType>* = 0)
{
    detail::register_exception_handler(
        pdalboost::bind<bool>(detail::translate_exception<ExceptionType,Translate>(), _1, _2, translate)
        );
}
