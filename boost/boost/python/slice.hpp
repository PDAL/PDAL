...
namespace detail
{
  class BOOST_PYTHON_DECL slice_base : public object
  {
   public:
      ...
      // equal to a default-constructed pdalboost::python::object.
...
class slice : public detail::slice_base
{
 ...
 public:
        ...
        const RandomAccessIterator& end) const
    {
        ...
        difference_type max_dist = pdalboost::detail::distance(begin, end);
        ...
        typename iterator_difference<RandomAccessIterator>::type final_dist = 
            pdalboost::detail::distance( ret.start, ret.stop);
