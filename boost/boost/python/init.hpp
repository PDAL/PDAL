...
namespace detail
{
  ...
  //
    ...
    private:
        ...
        static pdalboost::type_traits::yes_type f(optional<BOOST_PYTHON_OVERLOAD_ARGS>);
        static pdalboost::type_traits::no_type f(...);
        static T t();
    ...
    public:
        ...
        BOOST_STATIC_CONSTANT(
            bool, value =
                sizeof(f(t())) == sizeof(::pdalboost::type_traits::yes_type));
