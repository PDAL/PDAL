...
struct iterator_range
{
    ...
    typedef pdalboost::detail::iterator_traits<Iterator> traits_t;
...
# ifdef BOOST_NO_TEMPLATE_PARTIAL_SPECIALIZATION
    ...
    typedef mpl::if_<
        is_same<
            pdalboost::detail::please_invoke_BOOST_TT_BROKEN_COMPILER_SPEC_on_cv_unqualified_pointee<Iterator>
          , typename traits_t::value_type
        >
      , next_ptr
      , next
