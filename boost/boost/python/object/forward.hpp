...
// Very much like pdalboost::reference_wrapper<T>, except that in this
...
namespace detail
{
  ...
  template<typename T>
  yes_reference_to_value_t is_reference_to_value_test(pdalboost::type< reference_to_value<T> >);
  ...
  struct is_reference_to_value
  {
      BOOST_STATIC_CONSTANT(
          bool, value = (
              sizeof(is_reference_to_value_test(pdalboost::type<T>()))
