...
struct dynamic_id_generator
  : mpl::if_<
        pdalboost::is_polymorphic<T>
        , pdalboost::python::objects::polymorphic_id_generator<T>
        , pdalboost::python::objects::non_polymorphic_id_generator<T>
    >
{};
...
inline void register_conversion(
    bool is_downcast = ::pdalboost::is_base_and_derived<Source,Target>::value
