...
using pdalboost::python::self_ns::abs;
using pdalboost::python::self_ns::int_;
using pdalboost::python::self_ns::long_;
using pdalboost::python::self_ns::float_;
using pdalboost::python::self_ns::complex_;
using pdalboost::python::self_ns::str;
using pdalboost::python::self_ns::repr;
using pdalboost::python::self_ns::pow;
# endif
