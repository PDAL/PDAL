...
namespace pdalboost {} namespace boost = pdalboost; namespace pdalboost { namespace python { namespace container_utils {
    ...
    extend_container(Container& container, object l)
    {
        ...
        BOOST_FOREACH(object elem,
            std::make_pair(
              pdalboost::python::stl_input_iterator<object>(l),
              pdalboost::python::stl_input_iterator<object>()
              ))
        {
...
}}} // namespace pdalboost::python::container_utils
