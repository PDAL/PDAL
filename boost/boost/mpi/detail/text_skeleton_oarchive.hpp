...
class text_skeleton_oarchive 
  : public detail::ignore_oprimitive,
    public detail::forward_skeleton_oarchive<text_skeleton_oarchive,pdalboost::archive::text_oarchive>
{
public:
    text_skeleton_oarchive(std::ostream & s, unsigned int flags = 0) 
     : detail::forward_skeleton_oarchive<text_skeleton_oarchive,pdalboost::archive::text_oarchive>(skeleton_archive_)
     , skeleton_archive_(s,flags)
    {}

private:
    pdalboost::archive::text_oarchive skeleton_archive_;
};

namespace detail {

typedef pdalboost::mpi::detail::forward_skeleton_oarchive<pdalboost::mpi::text_skeleton_oarchive,pdalboost::archive::text_oarchive> type3;
...
// required by export
BOOST_SERIALIZATION_REGISTER_ARCHIVE(pdalboost::mpi::text_skeleton_oarchive)
BOOST_SERIALIZATION_REGISTER_ARCHIVE(pdalboost::mpi::detail::type3)
