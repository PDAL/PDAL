...
namespace pdalboost {} namespace boost = pdalboost; namespace pdalboost { namespace mpi { namespace detail {
...
public:
    ...
    {
      save_enum(t,pdalboost::is_enum<T>());
    }
    ...
    void save_enum(T const& t, mpl::true_)
    {
      ...
      typedef typename pdalboost::uint_t<8*sizeof(T)>::least int_type;
...
} } } // end namespace pdalboost::mpi::detail

// required by export
BOOST_SERIALIZATION_REGISTER_ARCHIVE(pdalboost::mpi::detail::mpi_datatype_oarchive)
BOOST_SERIALIZATION_REGISTER_ARCHIVE(pdalboost::mpi::detail::ignore_skeleton_oarchive<pdalboost::mpi::detail::mpi_datatype_oarchive>)
BOOST_SERIALIZATION_USE_ARRAY_OPTIMIZATION(pdalboost::mpi::detail::mpi_datatype_oarchive)
