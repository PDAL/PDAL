...
public:
   ...
   */
  packed_iarchive(MPI_Comm const & comm, buffer_type & b, unsigned int flags = pdalboost::archive::no_header, int position = 0)
...
BOOST_BROKEN_COMPILER_TYPE_TRAITS_SPECIALIZATION(pdalboost::mpi::packed_iarchive)
BOOST_SERIALIZATION_REGISTER_ARCHIVE(pdalboost::mpi::packed_iarchive)
BOOST_SERIALIZATION_USE_ARRAY_OPTIMIZATION(pdalboost::mpi::packed_iarchive)
