...
namespace pdalboost {} namespace boost = pdalboost; namespace pdalboost { namespace python { namespace api {    \
...
namespace detail {
  ...
  {
  public:
    typedef pdalboost::function3<void, OArchiver&, const object&, const unsigned int>
      saver_t;
    typedef pdalboost::function3<void, IArchiver&, object&, const unsigned int>
      loader_t;
...
void 
save_impl(Archiver& ar, const pdalboost::python::object& obj, 
          const unsigned int /*version*/,
          mpl::false_ /*has_direct_serialization*/)
{
  pdalboost::python::str py_string = pdalboost::python::pickle::dumps(obj);
  int len = pdalboost::python::extract<int>(py_string.attr("__len__")());
  const char* string = pdalboost::python::extract<const char*>(py_string);
  ar << len << pdalboost::serialization::make_array(string, len);
}
...
template<typename Archiver>
void 
load_impl(Archiver& ar, pdalboost::python::object& obj, 
          const unsigned int /*version*/, 
          mpl::false_ /*has_direct_serialization*/)
{
  int len;
  ...
  ar >> pdalboost::serialization::make_array(string.get(), len);
  pdalboost::python::str py_string(string.get(), len);
  obj = pdalboost::python::pickle::loads(py_string);
}
...
template<typename Archiver>
void 
save(Archiver& ar, const pdalboost::python::object& obj, 
     const unsigned int version)
{
  typedef Archiver OArchiver;
  typedef typename input_archiver<OArchiver>::type IArchiver;
...
template<typename Archiver>
void 
load(Archiver& ar, pdalboost::python::object& obj, 
     const unsigned int version)
{
  typedef Archiver IArchiver;
  typedef typename output_archiver<IArchiver>::type OArchiver;
...
inline void 
serialize(Archive& ar, pdalboost::python::object& obj, const unsigned int version)
{
  pdalboost::serialization::split_free(ar, obj, version);
}

} } // end namespace pdalboost::python
...
BOOST_PYTHON_DIRECT_SERIALIZATION_ARCHIVE(
  ::pdalboost::mpi::packed_iarchive,
  ::pdalboost::mpi::packed_oarchive)
...
{
  using pdalboost::python::register_serialized;
