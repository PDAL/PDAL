 ...
 */
class content : public pdalboost::mpi::content
{
  typedef pdalboost::mpi::content inherited;

 public:
  content(const inherited& base, pdalboost::python::object object) 
    : inherited(base), object(object) { }

  inherited&       base()       { return *this; }
  const inherited& base() const { return *this; }

  pdalboost::python::object object;
};
...
{
public:
  skeleton_proxy_base(const pdalboost::python::object& object) : object(object) { }
...
{
 public:
  skeleton_proxy(const pdalboost::python::object& object) 
    : skeleton_proxy_base(object) { }
};

namespace detail {
  using pdalboost::python::object;
  using pdalboost::python::extract;
   
  extern BOOST_MPI_DECL pdalboost::python::object skeleton_proxy_base_type;
  ...
  struct do_get_content
  {
    content operator()(object value_obj) {
      ...
      return content(pdalboost::mpi::get_content(value), value_obj);
    }
  };
...
{
  using pdalboost::python::detail::direct_serialization_table;
  using pdalboost::python::detail::get_direct_serialization_table;
  ...
  {
    pdalboost::python::scope proxy_scope(detail::skeleton_proxy_base_type);
