...
public:
   ...
   *  default flags.
   */
  packed_oarchive( MPI_Comm const & comm, buffer_type & b, unsigned int flags = pdalboost::archive::no_header)
         : oprimitive(b,comm),
   ...
   *  default flags.
   */
  packed_oarchive ( MPI_Comm const & comm, unsigned int flags =  pdalboost::archive::no_header)
...
// required by export
BOOST_SERIALIZATION_REGISTER_ARCHIVE(pdalboost::mpi::packed_oarchive)
BOOST_SERIALIZATION_USE_ARRAY_OPTIMIZATION(pdalboost::mpi::packed_oarchive)
