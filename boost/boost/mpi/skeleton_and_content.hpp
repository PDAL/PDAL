...
namespace detail {
  ...
  class BOOST_MPI_DECL mpi_datatype_holder : public pdalboost::noncopyable
  {
  public:
    mpi_datatype_holder()
     : is_committed(false)
...
private:
  pdalboost::shared_ptr<detail::mpi_datatype_holder> holder;
};
...
public:
  ...
  packed_skeleton_iarchive(MPI_Comm const & comm,
                           unsigned int flags =  pdalboost::archive::no_header)
  ...
  explicit packed_skeleton_iarchive(packed_iarchive & archive)
         ...
         , skeleton_archive_(MPI_COMM_WORLD, pdalboost::archive::no_header)
        {}
...
namespace detail {
  typedef pdalboost::mpi::detail::forward_skeleton_oarchive<pdalboost::mpi::packed_skeleton_oarchive,pdalboost::mpi::packed_oarchive> type1;
  typedef pdalboost::mpi::detail::forward_skeleton_iarchive<pdalboost::mpi::packed_skeleton_iarchive,pdalboost::mpi::packed_iarchive> type2;
}
...
// required by export
BOOST_SERIALIZATION_REGISTER_ARCHIVE(pdalboost::mpi::packed_skeleton_oarchive)
BOOST_SERIALIZATION_REGISTER_ARCHIVE(pdalboost::mpi::packed_skeleton_iarchive)
BOOST_SERIALIZATION_REGISTER_ARCHIVE(pdalboost::mpi::detail::type1)
BOOST_SERIALIZATION_REGISTER_ARCHIVE(pdalboost::mpi::detail::type2)

BOOST_SERIALIZATION_USE_ARRAY_OPTIMIZATION(pdalboost::mpi::packed_skeleton_oarchive)
BOOST_SERIALIZATION_USE_ARRAY_OPTIMIZATION(pdalboost::mpi::packed_skeleton_iarchive)
