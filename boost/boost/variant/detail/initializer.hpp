...
struct make_initializer_node
{
    ...
    private: // helpers, for metafunction result (below)
        ...
        private: // helpers, for static functions (below)
            ...
            typedef pdalboost::is_reference<public_T> 
                is_reference_content_t;

            typedef typename pdalboost::mpl::if_<is_reference_content_t, public_T, const public_T& >::type 
                param_T;

            template <class T> struct disable_overload{};

            typedef typename pdalboost::mpl::if_<is_reference_content_t, disable_overload<public_T>, public_T&& >::type 
                param2_T;
#else
        ...
        public: // static functions
            ...
            static int initialize(void* dest, param2_T operand)
            {
                ...
                typedef typename pdalboost::mpl::if_<is_reference_content_t, param2_T, recursive_enabled_T>::type value_T;
                new(dest) value_T( pdalboost::detail::variant::move(operand) );
                return BOOST_MPL_AUX_VALUE_WKND(index)::value; // which
            }
#endif
        };
