...
BOOST_VARIANT_TT_AUX_BOOL_TRAIT_DEF1(
      has_nothrow_move
    , T
    , (::pdalboost::detail::variant::has_nothrow_move_impl<T>::value)
    )
...
BOOST_VARIANT_TT_AUX_BOOL_TRAIT_DEF1(
    ...
    , T
    , (::pdalboost::detail::variant::has_nothrow_move_constructor_impl<T>::value)
    )
...
BOOST_VARIANT_TT_AUX_BOOL_TRAIT_DEF1(
    ...
    , T
    , (::pdalboost::detail::variant::has_nothrow_move_assign_impl<T>::value)
    )

}} // namespace detail::variant

BOOST_VARIANT_TT_AUX_TRAIT_SUFFIX(1,::pdalboost::detail::variant::has_nothrow_move)
BOOST_VARIANT_TT_AUX_TRAIT_SUFFIX(1,::pdalboost::detail::variant::has_nothrow_move_constructor)
BOOST_VARIANT_TT_AUX_TRAIT_SUFFIX(1,::pdalboost::detail::variant::has_nothrow_move_assign)
