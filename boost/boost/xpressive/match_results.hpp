...
namespace pdalboost {} namespace boost = pdalboost; namespace pdalboost { namespace xpressive { namespace detail
{
...
public:
    ...
    {
        return this->format_(out, pdalboost::as_literal(fmt), flags, mpl::size_t<0>());
    }
...
private:
    ...
    {
        return std::copy(pdalboost::begin(result), pdalboost::end(result), out);
    }
    ...
    ) const
    {
        ...
        iterator cur = pdalboost::begin(format), end = pdalboost::end(format);
    ...
    ) const
    {
        ...
        typedef typename pdalboost::uint_t<CHAR_BIT * sizeof(char_type)>::least uchar_t;
    ...
    pdalboost::optional<BidiIter> base_;
    pdalboost::optional<sub_match<BidiIter> > prefix_;
    pdalboost::optional<sub_match<BidiIter> > suffix_;
...
namespace std
{
    ...
    concept_map OutputIterator<
        pdalboost::xpressive::detail::case_converting_iterator<Iter_, Char_>
      , Char_
    >
    {};
    ...
    concept_map OutputIterator<
        pdalboost::xpressive::detail::noop_output_iterator<Char_>
      , Char_
    >
    {};
}
