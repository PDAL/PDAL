...
// char_literal
//
template<typename Char, pdalboost::intmax_t Ch, pdalboost::intmax_t Wch>
struct char_literal;

template<typename Char, pdalboost::intmax_t Ch>
struct char_literal<Char, Ch, Ch>
{
    BOOST_STATIC_CONSTANT(pdalboost::intmax_t, value = Ch);
};

#ifndef BOOST_NO_INCLASS_MEMBER_INITIALIZATION
template<typename Char, pdalboost::intmax_t Ch>
pdalboost::intmax_t const char_literal<Char, Ch, Ch>::value;
#endif
...
# define BOOST_XPR_CSTR_(Char, st) pdalboost::xpressive::detail::string_literal<Char>::pick(st, L##st)

#else

# define BOOST_XPR_CHAR_(Char, ch) pdalboost::xpressive::detail::char_literal<Char, ch, L##ch>::value
# define BOOST_XPR_CSTR_(Char, st) pdalboost::xpressive::detail::string_literal<Char>::pick(st, L##st)

#endif

}}} // namespace pdalboost::xpressive::detail
