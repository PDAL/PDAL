...
namespace pdalboost {} namespace boost = pdalboost; namespace pdalboost { namespace xpressive { namespace grammar_detail
{
    using proto::_;
    using proto::or_;
    using proto::if_;
...
namespace pdalboost {} namespace boost = pdalboost; namespace pdalboost { namespace xpressive { namespace op
{
    struct push;
    struct push_back;
    struct pop;
    ...
    template<typename T>
    struct throw_;
}}} // namespace pdalboost::xpressive::op

/// INTERNAL ONLY
namespace pdalboost {} namespace boost = pdalboost; namespace pdalboost { namespace xpressive
{
