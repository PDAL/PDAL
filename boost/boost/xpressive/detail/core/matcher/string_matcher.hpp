...
namespace pdalboost {} namespace boost = pdalboost; namespace pdalboost { namespace xpressive { namespace detail
{
      ...
      : quant_style_fixed_unknown_width
    {
        ...
        string_matcher(string_type const &str, Traits const &tr)
          ...
          , end_()
        {
            typename range_iterator<string_type>::type cur = pdalboost::begin(this->str_);
            typename range_iterator<string_type>::type end = pdalboost::end(this->str_);
            for(; cur != end; ++cur)
            {
        ...
        {
            return pdalboost::size(this->str_);
        }
    };
