...
namespace pdalboost {} namespace boost = pdalboost; namespace pdalboost { namespace xpressive { namespace regex_constants
{
...
}}} // namespace pdalboost::xpressive::regex_constants
