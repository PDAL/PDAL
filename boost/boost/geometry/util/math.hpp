...
struct equals<Type, true>
{
    ...
    static inline bool apply(Type const& a, Type const& b)
    {
        ...
        // FUTURE: replace by some boost tool or pdalboost::test::close_at_tolerance
...
struct define_pi
{
    static inline T apply()
    {
        ...
        return pdalboost::math::constants::pi<T>();
    }
};
...
inline bool equals(T1 const& a, T2 const& b)
{
    ...
    return detail::equals
        <
            select_type,
            pdalboost::is_floating_point<select_type>::type::value
        >::apply(a, b);
}
