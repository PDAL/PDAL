...
struct select_most_precise
{
    ...
    static const bool one_not_fundamental = !
        (pdalboost::is_fundamental<T1>::type::value
          && pdalboost::is_fundamental<T2>::type::value);

    static const bool both_same =
        pdalboost::is_floating_point<T1>::type::value
        == pdalboost::is_floating_point<T2>::type::value;
