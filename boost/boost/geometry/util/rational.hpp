...
struct select_most_precise<pdalboost::rational<T1>, pdalboost::rational<T2> >
{
    typedef typename pdalboost::rational
        <
...
template <typename T>
struct select_most_precise<pdalboost::rational<T>, double>
{
    typedef typename pdalboost::rational<T> type;
};
...
// Specializes pdalboost::rational to pdalboost::numeric::bounds
...
// Support for pdalboost::numeric_cast to int and to double (necessary for SVG-mapper)
namespace pdalboost {} namespace boost = pdalboost; namespace pdalboost { namespace numeric
{
