        ...
        static void apply(ApplyMethod const&, ResultMethod const& )
        {
            ...
            BOOST_MPL_ASSERT_MSG
                (
                    (pdalboost::is_same
                        <
                            bool, typename pdalboost::function_types::result_type<ApplyMethod>::type
                        >::type::value),
            ...
            BOOST_MPL_ASSERT_MSG
                (
                    (pdalboost::is_same
                        <
                            int, typename pdalboost::function_types::result_type<ResultMethod>::type
                        >::type::value),
            ...
            pdalboost::ignore_unused_variable_warning(str);
        }
    };
            ...
            BOOST_MPL_ASSERT_MSG
                (
                    (pdalboost::is_same
                        <
                            bool, 
                            typename pdalboost::function_types::result_type<ApplyMethod>::type
                        >::type::value),
                    WRONG_RETURN_TYPE
                    , (bool)
                );
...
// So now: pdalboost::geometry::concept::within
namespace within 
{ 
...
inline void check()
{
    ...
    pdalboost::ignore_unused_variable_warning(c);
}


}}}} // namespace pdalboost::geometry::concept::within
