...
protected :
    ...
    typedef pdalboost::numeric::ublas::matrix<coordinate_type> matrix_type;
...
public :
    ...
    inline bool apply(P1 const& p1, P2& p2) const
    {
        ...
        set<0>(p2, pdalboost::numeric_cast<ct2>(p2x));
        set<1>(p2, pdalboost::numeric_cast<ct2>(p2y));
