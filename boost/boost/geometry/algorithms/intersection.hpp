...
struct intersection
{
    ...
    static inline bool apply(Geometry1 const& geometry1,
            ...
            Strategy const& strategy)
    {
        typedef typename pdalboost::range_value<GeometryOut>::type OneOut;
...
\tparam GeometryOut Collection of geometries (e.g. std::vector, std::deque, pdalboost::geometry::multi*) of which
