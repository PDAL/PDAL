            ...
            bool check_for_orientation = false)
{
...

    {
        ...
        typedef typename pdalboost::range_iterator<vector_type const>::type vector_iterator_type;
        ...
        for (map_iterator_type it = pdalboost::begin(ring_map);
            it != pdalboost::end(ring_map); ++it, ++index)
        {
        ...
        if (! check_for_orientation)
        {
            ...
            if (count_positive == 1)
            {
                ...
                std::size_t index = 0;
                for (vector_iterator_type it = pdalboost::begin(vector);
                    it != pdalboost::end(vector); ++it, ++index)
                {
