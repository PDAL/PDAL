...
{
    typedef typename pdalboost::range_value<Turns>::type tp_type;

    for (typename pdalboost::range_iterator<Turns>::type
        it = pdalboost::begin(turns);
        it != pdalboost::end(turns);
        ++it)
    {
        for (typename pdalboost::range_iterator
            <
                typename tp_type::container_type
            >::type op_it = pdalboost::begin(it->operations);
...
public :
    ...
    static inline void apply(std::size_t size_at_start, 
                Rings& rings, typename pdalboost::range_value<Rings>::type& ring,
