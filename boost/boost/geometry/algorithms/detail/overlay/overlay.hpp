...
std::cout << "traverse" << std::endl;
        ...
        // Add rings created during traversal
        {
            ...
            for (typename pdalboost::range_iterator<ring_container_type>::type
                    it = pdalboost::begin(rings);
                    it != pdalboost::end(rings);
                    ++it)
            {
...
template <>
struct do_reverse<clockwise, false> : pdalboost::false_type {};

template <>
struct do_reverse<clockwise, true> : pdalboost::true_type {};

template <>
struct do_reverse<counterclockwise, false> : pdalboost::true_type {};

template <>
struct do_reverse<counterclockwise, true> : pdalboost::false_type {};
