...
// Don't use namespace pdalboost::geometry, to enable the library to stream custom
// geometries which are living outside the namespace pdalboost::geometry
...
{
    os << pdalboost::geometry::wkt(geom);
    return os;
}
