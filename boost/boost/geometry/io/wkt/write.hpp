...
// Silence warning C4512: 'pdalboost::geometry::wkt_manipulator<Geometry>' : assignment operator could not be generated
#if defined(_MSC_VER)
#pragma warning(push)  
...
struct wkt_range
{
                ...
                Range const& range)
    {
        ...
        for (iterator_type it = pdalboost::begin(range);
...
struct wkt_segment
{
                ...
                Segment const& segment)
    {
        ...
        typedef pdalboost::array<point_type, 2> sequence;
