...
struct svg_map<multi_tag, Multi>
{
    ...
    {
        for (typename pdalboost::range_iterator<Multi const>::type it
            = pdalboost::begin(multi);
        ...
        <
            typename tag_cast
                <
                    ...
                    multi_tag
                >::type,
            typename pdalboost::remove_const<Geometry>::type
...
class svg_mapper : pdalboost::noncopyable
{
    ...
    pdalboost::scoped_ptr<transformer_type> m_matrix;
    ...
    */
                ...
                int offset_x = 0, int offset_y = 0, int lineheight = 10)
    {
        ...
        else
        {
            ...
            pdalboost::split(splitted, s, pdalboost::is_any_of("\n"));
