...
namespace pdalboost {} namespace boost = pdalboost; namespace pdalboost { namespace geometry { namespace detail { namespace iterators
{
...
<
    ...
    typename Iterator,
    typename TraversalFlag = pdalboost::bidirectional_traversal_tag
>
struct iterator_base
    ...
    <
        ...
        <
            ...
            <
                typename pdalboost::iterator_traversal<Iterator>::type,
...
}}}} // namespace pdalboost::geometry::detail::iterators
#endif
