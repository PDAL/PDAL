...
struct tag<pdalboost::adjacent_filtered_range<Filter, Geometry, DefaultPass> >
#else
struct tag<pdalboost::range_detail::adjacent_filter_range<Filter, Geometry, DefaultPass> >
#endif
{
