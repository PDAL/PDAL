...
struct tag<pdalboost::array<CoordinateType, DimensionCount> >
    : detail::boost_array_tag<pdalboost::is_arithmetic<CoordinateType>::value> {};


template <typename CoordinateType, std::size_t DimensionCount>
struct coordinate_type<pdalboost::array<CoordinateType, DimensionCount> >
{
...
template <typename CoordinateType, std::size_t DimensionCount>
struct dimension<pdalboost::array<CoordinateType, DimensionCount> >: pdalboost::mpl::int_<DimensionCount> {};


template <typename CoordinateType, std::size_t DimensionCount, std::size_t Dimension>
struct access<pdalboost::array<CoordinateType, DimensionCount>, Dimension>
{
    static inline CoordinateType get(pdalboost::array<CoordinateType, DimensionCount> const& a)
    {
        return a[Dimension];
    }

    static inline void set(pdalboost::array<CoordinateType, DimensionCount>& a,
...
#define BOOST_GEOMETRY_REGISTER_BOOST_ARRAY_CS(CoordinateSystem) \
    ...
    struct coordinate_system<pdalboost::array<T, N> > \
    { \
