...
// pdalboost::polygon::point_data -> pdalboost::geometry::point
...
struct tag<pdalboost::polygon::point_data<CoordinateType> >
{
...
template <typename CoordinateType>
struct coordinate_type<pdalboost::polygon::point_data<CoordinateType> >
{
...
template <typename CoordinateType>
struct coordinate_system<pdalboost::polygon::point_data<CoordinateType> >
{
...
template <typename CoordinateType>
struct dimension<pdalboost::polygon::point_data<CoordinateType> >
            : pdalboost::mpl::int_<2>
{};


template <typename CoordinateType>
struct access<pdalboost::polygon::point_data<CoordinateType>, 0>
{
...
template <typename CoordinateType>
struct access<pdalboost::polygon::point_data<CoordinateType>, 1>
{
    typedef pdalboost::polygon::point_data<CoordinateType> point_type;
