...
// Polygon should implement the pdalboost::polygon::polygon_with_holes_concept
...
struct holes_proxy
{
    typedef ring_proxy
        <
            typename pdalboost::mpl::if_
                <
                    typename pdalboost::is_const<Polygon>,
                    Polygon const,
                    Polygon
                >::type
        > proxy_type;
    ...
    // typedef typename pdalboost::polygon::polygon_traits<Polygon>::coordinate_type coordinate_type;
    ...
    inline void clear()
    {
        ...
        polygon.set_holes
            (
                pdalboost::polygon::begin_holes(empty),
                pdalboost::polygon::end_holes(empty)
            );
    }

    inline void resize(std::size_t new_size)
    {
        std::vector<pdalboost::polygon::polygon_data<coordinate_type> > temporary_copy
            (
                pdalboost::polygon::begin_holes(polygon),
                pdalboost::polygon::end_holes(polygon)
            );
    ...
    inline void push_back(Ring const& ring)
    {
        ...
        pdalboost::polygon::polygon_data<coordinate_type> added;
        pdalboost::polygon::set_points(added, ring.begin(), ring.end());
...
// Const versions
template<typename Polygon>
inline typename pdalboost::geometry::adapt::bp::holes_proxy<Polygon const>::iterator_type
            range_begin(pdalboost::geometry::adapt::bp::holes_proxy<Polygon const> const& proxy)
{
    typename pdalboost::geometry::adapt::bp::holes_proxy<Polygon const>::iterator_type
            begin(proxy.polygon, pdalboost::polygon::begin_holes(proxy.polygon));
    return begin;
}

template<typename Polygon>
inline typename pdalboost::geometry::adapt::bp::holes_proxy<Polygon const>::iterator_type
            range_end(pdalboost::geometry::adapt::bp::holes_proxy<Polygon const> const& proxy)
{
    typename pdalboost::geometry::adapt::bp::holes_proxy<Polygon const>::iterator_type
            end(proxy.polygon, pdalboost::polygon::end_holes(proxy.polygon));
    return end;
}

// Mutable versions
template<typename Polygon>
inline typename pdalboost::geometry::adapt::bp::holes_proxy<Polygon>::iterator_type
            range_begin(pdalboost::geometry::adapt::bp::holes_proxy<Polygon>& proxy)
{
    typename pdalboost::geometry::adapt::bp::holes_proxy<Polygon>::iterator_type
            begin(proxy.polygon, pdalboost::polygon::begin_holes(proxy.polygon));
    return begin;
}
...
template<typename Polygon>
inline typename pdalboost::geometry::adapt::bp::holes_proxy<Polygon>::iterator_type
            range_end(pdalboost::geometry::adapt::bp::holes_proxy<Polygon>& proxy)
{
    typename pdalboost::geometry::adapt::bp::holes_proxy<Polygon>::iterator_type
            end(proxy.polygon, pdalboost::polygon::end_holes(proxy.polygon));
    return end;
