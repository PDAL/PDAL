...
struct modify<true>
{
    ...
    static inline void push_back(Ring& ring, Point const& point)
    {
        ...
        std::vector<Point> temporary_vector
            (
                pdalboost::polygon::begin_points(ring),
                pdalboost::polygon::end_points(ring)
            );
        temporary_vector.push_back(point);
        pdalboost::polygon::set_points(ring, temporary_vector.begin(), temporary_vector.end());
    }
...
public :
    typedef typename pdalboost::polygon::polygon_traits
        <
            typename pdalboost::remove_const<Polygon>::type
        >::iterator_type iterator_type;

    typedef typename pdalboost::polygon::polygon_with_holes_traits
        <
            typename pdalboost::remove_const<Polygon>::type
        >::iterator_holes_type hole_iterator_type;

    static const bool is_mutable = !pdalboost::is_const<Polygon>::type::value;
    ...
    {
        return m_do_hole
            ? pdalboost::polygon::begin_points(*m_hole_it)
            : pdalboost::polygon::begin_points(*m_polygon_pointer)
            ;
    }
    ...
    {
        return m_do_hole
            ? pdalboost::polygon::end_points(*m_hole_it)
            : pdalboost::polygon::end_points(*m_polygon_pointer)
            ;
    }
    ...
    void clear()
    {
        ...
        {
            pdalboost::polygon::set_points(*m_polygon_pointer,
                pdalboost::polygon::begin_points(p),
                pdalboost::polygon::end_points(p));
        }
    }
...
template<typename Polygon>
inline typename pdalboost::geometry::adapt::bp::ring_proxy<Polygon>::iterator_type
            range_begin(pdalboost::geometry::adapt::bp::ring_proxy<Polygon>& proxy)
{
    return proxy.begin();
}

template<typename Polygon>
inline typename pdalboost::geometry::adapt::bp::ring_proxy<Polygon const>::iterator_type
            range_begin(pdalboost::geometry::adapt::bp::ring_proxy<Polygon const> const& proxy)
{
    return proxy.begin();
}
...
template<typename Polygon>
inline typename pdalboost::geometry::adapt::bp::ring_proxy<Polygon>::iterator_type
            range_end(pdalboost::geometry::adapt::bp::ring_proxy<Polygon>& proxy)
{
    return proxy.end();
}
...
template<typename Polygon>
inline typename pdalboost::geometry::adapt::bp::ring_proxy<Polygon const>::iterator_type
            range_end(pdalboost::geometry::adapt::bp::ring_proxy<Polygon const> const& proxy)
{
    return proxy.end();
}
...
{
    static inline void apply(adapt::bp::ring_proxy<Polygon> proxy,
        typename pdalboost::polygon::polygon_traits<Polygon>::point_type const& point)
    {
