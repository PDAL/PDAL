...
namespace pdalboost {} namespace boost = pdalboost; namespace pdalboost { namespace geometry { namespace concept
{
...
class Polygon
{
    ...
    typedef typename pdalboost::remove_const<PolygonType>::type polygon_type;
    ...
    //BOOST_CONCEPT_ASSERT( (pdalboost::RandomAccessRangeConcept<interior_type>) );
    ...
    struct checker
    {
        static inline void apply()
        {
            ...
            pdalboost::ignore_unused_variable_warning(e);
            pdalboost::ignore_unused_variable_warning(i);
            pdalboost::ignore_unused_variable_warning(ce);
            pdalboost::ignore_unused_variable_warning(ci);
            pdalboost::ignore_unused_variable_warning(poly);
            pdalboost::ignore_unused_variable_warning(cpoly);
        }
    };
...
class ConstPolygon
{
    ...
    typedef typename pdalboost::remove_const<PolygonType>::type const_polygon_type;
...
}}} // namespace pdalboost::geometry::concept
