...
<
    ...
    bool IsConst = pdalboost::is_const<Geometry>::type::value
>
...
struct checker<pdalboost::variant<BOOST_VARIANT_ENUM_PARAMS(T)> >
{};

template <BOOST_VARIANT_ENUM_PARAMS(typename T)>
struct checker<pdalboost::variant<BOOST_VARIANT_ENUM_PARAMS(T)> const>
{};
