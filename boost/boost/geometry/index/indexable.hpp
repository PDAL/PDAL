...
This template is also specialized for std::pair<Indexable, T2> and pdalboost::tuple<Indexable, ...>.
...
This specialization translates from pdalboost::tuple<Indexable, ...>.

\tparam Indexable   The Indexable type.
*/
template <typename Indexable, typename T1, typename T2, typename T3, typename T4,
          typename T5, typename T6, typename T7, typename T8, typename T9>
struct indexable< pdalboost::tuple<Indexable, T1, T2, T3, T4, T5, T6, T7, T8, T9> >
{
    typedef pdalboost::tuple<Indexable, T1, T2, T3, T4, T5, T6, T7, T8, T9> value_type;
