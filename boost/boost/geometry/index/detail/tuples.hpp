...
struct find_index
{
    static const size_t value =
        find_index_impl<
            ...
            El,
            N,
            typename pdalboost::tuples::element<N - 1, Tuple>::type
        >::value;
};
...
struct has<Tuple, El, 1>
{
    static const bool value
        = pdalboost::is_same<
            typename pdalboost::tuples::element<0, Tuple>::type,
            El
        >::value;
};
...
struct add<pdalboost::tuple<T1>, T>
{
    typedef pdalboost::tuple<T1, T> type;
};

template <typename T1, typename T2, typename T>
struct add<pdalboost::tuple<T1, T2>, T>
{
    typedef pdalboost::tuple<T1, T2, T> type;
};
...
struct push_back_impl
{
    ...
    pdalboost::tuples::cons<
        typename pdalboost::tuples::element<I, Tuple>::type,
...
{
    typedef pdalboost::tuples::cons<T, pdalboost::tuples::null_type> type;

    static type apply(Tuple const&, T const& t)
    {
        return type(t, pdalboost::tuples::null_type());
    }
};
