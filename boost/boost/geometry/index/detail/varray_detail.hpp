...
namespace pdalboost {} namespace boost = pdalboost; namespace pdalboost { namespace geometry { namespace index { namespace detail { namespace varray_detail {

template <typename I>
struct are_elements_contiguous : pdalboost::is_pointer<I>
{};
...
struct are_elements_contiguous<
    pdalboost::container::container_detail::vector_const_iterator<Pointer>
> : pdalboost::true_type
{};

template <typename Pointer>
struct are_elements_contiguous<
    pdalboost::container::container_detail::vector_iterator<Pointer>
> : pdalboost::true_type
{};
    ...
    ::pdalboost::mpl::and_<
        ::pdalboost::is_same<
            ::pdalboost::remove_const<
                typename ::pdalboost::iterator_value<I>::type
            >,
            ::pdalboost::remove_const<
                typename ::pdalboost::iterator_value<O>::type
            >
        >,
...
void destroy_dispatch(I /*first*/, I /*last*/,
                      pdalboost::true_type const& /*has_trivial_destructor*/)
{}

template <typename I>
void destroy_dispatch(I first, I last,
                      pdalboost::false_type const& /*has_trivial_destructor*/)
{
    typedef typename pdalboost::iterator_value<I>::type value_type;
...
inline O copy_dispatch(I first, I last, O dst,
                       pdalboost::mpl::bool_<true> const& /*use_memmove*/)
{
    typedef typename pdalboost::iterator_value<I>::type value_type;
    typename pdalboost::iterator_difference<I>::type d = std::distance(first, last);

    ::memmove(pdalboost::addressof(*dst), pdalboost::addressof(*first), sizeof(value_type) * d);
    return dst + d;
}

template <typename I, typename O>
inline O copy_dispatch(I first, I last, O dst,
                       pdalboost::mpl::bool_<false> const& /*use_memmove*/)
{
...
O uninitialized_copy_dispatch(I first, I last, O dst,
                              pdalboost::mpl::bool_<true> const& /*use_memcpy*/)
{
    typedef typename pdalboost::iterator_value<I>::type value_type;
    typename pdalboost::iterator_difference<I>::type d = std::distance(first, last);

    ::memcpy(pdalboost::addressof(*dst), pdalboost::addressof(*first), sizeof(value_type) * d);
    return dst + d;
}
...
F uninitialized_copy_dispatch(I first, I last, F dst,
                              pdalboost::mpl::bool_<false> const& /*use_memcpy*/)
{
...
F uninitialized_copy(I first, I last, F dst)
{
    ...
    ::pdalboost::mpl::and_<
        ...
        ::pdalboost::has_trivial_copy<
            typename ::pdalboost::iterator_value<F>::type
        >
    >::type
    use_memcpy;
...
O uninitialized_move_dispatch(I first, I last, O dst,
                              pdalboost::mpl::bool_<false> const& /*use_memcpy*/)
{
    //return pdalboost::uninitialized_move(first, last, dst);                         // may throw
    ...
    BOOST_TRY
    {
        ...
        for (; first != last; ++first, ++o )
            new (pdalboost::addressof(*o)) value_type(pdalboost::move(*first));
    }
    BOOST_CATCH(...)
    {
        destroy(dst, o);
...
O move_dispatch(I first, I last, O dst,
                pdalboost::mpl::bool_<false> const& /*use_memmove*/)
{
    return pdalboost::move(first, last, dst);                                         // may throw
}
...
BDO move_backward_dispatch(BDI first, BDI last, BDO dst,
                           pdalboost::mpl::bool_<true> const& /*use_memmove*/)
{
    typedef typename pdalboost::iterator_value<BDI>::type value_type;
    typename pdalboost::iterator_difference<BDI>::type d = std::distance(first, last);

    BDO foo(dst - d);
    ::memmove(pdalboost::addressof(*foo), pdalboost::addressof(*first), sizeof(value_type) * d);
    return foo;
}
...
BDO move_backward_dispatch(BDI first, BDI last, BDO dst,
                           pdalboost::mpl::bool_<false> const& /*use_memmove*/)
{
    return pdalboost::move_backward(first, last, dst);                                // may throw
}
...
BDO move_backward(BDI first, BDI last, BDO dst)
{
    ...
    ::pdalboost::mpl::and_<
        ...
        ::pdalboost::has_trivial_assign<
            typename ::pdalboost::iterator_value<BDO>::type
        >
    >::type
    use_memmove;
...
struct has_nothrow_move : public
    ::pdalboost::mpl::or_<
        pdalboost::mpl::bool_<
            ::pdalboost::has_nothrow_move<
                typename ::pdalboost::remove_const<T>::type
            >::value
        >,
        pdalboost::mpl::bool_<
            ::pdalboost::has_nothrow_move<T>::value
        >
    >
{};
...
template <typename I, typename O>
inline
O uninitialized_move_if_noexcept_dispatch(I first, I last, O dst, pdalboost::mpl::bool_<true> const& /*use_move*/)
{ return varray_detail::uninitialized_move(first, last, dst); }

template <typename I, typename O>
inline
O uninitialized_move_if_noexcept_dispatch(I first, I last, O dst, pdalboost::mpl::bool_<false> const& /*use_move*/)
...
template <typename I, typename O>
inline
O move_if_noexcept_dispatch(I first, I last, O dst, pdalboost::mpl::bool_<true> const& /*use_move*/)
{ return move(first, last, dst); }

template <typename I, typename O>
inline
O move_if_noexcept_dispatch(I first, I last, O dst, pdalboost::mpl::bool_<false> const& /*use_move*/)
...
void uninitialized_fill_dispatch(I /*first*/, I /*last*/,
                                 pdalboost::true_type const& /*has_trivial_constructor*/,
                                 pdalboost::true_type const& /*disable_trivial_init*/)
{}
...
void uninitialized_fill_dispatch(I first, I last,
                                 pdalboost::true_type const& /*has_trivial_constructor*/,
                                 pdalboost::false_type const& /*disable_trivial_init*/)
{
    typedef typename pdalboost::iterator_value<I>::type value_type;
    for ( ; first != last ; ++first )
        new (pdalboost::addressof(*first)) value_type();
}

template <typename I, typename DisableTrivialInit>
inline
void uninitialized_fill_dispatch(I first, I last,
                                 pdalboost::false_type const& /*has_trivial_constructor*/,
                                 DisableTrivialInit const& /*not_used*/)
{
    ...
    {
        for ( ; it != last ; ++it )
            new (pdalboost::addressof(*it)) value_type();                           // may throw
    }
    BOOST_CATCH(...)
    {
        destroy(first, it);
...
{
    typedef typename pdalboost::iterator_value<I>::type value_type;
    uninitialized_fill_dispatch(first, last, pdalboost::has_trivial_constructor<value_type>(), disable_trivial_init);     // may throw
}
...
template <typename I>
inline
void construct_dispatch(pdalboost::mpl::bool_<true> const& /*dont_init*/, I /*pos*/)
{}

template <typename I>
inline
void construct_dispatch(pdalboost::mpl::bool_<false> const& /*dont_init*/, I pos)
{
    typedef typename ::pdalboost::iterator_value<I>::type value_type;
    new (static_cast<void*>(::pdalboost::addressof(*pos))) value_type();                      // may throw
}
...
{
    typedef typename ::pdalboost::iterator_value<I>::type value_type;
    typedef typename ::pdalboost::mpl::and_<
        pdalboost::has_trivial_constructor<value_type>,
        DisableTrivialInit
    >::type dont_init;
...
void construct_copy_dispatch(I pos, V const& v,
                             pdalboost::mpl::bool_<true> const& /*use_memcpy*/)
{
    ::memcpy(pdalboost::addressof(*pos), pdalboost::addressof(v), sizeof(V));
}
...
void construct_copy_dispatch(I pos, P const& p,
                             pdalboost::mpl::bool_<false> const& /*use_memcpy*/)
{
    typedef typename pdalboost::iterator_value<I>::type V;
    new (static_cast<void*>(pdalboost::addressof(*pos))) V(p);                      // may throw
}
...
{
    typedef typename pdalboost::iterator_value<I>::type V;
    new (static_cast<void*>(pdalboost::addressof(*pos))) V(::pdalboost::move(p));       // may throw
}
...
void construct(DisableTrivialInit const&, I pos, BOOST_RV_REF(P) p)
{
    ...
    ::pdalboost::mpl::and_<
        is_corresponding_value<I, P>,
        ::pdalboost::has_trivial_move_constructor<P>
    >::type
    use_memcpy;

    construct_move_dispatch(pos, ::pdalboost::move(p), use_memcpy());               // may throw
}
...
{
    typedef typename pdalboost::iterator_value<I>::type V;
    new (static_cast<void*>(pdalboost::addressof(*pos))) V(::pdalboost::forward<Args>(args)...);    // may throw
}
...
{                                                                                                   \
    typedef typename pdalboost::iterator_value<I>::type V;                                              \
    new                                                                                             \
    (static_cast<void*>(pdalboost::addressof(*pos)))                                                    \
...
void assign(I pos, V const& v)
{
    ...
    ::pdalboost::mpl::and_<
        ...
        ::pdalboost::has_trivial_assign<V>
    >::type
    use_memcpy;
...
void assign_move_dispatch(I pos, BOOST_RV_REF(V) v,
                          pdalboost::mpl::bool_<false> const& /*use_memcpy*/)
{
    *pos = pdalboost::move(v);                                                        // may throw
}
...
void assign(I pos, BOOST_RV_REF(V) v)
{
    ...
    ::pdalboost::mpl::and_<
        is_corresponding_value<I, V>,
        ::pdalboost::has_trivial_move_assign<V>
    >::type
    use_memcpy;

    assign_move_dispatch(pos, ::pdalboost::move(v), use_memcpy());
}
...
}}}}} // namespace pdalboost::geometry::index::detail::varray_detail
