...
public:
    ...
    {
        ::pdalboost::ignore_unused_variable_warning(parameters);
...
private:
                                                        ...
                                                        size_t overlap_cost_threshold)
    {
        ...
        typedef pdalboost::tuple<size_t, content_type, content_type> child_contents;
        ...
        for ( size_t i = 0 ; i < children_count ; ++i )
        {
            ...
            children_contents[i] = pdalboost::make_tuple(i, content_diff, content);
                                                                            ...
                                                                            ChildrenContents const& children_contents)
    {
        ...
        for (size_t i = 0 ; i < children_count ; ++i )
        {
            ...
            content_type content = pdalboost::get<2>(children_contents[i]);
            content_type content_diff = pdalboost::get<1>(children_contents[i]);
                                                                          ...
                                                                          ChildrenContents const& children_contents)
    {
        ...
        {
            size_t child_index = pdalboost::get<0>(children_contents[i]);
    ...
    //    // create container of children sorted by content enlargement needed to include the new value
    //    std::vector< pdalboost::tuple<size_t, content_type, content_type> > sorted_children(children_count);
    //    for ( size_t i = 0 ; i < children_count ; ++i )
    //    {
    //        child_type const& ch_i = children[i];
    ...
    //        sorted_children[i] = pdalboost::make_tuple(i, content_diff, content);
    //    }
    ...
    //    for (size_t i = 0 ; i < overlap_cost_threshold ; ++i )
    //    {
    //        size_t child_index = pdalboost::get<0>(sorted_children[i]);
    ...
    static inline bool content_diff_less(pdalboost::tuple<size_t, content_type, content_type> const& p1, pdalboost::tuple<size_t, content_type, content_type> const& p2)
    {
        return pdalboost::get<1>(p1) < pdalboost::get<1>(p2) ||
               (pdalboost::get<1>(p1) == pdalboost::get<1>(p2) && pdalboost::get<2>(p1) < pdalboost::get<2>(p2));
    }
