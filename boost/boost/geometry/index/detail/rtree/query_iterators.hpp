...
namespace pdalboost {} namespace boost = pdalboost; namespace pdalboost { namespace geometry { namespace index { namespace detail { namespace rtree { namespace iterators {
...
public:
    ...
    const value_type * operator->() const
    {
        return pdalboost::addressof(m_visitor.dereference());
    }
...
}}}}}} // namespace pdalboost::geometry::index::detail::rtree::iterators
...
public:
    ...
    {
        const query_iterator_wrapper * p = dynamic_cast<const query_iterator_wrapper *>(pdalboost::addressof(r));
...
public:
    ...
    pdalboost::function<query_iterator_base*()> clone;
    pdalboost::function<bool()> is_end;
    pdalboost::function<reference()> dereference;
    pdalboost::function<void()> increment;
    pdalboost::function<bool(query_iterator_base const&)> equals;
};
...
public:
    ...
    explicit query_iterator_wrapper(Iterator const& it)
        : m_iterator(it)
    {
        base_t::clone = pdalboost::bind(&query_iterator_wrapper::clone_, this);
        base_t::is_end = pdalboost::bind(&query_iterator_wrapper::is_end_, this);
        base_t::dereference = pdalboost::bind(&query_iterator_wrapper::dereference_, this);
        base_t::increment = pdalboost::bind(&query_iterator_wrapper::increment_, this);
        base_t::equals = pdalboost::bind(&query_iterator_wrapper::equals_, this, _1);
    }
...
public:
    ...
    const value_type * operator->() const
    {
        return pdalboost::addressof(m_ptr->dereference());
    }
...
struct single_pass_iterator_concept :
    ::pdalboost::mpl::vector<
        ...
        ::pdalboost::type_erasure::dereferenceable<typename Allocators::const_reference, T>,
        ::pdalboost::type_erasure::assignable<T>,
        ::pdalboost::type_erasure::incrementable<T>,
        ::pdalboost::type_erasure::equality_comparable<T, end_query_iterator<Value, Allocators> >,
        ::pdalboost::type_erasure::relaxed // default ctor
    >
{};
...
struct single_pass_iterator_type
{
    typedef ::pdalboost::type_erasure::any<
        single_pass_iterator_concept<
            ::pdalboost::type_erasure::_self, Value, Allocators
        >
    > type;
};
...
struct concept_interface<
    ::pdalboost::geometry::index::detail::rtree::single_pass_iterator_concept<
        T, Value, Allocators
    >, Base, T>
    : Base
{
...
public:
    ...
    query_iterator(BOOST_RV_REF(query_iterator) o)
        : m_iterator(pdalboost::move(o.m_iterator))
    {}
    query_iterator & operator=(BOOST_RV_REF(query_iterator) o)
    {
        if ( this != pdalboost::addressof(o) )
    ...
    const value_type * operator->() const
    {
        return pdalboost::addressof(*m_iterator);
    }
    ...
    friend bool operator==(query_iterator const& l, query_iterator const& r)
    {
        if ( !::pdalboost::type_erasure::is_empty(l.m_iterator) )
        {
            if ( !::pdalboost::type_erasure::is_empty(r.m_iterator) )
