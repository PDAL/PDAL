...
public:
    ...
    {
        pdalboost::serialization::load_construct_data_adl(ar, this->address(), version);
    }
...
private:
    pdalboost::aligned_storage<sizeof(T), pdalboost::alignment_of<T>::value> m_storage;
};
...
{
    namespace bs = pdalboost::serialization;    
    serialization_storage<T> storage(ar, bs::version<T>::value);        // load_construct_data
    ar >> pdalboost::serialization::make_nvp(name, *storage.address());   // serialize
...
{
    namespace bs = pdalboost::serialization;
    bs::save_construct_data_adl(ar, pdalboost::addressof(t), bs::version<T>::value);  // save_construct_data
    ar << pdalboost::serialization::make_nvp(name, t);                                // serialize
    //ar << t;                                                                      // serialize
}
...
// pdalboost::geometry::index::linear

template<class Archive, size_t Max, size_t Min>
void save_construct_data(Archive & ar, const pdalboost::geometry::index::linear<Max, Min> * params, unsigned int )
{
    size_t max = params->get_max_elements(), min = params->get_min_elements();
    ar << pdalboost::serialization::make_nvp("max", max);
    ar << pdalboost::serialization::make_nvp("min", min);
}
template<class Archive, size_t Max, size_t Min>
void load_construct_data(Archive & ar, pdalboost::geometry::index::linear<Max, Min> * params, unsigned int )
{
    size_t max, min;
    ar >> pdalboost::serialization::make_nvp("max", max);
    ar >> pdalboost::serialization::make_nvp("min", min);
    ...
    //::new(params)pdalboost::geometry::index::linear<Max, Min>();
}
template<class Archive, size_t Max, size_t Min> void serialize(Archive &, pdalboost::geometry::index::linear<Max, Min> &, unsigned int) {}

// pdalboost::geometry::index::quadratic

template<class Archive, size_t Max, size_t Min>
void save_construct_data(Archive & ar, const pdalboost::geometry::index::quadratic<Max, Min> * params, unsigned int )
{
    size_t max = params->get_max_elements(), min = params->get_min_elements();
    ar << pdalboost::serialization::make_nvp("max", max);
    ar << pdalboost::serialization::make_nvp("min", min);
...
template<class Archive, size_t Max, size_t Min>
void load_construct_data(Archive & ar, pdalboost::geometry::index::quadratic<Max, Min> * params, unsigned int )
{
    size_t max, min;
    ar >> pdalboost::serialization::make_nvp("max", max);
    ar >> pdalboost::serialization::make_nvp("min", min);
    if ( max != params->get_max_elements() || min != params->get_min_elements() )
        ...
        BOOST_THROW_EXCEPTION(std::runtime_error("parameters not compatible"));
    // the constructor musn't be called for this type
    //::new(params)pdalboost::geometry::index::quadratic<Max, Min>();
}
template<class Archive, size_t Max, size_t Min> void serialize(Archive &, pdalboost::geometry::index::quadratic<Max, Min> &, unsigned int) {}

// pdalboost::geometry::index::rstar

template<class Archive, size_t Max, size_t Min, size_t RE, size_t OCT>
void save_construct_data(Archive & ar, const pdalboost::geometry::index::rstar<Max, Min, RE, OCT> * params, unsigned int )
{
    ...
    ar << pdalboost::serialization::make_nvp("max", max);
    ar << pdalboost::serialization::make_nvp("min", min);
    ar << pdalboost::serialization::make_nvp("re", re);
    ar << pdalboost::serialization::make_nvp("oct", oct);
}
template<class Archive, size_t Max, size_t Min, size_t RE, size_t OCT>
void load_construct_data(Archive & ar, pdalboost::geometry::index::rstar<Max, Min, RE, OCT> * params, unsigned int )
{
    ...
    if ( max != params->get_max_elements() || min != params->get_min_elements() ||
        ...
        BOOST_THROW_EXCEPTION(std::runtime_error("parameters not compatible"));
    // the constructor musn't be called for this type
    //::new(params)pdalboost::geometry::index::rstar<Max, Min, RE, OCT>();
}
template<class Archive, size_t Max, size_t Min, size_t RE, size_t OCT>
void serialize(Archive &, pdalboost::geometry::index::rstar<Max, Min, RE, OCT> &, unsigned int) {}

// pdalboost::geometry::index::dynamic_linear

template<class Archive>
inline void save_construct_data(Archive & ar, const pdalboost::geometry::index::dynamic_linear * params, unsigned int )
{
    size_t max = params->get_max_elements(), min = params->get_min_elements();
    ar << pdalboost::serialization::make_nvp("max", max);
    ar << pdalboost::serialization::make_nvp("min", min);
...
template<class Archive>
inline void load_construct_data(Archive & ar, pdalboost::geometry::index::dynamic_linear * params, unsigned int )
{
    size_t max, min;
    ar >> pdalboost::serialization::make_nvp("max", max);
    ar >> pdalboost::serialization::make_nvp("min", min);
    ::new(params)pdalboost::geometry::index::dynamic_linear(max, min);
}
template<class Archive> void serialize(Archive &, pdalboost::geometry::index::dynamic_linear &, unsigned int) {}

// pdalboost::geometry::index::dynamic_quadratic

template<class Archive>
inline void save_construct_data(Archive & ar, const pdalboost::geometry::index::dynamic_quadratic * params, unsigned int )
{
    size_t max = params->get_max_elements(), min = params->get_min_elements();
    ar << pdalboost::serialization::make_nvp("max", max);
    ar << pdalboost::serialization::make_nvp("min", min);
...
template<class Archive>
inline void load_construct_data(Archive & ar, pdalboost::geometry::index::dynamic_quadratic * params, unsigned int )
{
    size_t max, min;
    ar >> pdalboost::serialization::make_nvp("max", max);
    ar >> pdalboost::serialization::make_nvp("min", min);
    ::new(params)pdalboost::geometry::index::dynamic_quadratic(max, min);
}
template<class Archive> void serialize(Archive &, pdalboost::geometry::index::dynamic_quadratic &, unsigned int) {}

// pdalboost::geometry::index::dynamic_rstar

template<class Archive>
inline void save_construct_data(Archive & ar, const pdalboost::geometry::index::dynamic_rstar * params, unsigned int )
{
    size_t max = params->get_max_elements()
         , min = params->get_min_elements()
         , re = params->get_reinserted_elements()
...
template<class Archive>
inline void load_construct_data(Archive & ar, pdalboost::geometry::index::dynamic_rstar * params, unsigned int )
{
    size_t max, min, re, oct;
    ar >> pdalboost::serialization::make_nvp("max", max);
    ar >> pdalboost::serialization::make_nvp("min", min);
    ar >> pdalboost::serialization::make_nvp("re", re);
    ar >> pdalboost::serialization::make_nvp("oct", oct);
    ::new(params)pdalboost::geometry::index::dynamic_rstar(max, min, re, oct);
}
template<class Archive> void serialize(Archive &, pdalboost::geometry::index::dynamic_rstar &, unsigned int) {}

}} // pdalboost::serialization
...
struct serialize_point
{
    ...
    static inline void save(Archive & ar, P const& p, unsigned int version)
    {
        ...
        ar << pdalboost::serialization::make_nvp("c", c);
...
void save(Archive & ar, pdalboost::geometry::model::point<T, D, C> const& p, unsigned int version)
{
    pdalboost::geometry::index::detail::serialize_point< pdalboost::geometry::model::point<T, D, C> >::save(ar, p, version);
}
template<class Archive, typename T, size_t D, typename C>
void load(Archive & ar, pdalboost::geometry::model::point<T, D, C> & p, unsigned int version)
{
    pdalboost::geometry::index::detail::serialize_point< pdalboost::geometry::model::point<T, D, C> >::load(ar, p, version);
}
template<class Archive, typename T, size_t D, typename C>
inline void serialize(Archive & ar, pdalboost::geometry::model::point<T, D, C> & o, const unsigned int version) { split_free(ar, o, version); }

template<class Archive, typename P>
inline void serialize(Archive & ar, pdalboost::geometry::model::box<P> & b, const unsigned int)
{
    ar & pdalboost::serialization::make_nvp("min", b.min_corner());
    ar & pdalboost::serialization::make_nvp("max", b.max_corner());
}

}} // pdalboost::serialization

// TODO - move to index/detail/rtree/visitors/save.hpp
namespace pdalboost {} namespace boost = pdalboost; namespace pdalboost { namespace geometry { namespace index { namespace detail { namespace rtree { namespace visitors {
...
public:
    ...
    inline void operator()(internal_node const& n)
    {
        ...
        m_archive << pdalboost::serialization::make_nvp("s", s);
...
}}}}}} // pdalboost::geometry::index::detail::rtree::visitors

// TODO - move to index/detail/rtree/load.hpp
namespace pdalboost {} namespace boost = pdalboost; namespace pdalboost { namespace geometry { namespace index { namespace detail { namespace rtree {
...
private:
    ...
    node_pointer raw_apply(Archive & ar, unsigned int version, size_type leafs_level, size_type & values_count, parameters_type const& parameters, Translator const& translator, Allocators & allocators, size_type current_level = 0)
    {
        ...
        ar >> pdalboost::serialization::make_nvp("s", elements_count);
...
}}}}} // pdalboost::geometry::index::detail::rtree
...
}}}}} // namespace pdalboost::geometry::index::detail::rtree

// TODO - move to index/serialization/rtree.hpp
namespace pdalboost {} namespace boost = pdalboost; namespace pdalboost { namespace serialization {

template<class Archive, typename V, typename P, typename I, typename E, typename A>
void save(Archive & ar, pdalboost::geometry::index::rtree<V, P, I, E, A> const& rt, unsigned int version)
{
    namespace detail = pdalboost::geometry::index::detail;

    typedef pdalboost::geometry::index::rtree<V, P, I, E, A> rtree;
    ...
    ar << pdalboost::serialization::make_nvp("values_count", tree.members().values_count);
    ar << pdalboost::serialization::make_nvp("leafs_level", tree.members().leafs_level);
...
template<class Archive, typename V, typename P, typename I, typename E, typename A>
void load(Archive & ar, pdalboost::geometry::index::rtree<V, P, I, E, A> & rt, unsigned int version)
{
    namespace detail = pdalboost::geometry::index::detail;
    ...
    ar >> pdalboost::serialization::make_nvp("values_count", values_count);
    ar >> pdalboost::serialization::make_nvp("leafs_level", leafs_level);
...
void serialize(Archive & ar, pdalboost::geometry::index::rtree<V, P, I, E, A> & rt, unsigned int version)
{
    split_free(ar, rt, version);
}

template<class Archive, typename V, typename P, typename I, typename E, typename A> inline
void serialize(Archive & ar, pdalboost::geometry::index::rtree<V, P, I, E, A> const& rt, unsigned int version)
{
    split_free(ar, rt, version);
}
