...
/*!
\defgroup rtree_functions R-tree free functions (pdalboost::geometry::index::)
*/
...
\li <tt>pdalboost::geometry::index::linear</tt>,
 \li <tt>pdalboost::geometry::index::quadratic</tt>,
 \li <tt>pdalboost::geometry::index::rstar</tt>.

\par
Predefined algorithms with run-time parameters are:
 \li \c pdalboost::geometry::index::dynamic_linear,
 \li \c pdalboost::geometry::index::dynamic_quadratic,
 \li \c pdalboost::geometry::index::dynamic_rstar.
...
<tt>pdalboost::tuple<Indexable, ...></tt>. For example, if <tt>std::pair<Box, int></tt> is stored in the
...
The default EqualTo returns the result of <tt>pdalboost::geometry::equals()</tt> for types adapted to some Geometry concept
...
public:
    ...
    */
        ...
        : m_members(getter, equal, parameters, allocator)
    {
        typedef detail::rtree::pack<value_type, options_type, translator_type, box_type, allocators_type> pack;
        size_type vc = 0, ll = 0;
        m_members.root = pack::apply(::pdalboost::begin(rng), ::pdalboost::end(rng), vc, ll,
                                     m_members.parameters(), m_members.translator(), m_members.allocators());
        m_members.values_count = vc;
        m_members.leafs_level = ll;
    }
    ...
    */
    inline rtree(BOOST_RV_REF(rtree) src)
        : m_members(src.m_members.indexable_getter(),
                    src.m_members.equal_to(),
                    src.m_members.parameters(),
                    pdalboost::move(src.m_members.allocators()))
    {
        pdalboost::swap(m_members.values_count, src.m_members.values_count);
        pdalboost::swap(m_members.leafs_level, src.m_members.leafs_level);
        pdalboost::swap(m_members.root, src.m_members.root);
    }
...
// TODO - shouldn't here propagate_on_container_copy_assignment be checked like in operator=(const&)?
    ...
    */
    ...
    {
        pdalboost::swap(m_members.indexable_getter(), other.m_members.indexable_getter());
        pdalboost::swap(m_members.equal_to(), other.m_members.equal_to());
        pdalboost::swap(m_members.parameters(), other.m_members.parameters());
        ...
        pdalboost::swap(m_members.values_count, other.m_members.values_count);
        pdalboost::swap(m_members.leafs_level, other.m_members.leafs_level);
        pdalboost::swap(m_members.root, other.m_members.root);
    }
    ...
    */
    ...
    inline void insert(Range const& rng)
    {
        ...
        typedef typename pdalboost::range_const_iterator<Range>::type It;
        for ( It it = pdalboost::const_begin(rng); it != pdalboost::const_end(rng) ; ++it )
            this->raw_insert(*it);
    }
    ...
    */
    ...
    \li \c pdalboost::geometry::index::contains(),
    \li \c pdalboost::geometry::index::covered_by(),
    \li \c pdalboost::geometry::index::covers(),
    \li \c pdalboost::geometry::index::disjoint(),
    \li \c pdalboost::geometry::index::intersects(),
    \li \c pdalboost::geometry::index::overlaps(),
    \li \c pdalboost::geometry::index::within(),

    It is possible to negate spatial predicates:
    \li <tt>! pdalboost::geometry::index::contains()</tt>,
    \li <tt>! pdalboost::geometry::index::covered_by()</tt>,
    \li <tt>! pdalboost::geometry::index::covers()</tt>,
    \li <tt>! pdalboost::geometry::index::disjoint()</tt>,
    \li <tt>! pdalboost::geometry::index::intersects()</tt>,
    \li <tt>! pdalboost::geometry::index::overlaps()</tt>,
    \li <tt>! pdalboost::geometry::index::within()</tt>
    ...
    \li \c pdalboost::geometry::index::satisfies().
    ...
    \li \c pdalboost::geometry::index::nearest().
    ...
    */
    ...
    size_type query(Predicates const& predicates, OutIter out_it) const
    {
        ...
        return query_dispatch(predicates, out_it, pdalboost::mpl::bool_<is_distance_predicate>());
    }
...
// If exception is thrown, m_values_count may be invalid
    ...
    */
    template <typename Predicates, typename OutIter>
    size_type query_dispatch(Predicates const& predicates, OutIter out_it, pdalboost::mpl::bool_<false> const& /*is_distance_predicate*/) const
    {
    ...
    */
    template <typename Predicates, typename OutIter>
    size_type query_dispatch(Predicates const& predicates, OutIter out_it, pdalboost::mpl::bool_<true> const& /*is_distance_predicate*/) const
    {
    ...
    public:
        ...
        members_holder(IndGet const& ind_get,
            ...
            , allocators_type(pdalboost::forward<Alloc>(alloc))
            , values_count(0)
            , leafs_level(0)
            , root(0)
        {}
