...
/*!
\defgroup predicates Predicates (pdalboost::geometry::index::)
*/
...
pdalboost::tuples::cons<
    Pred1,
    pdalboost::tuples::cons<Pred2, pdalboost::tuples::null_type>
>
operator&&(Pred1 const& p1, Pred2 const& p2)
{
    /*typedef typename pdalboost::mpl::if_c<is_predicate<Pred1>::value, Pred1, Pred1 const&>::type stored1;
    typedef typename pdalboost::mpl::if_c<is_predicate<Pred2>::value, Pred2, Pred2 const&>::type stored2;*/
    namespace bt = pdalboost::tuples;
...
>::type
operator&&(pdalboost::tuples::cons<Head, Tail> const& t, Pred const& p)
{
    //typedef typename pdalboost::mpl::if_c<is_predicate<Pred>::value, Pred, Pred const&>::type stored;
    namespace bt = pdalboost::tuples;
