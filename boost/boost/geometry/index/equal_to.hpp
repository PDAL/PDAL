...
struct tuple_equals
{
    ...
    {
        typedef typename pdalboost::tuples::element<I, Tuple>::type T;
        return
            equals<
                T, typename geometry::traits::tag<T>::type
            >::apply(pdalboost::get<I>(t1), pdalboost::get<I>(t2))
            &&
...
This template is also specialized for std::pair<T1, T2> and pdalboost::tuple<...>.
...
This specialization compares values of type pdalboost::tuple<...>.
It compares all members of the tuple from the first one to the last one.
*/
template <typename T0, typename T1, typename T2, typename T3, typename T4,
          typename T5, typename T6, typename T7, typename T8, typename T9>
struct equal_to< pdalboost::tuple<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9> >
{
    typedef pdalboost::tuple<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9> value_type;
    ...
    */
    bool operator()(value_type const& l, value_type const& r) const
    {
        return detail::tuple_equals<
            value_type, 0, pdalboost::tuples::length<value_type>::value
        >::apply(l ,r);
    }
};
