      ...
      >
{
                ...
                Strategy const& strategy)
    {
        ...
        for(typename range_iterator<MultiGeometry const>::type it = pdalboost::begin(multi);
      ...
      >
{
                ...
                Multi2 const& multi2, Strategy const& strategy)
    {
        ...
        for(typename range_iterator<Multi1 const>::type it = pdalboost::begin(multi1);
                it != pdalboost::end(multi1);
                ++it, first = false)
        {
