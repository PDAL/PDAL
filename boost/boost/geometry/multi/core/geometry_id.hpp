...
template <>
struct geometry_id<multi_point_tag>      : pdalboost::mpl::int_<4> {};


template <>
struct geometry_id<multi_linestring_tag> : pdalboost::mpl::int_<5> {};


template <>
struct geometry_id<multi_polygon_tag>    : pdalboost::mpl::int_<6> {};
