...
template <>
struct top_dim<multi_point_tag> : pdalboost::mpl::int_<0> {};


template <>
struct top_dim<multi_linestring_tag> : pdalboost::mpl::int_<1> {};


template <>
struct top_dim<multi_polygon_tag> : pdalboost::mpl::int_<2> {};
