...
// Specializations for linestring/ring, via pdalboost::range
template <typename Linestring>
struct point_type<linestring_tag, Linestring>
{
    typedef typename pdalboost::range_value<Linestring>::type type;
};
...
{
    typedef typename pdalboost::range_value<Ring>::type type;
};
...
struct point_type
{
    typedef typename core_dispatch::point_type
        <
            ...
            typename pdalboost::geometry::util::bare_type<Geometry>::type
        >::type type;
};
