...
template <>
struct geometry_id<point_tag>      : pdalboost::mpl::int_<1> {};


template <>
struct geometry_id<linestring_tag> : pdalboost::mpl::int_<2> {};


template <>
struct geometry_id<polygon_tag>    : pdalboost::mpl::int_<3> {};


template <>
struct geometry_id<segment_tag>    : pdalboost::mpl::int_<92> {};


template <>
struct geometry_id<ring_tag>       : pdalboost::mpl::int_<93> {};


template <>
struct geometry_id<box_tag>        : pdalboost::mpl::int_<94> {};
...
\details The meta-function geometry_id defines a numerical ID (based on 
    pdalboost::mpl::int_<...> ) for each geometry concept. A numerical ID is 
