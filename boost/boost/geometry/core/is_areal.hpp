...
template <typename GeometryTag> struct is_areal : pdalboost::false_type {};

template <> struct is_areal<ring_tag> : pdalboost::true_type {};
template <> struct is_areal<box_tag> : pdalboost::true_type {};
template <> struct is_areal<polygon_tag> : pdalboost::true_type {};
