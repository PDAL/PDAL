...
template <>
struct top_dim<point_tag>      : pdalboost::mpl::int_<0> {};


template <>
struct top_dim<linestring_tag> : pdalboost::mpl::int_<1> {};


template <>
struct top_dim<segment_tag>    : pdalboost::mpl::int_<1> {};


// ring: topological dimension of two, but some people say: 1 !!
template <>
struct top_dim<ring_tag>       : pdalboost::mpl::int_<2> {};


template <>
struct top_dim<box_tag>        : pdalboost::mpl::int_<2> {};


template <>
struct top_dim<polygon_tag>    : pdalboost::mpl::int_<2> {};
