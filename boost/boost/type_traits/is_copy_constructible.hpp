...
//                                                        ^ 
    ...
    template <class T1>
    static pdalboost::type_traits::yes_type test(T1&, pdalboost::mpl::int_<sizeof(T1(pdalboost::declval<T1&>()))>* = 0);
#else
    template <class T1>
    static pdalboost::type_traits::yes_type test(T1&, decltype(T1(pdalboost::declval<T1&>()))* = 0);
#endif
...
#else
    template <class T1>
    static pdalboost::type_traits::no_type test(T1&, typename T1::boost_move_no_copy_constructor_or_assign* = 0);
    ...
    BOOST_STATIC_CONSTANT(bool, value = (
            sizeof(test(
                pdalboost::declval<BOOST_DEDUCED_TYPENAME pdalboost::add_reference<T>::type>()
...
BOOST_TT_AUX_BOOL_TRAIT_DEF1(is_copy_constructible,T,::pdalboost::detail::is_copy_constructible_impl<T>::value)
