...
{ 
    BOOST_STATIC_CONSTANT(bool, value = 
        sizeof(::pdalboost::detail::is_array_tester2(
            ::pdalboost::detail::is_array_tester1(
                ::pdalboost::type_traits::wrap<T>()
                )
        )) == 1
    );
};
...
BOOST_TT_AUX_BOOL_TRAIT_DEF1(is_array,T,::pdalboost::detail::is_array_impl<T>::value)
