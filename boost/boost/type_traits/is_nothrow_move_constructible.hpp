...
struct is_nothrow_move_constructible_imp{
   BOOST_STATIC_CONSTANT(bool, value = 
        (::pdalboost::type_traits::ice_and<
            ...
            ::pdalboost::detail::false_or_cpp11_noexcept_move_constructible<T>::value
        >::value));
};
    ...
    BOOST_STATIC_CONSTANT(bool, value =(
        ::pdalboost::type_traits::ice_and<
            ::pdalboost::type_traits::ice_or<
                ::pdalboost::has_trivial_move_constructor<T>::value,
                ::pdalboost::has_nothrow_copy<T>::value
            >::value,
...
BOOST_TT_AUX_BOOL_TRAIT_DEF1(is_nothrow_move_constructible,T,::pdalboost::detail::is_nothrow_move_constructible_imp<T>::value)
