   ...
   ::pdalboost::type_traits::ice_or<\
      ::pdalboost::type_traits::ice_and<\
         ...
         ::pdalboost::type_traits::ice_and<\
            ...
            ::pdalboost::type_traits::ice_not< ::pdalboost::is_convertible< Rhs_nocv, bool >::value >::value\
         >::value\
      >::value,\
      ::pdalboost::type_traits::ice_and<\
         ...
         ::pdalboost::type_traits::ice_and<\
            ...
            ::pdalboost::type_traits::ice_not< ::pdalboost::is_convertible< Lhs_nocv, bool >::value >::value\
         >::value\
      >::value\
   >::value
