...
#       define BOOST_HAS_TRIVIAL_MOVE_CONSTRUCTOR(T) ((__has_trivial_move_constructor(T) || ::pdalboost::is_pod<T>::value) && !::pdalboost::is_volatile<T>::value)
#       define BOOST_HAS_TRIVIAL_MOVE_ASSIGN(T) ((__has_trivial_move_assign(T) || ::pdalboost::is_pod<T>::value) && ! ::pdalboost::is_const<T>::value && !::pdalboost::is_volatile<T>::value)
#   endif
