...
class shared_container_iterator : public iterator_adaptor<
  ...
  typedef pdalboost::shared_ptr<Container> container_ref_t;
...
make_shared_container_iterator(typename Container::iterator iter,
                               pdalboost::shared_ptr<Container> const& container) {
...
std::pair<
  shared_container_iterator<Container>,
  shared_container_iterator<Container> >
make_shared_container_range(pdalboost::shared_ptr<Container> const& container) {
  return
    std::make_pair(
