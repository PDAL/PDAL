...
namespace pdalboost {} namespace boost = pdalboost; namespace pdalboost {
  ...
  struct property_traits :
    pdalboost::mpl::if_<is_property_map<PA>,
...
# endif
  ...
  struct property_traits<T*> {
    // BOOST_STATIC_ASSERT(pdalboost::is_same<T, T*>::value && !"Using pointers as property maps is deprecated");
  ...
  // do pdalboost::get() anyways, and the using clause
...
namespace pdalboost {} namespace boost = pdalboost; namespace pdalboost {
  ...
  struct ReadablePropertyMapConcept
  {
    ...
    typedef pdalboost::readable_property_map_tag ReadableTag;
    void constraints() {
  ...
  struct WritablePropertyMapConcept
  {
    typedef typename property_traits<PMap>::key_type key_type;
    typedef typename property_traits<PMap>::category Category;
    typedef pdalboost::writable_property_map_tag WritableTag;
    void constraints() {
  ...
  {
    typedef typename property_traits<PMap>::category Category;
    typedef pdalboost::read_write_property_map_tag ReadWriteTag;
    void constraints() {
  ...
  {
    typedef typename property_traits<PMap>::category Category;
    typedef pdalboost::lvalue_property_map_tag LvalueTag;
    typedef typename property_traits<PMap>::reference reference;
    ...
    void constraints() {
      ...
      BOOST_MPL_ASSERT((pdalboost::mpl::or_<
                          pdalboost::is_same<const value_type&, reference>,
                          pdalboost::is_same<value_type&, reference> >));
  ...
  struct Mutable_LvaluePropertyMapConcept
  {
    ...
    typedef typename property_traits<PMap>::reference reference;
    void constraints() { 
      pdalboost::function_requires< ReadWritePropertyMapConcept<PMap, Key> >();
      pdalboost::function_requires<ConvertibleConcept<Category, LvalueTag> >();
      
      typedef typename property_traits<PMap>::value_type value_type;
      BOOST_MPL_ASSERT((pdalboost::is_same<value_type&, reference>));
  ...
  class iterator_property_map
    : public pdalboost::put_get_helper< R, 
  ...
  inline safe_iterator_property_map<
    RAIter, ID,
    typename pdalboost::detail::iterator_traits<RAIter>::value_type,
    typename pdalboost::detail::iterator_traits<RAIter>::reference>
  make_safe_iterator_property_map(RAIter iter, std::size_t n, ID id) {
    function_requires< RandomAccessIteratorConcept<RAIter> >();
    typedef safe_iterator_property_map<
      RAIter, ID,
      typename pdalboost::detail::iterator_traits<RAIter>::value_type,
      typename pdalboost::detail::iterator_traits<RAIter>::reference> PA;
    return PA(iter, n, id);
  }
#endif
  template <class RAIter, class Value, class ID>
  ...
  class static_property_map :
      public
  pdalboost::put_get_helper<ValueType,static_property_map<ValueType> >
  { 
    ValueType value;
  public:
  ...
  class ref_property_map :
    public
      pdalboost::put_get_helper<ValueType&,ref_property_map<KeyType,ValueType> >
  { 
    ValueType* value;
  public:
  ...
  template <typename T>
  struct typed_identity_property_map
    : public pdalboost::put_get_helper<T, typed_identity_property_map<T> >
  {
    typedef T key_type;
    typedef T value_type;
    typedef T reference;
...
//=========================================================================
  ...
  class dummy_property_map 
    : public pdalboost::put_get_helper<detail::dummy_pmap_reference,
        dummy_property_map  > 
  {
  public:
    typedef void key_type; 
    ...
    typedef pdalboost::read_write_property_map_tag category;
