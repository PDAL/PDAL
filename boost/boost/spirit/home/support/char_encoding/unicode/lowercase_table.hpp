...
{
    static const ::pdalboost::uint8_t lowercase_stage1[] = {
    ...
    static const ::pdalboost::uint32_t lowercase_stage2[] = {
    ...
    inline ::pdalboost::uint32_t lowercase_lookup(::pdalboost::uint32_t ch)
    {
        ::pdalboost::uint32_t block_offset = lowercase_stage1[ch / 256] * 256;
