...
#define SPIRIT_DECLARE_ARG(z, n, data)                                        \
    typedef pdalboostphoenix::actor<argument<n> >                                      \
        BOOST_PP_CAT(BOOST_PP_CAT(_, BOOST_PP_INC(n)), _type);                \
    pdalboostphoenix::actor<argument<n> > const                                        \
...
BOOST_PHOENIX_DEFINE_CUSTOM_TERMINAL(
    template <typename Dummy>
  , pdalboost::spirit::attribute_context<Dummy>
  , mpl::false_                 // is not nullary
  , v2_eval(
        proto::make<
            pdalboost::spirit::attribute_context<Dummy>()
...
namespace pdalboost{} namespace boost = pdalboost; namespace pdalboost{ namespace spirit
{
    ...
    typedef pdalboostphoenix::actor<attribute_context<void> > _0_type;
#ifndef BOOST_SPIRIT_NO_PREDEFINED_TERMINALS
    ...
    typedef pdalboostphoenix::actor<argument<0> > _1_type;
    typedef pdalboostphoenix::actor<argument<1> > _2_type;
    typedef pdalboostphoenix::actor<argument<2> > _3_type;
    ...
    typedef pdalboostphoenix::arg_names::_3_type _pass_type;
#ifndef BOOST_SPIRIT_NO_PREDEFINED_TERMINALS
