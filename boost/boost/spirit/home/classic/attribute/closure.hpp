...
BOOST_SPIRIT_CLASSIC_NAMESPACE_BEGIN
    ...
    public:
        ...
        typedef typename ::pdalboostphoenix::tuple_element<0,
        ...
        { hit.value(frame[::pdalboostphoenix::tuple_index<0>()]); return hit; }

    private:

        ::pdalboostphoenix::closure_frame<typename ClosureT::phoenix_closure_t> frame;
    };
    ...
    //      contains pdalboostphoenix::actor objects. These actors have to be
    //      dereferenced to gain the values to be used for initialization
    //      (this is done by the help of the pdalboostphoenix::convert_actors<>
    //      template).
    //
    ///////////////////////////////////////////////////////////////////////////
    ...
    public:
        ...
        : frame(clos.subject(), ::pdalboostphoenix::convert_actors<tuple_t>(clos.init)) {}
    ...
    private:
        ...
        ::pdalboostphoenix::closure_frame<closure_t> frame;
    };
    ...
    : public unary<ParserT, parser<init_closure_parser<ParserT, ActorTupleT> > >
    {
        ...
        typedef typename ::pdalboostphoenix::tuple_element<0, tuple_t>::type   attr_t;
    ...
    >
    struct closure :
        public ::pdalboostphoenix::closure<
            T0, T1, T2
    #if BOOST_SPIRIT_CLOSURE_LIMIT > 3
        ,   T3, T4, T5
    #if BOOST_SPIRIT_CLOSURE_LIMIT > 6
        ...
        >
    {
        typedef ::pdalboostphoenix::closure<
                T0, T1, T2
    #if BOOST_SPIRIT_CLOSURE_LIMIT > 3
            ,   T3, T4, T5
    #if BOOST_SPIRIT_CLOSURE_LIMIT > 6
        ...
        // initialization functions
            ...
            init_closure_parser<
                DerivedT2,
                ::pdalboostphoenix::tuple<
                    typename ::pdalboostphoenix::as_actor<A>::type
                >
            >
            operator()(A const &a) const
            {
                typedef typename ::pdalboostphoenix::as_actor<A>::type a_t;
                typedef ::pdalboostphoenix::tuple<a_t> actor_tuple_t;

                return init_closure_parser<DerivedT2, actor_tuple_t>(
                        aux_derived(),
                        actor_tuple_t(
                            ::pdalboostphoenix::as_actor<A>::convert(a)
                        )
                    );
            }
            ...
            init_closure_parser<
                ...
                ::pdalboostphoenix::tuple<
                    typename ::pdalboostphoenix::as_actor<A>::type,
                    typename ::pdalboostphoenix::as_actor<B>::type
                >
            >
            operator()(A const &a, B const &b) const
            {
                typedef typename ::pdalboostphoenix::as_actor<A>::type a_t;
                typedef typename ::pdalboostphoenix::as_actor<B>::type b_t;
                typedef ::pdalboostphoenix::tuple<a_t, b_t> actor_tuple_t;

                return init_closure_parser<DerivedT2, actor_tuple_t>(
                        aux_derived(),
                        actor_tuple_t(
                            ::pdalboostphoenix::as_actor<A>::convert(a),
                            ::pdalboostphoenix::as_actor<B>::convert(b)
                        )
                    );
            }
            ...
            init_closure_parser<
                ...
                ::pdalboostphoenix::tuple<
                    typename ::pdalboostphoenix::as_actor<A>::type,
                    typename ::pdalboostphoenix::as_actor<B>::type,
                    typename ::pdalboostphoenix::as_actor<C>::type
                >
            >
            operator()(A const &a, B const &b, C const &c) const
            {
                typedef typename ::pdalboostphoenix::as_actor<A>::type a_t;
                typedef typename ::pdalboostphoenix::as_actor<B>::type b_t;
                typedef typename ::pdalboostphoenix::as_actor<C>::type c_t;
                typedef ::pdalboostphoenix::tuple<a_t, b_t, c_t> actor_tuple_t;
                ...
                return init_closure_parser<DerivedT2, actor_tuple_t>(
                        ...
                        actor_tuple_t(
                            ::pdalboostphoenix::as_actor<A>::convert(a),
                            ::pdalboostphoenix::as_actor<B>::convert(b),
                            ::pdalboostphoenix::as_actor<C>::convert(c)
                        )
                    );
            }
            ...
            init_closure_parser<
                ...
                ::pdalboostphoenix::tuple<
                    ...
                    typename ::pdalboostphoenix::as_actor<B>::type,
                    typename ::pdalboostphoenix::as_actor<C>::type,
                    typename ::pdalboostphoenix::as_actor<D>::type
                >
            >
            operator()(
            ...
            ) const
            {
                ...
                typedef typename ::pdalboostphoenix::as_actor<B>::type b_t;
                typedef typename ::pdalboostphoenix::as_actor<C>::type c_t;
                typedef typename ::pdalboostphoenix::as_actor<D>::type d_t;
                typedef ::pdalboostphoenix::tuple<
                            a_t, b_t, c_t, d_t
                        > actor_tuple_t;
                ...
                return init_closure_parser<DerivedT2, actor_tuple_t>(
                        ...
                        actor_tuple_t(
                            ...
                            ::pdalboostphoenix::as_actor<B>::convert(b),
                            ::pdalboostphoenix::as_actor<C>::convert(c),
                            ::pdalboostphoenix::as_actor<D>::convert(d)
                        )
                    );
            }
            ...
            init_closure_parser<
                ...
                ::pdalboostphoenix::tuple<
                    ...
                    typename ::pdalboostphoenix::as_actor<C>::type,
                    typename ::pdalboostphoenix::as_actor<D>::type,
                    typename ::pdalboostphoenix::as_actor<E>::type
                >
            >
            operator()(
            ...
            ) const
            {
                ...
                typedef typename ::pdalboostphoenix::as_actor<C>::type c_t;
                typedef typename ::pdalboostphoenix::as_actor<D>::type d_t;
                typedef typename ::pdalboostphoenix::as_actor<E>::type e_t;
                typedef ::pdalboostphoenix::tuple<
                            a_t, b_t, c_t, d_t, e_t
                        > actor_tuple_t;
                ...
                return init_closure_parser<DerivedT2, actor_tuple_t>(
                        ...
                        actor_tuple_t(
                            ...
                            ::pdalboostphoenix::as_actor<C>::convert(c),
                            ::pdalboostphoenix::as_actor<D>::convert(d),
                            ::pdalboostphoenix::as_actor<E>::convert(e)
                        )
                    );
            }
            ...
            init_closure_parser<
                ...
                ::pdalboostphoenix::tuple<
                    ...
                    typename ::pdalboostphoenix::as_actor<D>::type,
                    typename ::pdalboostphoenix::as_actor<E>::type,
                    typename ::pdalboostphoenix::as_actor<F>::type
                >
            >
            operator()(
                A const &a, B const &b, C const &c, D const &d, E const &e,
            ...
            ) const
            {
                ...
                typedef typename ::pdalboostphoenix::as_actor<D>::type d_t;
                typedef typename ::pdalboostphoenix::as_actor<E>::type e_t;
                typedef typename ::pdalboostphoenix::as_actor<F>::type f_t;
                typedef ::pdalboostphoenix::tuple<
                ...
                return init_closure_parser<DerivedT2, actor_tuple_t>(
                        ...
                        actor_tuple_t(
                            ...
                            ::pdalboostphoenix::as_actor<D>::convert(d),
                            ::pdalboostphoenix::as_actor<E>::convert(e),
                            ::pdalboostphoenix::as_actor<F>::convert(f)
                        )
                    );
            }
            ...
            init_closure_parser<
                ...
                ::pdalboostphoenix::tuple<
                    ...
                    typename ::pdalboostphoenix::as_actor<E>::type,
                    typename ::pdalboostphoenix::as_actor<F>::type,
                    typename ::pdalboostphoenix::as_actor<G>::type
                >
            >
            operator()(
                A const &a, B const &b, C const &c, D const &d, E const &e,
            ...
            ) const
            {
                ...
                typedef typename ::pdalboostphoenix::as_actor<E>::type e_t;
                typedef typename ::pdalboostphoenix::as_actor<F>::type f_t;
                typedef typename ::pdalboostphoenix::as_actor<G>::type g_t;
                typedef ::pdalboostphoenix::tuple<
                ...
                return init_closure_parser<DerivedT2, actor_tuple_t>(
                        ...
                        actor_tuple_t(
                            ...
                            ::pdalboostphoenix::as_actor<E>::convert(e),
                            ::pdalboostphoenix::as_actor<F>::convert(f),
                            ::pdalboostphoenix::as_actor<G>::convert(g)
                        )
                    );
            }
            ...
            init_closure_parser<
                ...
                ::pdalboostphoenix::tuple<
                    ...
                    typename ::pdalboostphoenix::as_actor<F>::type,
                    typename ::pdalboostphoenix::as_actor<G>::type,
                    typename ::pdalboostphoenix::as_actor<H>::type
                >
            >
            operator()(
                A const &a, B const &b, C const &c, D const &d, E const &e,
            ...
            ) const
            {
                ...
                typedef typename ::pdalboostphoenix::as_actor<F>::type f_t;
                typedef typename ::pdalboostphoenix::as_actor<G>::type g_t;
                typedef typename ::pdalboostphoenix::as_actor<H>::type h_t;
                typedef ::pdalboostphoenix::tuple<
                ...
                return init_closure_parser<DerivedT2, actor_tuple_t>(
                        ...
                        actor_tuple_t(
                            ...
                            ::pdalboostphoenix::as_actor<F>::convert(f),
                            ::pdalboostphoenix::as_actor<G>::convert(g),
                            ::pdalboostphoenix::as_actor<H>::convert(h)
                        )
                    );
            }
            ...
            init_closure_parser<
                ...
                ::pdalboostphoenix::tuple<
                    ...
                    typename ::pdalboostphoenix::as_actor<G>::type,
                    typename ::pdalboostphoenix::as_actor<H>::type,
                    typename ::pdalboostphoenix::as_actor<I>::type
                >
            >
            operator()(
                A const &a, B const &b, C const &c, D const &d, E const &e,
            ...
            ) const
            {
                ...
                typedef typename ::pdalboostphoenix::as_actor<G>::type g_t;
                typedef typename ::pdalboostphoenix::as_actor<H>::type h_t;
                typedef typename ::pdalboostphoenix::as_actor<I>::type i_t;
                typedef ::pdalboostphoenix::tuple<
                ...
                return init_closure_parser<DerivedT2, actor_tuple_t>(
                        ...
                        actor_tuple_t(
                            ...
                            ::pdalboostphoenix::as_actor<G>::convert(g),
                            ::pdalboostphoenix::as_actor<H>::convert(h),
                            ::pdalboostphoenix::as_actor<I>::convert(i)
                        )
                    );
            }
            ...
            init_closure_parser<
                ...
                ::pdalboostphoenix::tuple<
                    ...
                    typename ::pdalboostphoenix::as_actor<H>::type,
                    typename ::pdalboostphoenix::as_actor<I>::type,
                    typename ::pdalboostphoenix::as_actor<J>::type
                >
            >
            operator()(
                A const &a, B const &b, C const &c, D const &d, E const &e,
            ...
            ) const
            {
                ...
                typedef typename ::pdalboostphoenix::as_actor<H>::type h_t;
                typedef typename ::pdalboostphoenix::as_actor<I>::type i_t;
                typedef typename ::pdalboostphoenix::as_actor<J>::type j_t;
                typedef ::pdalboostphoenix::tuple<
                ...
                return init_closure_parser<DerivedT2, actor_tuple_t>(
                        ...
                        actor_tuple_t(
                            ...
                            ::pdalboostphoenix::as_actor<H>::convert(h),
                            ::pdalboostphoenix::as_actor<I>::convert(i),
                            ::pdalboostphoenix::as_actor<J>::convert(j)
                        )
                    );
            }
            ...
            init_closure_parser<
                ...
                ::pdalboostphoenix::tuple<
                    ...
                    typename ::pdalboostphoenix::as_actor<I>::type,
                    typename ::pdalboostphoenix::as_actor<J>::type,
                    typename ::pdalboostphoenix::as_actor<K>::type
                >
            >
            operator()(
                A const &a, B const &b, C const &c, D const &d, E const &e,
            ...
            ) const
            {
                ...
                typedef typename ::pdalboostphoenix::as_actor<I>::type i_t;
                typedef typename ::pdalboostphoenix::as_actor<J>::type j_t;
                typedef typename ::pdalboostphoenix::as_actor<K>::type k_t;
                typedef ::pdalboostphoenix::tuple<
                            a_t, b_t, c_t, d_t, e_t, f_t, g_t, h_t, i_t, j_t,
                            k_t
                        > actor_tuple_t;
                ...
                return init_closure_parser<DerivedT2, actor_tuple_t>(
                        ...
                        actor_tuple_t(
                            ...
                            ::pdalboostphoenix::as_actor<I>::convert(i),
                            ::pdalboostphoenix::as_actor<J>::convert(j),
                            ::pdalboostphoenix::as_actor<K>::convert(k)
                        )
                    );
            }
            ...
            init_closure_parser<
                ...
                ::pdalboostphoenix::tuple<
                    ...
                    typename ::pdalboostphoenix::as_actor<J>::type,
                    typename ::pdalboostphoenix::as_actor<K>::type,
                    typename ::pdalboostphoenix::as_actor<L>::type
                >
            >
            operator()(
                A const &a, B const &b, C const &c, D const &d, E const &e,
            ...
            ) const
            {
                ...
                typedef typename ::pdalboostphoenix::as_actor<J>::type j_t;
                typedef typename ::pdalboostphoenix::as_actor<K>::type k_t;
                typedef typename ::pdalboostphoenix::as_actor<L>::type l_t;
                typedef ::pdalboostphoenix::tuple<
                            a_t, b_t, c_t, d_t, e_t, f_t, g_t, h_t, i_t, j_t,
                            k_t, l_t
                        > actor_tuple_t;
                ...
                return init_closure_parser<DerivedT2, actor_tuple_t>(
                        ...
                        actor_tuple_t(
                            ...
                            ::pdalboostphoenix::as_actor<J>::convert(j),
                            ::pdalboostphoenix::as_actor<K>::convert(k),
                            ::pdalboostphoenix::as_actor<L>::convert(l)
                        )
                    );
            }
            ...
            init_closure_parser<
                ...
                ::pdalboostphoenix::tuple<
                    ...
                    typename ::pdalboostphoenix::as_actor<K>::type,
                    typename ::pdalboostphoenix::as_actor<L>::type,
                    typename ::pdalboostphoenix::as_actor<M>::type
                >
            >
            operator()(
                A const &a, B const &b, C const &c, D const &d, E const &e,
            ...
            ) const
            {
                ...
                typedef typename ::pdalboostphoenix::as_actor<K>::type k_t;
                typedef typename ::pdalboostphoenix::as_actor<L>::type l_t;
                typedef typename ::pdalboostphoenix::as_actor<M>::type m_t;
                typedef ::pdalboostphoenix::tuple<
                            a_t, b_t, c_t, d_t, e_t, f_t, g_t, h_t, i_t, j_t,
                            k_t, l_t, m_t
                        > actor_tuple_t;
                ...
                return init_closure_parser<DerivedT2, actor_tuple_t>(
                        ...
                        actor_tuple_t(
                            ...
                            ::pdalboostphoenix::as_actor<K>::convert(k),
                            ::pdalboostphoenix::as_actor<L>::convert(l),
                            ::pdalboostphoenix::as_actor<M>::convert(m)
                        )
                    );
            }
            ...
            init_closure_parser<
                ...
                ::pdalboostphoenix::tuple<
                    ...
                    typename ::pdalboostphoenix::as_actor<L>::type,
                    typename ::pdalboostphoenix::as_actor<M>::type,
                    typename ::pdalboostphoenix::as_actor<N>::type
                >
            >
            operator()(
                A const &a, B const &b, C const &c, D const &d, E const &e,
            ...
            ) const
            {
                ...
                typedef typename ::pdalboostphoenix::as_actor<L>::type l_t;
                typedef typename ::pdalboostphoenix::as_actor<M>::type m_t;
                typedef typename ::pdalboostphoenix::as_actor<N>::type n_t;
                typedef ::pdalboostphoenix::tuple<
                            a_t, b_t, c_t, d_t, e_t, f_t, g_t, h_t, i_t, j_t,
                            k_t, l_t, m_t, n_t
                        > actor_tuple_t;
                ...
                return init_closure_parser<DerivedT2, actor_tuple_t>(
                        ...
                        actor_tuple_t(
                            ...
                            ::pdalboostphoenix::as_actor<L>::convert(l),
                            ::pdalboostphoenix::as_actor<M>::convert(m),
                            ::pdalboostphoenix::as_actor<N>::convert(n)
                        )
                    );
            }
            ...
            init_closure_parser<
                ...
                ::pdalboostphoenix::tuple<
                    ...
                    typename ::pdalboostphoenix::as_actor<M>::type,
                    typename ::pdalboostphoenix::as_actor<N>::type,
                    typename ::pdalboostphoenix::as_actor<O>::type
                >
            >
            operator()(
                A const &a, B const &b, C const &c, D const &d, E const &e,
            ...
            ) const
            {
                ...
                typedef typename ::pdalboostphoenix::as_actor<M>::type m_t;
                typedef typename ::pdalboostphoenix::as_actor<N>::type n_t;
                typedef typename ::pdalboostphoenix::as_actor<O>::type o_t;
                typedef ::pdalboostphoenix::tuple<
                            a_t, b_t, c_t, d_t, e_t, f_t, g_t, h_t, i_t, j_t,
                            k_t, l_t, m_t, n_t, o_t
                        > actor_tuple_t;
                ...
                return init_closure_parser<DerivedT2, actor_tuple_t>(
                        ...
                        actor_tuple_t(
                            ...
                            ::pdalboostphoenix::as_actor<M>::convert(m),
                            ::pdalboostphoenix::as_actor<N>::convert(n),
                            ::pdalboostphoenix::as_actor<O>::convert(o)
                        )
                    );
            }
    ...
    struct container_begin
    {
        ...
        struct result
        {
            typedef typename ::pdalboostphoenix::actor_result<ActorT, TupleT>
        ...
        template <typename TupleT>
        typename ::pdalboostphoenix::actor_result<self_t, TupleT>::type
    ...
    inline f_chseq<
        ::pdalboostphoenix::actor<container_begin< ::pdalboostphoenix::actor<BaseT> > >,
        ::pdalboostphoenix::actor<container_end< ::pdalboostphoenix::actor<BaseT> > >
    >
    f_chseq_p(::pdalboostphoenix::actor<BaseT> const& a)
    {
        typedef ::pdalboostphoenix::actor<container_begin< ::pdalboostphoenix::actor<BaseT> > >
            container_begin_t;
        typedef ::pdalboostphoenix::actor<container_end< ::pdalboostphoenix::actor<BaseT> > >
            container_end_t;
    ...
    inline f_strlit<
        ...
        ::pdalboostphoenix::actor<container_end< ::pdalboostphoenix::actor<BaseT> > >
    >
    f_str_p(::pdalboostphoenix::actor<BaseT> const& a)
    {
        typedef ::pdalboostphoenix::actor<container_begin< ::pdalboostphoenix::actor<BaseT> > >
            container_begin_t;
        typedef ::pdalboostphoenix::actor<container_end< ::pdalboostphoenix::actor<BaseT> > >
