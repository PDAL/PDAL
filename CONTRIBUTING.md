...
* [Run _all_ the tests](https://pdal.org/project/testing.html) to assure nothing else was accidentally broken.
...
* [PDAL's coding conventions](https://pdal.org/project/conventions.html)
